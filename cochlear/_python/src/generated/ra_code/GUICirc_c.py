...
class Code(AbstractCode):
    ...
    def GUI_FillEllipse(self, x0, y0, rx, ry):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def Draw8Point(self, x0, y0, xoff, yoff):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_DrawEllipse(self, x0, y0, rx, ry):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_FillCircle(self, x0, y0, r):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_DrawCircle(self, x0, y0, r):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_FillEllipse(self, x0, y0, rx, ry):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GUI_DrawEllipse(self, x0, y0, rx, ry):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GUI_DrawCircle(self, x0, y0, r):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GUI_FillCircle(self, x0, y0, r):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_FillEllipse = StaticFunction(device, 0x2f756, thumb=1, name='GUI_FillEllipse', return_type=None, size=126, line=197, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le)])
        self.Draw8Point = StaticFunction(device, 0x2f93e, thumb=1, name='Draw8Point', return_type=None, size=158, line=47, arg_list=[('x0',c_int_le),('y0',c_int_le),('xoff',c_int_le),('yoff',c_int_le)])
        self.GL_DrawEllipse = StaticFunction(device, 0x2f7d4, thumb=1, name='GL_DrawEllipse', return_type=None, size=176, line=219, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le)])
        self.GL_FillCircle = StaticFunction(device, 0x2f61c, thumb=1, name='GL_FillCircle', return_type=None, size=186, line=113, arg_list=[('x0',c_int_le),('y0',c_int_le),('r',c_int_le)])
        self.GL_DrawCircle = StaticFunction(device, 0x2f4a0, thumb=1, name='GL_DrawCircle', return_type=None, size=378, line=70, arg_list=[('x0',c_int_le),('y0',c_int_le),('r',c_int_le)])
        self.GL_FillEllipse = StaticFunction(device, 0x2f6d8, thumb=1, name='GL_FillEllipse', return_type=None, size=126, line=172, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le)])
        self.GUI_DrawEllipse = StaticFunction(device, 0x2f884, thumb=1, name='GUI_DrawEllipse', return_type=None, size=186, line=253, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le)])
        self.GUI_DrawCircle = StaticFunction(device, 0x2f61a, thumb=1, name='GUI_DrawCircle', return_type=None, size=2, line=89, arg_list=[('x0',c_int_le),('y0',c_int_le),('r',c_int_le)])
        self.GUI_FillCircle = StaticFunction(device, 0x2f6d6, thumb=1, name='GUI_FillCircle', return_type=None, size=2, line=138, arg_list=[('x0',c_int_le),('y0',c_int_le),('r',c_int_le)])
