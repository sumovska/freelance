...
class Code(AbstractCode):
    ...
    def GUI_ClearRect(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        self._HL_APIList = StaticVariable(device, self.tLCD_HL_APIList, 0x61254, True)
        ...
        ### Functions data ###
        ######################
        self.GUI_Clear = StaticFunction(device, 0x2afd2, thumb=1, name='GUI_Clear', return_type=None, size=42, line=130, arg_list=[])
        self.GUI_ClearRect = StaticFunction(device, 0x2afa8, thumb=1, name='GUI_ClearRect', return_type=None, size=42, line=102, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.GUI_Init = StaticFunction(device, 0x2affc, thumb=1, name='GUI_Init', return_type=c_int_le, size=80, line=142, arg_list=[])
