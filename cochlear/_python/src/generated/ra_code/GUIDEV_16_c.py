...
class Code(AbstractCode):
    ...
    def _SetPixelIndex(self, x, y, Index):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 624
        '''
        pass

    def _GetPixelIndex(self, x, y):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def _DrawHLine(self, x0, y, x1):
        ...
        Return type:
        -None
        Declaration line: 577
        '''
        pass

    def _DrawBitmap(self, x0, y0, xsize, ysize, BitsPerPixel, BytesPerLine, pData, Diff, pTrans):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        self.aID = StaticVariable(device, c_ushort_le * 16, 0x61b2c, True)
        ...
        ### Functions data ###
        ######################
        self._SetPixelIndex = StaticFunction(device, 0x2e032, thumb=1, name='_SetPixelIndex', return_type=None, size=94, line=624, arg_list=[('x',c_int_le),('y',c_int_le),('Index',c_int_le)])
        self._GetPixelIndex = StaticFunction(device, 0x2e0fa, thumb=1, name='_GetPixelIndex', return_type=c_uint_le, size=50, line=654, arg_list=[('x',c_int_le),('y',c_int_le)])
        self._DrawHLine = StaticFunction(device, 0x2df1c, thumb=1, name='_DrawHLine', return_type=None, size=296, line=577, arg_list=[('x0',c_int_le),('y',c_int_le),('x1',c_int_le)])
        self._DrawBitmap = StaticFunction(device, 0x2d698, thumb=1, name='_DrawBitmap', return_type=None, size=1956, line=448, arg_list=[('x0',c_int_le),('y0',c_int_le),('xsize',c_int_le),('ysize',c_int_le),('BitsPerPixel',c_int_le),('BytesPerLine',c_int_le),('pData',PointerType('c_ubyte')),('Diff',c_int_le),('pTrans',PointerType("c_ushort_le"))])
        self._DrawVLine = StaticFunction(device, 0x2df20, thumb=1, name='_DrawVLine', return_type=None, size=274, line=585, arg_list=[('x',c_int_le),('y0',c_int_le),('y1',c_int_le)])
        self._XorPixel = StaticFunction(device, 0x2e090, thumb=1, name='_XorPixel', return_type=None, size=106, line=638, arg_list=[('x',c_int_le),('y',c_int_le)])
