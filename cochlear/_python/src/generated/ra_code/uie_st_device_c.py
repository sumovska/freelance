...
class Code(AbstractCode):
    ...
    def ShowFmAdvantage(self, me, updateMode):
        '''
        Arguments:
    ...
    def UIE_P_StRaBeeps(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        ...
        Return type:
        -HSM_StateRet_t
        Declaration line: 879
        '''
        pass

    def UIE_P_StBteBeeps(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StBteVersion(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_IsSceneIconsInDeviceCarousel(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1209
        '''
        pass

    def UIE_P_IsFmAdvantageInDeviceCarousel(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1200
        '''
        pass

    def UIE_P_StSceneIcons(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StDeviceSettingsCarousel(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StAccessoryMixing(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 290
        '''
        pass

    def UIE_P_StBilateralControl(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StBteButtons(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StBteLights(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 773
        '''
        pass

    def UIE_P_StIntraOpSettingsCarousel(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 137
        '''
        pass

    def UIE_P_StFmAdvantage(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StRaAlerts(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 953
        '''
        pass

    def UIE_P_StRaVersion(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1158
        '''
        pass

    def UIE_P_StTelecoilMixing(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.ShowFmAdvantage = StaticFunction(device, 0x3d68c, thumb=1, name='ShowFmAdvantage', return_type=None, size=352, line=402, arg_list=[('me',PointerType('UIE_P_Sm_t')),('updateMode',WAGUI_UpdateMode_t)])
        self.UIE_P_StRaBeeps = StaticFunction(device, 0x3dc7c, thumb=1, name='UIE_P_StRaBeeps', return_type=HSM_StateRet_t, size=198, line=879, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StBteBeeps = StaticFunction(device, 0x3da2a, thumb=1, name='UIE_P_StBteBeeps', return_type=HSM_StateRet_t, size=284, line=671, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StBteVersion = StaticFunction(device, 0x3deba, thumb=1, name='UIE_P_StBteVersion', return_type=HSM_StateRet_t, size=140, line=1104, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_IsSceneIconsInDeviceCarousel = StaticFunction(device, 0x3e024, thumb=1, name='UIE_P_IsSceneIconsInDeviceCarousel', return_type=bool, size=68, line=1209, arg_list=[])
        self.UIE_P_IsFmAdvantageInDeviceCarousel = StaticFunction(device, 0x3dfd4, thumb=1, name='UIE_P_IsFmAdvantageInDeviceCarousel', return_type=bool, size=80, line=1200, arg_list=[])
        self.UIE_P_StSceneIcons = StaticFunction(device, 0x3de0c, thumb=1, name='UIE_P_StSceneIcons', return_type=HSM_StateRet_t, size=174, line=1033, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StDeviceSettingsCarousel = StaticFunction(device, 0x3d320, thumb=1, name='UIE_P_StDeviceSettingsCarousel', return_type=HSM_StateRet_t, size=116, line=72, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StAccessoryMixing = StaticFunction(device, 0x3d520, thumb=1, name='UIE_P_StAccessoryMixing', return_type=HSM_StateRet_t, size=364, line=290, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StBilateralControl = StaticFunction(device, 0x3d860, thumb=1, name='UIE_P_StBilateralControl', return_type=HSM_StateRet_t, size=170, line=498, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StBteButtons = StaticFunction(device, 0x3d90a, thumb=1, name='UIE_P_StBteButtons', return_type=HSM_StateRet_t, size=288, line=569, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StBteLights = StaticFunction(device, 0x3db46, thumb=1, name='UIE_P_StBteLights', return_type=HSM_StateRet_t, size=310, line=773, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StIntraOpSettingsCarousel = StaticFunction(device, 0x3d394, thumb=1, name='UIE_P_StIntraOpSettingsCarousel', return_type=HSM_StateRet_t, size=116, line=137, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StFmAdvantage = StaticFunction(device, 0x3d7ec, thumb=1, name='UIE_P_StFmAdvantage', return_type=HSM_StateRet_t, size=116, line=444, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StRaAlerts = StaticFunction(device, 0x3dd42, thumb=1, name='UIE_P_StRaAlerts', return_type=HSM_StateRet_t, size=202, line=953, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StRaVersion = StaticFunction(device, 0x3df46, thumb=1, name='UIE_P_StRaVersion', return_type=HSM_StateRet_t, size=68, line=1158, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StTelecoilMixing = StaticFunction(device, 0x3d408, thumb=1, name='UIE_P_StTelecoilMixing', return_type=HSM_StateRet_t, size=280, line=193, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.IsFmOrMm = StaticFunction(device, 0x3df8a, thumb=1, name='IsFmOrMm', return_type=bool, size=74, line=1185, arg_list=[('bteId',WBST_BteId_t)])
