...
class MCL_P_MVBTInitCtx_tag(Structure):
    bteId = INT_Bte_t
    pendingWriteCoefficient = bool
    issuedCoefficient = CIP_CoefficientId_t
    initializationInProgress = bool
    implantType = u8
    implantId = u32
    intraImplantType = u8
    intraImplantId = u32
    pendingFailingStopFitting = bool
    reportedBteError = MCL_Status_t
...
MCL_P_MVBTInitCtx_t = MCL_P_MVBTInitCtx_tag
...
class const():
    ...
    ### Defines ###
    ###############
    MCL_MVBT_MEASURE_LINK_ELECTRODE_RETRIES = 4
    MCL_MVBT_IMP_EL_NUM = 22
...
class Code(AbstractCode):
    ...
    MCL_P_MVBTInitCtx_tag = MCL_P_MVBTInitCtx_tag
    os_stk_data = os_stk_data
    ...
    MCL_P_MVBTInitCtx_t = MCL_P_MVBTInitCtx_t
    ...
    def MCL_P_MVBTRespMeasureImplantID(self, pCtx, pEvent):
        '''
        Arguments:
    ...
    def MCL_P_MVBTRespMeasureLink(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
    ...
    def mvbtFinishInitialization(self, pCtx, mclStatus):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        ...
        Return type:
        -None
        Declaration line: 831
        '''
        pass

    def MCL_P_MVBTRespStopFitting(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTGetResp(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTRespStartFitting(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTErrResp(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTRespReadCoef(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTRespWriteCoef(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 493
        '''
        pass

    def MCL_P_MVBTRespMeasureImpedance(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTGetReq(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTSetResp(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTSetReq(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def MCL_P_MVBTInitReq(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    OSIdleCtr = INT32U
    mclMvbtSetCache = MCL_P_MVBTSet_t
    OSCtxSwCtr = INT32U
    OSRunning = BOOLEAN
    OSTaskCtr = INT8U
    OSTmrTime = INT32U
    ...
    def __init__(self, device):
        ...
        self.mclMvbtSetCache = StaticVariable(device, self.MCL_P_MVBTSet_t, 0x8000838eL, False)
        ...
        self.initCtx = StaticVariable(device, self.MCL_P_MVBTInitCtx_t, 0x4000a694, False)
        ...
        ### Functions data ###
        ######################
        self.MCL_P_MVBTRespMeasureImplantID = StaticFunction(device, 0x373a0, thumb=1, name='MCL_P_MVBTRespMeasureImplantID', return_type=None, size=60, line=610, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.MCL_P_MVBTRespMeasureLink = StaticFunction(device, 0x37434, thumb=1, name='MCL_P_MVBTRespMeasureLink', return_type=None, size=204, line=674, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.mvbtFinishInitialization = StaticFunction(device, 0x36fc6, thumb=1, name='mvbtFinishInitialization', return_type=None, size=80, line=831, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('mclStatus',MCL_Status_t)])
        self.MCL_P_MVBTRespStopFitting = StaticFunction(device, 0x37376, thumb=1, name='MCL_P_MVBTRespStopFitting', return_type=None, size=42, line=597, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTGetResp = StaticFunction(device, 0x36ee8, thumb=1, name='MCL_P_MVBTGetResp', return_type=None, size=66, line=150, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTRespStartFitting = StaticFunction(device, 0x3733e, thumb=1, name='MCL_P_MVBTRespStartFitting', return_type=None, size=56, line=573, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTErrResp = StaticFunction(device, 0x37500, thumb=1, name='MCL_P_MVBTErrResp', return_type=None, size=168, line=770, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTRespReadCoef = StaticFunction(device, 0x370da, thumb=1, name='MCL_P_MVBTRespReadCoef', return_type=None, size=400, line=339, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTRespWriteCoef = StaticFunction(device, 0x3726a, thumb=1, name='MCL_P_MVBTRespWriteCoef', return_type=None, size=212, line=493, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTRespMeasureImpedance = StaticFunction(device, 0x373dc, thumb=1, name='MCL_P_MVBTRespMeasureImpedance', return_type=None, size=88, line=635, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTGetReq = StaticFunction(device, 0x36eac, thumb=1, name='MCL_P_MVBTGetReq', return_type=None, size=60, line=117, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTSetResp = StaticFunction(device, 0x36f84, thumb=1, name='MCL_P_MVBTSetResp', return_type=None, size=66, line=230, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTSetReq = StaticFunction(device, 0x36f2a, thumb=1, name='MCL_P_MVBTSetReq', return_type=None, size=90, line=187, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_MVBTInitReq = StaticFunction(device, 0x37016, thumb=1, name='MCL_P_MVBTInitReq', return_type=None, size=196, line=263, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
