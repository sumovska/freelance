...
class Code(AbstractCode):
    ...
    def MCL_P_ImpedanceCheck(self, impedance):
        '''
        Arguments:
        -impedance - u16
        Return type:
    ...
    def MCL_P_ImpedanceCheckFlaggedOnly(self, impedance):
        '''
        Arguments:
        -impedance - u16
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.MCL_P_ImpedanceCheck = StaticFunction(device, 0x36c6c, thumb=1, name='MCL_P_ImpedanceCheck', return_type=MCL_ElImpStatus_t, size=24, line=65, arg_list=[('impedance',u16)])
        self.MCL_P_ImpedanceCheckFlaggedOnly = StaticFunction(device, 0x36c84, thumb=1, name='MCL_P_ImpedanceCheckFlaggedOnly', return_type=MCL_ElImpStatus_t, size=16, line=76, arg_list=[('impedance',u16)])
