...
class Code(AbstractCode):
    ...
    def WAE_P_UIE_SendBteAlarm(self, alarmMask, bteId):
        '''
        Arguments:
        -alarmMask - s16
        -bteId - WBST_BteId_t
    ...
    def WAE_P_UIE_SendBtePollModeStatus(self, newPollMode):
        '''
        Arguments:
        -newPollMode - WAE_PollingMode_t
        Return type:
        -None
    ...
    def WAE_P_UIE_SendBteStatus(self, statId, bteId, statCode):
        '''
        Arguments:
        -statId - WAE_BteStatusId_t
        -bteId - WBST_BteId_t
    ...
    def WAE_P_UIE_SendWaStatus(self, statId):
        '''
        Arguments:
        -statId - WAE_WaStatusId_t
        Return type:
    ...
    def WAE_P_UIE_EventsPending(self, ):
        '''
        Arguments:
        Return type:
        -bool
    ...
    def WAE_P_UIE_SendWaAlarm(self, alarmMask):
        '''
        Arguments:
        -alarmMask - s16
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.WAE_P_UIE_SendBteAlarm = StaticFunction(device, 0x4775c, thumb=1, name='WAE_P_UIE_SendBteAlarm', return_type=None, size=30, line=122, arg_list=[('alarmMask',s16),('bteId',WBST_BteId_t)])
        self.WAE_P_UIE_SendBtePollModeStatus = StaticFunction(device, 0x4777a, thumb=1, name='WAE_P_UIE_SendBtePollModeStatus', return_type=None, size=26, line=161, arg_list=[('newPollMode',WAE_PollingMode_t)])
        self.WAE_P_UIE_SendBteStatus = StaticFunction(device, 0x47738, thumb=1, name='WAE_P_UIE_SendBteStatus', return_type=None, size=36, line=80, arg_list=[('statId',WAE_BteStatusId_t),('bteId',WBST_BteId_t),('statCode',WAE_StatusCode_t)])
        self.WAE_P_UIE_SendWaStatus = StaticFunction(device, 0x47794, thumb=1, name='WAE_P_UIE_SendWaStatus', return_type=None, size=26, line=197, arg_list=[('statId',WAE_WaStatusId_t)])
        self.WAE_P_UIE_EventsPending = StaticFunction(device, 0x477c8, thumb=1, name='WAE_P_UIE_EventsPending', return_type=bool, size=24, line=260, arg_list=[])
        self.WAE_P_UIE_SendWaAlarm = StaticFunction(device, 0x477ae, thumb=1, name='WAE_P_UIE_SendWaAlarm', return_type=None, size=26, line=230, arg_list=[('alarmMask',s16)])
