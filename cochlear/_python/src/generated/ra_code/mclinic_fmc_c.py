...
class MCL_P_FmcAnrtErrorNextStep_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_FMC_ANRT_ERR_RETRY_NRT_TRACE = 0
    MCL_FMC_ANRT_ERR_SKIP = 1
    MCL_FMC_ANRT_ERR_FAIL = 2
...
class MCL_P_NrtStatus_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_NRT_PROCESS_CONTINUE = 0
    MCL_NRT_PROCESS_ASC_SUCCEEDED = 1
    MCL_NRT_PROCESS_SUCCEEDED = 2
    MCL_NRT_PROCESS_FAILED = 3
    MCL_NRT_PROCESS_PARAM_INVALID = 4
...
class MCL_P_FmcStage_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_FMC_STAGE_INACTIVE = 0
    MCL_FMC_STAGE_START_FITTING = 1
    MCL_FMC_STAGE_MEASURE_IMPLANT = 2
    MCL_FMC_STAGE_MEASURE_IMPEDANCE = 3
    MCL_FMC_STAGE_CONDITION_EL = 4
    MCL_FMC_STAGE_MEASURE_NRT = 5
    MCL_FMC_STAGE_READ_IMPEDANCE_1 = 6
    MCL_FMC_STAGE_READ_IMPEDANCE_2 = 7
    MCL_FMC_STAGE_MEASURE_LINK = 8
    MCL_FMC_STAGE_WRITE_LINK_CONST = 9
    MCL_FMC_STAGE_WRITE_PROFILE_T = 10
    MCL_FMC_STAGE_WRITE_PROFILE_C = 11
    MCL_FMC_STAGE_STOP_FITTING = 12
...
class MCL_P_ANrtRetCode_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_A_NRT_OK_NEXT_CL = 0
    MCL_A_NRT_OK_NEXT_STAGE = 1
    MCL_A_NRT_OK_FINISHED = 2
    MCL_A_NRT_FAILURE = 3
...
class MCL_P_FmcContinueStatus_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_FMC_CONTINUE_OK = 0
    MCL_FMC_CONTINUE_END_OF_ANRT = 1
    MCL_FMC_CONTINUE_STOPPED = 2
    MCL_FMC_CONTINUE_EXCESSIVE_SKIP = 3
    MCL_FMC_CONTINUE_NO_REPLACEMENT_ELECTRODE = 4
    MCL_FMC_CONTINUE_NOT_ENOUGH_VIABLE_ELECTRODES = 5
    MCL_FMC_CONTINUE_COMS_ERROR = 6
    MCL_FMC_CONTINUE_INTERNAL_ERROR = 7
...
class MCL_P_NrtTimeout_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_NRT_TIMEOUT_MIN = 0
    MCL_NRT_TIMEOUT_MAX = 1
    MCL_NRT_TIMEOUT_NUM = 2
...
MCL_P_FmcContinueStatus_t = MCL_P_FmcContinueStatus_tag
...
MCL_P_NrtTimeout_t = MCL_P_NrtTimeout_tag
...
MCL_P_FmcAnrtErrorNextStep_t = MCL_P_FmcAnrtErrorNextStep_tag
...
MCL_P_FmcStage_t = MCL_P_FmcStage_tag
...
MCL_P_ANrtRetCode_t = MCL_P_ANrtRetCode_tag
CIP_MixingRatio_t = CIP_MixingRatio_tag
CIP_MemoryType_t = CIP_MemoryType_tag
MCL_P_NrtStatus_t = MCL_P_NrtStatus_tag
OS_FLAGS = INT16U
...
class MCL_P_FmcCfg_tag(Structure):
    conditioningCL = u8
    intraStimCLStart = u8
    intraStimCLMin = u8
    intraStimCLMax = u8
...
class MCL_P_NrtTrace_tag(Structure):
    traceSample = c_float_le * 30
    paramN1P1 = c_float_le
    paramNoise = c_float_le
    paramN1P1DivNoise = c_float_le
    paramRResp = c_float_le
    paramRRespArtefact = c_float_le
    paramRPrev = c_float_le
    currentLvl = u8
    resultCode = u8
    resultFlag = u8
    x__pad = u8 * 5
...
class MCL_P_FmcCtx_tag(Structure):
    clbkFmc = MCL_FMCStatusCallback_t
    clbkAnrt = MCL_ANRTStatusCallback_t
    clbkElCond = MCL_ElConditionStatusCallback_t
    bteId = INT_Bte_t
    flow = MCL_FlowType_t
    stage = MCL_P_FmcStage_t
    status = MCL_P_FmcContinueStatus_t
    aNrtECAPNo = u8
    aNrtSkipNo = u8
    aNrtElIdx = u8
    aNrtElList = u8 * 22
    ...
    implantType = u8
    implantId = u32
    measureImpedanceCG = bool
    measureImpedanceMP1 = bool
    measureImpedanceMP2 = bool
    measureImpedanceMP1plus2 = bool
    flaggedAuto = u32
    flaggedManual = u32
    measuredElectrodes = u32
    recordingEl = u8
    condElectrLeftRetries = u8
    measureNrtLeftRetries = u8
    measureNrtTimeout = u16
    measureLinkLeftRetries = u8
    linkConstK = u16
    linkConstA = u16
    linkConstB = u16
    pendingForFailingStopFitting = bool
    originalMCLstatus = MCL_Status_t
    originalFMCstatus = MCL_FMCStatus_t
    _fields_ = [
                ('clbkFmc', MCL_FMCStatusCallback_t),
                ('clbkAnrt', MCL_ANRTStatusCallback_t),
                ('clbkElCond', MCL_ElConditionStatusCallback_t),
...
class MCL_P_NrtTraceLogData_tag(Structure):
    probeElectrode = u8
    recordingElectrode = u8
    probeRate = u8
    traceGain = u16
    traceScale = u16
    NrtTraceMicroS = u8 * 30
    aNrtStatus = MCL_P_NrtStatus_t
    _fields_ = [
                ('probeElectrode', u8),
                ('recordingElectrode', u8),
                ('probeRate', u8),
...
MCL_P_NrtTrace_t = MCL_P_NrtTrace_tag
...
MCL_P_FmcCfg_t = MCL_P_FmcCfg_tag
...
MCL_P_FmcCtx_t = MCL_P_FmcCtx_tag
...
MCL_P_NrtTraceLogData_t = MCL_P_NrtTraceLogData_tag
...
class const():
    ...
    ###############
    MCL_TRACE_MAX = 30
    MCL_A_NRT_ECAP_NO_INTRA = 3
    MCL_A_NRT_ECAP_NO_POST = 3
    MCL_A_NRT_MAX_SKIP_NO = 3
    MCL_FMC_A_NRT_EL_NUM = 22
    MCL_FMC_IMP_EL_NUM = 22
    MCL_FMC_ALL_EL_NUM = 24
    MCL_FMC_FIRST_ELECTRODE_ID = 1
    MCL_FMC_CONDITION_ELECTRODE_RETRIES = 5
    MCL_FMC_MEASURE_NRT_TRACE_RETRIES = 3
    MCL_FMC_MEASURE_LINK_ELECTRODE_RETRIES = 4
    ...
    MCL_NRT_SAMPLES_NUM = 30
    MAX_ALLOWED_TNRT_MAX_MIN_DIFFERENCE = 20
...
class Code(AbstractCode):
    ...
    MCL_P_FmcAnrtErrorNextStep_tag = MCL_P_FmcAnrtErrorNextStep_tag
    ...
    MCL_P_NrtStatus_tag = MCL_P_NrtStatus_tag
    ...
    MCL_P_FmcStage_tag = MCL_P_FmcStage_tag
    ...
    MCL_P_ANrtRetCode_tag = MCL_P_ANrtRetCode_tag
    ...
    MCL_P_FmcContinueStatus_tag = MCL_P_FmcContinueStatus_tag
    ...
    MCL_P_NrtTimeout_tag = MCL_P_NrtTimeout_tag
    ...
    MCL_P_FmcContinueStatus_t = MCL_P_FmcContinueStatus_t
    ...
    MCL_P_NrtTimeout_t = MCL_P_NrtTimeout_t
    ...
    MCL_P_FmcAnrtErrorNextStep_t = MCL_P_FmcAnrtErrorNextStep_t
    ...
    MCL_P_FmcStage_t = MCL_P_FmcStage_t
    ...
    MCL_P_ANrtRetCode_t = MCL_P_ANrtRetCode_t
    CIP_MixingRatio_t = CIP_MixingRatio_t
    CIP_MemoryType_t = CIP_MemoryType_t
    MCL_P_NrtStatus_t = MCL_P_NrtStatus_t
    OS_FLAGS = OS_FLAGS
    ...
    MCL_P_FmcCfg_tag = MCL_P_FmcCfg_tag
    os_mutex_data = os_mutex_data
    ...
    os_mem = os_mem
    os_tmr = os_tmr
    MCL_P_NrtTrace_tag = MCL_P_NrtTrace_tag
    ...
    MCL_P_FmcCtx_tag = MCL_P_FmcCtx_tag
    ...
    MCL_P_NrtTraceLogData_tag = MCL_P_NrtTraceLogData_tag
    os_mem_data = os_mem_data
    os_stk_data = os_stk_data
    ...
    MCL_P_NrtTrace_t = MCL_P_NrtTrace_t
    ...
    MCL_P_NrtTraceLogData_t = MCL_P_NrtTraceLogData_t
    ...
    def fmcCtxReset(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1907
        '''
        pass

    def MCL_P_FmcConfigure(self, conditioningCL, intraStimCLStart, intraStimCLMin, intraStimCLMax, intraProbeRate, postStimCLStart, postStimCLMin, postStimCLMax, postProbeRate):
        '''
        Arguments:
        -conditioningCL - u8
        -intraStimCLStart - u8
    ...
    def isFmcError(self, status):
        '''
        Arguments:
        -status - MCL_P_FmcContinueStatus_t
        Return type:
        -bool
        Declaration line: 2050
        '''
        pass

    def shouldWritePopulationMeanProfile(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 2620
        '''
        pass

    def MCL_P_FmcStart(self, pCtx, pEvent):
        '''
        Arguments:
    ...
    def MCL_P_FmcRespWriteCoefficient(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
        Return type:
        -None
        Declaration line: 1589
        '''
        pass

    def fmcRecordingProcedure(self, status):
        '''
        Arguments:
        -status - MCL_P_FmcContinueStatus_t
        Return type:
        -Status
        Declaration line: 2476
        '''
        pass

    def fmcInterpolateReverseNormaliseAndCalculateMean(self, ):
        '''
        Arguments:
        Return type:
        -Status
        Declaration line: 2349
        '''
        pass

    def MCL_P_FmcRespStartFitting(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
        Return type:
        -None
        Declaration line: 836
        '''
        pass

    def fmcRespBteErrorDuringAnrt(self, bteError):
        '''
        Arguments:
        -bteError - CIP_ProcResult_t
        Return type:
        -MCL_P_FmcAnrtErrorNextStep_t
        Declaration line: 2638
        '''
        pass

    def fmcFindNextProbeElectrode(self, ):
        '''
        Arguments:
        Return type:
        -MCL_P_FmcContinueStatus_t
        Declaration line: 2066
        '''
        pass

    def fmcReInitNrt(self, ):
        '''
        Arguments:
        Return type:
        -Status
        Declaration line: 2287
        '''
        pass

    def getFmcReportingStatus(self, status, mclStatus, fmcStatus):
        '''
        Arguments:
        -status - MCL_P_FmcContinueStatus_t
        -mclStatus - PointerType("MCL_Status_t")
        -fmcStatus - PointerType('MCL_FMCStatus_t')
        Return type:
        -None
        Declaration line: 2415
        '''
        pass

    def MCL_P_FmcContinue(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
        Return type:
        -None
        Declaration line: 562
        '''
        pass

    def fmcFailProcedure(self, pCtx, mclStatus, fmcStatus, sendStopFitting):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -mclStatus - MCL_Status_t
        -fmcStatus - MCL_FMCStatus_t
        -sendStopFitting - bool
        Return type:
        -None
        Declaration line: 1948
        '''
        pass

    def fmcReqConditionElectrode(self, firstRequest):
        '''
        Arguments:
        -firstRequest - bool
        Return type:
        -Status
        Declaration line: 2391
        '''
        pass

    def MCL_P_FmcRespConditionElectrode(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 1259
        '''
        pass

    def MCL_P_FmcStop(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 816
        '''
        pass

    def fmcNextMeasureNrtTrace(self, ):
        '''
        Arguments:
        Return type:
        -MCL_P_FmcContinueStatus_t
        Declaration line: 2204
        '''
        pass

    def MCL_P_FmcRespProcessNrtTrace(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 1343
        '''
        pass

    def MCL_P_FmcSkip(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 757
        '''
        pass

    def fmcSkipElectrode(self, ):
        '''
        Arguments:
        Return type:
        -MCL_P_FmcContinueStatus_t
        Declaration line: 2246
        '''
        pass

    def MCL_P_FmcRespMeasureLink(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 1485
        '''
        pass

    def MCL_P_FmcRespBteError(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 1686
        '''
        pass

    def MCL_P_FmcPausingResp(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 1874
        '''
        pass

    def MCL_P_FmcInit(self, clbkFmcStatus, clbkAnrtStatus, clbkElConditionStatus, bteId, fmcFlow):
        '''
        Arguments:
        -clbkFmcStatus - MCL_FMCStatusCallback_t
        -clbkAnrtStatus - MCL_ANRTStatusCallback_t
        -clbkElConditionStatus - MCL_ElConditionStatusCallback_t
        -bteId - INT_Bte_t
        -fmcFlow - MCL_FlowType_t
        Return type:
        -MCL_Status_t
    ...
    def MCL_P_FmcRespMeasureImplantID(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def fmcFinishProcedure(self, pCtx, status, sendStopFitting):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -status - MCL_P_FmcContinueStatus_t
        ...
        Return type:
        -None
        Declaration line: 2015
        '''
        pass

    def MCL_P_FmcRespStopFitting(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
        Return type:
        -None
        Declaration line: 869
        '''
        pass

    def fmcReqMeasureNrtTrace(self, ):
        '''
        Arguments:
        Return type:
        -Status
        Declaration line: 2165
        '''
        pass

    def fmcFindReplacementElectrode(self, ):
        '''
        Arguments:
        Return type:
        -MCL_P_FmcContinueStatus_t
        Declaration line: 2116
        '''
        pass

    def MCL_P_FmcPause(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
    ...
    def MCL_P_FmcFailProcedure(self, pCtx, error):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -error - MCL_Status_t
        Return type:
        -None
        Declaration line: 1863
        '''
        pass

    def MCL_P_FmcRespMeasureImpedance(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
        Return type:
        -None
        Declaration line: 980
        '''
        pass

    def fmcReqMeasureLink(self, ):
        '''
        Arguments:
        Return type:
        -Status
        Declaration line: 2325
        '''
        pass

    def MCL_P_FmcRespReadImpedance(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_Context_t')
        -pEvent - PointerType("MCL_P_Msg_t")
    ...
    def getFmcStatusFromContext(self, ):
        '''
        Arguments:
        Return type:
        -MCL_FMCStatus_t
        Declaration line: 2578
        '''
        pass
    ...
    fmcConfig = MCL_P_FmcCfg_t
    OSQFreeList = PointerType("OS_Q")
    OSTCBTbl = OS_TCB * 26
    OSTmrUsed = INT16U
    OSTmrWheelTbl = OS_TMR_WHEEL * 8
    fmcCtx = MCL_P_FmcCtx_t
    OSPrioHighRdy = INT8U
    fmcMeasureNrtTimeout = u16 * 2 * 2
    ...
    def __init__(self, device):
        ...
        self.fmcConfig = StaticVariable(device, self.MCL_P_FmcCfg_t, 0x4000a5d8, False)
        ...
        self.fmcCtx = StaticVariable(device, self.MCL_P_FmcCtx_t, 0x4000a610, False)
        self.OSPrioHighRdy = StaticVariable(device, self.INT8U, 0x40000047, False)
        self.fmcMeasureNrtTimeout = StaticVariable(device, u16 * 2 * 2, 0x6f712, True)
        ...
        ### Functions data ###
        ######################
        self.fmcCtxReset = StaticFunction(device, 0x358cc, thumb=1, name='fmcCtxReset', return_type=None, size=104, line=1907, arg_list=[])
        self.MCL_P_FmcConfigure = StaticFunction(device, 0x35934, thumb=1, name='MCL_P_FmcConfigure', return_type=None, size=36, line=372, arg_list=[('conditioningCL',u8),('intraStimCLStart',u8),('intraStimCLMin',u8),('intraStimCLMax',u8),('intraProbeRate',u8),('postStimCLStart',u8),('postStimCLMin',u8),('postStimCLMax',u8),('postProbeRate',u8)])
        self.isFmcError = StaticFunction(device, 0x35b48, thumb=1, name='isFmcError', return_type=bool, size=20, line=2050, arg_list=[('status',MCL_P_FmcContinueStatus_t)])
        self.shouldWritePopulationMeanProfile = StaticFunction(device, 0x359ea, thumb=1, name='shouldWritePopulationMeanProfile', return_type=bool, size=28, line=2620, arg_list=[])
        self.MCL_P_FmcStart = StaticFunction(device, 0x35d12, thumb=1, name='MCL_P_FmcStart', return_type=None, size=76, line=476, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.MCL_P_FmcRespWriteCoefficient = StaticFunction(device, 0x3696c, thumb=1, name='MCL_P_FmcRespWriteCoefficient', return_type=None, size=164, line=1589, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.fmcRecordingProcedure = StaticFunction(device, 0x35bc6, thumb=1, name='fmcRecordingProcedure', return_type=Status, size=204, line=2476, arg_list=[('status',MCL_P_FmcContinueStatus_t)])
        self.fmcInterpolateReverseNormaliseAndCalculateMean = StaticFunction(device, 0x35ab0, thumb=1, name='fmcInterpolateReverseNormaliseAndCalculateMean', return_type=Status, size=152, line=2349, arg_list=[])
        self.MCL_P_FmcRespStartFitting = StaticFunction(device, 0x3625a, thumb=1, name='MCL_P_FmcRespStartFitting', return_type=None, size=56, line=836, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.fmcRespBteErrorDuringAnrt = StaticFunction(device, 0x36a10, thumb=1, name='fmcRespBteErrorDuringAnrt', return_type=MCL_P_FmcAnrtErrorNextStep_t, size=130, line=2638, arg_list=[('bteError',CIP_ProcResult_t)])
        self.fmcFindNextProbeElectrode = StaticFunction(device, 0x35e16, thumb=1, name='fmcFindNextProbeElectrode', return_type=MCL_P_FmcContinueStatus_t, size=106, line=2066, arg_list=[])
        self.fmcReInitNrt = StaticFunction(device, 0x35f98, thumb=1, name='fmcReInitNrt', return_type=Status, size=78, line=2287, arg_list=[])
        self.getFmcReportingStatus = StaticFunction(device, 0x35b5c, thumb=1, name='getFmcReportingStatus', return_type=None, size=106, line=2415, arg_list=[('status',MCL_P_FmcContinueStatus_t),('mclStatus',PointerType("MCL_Status_t")),('fmcStatus',PointerType('MCL_FMCStatus_t'))])
        self.MCL_P_FmcContinue = StaticFunction(device, 0x35fe6, thumb=1, name='MCL_P_FmcContinue', return_type=None, size=482, line=562, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.fmcFailProcedure = StaticFunction(device, 0x35a06, thumb=1, name='fmcFailProcedure', return_type=None, size=144, line=1948, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('mclStatus',MCL_Status_t),('fmcStatus',MCL_FMCStatus_t),('sendStopFitting',bool)])
        self.fmcReqConditionElectrode = StaticFunction(device, 0x35dde, thumb=1, name='fmcReqConditionElectrode', return_type=Status, size=56, line=2391, arg_list=[('firstRequest',bool)])
        self.MCL_P_FmcRespConditionElectrode = StaticFunction(device, 0x36636, thumb=1, name='MCL_P_FmcRespConditionElectrode', return_type=None, size=216, line=1259, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_FmcStop = StaticFunction(device, 0x36242, thumb=1, name='MCL_P_FmcStop', return_type=None, size=24, line=816, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.fmcNextMeasureNrtTrace = StaticFunction(device, 0x35f5a, thumb=1, name='fmcNextMeasureNrtTrace', return_type=MCL_P_FmcContinueStatus_t, size=62, line=2204, arg_list=[])
        self.MCL_P_FmcRespProcessNrtTrace = StaticFunction(device, 0x3670e, thumb=1, name='MCL_P_FmcRespProcessNrtTrace', return_type=None, size=374, line=1343, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_FmcSkip = StaticFunction(device, 0x361c8, thumb=1, name='MCL_P_FmcSkip', return_type=None, size=122, line=757, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.fmcSkipElectrode = StaticFunction(device, 0x35ed0, thumb=1, name='fmcSkipElectrode', return_type=MCL_P_FmcContinueStatus_t, size=68, line=2246, arg_list=[])
        self.MCL_P_FmcRespMeasureLink = StaticFunction(device, 0x36884, thumb=1, name='MCL_P_FmcRespMeasureLink', return_type=None, size=232, line=1485, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_FmcRespBteError = StaticFunction(device, 0x36a92, thumb=1, name='MCL_P_FmcRespBteError', return_type=None, size=402, line=1686, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_FmcPausingResp = StaticFunction(device, 0x36c34, thumb=1, name='MCL_P_FmcPausingResp', return_type=None, size=42, line=1874, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.MCL_P_FmcInit = StaticFunction(device, 0x35958, thumb=1, name='MCL_P_FmcInit', return_type=MCL_Status_t, size=132, line=416, arg_list=[('clbkFmcStatus',MCL_FMCStatusCallback_t),('clbkAnrtStatus',MCL_ANRTStatusCallback_t),('clbkElConditionStatus',MCL_ElConditionStatusCallback_t),('bteId',INT_Bte_t),('fmcFlow',MCL_FlowType_t)])
        self.MCL_P_FmcRespMeasureImplantID = StaticFunction(device, 0x3634c, thumb=1, name='MCL_P_FmcRespMeasureImplantID', return_type=None, size=84, line=939, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.fmcFinishProcedure = StaticFunction(device, 0x35c92, thumb=1, name='fmcFinishProcedure', return_type=None, size=128, line=2015, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('status',MCL_P_FmcContinueStatus_t),('sendStopFitting',bool)])
        self.MCL_P_FmcRespStopFitting = StaticFunction(device, 0x36292, thumb=1, name='MCL_P_FmcRespStopFitting', return_type=None, size=186, line=869, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.fmcReqMeasureNrtTrace = StaticFunction(device, 0x35f14, thumb=1, name='fmcReqMeasureNrtTrace', return_type=Status, size=70, line=2165, arg_list=[])
        self.fmcFindReplacementElectrode = StaticFunction(device, 0x35e80, thumb=1, name='fmcFindReplacementElectrode', return_type=MCL_P_FmcContinueStatus_t, size=80, line=2116, arg_list=[])
        self.MCL_P_FmcPause = StaticFunction(device, 0x35dac, thumb=1, name='MCL_P_FmcPause', return_type=None, size=50, line=524, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.MCL_P_FmcInitialised = StaticFunction(device, 0x359dc, thumb=1, name='MCL_P_FmcInitialised', return_type=bool, size=14, line=464, arg_list=[])
        self.MCL_P_FmcFailProcedure = StaticFunction(device, 0x36c24, thumb=1, name='MCL_P_FmcFailProcedure', return_type=None, size=16, line=1863, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('error',MCL_Status_t)])
        self.MCL_P_FmcRespMeasureImpedance = StaticFunction(device, 0x363a0, thumb=1, name='MCL_P_FmcRespMeasureImpedance', return_type=None, size=288, line=980, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.fmcReqMeasureLink = StaticFunction(device, 0x35a96, thumb=1, name='fmcReqMeasureLink', return_type=Status, size=26, line=2325, arg_list=[])
        self.MCL_P_FmcRespReadImpedance = StaticFunction(device, 0x364c0, thumb=1, name='MCL_P_FmcRespReadImpedance', return_type=None, size=374, line=1131, arg_list=[('pCtx',PointerType('MCL_P_Context_t')),('pEvent',PointerType("MCL_P_Msg_t"))])
        self.getFmcStatusFromContext = StaticFunction(device, 0x35d5e, thumb=1, name='getFmcStatusFromContext', return_type=MCL_FMCStatus_t, size=78, line=2578, arg_list=[])
