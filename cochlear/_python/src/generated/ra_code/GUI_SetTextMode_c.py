...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_SetTextMode = StaticFunction(device, 0x2e1f8, thumb=1, name='GUI_SetTextMode', return_type=c_int_le, size=12, line=32, arg_list=[('Mode',c_int_le)])
