...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_GotoX = StaticFunction(device, 0x2c710, thumb=1, name='GUI_GotoX', return_type=c_byte, size=8, line=71, arg_list=[('x',c_int_le)])
        self.GUI_GotoXY = StaticFunction(device, 0x2c718, thumb=1, name='GUI_GotoXY', return_type=c_byte, size=10, line=83, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.GUI_GotoY = StaticFunction(device, 0x2c708, thumb=1, name='GUI_GotoY', return_type=c_byte, size=8, line=59, arg_list=[('y',c_int_le)])
