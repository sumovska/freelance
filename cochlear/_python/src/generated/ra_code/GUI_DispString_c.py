...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_DispString = StaticFunction(device, 0x2c608, thumb=1, name='GUI_DispString', return_type=None, size=246, line=34, arg_list=[('s',PointerType("c_byte"))])
