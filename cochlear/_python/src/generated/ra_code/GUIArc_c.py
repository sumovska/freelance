...
class Code(AbstractCode):
    ...
    def GUI_DrawArc(self, x0, y0, rx, ry, a0, a1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_DrawArc(self, x0, y0, rx, ry, a0, a1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def _DrawArc(self, x0, y0, rx, ry, Angle0, Angle1, xMul, yMul):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_DrawArc = StaticFunction(device, 0x32638, thumb=1, name='GUI_DrawArc', return_type=None, size=32, line=222, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le),('a0',c_int_le),('a1',c_int_le)])
        self.GL_DrawArc = StaticFunction(device, 0x32514, thumb=1, name='GL_DrawArc', return_type=None, size=292, line=162, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le),('a0',c_int_le),('a1',c_int_le)])
        self._DrawArc = StaticFunction(device, 0x32210, thumb=1, name='_DrawArc', return_type=None, size=772, line=80, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le),('Angle0',c_int_le),('Angle1',c_int_le),('xMul',c_int_le),('yMul',c_int_le)])
