...
class Code(AbstractCode):
    ...
    def GUI_XBF__GetCharDistX(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
    ...
    def GUI_XBF__IsInFont(self, pFont, c):
        '''
        Arguments:
        -pFont - PointerType("GUI_FONT")
        -c - c_ushort_le
        Return type:
        -c_byte
        Declaration line: 96
    ...
    def GUI_XBF__GetOffAndSize(self, pXBF_Data, c, pOff, pSize):
        '''
        Arguments:
        -pXBF_Data - PointerType('GUI_XBF_DATA')
        -c - c_uint_le
        -pOff - PointerType("c_ulong_le")
        -pSize - PointerType('c_ushort_le')
        Return type:
        -c_int_le
        Declaration line: 46
        '''
    ...
    def GUI_XBF_DeleteFont(self, pFont):
        '''
        Arguments:
        -pFont - PointerType("GUI_FONT")
        Return type:
    ...
    def GUI_XBF__GetFontInfo(self, pFont, pInfo):
        '''
        Arguments:
        -pFont - PointerType('GUI_FONT')
        -pInfo - PointerType("GUI_FONTINFO")
        Return type:
        -None
        Declaration line: 85
        '''
    ...
    def GUI_XBF_CreateFont(self, pFont, pXBF_Data, pFontType, pfGetData, pVoid):
        '''
        Arguments:
        -pFont - PointerType('GUI_FONT')
        -pXBF_Data - PointerType("GUI_XBF_DATA")
        -pFontType - PointerType('tGUI_XBF_APIList')
        -pfGetData - PointerType("GUI_XBF_GET_DATA_FUNC")
        -pVoid - PointerType('void')
        Return type:
        -c_int_le
    ...
    def GUI_XBF__GetOff(self, pXBF_Data, c, pOff):
        '''
        Arguments:
        -pXBF_Data - PointerType("GUI_XBF_DATA")
        -c - c_uint_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_XBF__GetCharDistX = StaticFunction(device, 0x309e0, thumb=1, name='GUI_XBF__GetCharDistX', return_type=c_int_le, size=84, line=64, arg_list=[('c',c_ushort_le)])
        self.GUI_XBF__IsInFont = StaticFunction(device, 0x30a46, thumb=1, name='GUI_XBF__IsInFont', return_type=c_byte, size=52, line=96, arg_list=[('pFont',PointerType("GUI_FONT")),('c',c_ushort_le)])
        self.GUI_XBF__GetOffAndSize = StaticFunction(device, 0x30992, thumb=1, name='GUI_XBF__GetOffAndSize', return_type=c_int_le, size=78, line=46, arg_list=[('pXBF_Data',PointerType('GUI_XBF_DATA')),('c',c_uint_le),('pOff',PointerType("c_ulong_le")),('pSize',PointerType('c_ushort_le'))])
        self.GUI_XBF_DeleteFont = StaticFunction(device, 0x30b1a, thumb=1, name='GUI_XBF_DeleteFont', return_type=None, size=2, line=172, arg_list=[('pFont',PointerType("GUI_FONT"))])
        self.GUI_XBF__GetFontInfo = StaticFunction(device, 0x30a34, thumb=1, name='GUI_XBF__GetFontInfo', return_type=None, size=18, line=85, arg_list=[('pFont',PointerType('GUI_FONT')),('pInfo',PointerType("GUI_FONTINFO"))])
        self.GUI_XBF_CreateFont = StaticFunction(device, 0x30a7a, thumb=1, name='GUI_XBF_CreateFont', return_type=c_int_le, size=160, line=121, arg_list=[('pFont',PointerType('GUI_FONT')),('pXBF_Data',PointerType("GUI_XBF_DATA")),('pFontType',PointerType('tGUI_XBF_APIList')),('pfGetData',PointerType("GUI_XBF_GET_DATA_FUNC")),('pVoid',PointerType('void'))])
        self.GUI_XBF__GetOff = StaticFunction(device, 0x30968, thumb=1, name='GUI_XBF__GetOff', return_type=c_int_le, size=42, line=34, arg_list=[('pXBF_Data',PointerType("GUI_XBF_DATA")),('c',c_uint_le),('pOff',PointerType('c_ulong_le'))])
