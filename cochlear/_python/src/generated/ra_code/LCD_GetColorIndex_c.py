...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_GetBkColorIndex = StaticFunction(device, 0x2ce64, thumb=1, name='LCD_GetBkColorIndex', return_type=c_int_le, size=6, line=33, arg_list=[])
        self.LCD_GetColorIndex = StaticFunction(device, 0x2ce6a, thumb=1, name='LCD_GetColorIndex', return_type=c_int_le, size=6, line=41, arg_list=[])
