...
class Code(AbstractCode):
    ...
    def GUI__memset(self, p, Fill, NumBytes):
        '''
        Arguments:
        -p - PointerType('c_ubyte')
        -Fill - c_ubyte
        -NumBytes - c_int_le
        Return type:
        -None
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI__memset = StaticFunction(device, 0x2cdd8, thumb=1, name='GUI__memset', return_type=None, size=140, line=40, arg_list=[('p',PointerType('c_ubyte')),('Fill',c_ubyte),('NumBytes',c_int_le)])
