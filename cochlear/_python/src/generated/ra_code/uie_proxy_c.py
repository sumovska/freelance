...
class Code(AbstractCode):
    ...
    def UIE_P_PostWaReq(self, pSm, actId, actValue):
        '''
        Arguments:
    ...
    def UIE_P_GetBteEcapProfile(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
    ...
    def UIE_P_GetBteNrtTraceData(self, bteId, elNum):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -elNum - c_int_le
    ...
    def UIE_P_GetRealPairStatus(self, ):
        '''
        Arguments:
        Return type:
        -bool
    ...
    def UIE_P_AreBteIdentifiersValid(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
    ...
    def UIE_P_SetPairStatusValid(self, status):
        '''
        Arguments:
        -status - bool
        Return type:
    ...
    def UIE_P_GetBteLastNrtTraceData(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -PointerType("WBST_NrtTraceData_t")
        Declaration line: 274
        '''
        pass

    def UIE_P_GetBteNrtElectrodeData(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
    ...
    def UIE_P_GetBteIdentifiers(self, bteId, pIdent):
        '''
        Arguments:
        -bteId - WBST_BteId_t
    ...
    def UIE_P_PostBteReq(self, pSm, bteId, actId, actValue, statId, interceptFlag):
        '''
        Arguments:
        -pSm - PointerType('UIE_P_Sm_t')
        -bteId - WBST_BteId_t
    ...
    def UIE_P_GetWaSetting(self, settingId):
        '''
        Arguments:
    ...
    def UIE_P_IsPairStatusValid(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 184
        '''
        pass

    def UIE_P_GetBteSetting(self, bteId, settingId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
    ...
    def UIE_P_GetBteDiagElectrodeData(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -PointerType("WBST_ElectrodeData_t")
        Declaration line: 260
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self.pairStatusValid = StaticVariable(device, self.bool, 0x8000840cL, False)
        ...
        ### Functions data ###
        ######################
        self.UIE_P_PostWaReq = StaticFunction(device, 0x39cda, thumb=1, name='UIE_P_PostWaReq', return_type=None, size=8, line=116, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('actId',WAE_WaUserActionId_t),('actValue',WAE_UserActionValue_t)])
        self.UIE_P_GetBteEcapProfile = StaticFunction(device, 0x39e08, thumb=1, name='UIE_P_GetBteEcapProfile', return_type=PointerType("WBST_EcapProfile_t"), size=28, line=288, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_GetBteNrtTraceData = StaticFunction(device, 0x39de6, thumb=1, name='UIE_P_GetBteNrtTraceData', return_type=PointerType('WBST_NrtTraceData_t'), size=34, line=281, arg_list=[('bteId',WBST_BteId_t),('elNum',c_int_le)])
        self.UIE_P_GetRealPairStatus = StaticFunction(device, 0x39d4e, thumb=1, name='UIE_P_GetRealPairStatus', return_type=bool, size=6, line=203, arg_list=[])
        self.UIE_P_AreBteIdentifiersValid = StaticFunction(device, 0x39d54, thumb=1, name='UIE_P_AreBteIdentifiersValid', return_type=bool, size=28, line=215, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_SetPairStatusValid = StaticFunction(device, 0x39d36, thumb=1, name='UIE_P_SetPairStatusValid', return_type=None, size=6, line=173, arg_list=[('status',bool)])
        self.UIE_P_GetBteLastNrtTraceData = StaticFunction(device, 0x39dca, thumb=1, name='UIE_P_GetBteLastNrtTraceData', return_type=PointerType("WBST_NrtTraceData_t"), size=28, line=274, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_GetBteNrtElectrodeData = StaticFunction(device, 0x39dae, thumb=1, name='UIE_P_GetBteNrtElectrodeData', return_type=PointerType('WBST_ElectrodeData_t'), size=28, line=267, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_GetBteIdentifiers = StaticFunction(device, 0x39d70, thumb=1, name='UIE_P_GetBteIdentifiers', return_type=Status, size=34, line=242, arg_list=[('bteId',WBST_BteId_t),('pIdent',PointerType("PointerType('WBST_BteIdentifiers_t')"))])
        self.UIE_P_PostBteReq = StaticFunction(device, 0x39ce2, thumb=1, name='UIE_P_PostBteReq', return_type=Status, size=84, line=136, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('bteId',WBST_BteId_t),('actId',WAE_BteUserActionId_t),('actValue',WAE_UserActionValue_t),('statId',WAE_BteStatusId_t),('interceptFlag',u32)])
        self.UIE_P_GetWaSetting = StaticFunction(device, 0x39ca8, thumb=1, name='UIE_P_GetWaSetting', return_type=WBST_Value_t, size=12, line=70, arg_list=[('settingId',WBST_WaSettingId_t)])
        self.UIE_P_IsPairStatusValid = StaticFunction(device, 0x39d3c, thumb=1, name='UIE_P_IsPairStatusValid', return_type=bool, size=18, line=184, arg_list=[])
        self.UIE_P_GetBteSetting = StaticFunction(device, 0x39cb4, thumb=1, name='UIE_P_GetBteSetting', return_type=WBST_Value_t, size=38, line=89, arg_list=[('bteId',WBST_BteId_t),('settingId',WBST_BteSettingId_t)])
        self.UIE_P_GetBteDiagElectrodeData = StaticFunction(device, 0x39d92, thumb=1, name='UIE_P_GetBteDiagElectrodeData', return_type=PointerType("WBST_ElectrodeData_t"), size=28, line=260, arg_list=[('bteId',WBST_BteId_t)])
