...
class Code(AbstractCode):
    ...
    def _FillRect(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self._FillRect = StaticFunction(device, 0x2de3c, thumb=1, name='_FillRect', return_type=None, size=224, line=526, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
