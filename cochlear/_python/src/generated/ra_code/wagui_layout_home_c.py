...
class HomeTabPos_tag(Structure):
    x = c_int_le
    yUnsel = c_int_le
    ySel = c_int_le
    yLabelOffs = c_int_le
...
class HomeAnimCtx_tag(Structure):
    autoAnim = bool
    animSide = u8
    mapIndex = u8
    classAnim = bool
...
class HomeMapIcons_tag(Structure):
    uni = WAGUI_P_Res_t
    left = WAGUI_P_Res_t
    right = WAGUI_P_Res_t
    _pack_ = 1
...
class HomeTabIconSet_tag(Structure):
    regular = WAGUI_P_Res_t
    user = WAGUI_P_Res_t
    _pack_ = 1
    _fields_ = [
                ('regular', WAGUI_P_Res_t),
...
class HomeEnvIcons_tag(Structure):
    uni = WAGUI_P_Res_t
    bi = WAGUI_P_Res_t
    _pack_ = 1
    _fields_ = [
...
class HomeMapIconsSU_tag(Structure):
    env = HomeMapIcons_t * 4
    num = HomeMapIcons_t * 4
    _pack_ = 1
    _fields_ = [
                ('env', HomeMapIcons_t * 4),
                ('num', HomeMapIcons_t * 4),
...
class HomeTabIconTB_tag(Structure):
    slot = HomeTabIconSet_t * 4
    _pack_ = 1
    _fields_ = [
                ('slot', HomeTabIconSet_t * 4),
               ]
...
HomeMapIconsSU_t = HomeMapIconsSU_tag
HomeTabIconTB_t = HomeTabIconTB_tag
WAGUI_HomeInfo_t = WAGUI_HomeInfo_tag
HomeEnvIconsSU_t = HomeEnvIcons_t * 4
...
class Code(AbstractCode):
    ...
    HomeAnimCtx_tag = HomeAnimCtx_tag
    ColorSchemeDesc_tag = ColorSchemeDesc_tag
    HomeMapIcons_tag = HomeMapIcons_tag
    ...
    os_mem_data = os_mem_data
    os_stk_data = os_stk_data
    HomeTabIconSet_tag = HomeTabIconSet_tag
    HomeEnvIcons_tag = HomeEnvIcons_tag
    ...
    def GetHomeAccIcon(self, tcoil, acc, stream, accType, streamType):
        '''
        Arguments:
        -tcoil - WBST_Value_t
        -acc - WBST_Value_t
    ...
    def DrawHomeMapIcon(self, mapCategory, expertMode, showAutoClass, index, mapClass, sideAlign):
        '''
        Arguments:
        -mapCategory - WBST_Value_t
        -expertMode - bool
        -showAutoClass - bool
        -index - WBST_Value_t
        -mapClass - WBST_Value_t
        ...
        Return type:
        -None
        Declaration line: 1187
        '''
        pass

    def DrawAudioInputPopupBiSide(self, x, y, hAlign, mode, icon, locked, textId, sideIcon, sideText):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        -sideIcon - WAGUI_P_Res_t
        -sideText - WAGUI_P_TextId_t
        Return type:
        -None
        Declaration line: 1801
        '''
        pass

    def WAGUI_WriteHomeScreenBackground(self, hMem):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        Return type:
        -None
        Declaration line: 737
        '''
        pass

    def WAGUI_OverlayAudioInputPopup(self, mode, audioInput):
        '''
        Arguments:
        -mode - WAGUI_CoverMode_t
        ...
        Return type:
        -None
        Declaration line: 910
        '''
        pass

    def DrawHomeMap(self, pHI):
        '''
        Arguments:
        -pHI - PointerType('WAGUI_HomeInfo_t')
        Return type:
        -None
        Declaration line: 1560
        '''
        pass

    def saveStreamScreenAnimPos(self, x, y, bkColor):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def DrawAccSide(self, x, y, hAlign, icon, sideInd):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        -hAlign - c_int_le
        -icon - WAGUI_P_Res_t
        -sideInd - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1489
        '''
        pass

    def WAGUI_ShowStreamSelectionSearchAnim(self, searchAnimFrame):
        '''
        Arguments:
        -searchAnimFrame - u8
        Return type:
    ...
    def DrawAudioInputPopupBi(self, mode, audioInput):
        '''
        Arguments:
        -mode - WAGUI_CoverMode_t
        -audioInput - PointerType("WAGUI_CoverAudioInput_t")
        Return type:
        -None
        Declaration line: 1845
        '''
        pass

    def DrawAudioInputPopupSplit(self, mode, audioInput, bteId):
        '''
        Arguments:
        -mode - WAGUI_CoverMode_t
        -audioInput - PointerType('WAGUI_CoverAudioInputSide_t')
        -bteId - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1779
        '''
        pass

    def WAGUI_ShowHomeMapAnim(self, pHomeInfo, hideTabs):
        '''
        Arguments:
    ...
    def WAGUI_ShowHomeAutoAnim(self, showClass, progress):
        '''
        Arguments:
        -showClass - bool
        -progress - bool
    ...
    def WAGUI_ShowHome(self, pHomeInfo):
        '''
        Arguments:
        -pHomeInfo - PointerType('WAGUI_HomeInfo_t')
        Return type:
    ...
    def DrawHomeTab(self, x, y, yText, flags, mapCategory, mapIndex, tabSide):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        -yText - c_int_le
        -flags - c_int_le
        -mapCategory - c_int_le
        -mapIndex - c_int_le
        -tabSide - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1046
        '''
        pass

    def WAGUI_ShowHomeAutoClassAnim(self, pHomeInfo):
        '''
        Arguments:
        -pHomeInfo - PointerType("WAGUI_HomeInfo_t")
        Return type:
        -None
        Declaration line: 798
        '''
        pass

    def WAGUI_ShowStreamSelection(self, bteId, selection, selNumbers, selected, active, state, btbActive):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -selection - PointerType('WAGUI_Selection_t')
        -selNumbers - PointerType("u8")
        -selected - c_int_le
        -active - c_int_le
        -state - WBST_Value_t
        -btbActive - bool
        Return type:
        -None
        Declaration line: 958
        '''
        pass

    def WAGUI_DrawHomeAutoAnim(self, showClass, progress):
        '''
        Arguments:
        -showClass - bool
        -progress - bool
    ...
    def GetMapBkgColor(self, hAlign):
        '''
        Arguments:
        -hAlign - c_int_le
        Return type:
        -GUI_COLOR
        Declaration line: 662
        '''
        pass

    def DrawHomeTabs(self, pHI, selShown):
        '''
        Arguments:
        -pHI - PointerType('WAGUI_HomeInfo_t')
        -selShown - bool
    ...
    def DrawAudioInputPopupUni(self, mode, audioInput):
        '''
        Arguments:
        -mode - WAGUI_CoverMode_t
        -audioInput - PointerType("WAGUI_CoverAudioInputSide_t")
        Return type:
        -None
        Declaration line: 1757
        '''
        pass

    def GetHomeMapClass(self, bteInfo):
        '''
        Arguments:
        -bteInfo - PointerType('WAGUI_HomeBteInfo_t')
        Return type:
        -WBST_Value_t
    ...
    def GetHomeMapCategory(self, bteInfo):
        '''
        Arguments:
        -bteInfo - PointerType("WAGUI_HomeBteInfo_t")
        Return type:
        -WBST_Value_t
        Declaration line: 1527
        '''
        pass

    def GetPopupAccIcon(self, mode, audioInput, sideChanged, textId, locked):
        '''
        Arguments:
        -mode - WAGUI_CoverMode_t
        -audioInput - PointerType('WAGUI_CoverAudioInputSide_t')
        -sideChanged - bool
        -textId - PointerType("WAGUI_P_TextId_t")
        -locked - PointerType('bool')
        Return type:
        -WAGUI_P_Res_t
        Declaration line: 1279
        '''
        pass

    def DrawStreamBluetoothDevice(self, state):
        '''
        Arguments:
        -state - WBST_Value_t
        Return type:
        -None
        Declaration line: 1880
        '''
        pass

    def DrawHomeAcc(self, pHI):
        '''
        Arguments:
        -pHI - PointerType("WAGUI_HomeInfo_t")
        Return type:
        -None
        Declaration line: 1694
        '''
        pass
    ...
    homeTabIcons = HomeTabIconTB_t * 22
    OSLockNesting = INT8U
    OSMemTbl = OS_MEM * 15
    ...
    def __init__(self, device):
        ...
        self.homeTabIcons = StaticVariable(device, HomeTabIconTB_t * 22, 0x70594, True)
        ...
        self.homeAnimCtx = StaticVariable(device, self.HomeAnimCtx_t, 0x80008854L, False)
        ...
        self.tLabel = StaticVariable(device, WAGUI_P_TextId_t * 22, 0x80008828L, False)
        ...
        self.homeTabInvalidIcons = StaticVariable(device, self.HomeTabIconTB_t, 0x70584, True)
        ...
        self.homeEnvIcons = StaticVariable(device, HomeEnvIcons_t * 17, 0x70894, True)
        self.homeMapIcons = StaticVariable(device, HomeMapIconsSU_t * 5, 0x706f4, True)
        self.OSTmrFreeList = StaticVariable(device, PointerType("OS_TMR"), 0x40000090, False)
        self.streamScreenSearchAnimX = StaticVariable(device, c_int_le, 0x80008818L, False)
        self.streamScreenSearchAnimY = StaticVariable(device, c_int_le, 0x8000881cL, False)
        ...
        self.homeTabPos = StaticVariable(device, HomeTabPos_t * 4, 0x708d8, True)
        ...
        self.homeAutoBkgIcons = StaticVariable(device, HomeEnvIcons_t * 4, 0x707e4, True)
        ...
        self.homeEnvBkgIcons = StaticVariable(device, HomeEnvIcons_t * 4, 0x70884, True)
        ...
        self.mapClassIcon = StaticVariable(device, HomeEnvIcons_t * 4 * 9, 0x707f4, True)
        self.OSTCBHighRdy = StaticVariable(device, PointerType('OS_TCB'), 0x40000060, False)
        self.streamScreenSearchAnimBkColor = StaticVariable(device, c_int_le, 0x80008820L, False)

        ######################
        ### Functions data ###
        ######################
        self.GetHomeAccIcon = StaticFunction(device, 0x4ab92, thumb=1, name='GetHomeAccIcon', return_type=WAGUI_P_Res_t, size=112, line=1414, arg_list=[('tcoil',WBST_Value_t),('acc',WBST_Value_t),('stream',WBST_Value_t),('accType',WBST_Value_t),('streamType',WBST_Value_t)])
        self.DrawHomeMapIcon = StaticFunction(device, 0x4af48, thumb=1, name='DrawHomeMapIcon', return_type=None, size=380, line=1187, arg_list=[('mapCategory',WBST_Value_t),('expertMode',bool),('showAutoClass',bool),('index',WBST_Value_t),('mapClass',WBST_Value_t),('sideAlign',c_int_le)])
        self.DrawAudioInputPopupBiSide = StaticFunction(device, 0x4b7ee, thumb=1, name='DrawAudioInputPopupBiSide', return_type=None, size=172, line=1801, arg_list=[('x',c_int_le),('y',c_int_le),('hAlign',c_int_le),('mode',WAGUI_CoverMode_t),('icon',WAGUI_P_Res_t),('locked',bool),('textId',WAGUI_P_TextId_t),('sideIcon',WAGUI_P_Res_t),('sideText',WAGUI_P_TextId_t)])
        self.WAGUI_WriteHomeScreenBackground = StaticFunction(device, 0x4b476, thumb=1, name='WAGUI_WriteHomeScreenBackground', return_type=None, size=280, line=737, arg_list=[('hMem',GUI_MEMDEV_Handle)])
        self.WAGUI_OverlayAudioInputPopup = StaticFunction(device, 0x4bbc4, thumb=1, name='WAGUI_OverlayAudioInputPopup', return_type=None, size=112, line=910, arg_list=[('mode',WAGUI_CoverMode_t),('audioInput',PointerType("WAGUI_CoverAudioInput_t"))])
        self.DrawHomeMap = StaticFunction(device, 0x4b0c4, thumb=1, name='DrawHomeMap', return_type=None, size=518, line=1560, arg_list=[('pHI',PointerType('WAGUI_HomeInfo_t'))])
        self.saveStreamScreenAnimPos = StaticFunction(device, 0x4bc34, thumb=1, name='saveStreamScreenAnimPos', return_type=None, size=10, line=950, arg_list=[('x',c_int_le),('y',c_int_le),('bkColor',GUI_COLOR)])
        self.DrawAccSide = StaticFunction(device, 0x4ac02, thumb=1, name='DrawAccSide', return_type=None, size=130, line=1489, arg_list=[('x',c_int_le),('y',c_int_le),('hAlign',c_int_le),('icon',WAGUI_P_Res_t),('sideInd',WBST_BteId_t)])
        self.WAGUI_ShowStreamSelectionSearchAnim = StaticFunction(device, 0x4b78e, thumb=1, name='WAGUI_ShowStreamSelectionSearchAnim', return_type=None, size=96, line=891, arg_list=[('searchAnimFrame',u8)])
        self.DrawAudioInputPopupBi = StaticFunction(device, 0x4ba3a, thumb=1, name='DrawAudioInputPopupBi', return_type=None, size=174, line=1845, arg_list=[('mode',WAGUI_CoverMode_t),('audioInput',PointerType("WAGUI_CoverAudioInput_t"))])
        self.DrawAudioInputPopupSplit = StaticFunction(device, 0x4bae8, thumb=1, name='DrawAudioInputPopupSplit', return_type=None, size=122, line=1779, arg_list=[('mode',WAGUI_CoverMode_t),('audioInput',PointerType('WAGUI_CoverAudioInputSide_t')),('bteId',WBST_BteId_t)])
        self.WAGUI_ShowHomeMapAnim = StaticFunction(device, 0x4b2f8, thumb=1, name='WAGUI_ShowHomeMapAnim', return_type=None, size=382, line=571, arg_list=[('pHomeInfo',PointerType("WAGUI_HomeInfo_t")),('hideTabs',bool)])
        self.WAGUI_ShowHomeAutoAnim = StaticFunction(device, 0x4b58e, thumb=1, name='WAGUI_ShowHomeAutoAnim', return_type=None, size=60, line=781, arg_list=[('showClass',bool),('progress',bool)])
        self.WAGUI_ShowHome = StaticFunction(device, 0x4b2ca, thumb=1, name='WAGUI_ShowHome', return_type=None, size=46, line=556, arg_list=[('pHomeInfo',PointerType('WAGUI_HomeInfo_t'))])
        self.DrawHomeTab = StaticFunction(device, 0x4a958, thumb=1, name='DrawHomeTab', return_type=None, size=176, line=1046, arg_list=[('x',c_int_le),('y',c_int_le),('yText',c_int_le),('flags',c_int_le),('mapCategory',c_int_le),('mapIndex',c_int_le),('tabSide',WBST_BteId_t)])
        self.WAGUI_ShowHomeAutoClassAnim = StaticFunction(device, 0x4b5ca, thumb=1, name='WAGUI_ShowHomeAutoClassAnim', return_type=None, size=452, line=798, arg_list=[('pHomeInfo',PointerType("WAGUI_HomeInfo_t"))])
        self.WAGUI_ShowStreamSelection = StaticFunction(device, 0x4bcfc, thumb=1, name='WAGUI_ShowStreamSelection', return_type=None, size=240, line=958, arg_list=[('bteId',WBST_BteId_t),('selection',PointerType('WAGUI_Selection_t')),('selNumbers',PointerType("u8")),('selected',c_int_le),('active',c_int_le),('state',WBST_Value_t),('btbActive',bool)])
        self.WAGUI_DrawHomeAutoAnim = StaticFunction(device, 0x4ae22, thumb=1, name='WAGUI_DrawHomeAutoAnim', return_type=None, size=294, line=678, arg_list=[('showClass',bool),('progress',bool)])
        self.GetMapBkgColor = StaticFunction(device, 0x4add2, thumb=1, name='GetMapBkgColor', return_type=GUI_COLOR, size=32, line=662, arg_list=[('hAlign',c_int_le)])
        self.DrawHomeTabs = StaticFunction(device, 0x4aa08, thumb=1, name='DrawHomeTabs', return_type=None, size=394, line=1082, arg_list=[('pHI',PointerType('WAGUI_HomeInfo_t')),('selShown',bool)])
        self.DrawAudioInputPopupUni = StaticFunction(device, 0x4bb62, thumb=1, name='DrawAudioInputPopupUni', return_type=None, size=98, line=1757, arg_list=[('mode',WAGUI_CoverMode_t),('audioInput',PointerType("WAGUI_CoverAudioInputSide_t"))])
        self.GetHomeMapClass = StaticFunction(device, 0x4adf2, thumb=1, name='GetHomeMapClass', return_type=WBST_Value_t, size=48, line=1539, arg_list=[('bteInfo',PointerType('WAGUI_HomeBteInfo_t'))])
        self.GetHomeMapCategory = StaticFunction(device, 0x4ac84, thumb=1, name='GetHomeMapCategory', return_type=WBST_Value_t, size=26, line=1527, arg_list=[('bteInfo',PointerType("WAGUI_HomeBteInfo_t"))])
        self.GetPopupAccIcon = StaticFunction(device, 0x4b89a, thumb=1, name='GetPopupAccIcon', return_type=WAGUI_P_Res_t, size=416, line=1279, arg_list=[('mode',WAGUI_CoverMode_t),('audioInput',PointerType('WAGUI_CoverAudioInputSide_t')),('sideChanged',bool),('textId',PointerType("WAGUI_P_TextId_t")),('locked',PointerType('bool'))])
        self.DrawStreamBluetoothDevice = StaticFunction(device, 0x4bc3e, thumb=1, name='DrawStreamBluetoothDevice', return_type=None, size=190, line=1880, arg_list=[('state',WBST_Value_t)])
        self.DrawHomeAcc = StaticFunction(device, 0x4ac9e, thumb=1, name='DrawHomeAcc', return_type=None, size=308, line=1694, arg_list=[('pHI',PointerType("WAGUI_HomeInfo_t"))])
