...
class Code(AbstractCode):
    ...
    def LCD_Index2Color_M565(self, Index):
        '''
        Arguments:
        -Index - c_int_le
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_Index2Color_M565 = StaticFunction(device, 0x2d23c, thumb=1, name='LCD_Index2Color_M565', return_type=LCD_COLOR, size=56, line=49, arg_list=[('Index',c_int_le)])
