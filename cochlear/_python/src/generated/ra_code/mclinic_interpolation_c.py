...
class Code(AbstractCode):
    ...
    def MCL_P_Interpolate(self, input, output):
        '''
        Arguments:
        -input - PointerType("u8")
        -output - PointerType('u16')
        Return type:
        -Status
        Declaration line: 55
        '''
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.MCL_P_Interpolate = StaticFunction(device, 0x36c9c, thumb=1, name='MCL_P_Interpolate', return_type=Status, size=506, line=55, arg_list=[('input',PointerType("u8")),('output',PointerType('u16'))])
