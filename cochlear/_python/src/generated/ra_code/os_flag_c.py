...
class Code(AbstractCode):
    ...
    def OSFlagPend(self, pgrp, flags, wait_type, timeout, err):
        '''
        Arguments:
        -pgrp - PointerType('OS_FLAG_GRP')
        -flags - OS_FLAGS
        -wait_type - INT8U
        -timeout - INT16U
    ...
    def OSFlagAccept(self, pgrp, flags, wait_type, err):
        '''
        Arguments:
        -pgrp - PointerType('OS_FLAG_GRP')
        -flags - OS_FLAGS
    ...
    def OSFlagNameSet(self, pgrp, pname, err):
        '''
        Arguments:
        -pgrp - PointerType('OS_FLAG_GRP')
        ...
        Return type:
        -None
        Declaration line: 457
        '''
        pass

    def OSFlagCreate(self, flags, err):
        '''
        Arguments:
        -flags - OS_FLAGS
        -err - PointerType("INT8U")
        Return type:
        -PointerType('OS_FLAG_GRP')
        Declaration line: 208
        '''
        pass

    def OSFlagNameGet(self, pgrp, pname, err):
        '''
        Arguments:
        -pgrp - PointerType("OS_FLAG_GRP")
        -pname - PointerType('INT8U')
    ...
    def OSFlagPost(self, pgrp, flags, opt, err):
        '''
        Arguments:
        -pgrp - PointerType('OS_FLAG_GRP')
        -flags - OS_FLAGS
        ...
        Return type:
        -OS_FLAGS
        Declaration line: 791
        '''
        pass

    def OS_FlagTaskRdy(self, pnode, flags_rdy):
        '''
        Arguments:
        -pnode - PointerType('OS_FLAG_NODE')
        -flags_rdy - OS_FLAGS
        Return type:
        -BOOLEAN
        Declaration line: 1097
        '''
        pass

    def OS_FlagBlock(self, pgrp, pnode, flags, wait_type, timeout):
        '''
        Arguments:
        -pgrp - PointerType("OS_FLAG_GRP")
        -pnode - PointerType('OS_FLAG_NODE')
    ...
    def OS_FlagUnlink(self, pnode):
        '''
        Arguments:
        -pnode - PointerType("OS_FLAG_NODE")
        Return type:
        -None
        Declaration line: 1141
        '''
        pass

    def OSFlagPendGetFlagsRdy(self, ):
        '''
        Arguments:
        Return type:
        -OS_FLAGS
    ...
    def OS_FlagInit(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1031
        '''
        pass
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.OSFlagPend = StaticFunction(device, 0x28e2c, thumb=1, name='OSFlagPend', return_type=OS_FLAGS, size=340, line=556, arg_list=[('pgrp',PointerType('OS_FLAG_GRP')),('flags',OS_FLAGS),('wait_type',INT8U),('timeout',INT16U),('err',PointerType("INT8U"))])
        self.OSFlagAccept = StaticFunction(device, 0x28c40, thumb=1, name='OSFlagAccept', return_type=OS_FLAGS, size=154, line=92, arg_list=[('pgrp',PointerType('OS_FLAG_GRP')),('flags',OS_FLAGS),('wait_type',INT8U),('err',PointerType("INT8U"))])
        self.OSFlagNameSet = StaticFunction(device, 0x28d64, thumb=1, name='OSFlagNameSet', return_type=None, size=72, line=457, arg_list=[('pgrp',PointerType('OS_FLAG_GRP')),('pname',PointerType("INT8U")),('err',PointerType('INT8U'))])
        self.OSFlagCreate = StaticFunction(device, 0x28cda, thumb=1, name='OSFlagCreate', return_type=PointerType('OS_FLAG_GRP'), size=78, line=208, arg_list=[('flags',OS_FLAGS),('err',PointerType("INT8U"))])
        self.OSFlagNameGet = StaticFunction(device, 0x28d28, thumb=1, name='OSFlagNameGet', return_type=INT8U, size=60, line=395, arg_list=[('pgrp',PointerType("OS_FLAG_GRP")),('pname',PointerType('INT8U')),('err',PointerType("INT8U"))])
        self.OSFlagPost = StaticFunction(device, 0x28fd8, thumb=1, name='OSFlagPost', return_type=OS_FLAGS, size=182, line=791, arg_list=[('pgrp',PointerType('OS_FLAG_GRP')),('flags',OS_FLAGS),('opt',INT8U),('err',PointerType("INT8U"))])
        self.OS_FlagTaskRdy = StaticFunction(device, 0x28f98, thumb=1, name='OS_FlagTaskRdy', return_type=BOOLEAN, size=64, line=1097, arg_list=[('pnode',PointerType('OS_FLAG_NODE')),('flags_rdy',OS_FLAGS)])
        self.OS_FlagBlock = StaticFunction(device, 0x28dd0, thumb=1, name='OS_FlagBlock', return_type=None, size=92, line=984, arg_list=[('pgrp',PointerType("OS_FLAG_GRP")),('pnode',PointerType('OS_FLAG_NODE')),('flags',OS_FLAGS),('wait_type',INT8U),('timeout',INT16U)])
        self.OS_FlagUnlink = StaticFunction(device, 0x28dac, thumb=1, name='OS_FlagUnlink', return_type=None, size=36, line=1141, arg_list=[('pnode',PointerType("OS_FLAG_NODE"))])
        self.OSFlagPendGetFlagsRdy = StaticFunction(device, 0x28f80, thumb=1, name='OSFlagPendGetFlagsRdy', return_type=OS_FLAGS, size=24, line=734, arg_list=[])
        self.OS_FlagInit = StaticFunction(device, 0x2908e, thumb=1, name='OS_FlagInit', return_type=None, size=90, line=1031, arg_list=[])
