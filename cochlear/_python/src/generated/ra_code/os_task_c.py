...
class Code(AbstractCode):
    ...
    def OSTaskStkChk(self, prio, p_stk_data):
        '''
        Arguments:
        -prio - INT8U
        -p_stk_data - PointerType('OS_STK_DATA')
        Return type:
        -INT8U
        Declaration line: 819
        '''
        pass

    def OSTaskChangePrio(self, oldprio, newprio):
        '''
        Arguments:
        -oldprio - INT8U
        -newprio - INT8U
    ...
    def OSTaskNameSet(self, prio, pname, err):
        '''
        Arguments:
        -prio - INT8U
        ...
        Return type:
        -None
        Declaration line: 680
        '''
        pass

    def OSTaskNameGet(self, prio, pname, err):
        '''
        Arguments:
        -prio - INT8U
        -pname - PointerType("INT8U")
    ...
    def OS_TaskStkClr(self, pbos, size, opt):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 1038
        '''
        pass

    def OSTaskDel(self, prio):
        '''
        Arguments:
        -prio - INT8U
        Return type:
        -INT8U
        Declaration line: 391
        '''
        pass

    def OSTaskSuspend(self, prio):
        '''
        Arguments:
        -prio - INT8U
        Return type:
        -INT8U
        Declaration line: 903
        '''
        pass

    def OSTaskQuery(self, prio, p_task_data):
        '''
        Arguments:
        -prio - INT8U
        -p_task_data - PointerType('OS_TCB')
        Return type:
        -INT8U
        Declaration line: 976
        '''
        pass

    def OSTaskCreate(self, task, p_arg, ptos, prio):
        '''
        Arguments:
        -task - PointerType("Subroutine")
    ...
    def OSTaskCreateExt(self, task, p_arg, ptos, prio, id, pbos, stk_size, pext, opt):
        '''
        Arguments:
        -task - PointerType('Subroutine')
        -p_arg - PointerType("void")
        ...
        Return type:
        -INT8U
        Declaration line: 301
        '''
        pass

    def OSTaskDelReq(self, prio):
        '''
        Arguments:
        -prio - INT8U
        Return type:
        -INT8U
        Declaration line: 540
        '''
        pass
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.OSTaskStkChk = StaticFunction(device, 0x2a774, thumb=1, name='OSTaskStkChk', return_type=INT8U, size=98, line=819, arg_list=[('prio',INT8U),('p_stk_data',PointerType('OS_STK_DATA'))])
        self.OSTaskChangePrio = StaticFunction(device, 0x2a29c, thumb=1, name='OSTaskChangePrio', return_type=INT8U, size=258, line=51, arg_list=[('oldprio',INT8U),('newprio',INT8U)])
        self.OSTaskNameSet = StaticFunction(device, 0x2a676, thumb=1, name='OSTaskNameSet', return_type=None, size=132, line=680, arg_list=[('prio',INT8U),('pname',PointerType("INT8U")),('err',PointerType('INT8U'))])
        self.OSTaskNameGet = StaticFunction(device, 0x2a628, thumb=1, name='OSTaskNameGet', return_type=INT8U, size=78, line=606, arg_list=[('prio',INT8U),('pname',PointerType("INT8U")),('err',PointerType('INT8U'))])
        self.OS_TaskStkClr = StaticFunction(device, 0x2a41a, thumb=1, name='OS_TaskStkClr', return_type=None, size=22, line=1038, arg_list=[('pbos',PointerType("OS_STK")),('size',INT32U),('opt',INT16U)])
        self.OSTaskDel = StaticFunction(device, 0x2a4b4, thumb=1, name='OSTaskDel', return_type=INT8U, size=284, line=391, arg_list=[('prio',INT8U)])
        self.OSTaskSuspend = StaticFunction(device, 0x2a7d6, thumb=1, name='OSTaskSuspend', return_type=INT8U, size=124, line=903, arg_list=[('prio',INT8U)])
        self.OSTaskQuery = StaticFunction(device, 0x2a852, thumb=1, name='OSTaskQuery', return_type=INT8U, size=76, line=976, arg_list=[('prio',INT8U),('p_task_data',PointerType('OS_TCB'))])
        self.OSTaskCreate = StaticFunction(device, 0x2a39e, thumb=1, name='OSTaskCreate', return_type=INT8U, size=124, line=188, arg_list=[('task',PointerType("Subroutine")),('p_arg',PointerType('void')),('ptos',PointerType("OS_STK")),('prio',INT8U)])
        self.OSTaskResume = StaticFunction(device, 0x2a6fa, thumb=1, name='OSTaskResume', return_type=INT8U, size=122, line=752, arg_list=[('prio',INT8U)])
        self.OSTaskCreateExt = StaticFunction(device, 0x2a430, thumb=1, name='OSTaskCreateExt', return_type=INT8U, size=132, line=301, arg_list=[('task',PointerType('Subroutine')),('p_arg',PointerType("void")),('ptos',PointerType('OS_STK')),('prio',INT8U),('id',INT16U),('pbos',PointerType("OS_STK")),('stk_size',INT32U),('pext',PointerType('void')),('opt',INT16U)])
        self.OSTaskDelReq = StaticFunction(device, 0x2a5d0, thumb=1, name='OSTaskDelReq', return_type=INT8U, size=88, line=540, arg_list=[('prio',INT8U)])
