...
class Code(AbstractCode):
    ...
    def UIE_P_GetCurrentCarousel(self, ):
        '''
        Arguments:
        Return type:
        -HSM_State_t
    ...
    def UIE_P_HandleCarouselLeftRight(self, me, key):
        '''
        Arguments:
    ...
    def UIE_P_IsInCarousel(self, state):
        '''
        Arguments:
        -state - HSM_State_t
        Return type:
    ...
    def UIE_P_GetFirstCarouselState(self, carouselStates):
        '''
        Arguments:
        -carouselStates - PointerType('UIE_P_CarouselState_t')
        Return type:
        -HSM_State_t
        Declaration line: 206
        '''
        pass

    def UIE_P_SetCarousel(self, carousel, states):
        '''
        Arguments:
        -carousel - HSM_State_t
        -states - PointerType("UIE_P_CarouselState_t")
        Return type:
        -None
    ...
    def UIE_P_IsInAdvancedMode(self, ):
        '''
        Arguments:
        Return type:
        -bool
    ...
    def UIE_P_ResetBottomPane(self, me, style):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -style - WAGUI_BottomPaneStyle_t
    ...
    def UIE_P_ExitCarousel(self, me):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        Return type:
        -None
        Declaration line: 138
        '''
        pass
    ...
    currentCarousel = HSM_State_t
    GUI_XBF_APIList_Prop_Ext = tGUI_XBF_APIList
    currentCarouselStates = PointerType("UIE_P_CarouselState_t")
    ...
    def __init__(self, device):
        ...
        self.currentCarousel = StaticVariable(device, self.HSM_State_t, 0x800084c8L, False)
        self.GUI_XBF_APIList_Prop_Ext = StaticVariable(device, self.tGUI_XBF_APIList, 0x61c08, True)
        self.currentCarouselStates = StaticVariable(device, PointerType("UIE_P_CarouselState_t"), 0x800084ccL, False)
        ...
        ### Functions data ###
        ######################
        self.UIE_P_GetCurrentCarousel = StaticFunction(device, 0x3ce36, thumb=1, name='UIE_P_GetCurrentCarousel', return_type=HSM_State_t, size=6, line=125, arg_list=[])
        self.UIE_P_IsPairedRight = StaticFunction(device, 0x3cf70, thumb=1, name='UIE_P_IsPairedRight', return_type=bool, size=12, line=233, arg_list=[])
        self.UIE_P_IsPairedLeft = StaticFunction(device, 0x3cf64, thumb=1, name='UIE_P_IsPairedLeft', return_type=bool, size=12, line=227, arg_list=[])
        self.UIE_P_HandleCarouselLeftRight = StaticFunction(device, 0x3cd7c, thumb=1, name='UIE_P_HandleCarouselLeftRight', return_type=bool, size=186, line=67, arg_list=[('me',PointerType("UIE_P_Sm_t")),('key',KHDL_KeyId_t)])
        self.UIE_P_IsInCarousel = StaticFunction(device, 0x3ceec, thumb=1, name='UIE_P_IsInCarousel', return_type=bool, size=54, line=144, arg_list=[('state',HSM_State_t)])
        self.UIE_P_GetFirstCarouselState = StaticFunction(device, 0x3cf22, thumb=1, name='UIE_P_GetFirstCarouselState', return_type=HSM_State_t, size=48, line=206, arg_list=[('carouselStates',PointerType('UIE_P_CarouselState_t'))])
        self.UIE_P_SetCarousel = StaticFunction(device, 0x3ce3c, thumb=1, name='UIE_P_SetCarousel', return_type=None, size=8, line=131, arg_list=[('carousel',HSM_State_t),('states',PointerType("UIE_P_CarouselState_t"))])
        self.UIE_P_IsInAdvancedMode = StaticFunction(device, 0x3cf52, thumb=1, name='UIE_P_IsInAdvancedMode', return_type=bool, size=18, line=221, arg_list=[])
        self.UIE_P_ResetBottomPane = StaticFunction(device, 0x3ce44, thumb=1, name='UIE_P_ResetBottomPane', return_type=None, size=164, line=159, arg_list=[('me',PointerType('UIE_P_Sm_t')),('style',WAGUI_BottomPaneStyle_t)])
        self.UIE_P_IsBilateral = StaticFunction(device, 0x3cf7c, thumb=1, name='UIE_P_IsBilateral', return_type=bool, size=18, line=239, arg_list=[])
        self.UIE_P_ExitCarousel = StaticFunction(device, 0x3cee8, thumb=1, name='UIE_P_ExitCarousel', return_type=None, size=4, line=138, arg_list=[('me',PointerType("UIE_P_Sm_t"))])
