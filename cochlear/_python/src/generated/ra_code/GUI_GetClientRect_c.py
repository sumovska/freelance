...
class Code(AbstractCode):
    ...
    def GUI_GetClientRect(self, pRect):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_GetClientRect = StaticFunction(device, 0x2e2c4, thumb=1, name='GUI_GetClientRect', return_type=None, size=34, line=38, arg_list=[('pRect',PointerType('GUI_RECT'))])
