...
class Code(AbstractCode):
    ...
    def DNRF_ReuseTx(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
        -None
        Declaration line: 787
        '''
        pass

    def DNRF_SetTxAddr(self, chipNo, pAddr, length):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pAddr - PointerType("byte")
        -length - byte
        Return type:
        -Status
        Declaration line: 596
        '''
        pass

    def DNRF_Initialize(self, chipNo, pWdlpMbox):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pWdlpMbox - PointerType('PointerType("OS_EVENT")')
        Return type:
        -Status
        Declaration line: 839
        '''
        pass

    def DNRF_ConfigureRfChip(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 889
        '''
        pass

    def DNRF_ReadPacket(self, chipNo, pDst, bytesCnt):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pDst - PointerType("byte")
        -bytesCnt - byte
        Return type:
        -None
    ...
    def DNRF_SetRxPayloadLen(self, chipNo, pipeNo, len):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pipeNo - byte
    ...
    def DNRF_ReadReg(self, chipNo, regAddr):
        '''
        Arguments:
        -chipNo - c_ubyte
        -regAddr - byte
    ...
    def DNRF_WriteReg(self, chipNo, regAddr, value):
        '''
        Arguments:
        -chipNo - c_ubyte
        -regAddr - byte
    ...
    def DNRF_ConfigureFreq(self, chipNo, freq):
        '''
        Arguments:
        -chipNo - c_ubyte
        -freq - byte
    ...
    def DnrfChipConfig(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
        -None
        Declaration line: 1156
        '''
        pass

    def DNRF_IrqClear(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
        -None
        Declaration line: 1119
        '''
        pass

    def DNRF_EnablePipe(self, chipNo, pipeNo, enable):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pipeNo - byte
        ...
        Return type:
        -Status
        Declaration line: 687
        '''
        pass

    def DNRF_WriteRegN(self, chipNo, regAddr, bytesCnt, pSrc):
        '''
        Arguments:
        -chipNo - c_ubyte
        -regAddr - byte
        -bytesCnt - byte
        -pSrc - PointerType('byte')
        Return type:
        -None
    ...
    def DNRF_ReadRegN(self, chipNo, regAddr, bytesCnt, pDst):
        '''
        Arguments:
        -chipNo - c_ubyte
        -regAddr - byte
    ...
    def DNRF_EsbEnable(self, chipNo, pipeNo, arDelay, arCount):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pipeNo - byte
    ...
    def DNRF_FlushRx(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
        -None
        Declaration line: 764
        '''
        pass

    def DNRF_ConfiguerPwrUp(self, val):
        '''
        Arguments:
        -val - bool
        Return type:
    ...
    def DNRF_FlushTx(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
        -None
        Declaration line: 741
        '''
        pass

    def DNRF_Isr(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
        -None
        Declaration line: 951
        '''
        pass

    def DNRF_CePinConfig(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
    ...
    def DNRF_SetRxAddr(self, chipNo, pipeNo, pAddr, length):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pipeNo - byte
    ...
    def DNRF_EsbDisable(self, chipNo, pipeNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pipeNo - byte
        Return type:
        -None
        Declaration line: 437
        '''
        pass

    def DNRF_WritePacket(self, chipNo, pSrc, bytesCnt):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pSrc - PointerType("byte")
    ...
    def DNRF_SetAddrWidth(self, chipNo, width):
        '''
        Arguments:
        -chipNo - c_ubyte
        -width - byte
    ...
    def DnrfConfiguerPwrUp(self, chipNo, val):
        '''
        Arguments:
        -chipNo - c_ubyte
        -val - bool
        Return type:
        -None
        Declaration line: 1221
        '''
        pass

    def DNRF_ConfigurePrimaryMode(self, chipNo, primMode):
        '''
        Arguments:
        -chipNo - c_ubyte
        -primMode - DNRF_PrimMode_t
        Return type:
        -None
    ...
    def DNRF_EmptyRx(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
        -None
        Declaration line: 1051
        '''
        pass

    def DNRF_GetStatus(self, chipNo):
        '''
        Arguments:
        -chipNo - c_ubyte
        Return type:
    ...
    def DNRF_Delay(self, retrNum, retrDelay):
        '''
        Arguments:
        -retrNum - u8
        -retrDelay - u8
        Return type:
        -None
        Declaration line: 1080
        '''
        pass

    def DNRF_RegSnapshot(self, chipNo, pRegs):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pRegs - PointerType('DNRF_RegSnapshot_t')
        Return type:
        -Status
    ...
    OSIdleCtr = INT32U
    pNrfIrqMbox = PointerType('OS_EVENT') * 2
    OSCtxSwCtr = INT32U
    OSRunning = BOOLEAN
    OSTaskCtr = INT8U
    OSTmrTime = INT32U
    ...
    def __init__(self, device):
        ...
        self.pNrfIrqMbox = StaticVariable(device, PointerType('OS_EVENT') * 2, 0x400001ac, False)
        ...
        self.DNRF_DefaultChip = StaticVariable(device, c_ubyte, 0x400001a4, False)
        ...
        self.waitCycles = StaticVariable(device, self.u32, 0x400001a8, False)
        ...
        self.DNRF_ReuseTx = StaticFunction(device, 0x5adae, thumb=1, name='DNRF_ReuseTx', return_type=None, size=32, line=787, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_SetTxAddr = StaticFunction(device, 0x5acfc, thumb=1, name='DNRF_SetTxAddr', return_type=Status, size=24, line=596, arg_list=[('chipNo',c_ubyte),('pAddr',PointerType("byte")),('length',byte)])
        self.DNRF_Initialize = StaticFunction(device, 0x5aeb6, thumb=1, name='DNRF_Initialize', return_type=Status, size=50, line=839, arg_list=[('chipNo',c_ubyte),('pWdlpMbox',PointerType('PointerType("OS_EVENT")'))])
        self.DNRF_ConfigureRfChip = StaticFunction(device, 0x5ae66, thumb=1, name='DNRF_ConfigureRfChip', return_type=None, size=80, line=889, arg_list=[])
        self.DNRF_ReadPacket = StaticFunction(device, 0x5aa70, thumb=1, name='DNRF_ReadPacket', return_type=None, size=86, line=278, arg_list=[('chipNo',c_ubyte),('pDst',PointerType("byte")),('bytesCnt',byte)])
        self.DNRF_SetRxPayloadLen = StaticFunction(device, 0x5ad14, thumb=1, name='DNRF_SetRxPayloadLen', return_type=Status, size=90, line=628, arg_list=[('chipNo',c_ubyte),('pipeNo',byte),('len',byte)])
        ...
        self.DNRF_ReadReg = StaticFunction(device, 0x5a972, thumb=1, name='DNRF_ReadReg', return_type=byte, size=52, line=128, arg_list=[('chipNo',c_ubyte),('regAddr',byte)])
        ...
        self.DNRF_WriteReg = StaticFunction(device, 0x5a93c, thumb=1, name='DNRF_WriteReg', return_type=None, size=54, line=96, arg_list=[('chipNo',c_ubyte),('regAddr',byte),('value',byte)])
        self.DNRF_ToggleCe = StaticFunction(device, 0x5adce, thumb=1, name='DNRF_ToggleCe', return_type=None, size=54, line=809, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_ConfigureFreq = StaticFunction(device, 0x5ac0e, thumb=1, name='DNRF_ConfigureFreq', return_type=None, size=8, line=467, arg_list=[('chipNo',c_ubyte),('freq',byte)])
        self.DnrfChipConfig = StaticFunction(device, 0x5ae04, thumb=1, name='DnrfChipConfig', return_type=None, size=98, line=1156, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_IrqClear = StaticFunction(device, 0x5b040, thumb=1, name='DNRF_IrqClear', return_type=None, size=72, line=1119, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_EnablePipe = StaticFunction(device, 0x5ab44, thumb=1, name='DNRF_EnablePipe', return_type=Status, size=74, line=687, arg_list=[('chipNo',c_ubyte),('pipeNo',byte),('enable',bool)])
        self.DNRF_WriteRegN = StaticFunction(device, 0x5aa22, thumb=1, name='DNRF_WriteRegN', return_type=None, size=78, line=236, arg_list=[('chipNo',c_ubyte),('regAddr',byte),('bytesCnt',byte),('pSrc',PointerType('byte'))])
        self.DNRF_ReadRegN = StaticFunction(device, 0x5a9ca, thumb=1, name='DNRF_ReadRegN', return_type=None, size=88, line=188, arg_list=[('chipNo',c_ubyte),('regAddr',byte),('bytesCnt',byte),('pDst',PointerType("byte"))])
        self.DNRF_EsbEnable = StaticFunction(device, 0x5ab8e, thumb=1, name='DNRF_EsbEnable', return_type=None, size=76, line=404, arg_list=[('chipNo',c_ubyte),('pipeNo',byte),('arDelay',byte),('arCount',byte)])
        self.DNRF_FlushRx = StaticFunction(device, 0x5ad8e, thumb=1, name='DNRF_FlushRx', return_type=None, size=32, line=764, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_ConfiguerPwrUp = StaticFunction(device, 0x5ac48, thumb=1, name='DNRF_ConfiguerPwrUp', return_type=None, size=26, line=481, arg_list=[('val',bool)])
        self.DNRF_FlushTx = StaticFunction(device, 0x5ad6e, thumb=1, name='DNRF_FlushTx', return_type=None, size=32, line=741, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_Isr = StaticFunction(device, 0x5aee8, thumb=1, name='DNRF_Isr', return_type=None, size=74, line=951, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_CePinConfig = StaticFunction(device, 0x5dc6c, thumb=1, name='DNRF_CePinConfig', return_type=None, size=138, line=692, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_SetRxAddr = StaticFunction(device, 0x5ac96, thumb=1, name='DNRF_SetRxAddr', return_type=Status, size=102, line=541, arg_list=[('chipNo',c_ubyte),('pipeNo',byte),('pAddr',PointerType('byte')),('length',byte)])
        self.DNRF_EsbDisable = StaticFunction(device, 0x5abda, thumb=1, name='DNRF_EsbDisable', return_type=None, size=52, line=437, arg_list=[('chipNo',c_ubyte),('pipeNo',byte)])
        self.DNRF_WritePacket = StaticFunction(device, 0x5aac6, thumb=1, name='DNRF_WritePacket', return_type=None, size=74, line=329, arg_list=[('chipNo',c_ubyte),('pSrc',PointerType("byte")),('bytesCnt',byte)])
        self.DNRF_SetAddrWidth = StaticFunction(device, 0x5ac62, thumb=1, name='DNRF_SetAddrWidth', return_type=Status, size=52, line=506, arg_list=[('chipNo',c_ubyte),('width',byte)])
        ...
        self.DnrfConfiguerPwrUp = StaticFunction(device, 0x5ac16, thumb=1, name='DnrfConfiguerPwrUp', return_type=None, size=50, line=1221, arg_list=[('chipNo',c_ubyte),('val',bool)])
        self.DNRF_ConfigurePrimaryMode = StaticFunction(device, 0x5ab10, thumb=1, name='DNRF_ConfigurePrimaryMode', return_type=None, size=52, line=372, arg_list=[('chipNo',c_ubyte),('primMode',DNRF_PrimMode_t)])
        self.DNRF_EmptyRx = StaticFunction(device, 0x5afea, thumb=1, name='DNRF_EmptyRx', return_type=None, size=42, line=1051, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_GetStatus = StaticFunction(device, 0x5a9a6, thumb=1, name='DNRF_GetStatus', return_type=byte, size=36, line=161, arg_list=[('chipNo',c_ubyte)])
        ...
        self.DNRF_Delay = StaticFunction(device, 0x5b014, thumb=1, name='DNRF_Delay', return_type=None, size=44, line=1080, arg_list=[('retrNum',u8),('retrDelay',u8)])
        self.DNRF_RegSnapshot = StaticFunction(device, 0x5af32, thumb=1, name='DNRF_RegSnapshot', return_type=Status, size=184, line=1002, arg_list=[('chipNo',c_ubyte),('pRegs',PointerType('DNRF_RegSnapshot_t'))])
