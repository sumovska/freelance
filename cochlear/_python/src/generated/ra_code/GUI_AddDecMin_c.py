...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_AddDecMin = StaticFunction(device, 0x2fd7a, thumb=1, name='GUI_AddDecMin', return_type=None, size=30, line=34, arg_list=[('v',c_long_le),('ps',PointerType('PointerType("c_byte")'))])
