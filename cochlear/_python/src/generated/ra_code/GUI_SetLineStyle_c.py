...
class Code(AbstractCode):
    ...
    def GUI_SetLineStyle(self, LineStyle):
        '''
        Arguments:
        -LineStyle - c_ubyte
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_SetLineStyle = StaticFunction(device, 0x2feac, thumb=1, name='GUI_SetLineStyle', return_type=c_ubyte, size=10, line=32, arg_list=[('LineStyle',c_ubyte)])
