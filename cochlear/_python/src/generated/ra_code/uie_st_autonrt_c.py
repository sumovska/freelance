...
class Code(AbstractCode):
    ...
    def UIE_P_StNrtTrebleInstruction(self, me, pEvt):
        '''
        Arguments:
    ...
    def UIE_P_StNrtConfirmation(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtSkippedInstruction(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtMasterVolumeInstruction(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 731
        '''
        pass

    def UIE_P_StNrt(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtInProgress(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 261
        '''
        pass

    def UIE_P_StNrtInit(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtMasterVolume(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtBass(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtBilateralInstruction(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtFailed(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtFinishing(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def IsMClinicBteAvailable(self, ):
        ...
        Return type:
        -bool
        Declaration line: 1337
        '''
        pass

    def UIE_P_StNrtTreble(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StNrtAbortInstruction(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 643
        '''
        pass

    def UIE_P_StNrtBassInstruction(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 915
        '''
        pass

    def UIE_P_StNrtPaused(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_GetMClinicPostOpEnabledBtes(self, ):
        '''
        Arguments:
        Return type:
        -WBST_BteId_t
        Declaration line: 1311
        '''
        pass
    ...
    def __init__(self, device):
        ...
        ### Variables ###
        #################
        self.nrtEntryState = StaticVariable(device, self.HSM_State_t, 0x800084c4L, False)
        ...
        ### Functions data ###
        ######################
        self.UIE_P_StNrtTrebleInstruction = StaticFunction(device, 0x3c208, thumb=1, name='UIE_P_StNrtTrebleInstruction', return_type=HSM_StateRet_t, size=92, line=1072, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtConfirmation = StaticFunction(device, 0x3bff2, thumb=1, name='UIE_P_StNrtConfirmation', return_type=HSM_StateRet_t, size=194, line=1225, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtSkippedInstruction = StaticFunction(device, 0x3c6a2, thumb=1, name='UIE_P_StNrtSkippedInstruction', return_type=HSM_StateRet_t, size=92, line=685, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtMasterVolumeInstruction = StaticFunction(device, 0x3c600, thumb=1, name='UIE_P_StNrtMasterVolumeInstruction', return_type=HSM_StateRet_t, size=162, line=731, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrt = StaticFunction(device, 0x3cc74, thumb=1, name='UIE_P_StNrt', return_type=HSM_StateRet_t, size=170, line=75, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtInProgress = StaticFunction(device, 0x3c930, thumb=1, name='UIE_P_StNrtInProgress', return_type=HSM_StateRet_t, size=562, line=261, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtInit = StaticFunction(device, 0x3cb7a, thumb=1, name='UIE_P_StNrtInit', return_type=HSM_StateRet_t, size=120, line=201, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtMasterVolume = StaticFunction(device, 0x3c452, thumb=1, name='UIE_P_StNrtMasterVolume', return_type=HSM_StateRet_t, size=430, line=797, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtBass = StaticFunction(device, 0x3c264, thumb=1, name='UIE_P_StNrtBass', return_type=HSM_StateRet_t, size=404, line=961, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtBilateralInstruction = StaticFunction(device, 0x3cbf2, thumb=1, name='UIE_P_StNrtBilateralInstruction', return_type=HSM_StateRet_t, size=130, line=157, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtFailed = StaticFunction(device, 0x3bf84, thumb=1, name='UIE_P_StNrtFailed', return_type=HSM_StateRet_t, size=110, line=596, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtFinishing = StaticFunction(device, 0x3c6fe, thumb=1, name='UIE_P_StNrtFinishing', return_type=HSM_StateRet_t, size=162, line=436, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.IsMClinicBteAvailable = StaticFunction(device, 0x3cb62, thumb=1, name='IsMClinicBteAvailable', return_type=bool, size=24, line=1337, arg_list=[])
        self.UIE_P_StNrtTreble = StaticFunction(device, 0x3c0b4, thumb=1, name='UIE_P_StNrtTreble', return_type=HSM_StateRet_t, size=340, line=1118, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtAbortInstruction = StaticFunction(device, 0x3c7a0, thumb=1, name='UIE_P_StNrtAbortInstruction', return_type=HSM_StateRet_t, size=136, line=643, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtBassInstruction = StaticFunction(device, 0x3c3f8, thumb=1, name='UIE_P_StNrtBassInstruction', return_type=HSM_StateRet_t, size=90, line=915, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StNrtPaused = StaticFunction(device, 0x3c828, thumb=1, name='UIE_P_StNrtPaused', return_type=HSM_StateRet_t, size=264, line=495, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_GetMClinicPostOpEnabledBtes = StaticFunction(device, 0x3cd1e, thumb=1, name='UIE_P_GetMClinicPostOpEnabledBtes', return_type=WBST_BteId_t, size=56, line=1311, arg_list=[])
