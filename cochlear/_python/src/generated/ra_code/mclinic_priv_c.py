...
class Code(AbstractCode):
    ...
    def MCL_P_ConvertBteErrToStatus(self, bteStatus):
        '''
        Arguments:
        -bteStatus - CIP_ProcResult_t
        Return type:
        -MCL_Status_t
        Declaration line: 72
        '''
    ...
    def MCL_P_GetClientIdFromFlow(self, flow):
        '''
        Arguments:
        -flow - MCL_FlowType_t
        Return type:
        -CIP_StartFittingSessionClientId_t
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.MCL_P_ConvertBteErrToStatus = StaticFunction(device, 0x38388, thumb=1, name='MCL_P_ConvertBteErrToStatus', return_type=MCL_Status_t, size=70, line=72, arg_list=[('bteStatus',CIP_ProcResult_t)])
        self.MCL_P_GetClientIdFromFlow = StaticFunction(device, 0x383ce, thumb=1, name='MCL_P_GetClientIdFromFlow', return_type=CIP_StartFittingSessionClientId_t, size=20, line=119, arg_list=[('flow',MCL_FlowType_t)])
