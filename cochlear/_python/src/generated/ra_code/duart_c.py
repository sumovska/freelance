...
class Code(AbstractCode):
    ...
    def DUART_Fini(self, fini_type):
        '''
        Arguments:
        -fini_type - INT_FiniType_t
        Return type:
        -Status
        Declaration line: 472
        '''
        pass
    ...
    def DUART1_SimpleSend(self, newData):
        '''
        Arguments:
    ...
    def Duart1PutChar(self, ):
        '''
        Arguments:
        Return type:
        -Status
        Declaration line: 926
        '''
        pass

    def DUART1_InsertData(self, newData, newDataSize):
        '''
        Arguments:
        -newData - PointerType("c_byte")
        -newDataSize - u32
        Return type:
        -Status
        Declaration line: 616
        '''
        pass

    def Duart0PutChar(self, ):
        '''
        Arguments:
        Return type:
        -Status
    ...
    def DUART_RegisterRxQ(self, duartRxQ):
        '''
        Arguments:
        -duartRxQ - PointerType('OS_EVENT')
        Return type:
        -Status
        Declaration line: 693
        '''
        pass

    def DUART_Init(self, init_type):
        '''
        Arguments:
    ...
    def DUART0_InsertData(self, newData, newDataSize):
        '''
        Arguments:
        -newData - PointerType("c_byte")
        -newDataSize - u32
    ...
    def DUART0_SimpleSend(self, newData):
        '''
        Arguments:
        -newData - PointerType('c_byte')
        Return type:
    ...
    duart0CBufAccessMutex = PointerType('OS_EVENT')
    duart1CBufTab = byte * 2048
    OSEventFreeList = PointerType("OS_EVENT")
    OSPrioHighRdy = INT8U
    duart1CBufAccessMutex = PointerType('OS_EVENT')
    OSFlagFreeList = PointerType("OS_FLAG_GRP")
    OSLockNesting = INT8U
    OSRdyGrp = INT8U
    OSTCBCur = PointerType('OS_TCB')
    duart0RxQ = PointerType("OS_EVENT")
    OSMemTbl = OS_MEM * 15
    ...
    duart0CBuf = DUART_P_CircularBuf_t
    ...
    def __init__(self, device):
        ...
        self.duart0CBufAccessMutex = StaticVariable(device, PointerType('OS_EVENT'), 0x80008a14L, False)
        self.duart1CBufTab = StaticVariable(device, byte * 2048, 0x4000c70c, False)
        ...
        self.duart1CBufAccessMutex = StaticVariable(device, PointerType('OS_EVENT'), 0x80008a1cL, False)
        ...
        self.duart0RxQ = StaticVariable(device, PointerType("OS_EVENT"), 0x80008a18L, False)
        ...
        self.duart0CBuf = StaticVariable(device, self.DUART_P_CircularBuf_t, 0x4000c65c, False)
        ...
        self.duart0CBufTab = StaticVariable(device, byte * 128, 0x4000c674, False)
        ...
        self.duart1CBuf = StaticVariable(device, self.DUART_P_CircularBuf_t, 0x4000c6f4, False)
        ...
        ### Functions data ###
        ######################
        self.DUART_Fini = StaticFunction(device, 0x5b4e4, thumb=1, name='DUART_Fini', return_type=Status, size=132, line=472, arg_list=[('fini_type',INT_FiniType_t)])
        self.Duart0Isr = StaticFunction(device, 0x5b354, thumb=1, name='Duart0Isr', return_type=None, size=56, line=824, arg_list=[])
        self.DUART1_SimpleSend = StaticFunction(device, 0x5b786, thumb=1, name='DUART1_SimpleSend', return_type=None, size=142, line=756, arg_list=[('newData',PointerType('c_byte'))])
        self.Duart1PutChar = StaticFunction(device, 0x5b2d8, thumb=1, name='Duart1PutChar', return_type=Status, size=44, line=926, arg_list=[])
        self.DUART1_InsertData = StaticFunction(device, 0x5b618, thumb=1, name='DUART1_InsertData', return_type=Status, size=204, line=616, arg_list=[('newData',PointerType("c_byte")),('newDataSize',u32)])
        self.Duart0PutChar = StaticFunction(device, 0x5b328, thumb=1, name='Duart0PutChar', return_type=Status, size=44, line=913, arg_list=[])
        self.DUART1_IsEmpty = StaticFunction(device, 0x5b814, thumb=1, name='DUART1_IsEmpty', return_type=bool, size=26, line=793, arg_list=[])
        self.DUART_RegisterRxQ = StaticFunction(device, 0x5b6e4, thumb=1, name='DUART_RegisterRxQ', return_type=Status, size=28, line=693, arg_list=[('duartRxQ',PointerType('OS_EVENT'))])
        self.DUART_Init = StaticFunction(device, 0x5b38c, thumb=1, name='DUART_Init', return_type=Status, size=344, line=347, arg_list=[('init_type',INT_InitType_t)])
        self.DUART0_InsertData = StaticFunction(device, 0x5b568, thumb=1, name='DUART0_InsertData', return_type=Status, size=176, line=553, arg_list=[('newData',PointerType("c_byte")),('newDataSize',u32)])
        self.DUART0_SimpleSend = StaticFunction(device, 0x5b700, thumb=1, name='DUART0_SimpleSend', return_type=None, size=134, line=714, arg_list=[('newData',PointerType('c_byte'))])
        self.Duart1Isr = StaticFunction(device, 0x5b304, thumb=1, name='Duart1Isr', return_type=None, size=36, line=875, arg_list=[])
