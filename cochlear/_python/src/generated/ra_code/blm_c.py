...
class BLM_ClinicalState_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    BLM_IDLE = 0
    BLM_PRG_SETUP = 1
    BLM_SYSTEM_PRG = 2
    BLM_SIMPLE_BRIDGE_PROCESSING = 3
...
BLM_ClinicalState_t = BLM_ClinicalState_tag
...
class BLM_ClinicalMode_tag(Structure):
    cliState = BLM_ClinicalState_t
    isShuttingDown = bool
    retransSysPrgCo = u8
    cliPairingCnt = u8
    _pack_ = 1
...
class BLM_SimpleBridgeReq_tag(Structure):
    timeout = u16
    payload = u8 * 31
    _fields_ = [
                ('timeout', u16),
...
BLM_SimpleBridgeReq_t = BLM_SimpleBridgeReq_tag
...
BLM_ClinicalMode_t = BLM_ClinicalMode_tag
...
class Code(AbstractCode):
    ...
    BLM_ClinicalState_tag = BLM_ClinicalState_tag
    ...
    BLM_ClinicalState_t = BLM_ClinicalState_t
    ...
    BLM_ClinicalMode_tag = BLM_ClinicalMode_tag
    ...
    os_q_data = os_q_data
    BLM_SimpleBridgeReq_tag = BLM_SimpleBridgeReq_tag
    os_mutex_data = os_mutex_data
    ...
    BLM_SimpleBridgeReq_t = BLM_SimpleBridgeReq_t
    ...
    BLM_ClinicalMode_t = BLM_ClinicalMode_t
    ...
    def BLM_Init(self, initType):
        '''
        Arguments:
        -initType - INT_InitType_t
        Return type:
        -Status
        Declaration line: 221
        '''
        pass
    ...
    def ProcessShutDownRequest(self, ):
        ...
        Return type:
        -BLM_Status_t
        Declaration line: 1486
        '''
        pass

    def CliPairCntInc(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1871
        '''
        pass

    def CliPairCntDec(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1887
        '''
        pass

    def ProcessDataRequest(self, pEventData):
        '''
        Arguments:
        -pEventData - PointerType('VCH_DataPktReq_t')
        Return type:
        -BLM_Status_t
        Declaration line: 696
        '''
        pass

    def ReadPktQueue(self, ):
        '''
        Arguments:
        Return type:
        -BLM_Status_t
        Declaration line: 1806
        '''
        pass

    def CheckAcl(self, cmdId):
        '''
        Arguments:
        -cmdId - u8
        Return type:
        -bool
        Declaration line: 1906
        '''
        pass

    def BlmTask(self, pArg):
        '''
        Arguments:
        -pArg - PointerType("void")
        Return type:
        -None
        Declaration line: 1620
        '''
        pass

    def ProcessDataResponse(self, pEventData):
        '''
        Arguments:
        -pEventData - PointerType('WDLP_PktSendAck_t')
        Return type:
        -BLM_Status_t
    ...
    def ProcessSystemResponse(self, eventId, pEventData):
        '''
        Arguments:
        -eventId - ITC_EventId_t
        -pEventData - PointerType("BlmMaxEventPayload_t")
        Return type:
        -BLM_Status_t
    ...
    def ProcessPairingResponse(self, eventId, pEventData):
        '''
        Arguments:
        -eventId - ITC_EventId_t
        -pEventData - PointerType('BlmMaxEventPayload_t')
    ...
    def ProcessPairingRequest(self, eventId, pEventData):
        '''
        Arguments:
        -eventId - ITC_EventId_t
        -pEventData - PointerType("BlmMaxEventPayload_t")
    ...
    def ProcessTimeoutRequest(self, eventId):
        '''
        Arguments:
        -eventId - ITC_EventId_t
        Return type:
        -BLM_Status_t
        Declaration line: 1351
        '''
        pass
    ...
    blmPoolMem = ITC_MemPool_t * 44 * 5
    OSTCBPrioTbl = PointerType('OS_TCB') * 61
    blmIntQueue = ITC_Queue_t * 5
    OSPrioHighRdy = INT8U
    ...
    blmIntPoolMem = ITC_MemPool_t * 20 * 5
    OSTime = INT32U
    ...
    def __init__(self, device):
        ...
        self.blmQueueTimeout = StaticVariable(device, self.u32, 0x81008034L, False)
        ...
        self.blmPoolMem = StaticVariable(device, ITC_MemPool_t * 44 * 5, 0x8100953cL, False)
        self.OSTCBPrioTbl = StaticVariable(device, PointerType('OS_TCB') * 61, 0x400045a4, False)
        self.blmIntQueue = StaticVariable(device, ITC_Queue_t * 5, 0x81009618L, False)
        ...
        self.blmTaskStack = StaticVariable(device, OS_STK * 512, 0x81009690L, False)
        ...
        self.blmQueue = StaticVariable(device, ITC_Queue_t * 5, 0x81009528L, False)
        ...
        self.blmClinicalMode = StaticVariable(device, self.BLM_ClinicalMode_t, 0x81008040L, False)
        ...
        self.blmIntPoolMem = StaticVariable(device, ITC_MemPool_t * 20 * 5, 0x8100962cL, False)
        ...
        ### Functions data ###
        ######################
        self.BLM_Init = StaticFunction(device, 0x51c4c, thumb=1, name='BLM_Init', return_type=Status, size=214, line=221, arg_list=[('initType',INT_InitType_t)])
        self.ProcessShutDownRequest = StaticFunction(device, 0x51494, thumb=1, name='ProcessShutDownRequest', return_type=BLM_Status_t, size=202, line=1486, arg_list=[])
        self.CliPairCntInc = StaticFunction(device, 0x51934, thumb=1, name='CliPairCntInc', return_type=None, size=16, line=1871, arg_list=[])
        self.CliPairCntDec = StaticFunction(device, 0x51924, thumb=1, name='CliPairCntDec', return_type=None, size=16, line=1887, arg_list=[])
        self.ProcessDataRequest = StaticFunction(device, 0x5156e, thumb=1, name='ProcessDataRequest', return_type=BLM_Status_t, size=560, line=696, arg_list=[('pEventData',PointerType('VCH_DataPktReq_t'))])
        self.ReadPktQueue = StaticFunction(device, 0x5179e, thumb=1, name='ReadPktQueue', return_type=BLM_Status_t, size=124, line=1806, arg_list=[])
        self.CheckAcl = StaticFunction(device, 0x5155e, thumb=1, name='CheckAcl', return_type=bool, size=16, line=1906, arg_list=[('cmdId',u8)])
        self.BlmTask = StaticFunction(device, 0x51b1e, thumb=1, name='BlmTask', return_type=None, size=302, line=1620, arg_list=[('pArg',PointerType("void"))])
        self.ProcessDataResponse = StaticFunction(device, 0x5181a, thumb=1, name='ProcessDataResponse', return_type=BLM_Status_t, size=266, line=973, arg_list=[('pEventData',PointerType('WDLP_PktSendAck_t'))])
        self.BLM_Fini = StaticFunction(device, 0x51d22, thumb=1, name='BLM_Fini', return_type=Status, size=26, line=333, arg_list=[('finiType',INT_FiniType_t)])
        self.ProcessSystemResponse = StaticFunction(device, 0x51298, thumb=1, name='ProcessSystemResponse', return_type=BLM_Status_t, size=328, line=1134, arg_list=[('eventId',ITC_EventId_t),('pEventData',PointerType("BlmMaxEventPayload_t"))])
        self.ProcessPairingResponse = StaticFunction(device, 0x51944, thumb=1, name='ProcessPairingResponse', return_type=BLM_Status_t, size=260, line=515, arg_list=[('eventId',ITC_EventId_t),('pEventData',PointerType('BlmMaxEventPayload_t'))])
        self.ProcessPairingRequest = StaticFunction(device, 0x51a48, thumb=1, name='ProcessPairingRequest', return_type=BLM_Status_t, size=214, line=370, arg_list=[('eventId',ITC_EventId_t),('pEventData',PointerType("BlmMaxEventPayload_t"))])
        self.ProcessTimeoutRequest = StaticFunction(device, 0x513e0, thumb=1, name='ProcessTimeoutRequest', return_type=BLM_Status_t, size=180, line=1351, arg_list=[('eventId',ITC_EventId_t)])
