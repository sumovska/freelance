...
class KEY_INFO__structure(Structure):
    Isolated = c_ushort_le
    Final = c_ushort_le
    Initial = c_ushort_le
    Medial = c_ushort_le
    _pack_ = 1
...
class Code(AbstractCode):
    ...
    KEY_INFO__structure = KEY_INFO__structure
    ...
    def GUI__GetPresentationForm(self, Char, Next, Prev, pIgnoreNext, s):
        '''
        Arguments:
        -Char - c_ushort_le
        -Next - c_ushort_le
        -Prev - c_ushort_le
        -pIgnoreNext - PointerType('c_int_le')
    ...
    def GUI__IsArabicCharacter(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
        -c_int_le
        Declaration line: 174
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self._aKeyInfo = StaticVariable(device, KEY_INFO * 42, 0x6f564, True)
        ...
        ### Functions data ###
        ######################
        self.GUI__GetPresentationForm = StaticFunction(device, 0x31e76, thumb=1, name='GUI__GetPresentationForm', return_type=c_ushort_le, size=584, line=200, arg_list=[('Char',c_ushort_le),('Next',c_ushort_le),('Prev',c_ushort_le),('pIgnoreNext',PointerType('c_int_le')),('s',PointerType("c_byte"))])
        self.GUI__IsArabicCharacter = StaticFunction(device, 0x31e64, thumb=1, name='GUI__IsArabicCharacter', return_type=c_int_le, size=18, line=174, arg_list=[('c',c_ushort_le)])
