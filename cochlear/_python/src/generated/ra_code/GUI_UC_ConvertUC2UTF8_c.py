...
class Code(AbstractCode):
    ...
    def GUI_UC_ConvertUC2UTF8(self, s, Len, pBuffer, BufferSize):
        '''
        Arguments:
        -s - PointerType("c_ushort_le")
        -Len - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_UC_ConvertUC2UTF8 = StaticFunction(device, 0x3211c, thumb=1, name='GUI_UC_ConvertUC2UTF8', return_type=c_int_le, size=54, line=32, arg_list=[('s',PointerType("c_ushort_le")),('Len',c_int_le),('pBuffer',PointerType('c_byte')),('BufferSize',c_int_le)])
