...
class WdlpRccPkt_tag(Structure):
    mode = byte
    payload = byte * 31
    _pack_ = 1
    _fields_ = [
...
Wdlp8bPkt_t = Wdlp8bPkt_tag
OS_SEM_DATA = os_sem_data
OS_FLAG_GRP = os_flag_grp
PktParingReq_t = Wdlp8bPkt_t
ITC_EvntHdr_t = ITC_EvntHdr_tag
PktParingRes_t = Wdlp8bPkt_t
OS_TMR_WHEEL = os_tmr_wheel
OS_STK_DATA = os_stk_data
PktSyncRes_t = Wdlp8bPkt_t
PktSyncReq_t = Wdlp8bPkt_t
...
WdlpSysPrgPkt_t = WdlpRccPkt_t
WDLP_PktSendAck_t = WDLP_CmdSendAck_t
PktLinkModRes_t = Wdlp8bPkt_t
PktReParingReq_t = Wdlp8bPkt_t
PktLinkModReq_t = Wdlp8bPkt_t
PktReParingRes_t = Wdlp8bPkt_t
...
class Code(AbstractCode):
    ...
    Wdlp8bPkt_t = Wdlp8bPkt_t
    OS_SEM_DATA = OS_SEM_DATA
    OS_FLAG_GRP = OS_FLAG_GRP
    PktParingReq_t = PktParingReq_t
    ITC_EvntHdr_t = ITC_EvntHdr_t
    PktParingRes_t = PktParingRes_t
    OS_TMR_WHEEL = OS_TMR_WHEEL
    OS_STK_DATA = OS_STK_DATA
    PktSyncRes_t = PktSyncRes_t
    PktSyncReq_t = PktSyncReq_t
    ...
    WdlpSysPrgPkt_t = WdlpSysPrgPkt_t
    WDLP_PktSendAck_t = WDLP_PktSendAck_t
    PktLinkModRes_t = PktLinkModRes_t
    PktReParingReq_t = PktReParingReq_t
    PktLinkModReq_t = PktLinkModReq_t
    PktReParingRes_t = PktReParingRes_t
    ...
    def WDLP_P_GetPfc(self, version, pfc):
        '''
        Arguments:
        -version - byte
        -pfc - byte
        Return type:
        -byte
        Declaration line: 2616
        '''
        pass

    def ValidatePktPairingRes(self, pRes, pairType):
        '''
        Arguments:
        -pRes - PointerType('PktParingReq_t')
        -pairType - WDLP_P_PairType_t
        Return type:
        -bool
    ...
    def ValidatePktLinkModRes(self, pRes):
        '''
        Arguments:
        -pRes - PointerType("PktLinkModReq_t")
        Return type:
        -bool
        Declaration line: 2506
        '''
        pass

    def WDLP_P_InitialPair(self, pairType, rfPwr, uda5, bte, slotTimeout, pktsSent):
        '''
        Arguments:
        -pairType - WDLP_P_PairType_t
        -rfPwr - byte
        -uda5 - PointerType('byte')
        -bte - PointerType("WDLP_P_BteInfo_t")
        -slotTimeout - u32
        -pktsSent - PointerType('u32')
        Return type:
        -WDLP_Status_t
    ...
    def WDLP_P_SendSysPrgPacket(self, mode, pBte, txPayload, rxPayload, slotTimeout, retries):
        '''
        Arguments:
        -mode - WDLP_P_Mode_t
        -pBte - PointerType("WDLP_P_BteInfo_t")
        -txPayload - PointerType('byte')
        -rxPayload - PointerType("byte")
        -slotTimeout - u32
        -retries - PointerType('u32')
        Return type:
        -WDLP_Status_t
        Declaration line: 1678
        '''
        pass
    ...
    def WDLP_P_LinkModify(self, bte, nextMode, newPfc, slotTimeout, pktsSent):
        '''
        Arguments:
        -bte - PointerType("WDLP_P_BteInfo_t")
        -nextMode - WDLP_P_Mode_t
        -newPfc - byte
        -slotTimeout - u32
        -pktsSent - PointerType('u32')
        Return type:
        -WDLP_Status_t
        Declaration line: 943
        '''
        pass

    def PktMode(self, mode):
        '''
        Arguments:
        -mode - WDLP_P_Mode_t
        Return type:
        -byte
        Declaration line: 2562
        '''
        pass

    def CreatePktPairingReq(self, pReq, pBte, uda5, pairType):
        '''
        Arguments:
        -pReq - PointerType("PktParingReq_t")
        -pBte - PointerType('WDLP_P_BteInfo_t')
        -uda5 - PointerType("byte")
        -pairType - WDLP_P_PairType_t
        Return type:
        -None
        Declaration line: 2081
        '''
        pass

    def WDLP_P_GetAddrLen(self, version):
        '''
        Arguments:
        -version - byte
        Return type:
        -byte
        Declaration line: 2611
        '''
        pass

    def CreatePktReq(self, pReq, mode, address, param1, param2, wdlpVer):
        '''
        Arguments:
        -pReq - PointerType('Wdlp8bPkt_t')
        -mode - byte
        -address - PointerType("byte")
        -param1 - byte
        -param2 - byte
        -wdlpVer - byte
        Return type:
        -None
        Declaration line: 2029
        '''
        pass

    def ValidatePktSyncRes(self, pRes, wdlpVer):
        '''
        Arguments:
        -pRes - PointerType('PktSyncReq_t')
        -wdlpVer - byte
        Return type:
        -bool
        Declaration line: 2426
        '''
        pass

    def CreatePktSyncReq(self, pReq, pBte, nextMode):
        '''
        Arguments:
        -pReq - PointerType("PktSyncReq_t")
        -pBte - PointerType('WDLP_P_BteInfo_t')
        -nextMode - WDLP_P_Mode_t
        Return type:
        -None
    ...
    def WDLP_P_InterferencePresent(self, bte, channel):
        '''
        Arguments:
        -bte - PointerType("WDLP_P_BteInfo_t")
        -channel - byte
        Return type:
        -bool
        Declaration line: 1597
        '''
        pass

    def WDLP_P_RePair(self, bte, nextMode, slotTimeout, pktsSent):
        '''
        Arguments:
        -bte - PointerType('WDLP_P_BteInfo_t')
        -nextMode - WDLP_P_Mode_t
        ...
        Return type:
        -WDLP_Status_t
        Declaration line: 717
        '''
        pass

    def WDLP_P_Sync(self, bte, nextMode, slotTimeout, pktsSent):
        '''
        Arguments:
        -bte - PointerType('WDLP_P_BteInfo_t')
        -nextMode - WDLP_P_Mode_t
        ...
        Return type:
        -WDLP_Status_t
        Declaration line: 547
        '''
        pass

    def ValidatePktRePairingRes(self, pRes, wdlpVer):
        '''
        Arguments:
        -pRes - PointerType('PktReParingReq_t')
        -wdlpVer - byte
        Return type:
        -bool
    ...
    def WDLP_P_SendCmd(self, mode, bte, txPayload, rxPayload, slotTimeout, retries):
        '''
        Arguments:
        -mode - WDLP_P_Mode_t
        -bte - PointerType("WDLP_P_BteInfo_t")
        ...
        Return type:
        -WDLP_Status_t
        Declaration line: 1130
        '''
        pass

    def wdlpSendCmdNormalMode(self, mode, bte, txPayload, rxPayload, slotTimeout, retries):
        '''
        Arguments:
        -mode - WDLP_P_Mode_t
        -bte - PointerType("WDLP_P_BteInfo_t")
        ...
        Return type:
        -WDLP_Status_t
        Declaration line: 1168
        '''
        pass

    def wdlpSendCmdStreamMode(self, mode, bte, txPayload, rxPayload, slotTimeout):
        '''
        Arguments:
        -mode - WDLP_P_Mode_t
        -bte - PointerType("WDLP_P_BteInfo_t")
    ...
    def WDLP_P_SysPrgEnable(self, pBte, mode):
        '''
        Arguments:
        -pBte - PointerType('WDLP_P_BteInfo_t')
        -mode - WDLP_P_Mode_t
    ...
    def WDLP_MboxPend(self, chipNo, pevent, timeout, perr):
        '''
        Arguments:
        -chipNo - c_ubyte
        -pevent - PointerType("OS_EVENT")
        -timeout - INT16U
        -perr - PointerType('INT8U')
        Return type:
        -INT32U
    ...
    def WDLP_P_GetNextPfc(self, version, pfc):
        '''
        Arguments:
        -version - byte
        -pfc - byte
    ...
    def CreatePktLinkModReq(self, pReq, pBte, nextMode, newPfc):
        '''
        Arguments:
        -pReq - PointerType("PktLinkModReq_t")
        -pBte - PointerType('WDLP_P_BteInfo_t')
        -nextMode - WDLP_P_Mode_t
        -newPfc - byte
        Return type:
        -None
        Declaration line: 2474
        '''
        pass

    def WDLP_P_UtilsRfReInit(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 185
        '''
        pass

    def WDLP_P_SysPrgDisable(self, pBte, mode):
        '''
        Arguments:
        -pBte - PointerType("WDLP_P_BteInfo_t")
        -mode - WDLP_P_Mode_t
        Return type:
        -None
        Declaration line: 1931
        '''
        pass

    def CreatePktRePairingReq(self, pReq, pBte, nextMode):
        '''
        Arguments:
        -pReq - PointerType('PktReParingReq_t')
        -pBte - PointerType("WDLP_P_BteInfo_t")
        -nextMode - WDLP_P_Mode_t
        Return type:
        -None
        Declaration line: 2319
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self.WdlpPfcN5 = StaticVariable(device, byte * 10, 0x40000170, False)
        self.WdlpPfcN6 = StaticVariable(device, byte * 5, 0x4000011d, False)
        ...
        self.WdlpAddrCA = StaticVariable(device, byte * 5, 0x40000118, False)
        ...
        self.WDLP_P_GetPfc = StaticFunction(device, 0x54c4c, thumb=1, name='WDLP_P_GetPfc', return_type=byte, size=18, line=2616, arg_list=[('version',byte),('pfc',byte)])
        self.ValidatePktPairingRes = StaticFunction(device, 0x54bb6, thumb=1, name='ValidatePktPairingRes', return_type=bool, size=150, line=2189, arg_list=[('pRes',PointerType('PktParingReq_t')),('pairType',WDLP_P_PairType_t)])
        self.ValidatePktLinkModRes = StaticFunction(device, 0x553e4, thumb=1, name='ValidatePktLinkModRes', return_type=bool, size=44, line=2506, arg_list=[('pRes',PointerType("PktLinkModReq_t"))])
        self.WDLP_P_InitialPair = StaticFunction(device, 0x54d74, thumb=1, name='WDLP_P_InitialPair', return_type=WDLP_Status_t, size=680, line=262, arg_list=[('pairType',WDLP_P_PairType_t),('rfPwr',byte),('uda5',PointerType('byte')),('bte',PointerType("WDLP_P_BteInfo_t")),('slotTimeout',u32),('pktsSent',PointerType('u32'))])
        ...
        self.WDLP_P_SendSysPrgPacket = StaticFunction(device, 0x559fa, thumb=1, name='WDLP_P_SendSysPrgPacket', return_type=WDLP_Status_t, size=474, line=1678, arg_list=[('mode',WDLP_P_Mode_t),('pBte',PointerType("WDLP_P_BteInfo_t")),('txPayload',PointerType('byte')),('rxPayload',PointerType("byte")),('slotTimeout',u32),('retries',PointerType('u32'))])
        ...
        self.WDLP_P_LinkModify = StaticFunction(device, 0x55438, thumb=1, name='WDLP_P_LinkModify', return_type=WDLP_Status_t, size=356, line=943, arg_list=[('bte',PointerType("WDLP_P_BteInfo_t")),('nextMode',WDLP_P_Mode_t),('newPfc',byte),('slotTimeout',u32),('pktsSent',PointerType('u32'))])
        self.PktMode = StaticFunction(device, 0x5503e, thumb=1, name='PktMode', return_type=byte, size=52, line=2562, arg_list=[('mode',WDLP_P_Mode_t)])
        self.CreatePktPairingReq = StaticFunction(device, 0x54cbe, thumb=1, name='CreatePktPairingReq', return_type=None, size=182, line=2081, arg_list=[('pReq',PointerType("PktParingReq_t")),('pBte',PointerType('WDLP_P_BteInfo_t')),('uda5',PointerType("byte")),('pairType',WDLP_P_PairType_t)])
        self.WDLP_P_GetAddrLen = StaticFunction(device, 0x54c76, thumb=1, name='WDLP_P_GetAddrLen', return_type=byte, size=12, line=2611, arg_list=[('version',byte)])
        self.CreatePktReq = StaticFunction(device, 0x54c82, thumb=1, name='CreatePktReq', return_type=None, size=60, line=2029, arg_list=[('pReq',PointerType('Wdlp8bPkt_t')),('mode',byte),('address',PointerType("byte")),('param1',byte),('param2',byte),('wdlpVer',byte)])
        self.ValidatePktSyncRes = StaticFunction(device, 0x5501c, thumb=1, name='ValidatePktSyncRes', return_type=bool, size=34, line=2426, arg_list=[('pRes',PointerType('PktSyncReq_t')),('wdlpVer',byte)])
        self.CreatePktSyncReq = StaticFunction(device, 0x55072, thumb=1, name='CreatePktSyncReq', return_type=None, size=38, line=2395, arg_list=[('pReq',PointerType("PktSyncReq_t")),('pBte',PointerType('WDLP_P_BteInfo_t')),('nextMode',WDLP_P_Mode_t)])
        self.WDLP_P_InterferencePresent = StaticFunction(device, 0x5598a, thumb=1, name='WDLP_P_InterferencePresent', return_type=bool, size=112, line=1597, arg_list=[('bte',PointerType("WDLP_P_BteInfo_t")),('channel',byte)])
        self.WDLP_P_RePair = StaticFunction(device, 0x5522a, thumb=1, name='WDLP_P_RePair', return_type=WDLP_Status_t, size=442, line=717, arg_list=[('bte',PointerType('WDLP_P_BteInfo_t')),('nextMode',WDLP_P_Mode_t),('slotTimeout',u32),('pktsSent',PointerType("u32"))])
        self.WDLP_P_Sync = StaticFunction(device, 0x55098, thumb=1, name='WDLP_P_Sync', return_type=WDLP_Status_t, size=332, line=547, arg_list=[('bte',PointerType('WDLP_P_BteInfo_t')),('nextMode',WDLP_P_Mode_t),('slotTimeout',u32),('pktsSent',PointerType("u32"))])
        self.ValidatePktRePairingRes = StaticFunction(device, 0x551e4, thumb=1, name='ValidatePktRePairingRes', return_type=bool, size=34, line=2350, arg_list=[('pRes',PointerType('PktReParingReq_t')),('wdlpVer',byte)])
        ...
        self.WDLP_P_SendCmd = StaticFunction(device, 0x55960, thumb=1, name='WDLP_P_SendCmd', return_type=WDLP_Status_t, size=42, line=1130, arg_list=[('mode',WDLP_P_Mode_t),('bte',PointerType("WDLP_P_BteInfo_t")),('txPayload',PointerType('byte')),('rxPayload',PointerType("byte")),('slotTimeout',u32),('retries',PointerType('u32'))])
        self.wdlpSendCmdNormalMode = StaticFunction(device, 0x55700, thumb=1, name='wdlpSendCmdNormalMode', return_type=WDLP_Status_t, size=608, line=1168, arg_list=[('mode',WDLP_P_Mode_t),('bte',PointerType("WDLP_P_BteInfo_t")),('txPayload',PointerType('byte')),('rxPayload',PointerType("byte")),('slotTimeout',u32),('retries',PointerType('u32'))])
        self.wdlpSendCmdStreamMode = StaticFunction(device, 0x5559c, thumb=1, name='wdlpSendCmdStreamMode', return_type=WDLP_Status_t, size=356, line=1420, arg_list=[('mode',WDLP_P_Mode_t),('bte',PointerType("WDLP_P_BteInfo_t")),('txPayload',PointerType('byte')),('rxPayload',PointerType("byte")),('slotTimeout',u32)])
        self.WDLP_P_SysPrgEnable = StaticFunction(device, 0x55bd4, thumb=1, name='WDLP_P_SysPrgEnable', return_type=None, size=78, line=1894, arg_list=[('pBte',PointerType('WDLP_P_BteInfo_t')),('mode',WDLP_P_Mode_t)])
        self.WDLP_MboxPend = StaticFunction(device, 0x54b8e, thumb=1, name='WDLP_MboxPend', return_type=INT32U, size=40, line=215, arg_list=[('chipNo',c_ubyte),('pevent',PointerType("OS_EVENT")),('timeout',INT16U),('perr',PointerType('INT8U'))])
        self.WDLP_P_GetNextPfc = StaticFunction(device, 0x54c5e, thumb=1, name='WDLP_P_GetNextPfc', return_type=byte, size=24, line=2633, arg_list=[('version',byte),('pfc',byte)])
        self.CreatePktLinkModReq = StaticFunction(device, 0x55410, thumb=1, name='CreatePktLinkModReq', return_type=None, size=40, line=2474, arg_list=[('pReq',PointerType("PktLinkModReq_t")),('pBte',PointerType('WDLP_P_BteInfo_t')),('nextMode',WDLP_P_Mode_t),('newPfc',byte)])
        self.WDLP_P_UtilsRfReInit = StaticFunction(device, 0x54b70, thumb=1, name='WDLP_P_UtilsRfReInit', return_type=None, size=30, line=185, arg_list=[])
        self.WDLP_P_SysPrgDisable = StaticFunction(device, 0x55c22, thumb=1, name='WDLP_P_SysPrgDisable', return_type=None, size=216, line=1931, arg_list=[('pBte',PointerType("WDLP_P_BteInfo_t")),('mode',WDLP_P_Mode_t)])
        self.CreatePktRePairingReq = StaticFunction(device, 0x55206, thumb=1, name='CreatePktRePairingReq', return_type=None, size=36, line=2319, arg_list=[('pReq',PointerType('PktReParingReq_t')),('pBte',PointerType("WDLP_P_BteInfo_t")),('nextMode',WDLP_P_Mode_t)])
