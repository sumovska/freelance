...
class Code(AbstractCode):
    ...
    def GUIPROP_GetCharDistX(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
    ...
    def GUIPROP_IsInFont(self, pFont, c):
        '''
        Arguments:
    ...
    def GUIPROP_GetFontInfo(self, pFont, pfi):
        '''
        Arguments:
        -pFont - PointerType("GUI_FONT")
        -pfi - PointerType('GUI_FONTINFO')
        Return type:
        -None
    ...
    def __init__(self, device):
        ...
        self.GUI_Context = StaticVariable(device, self.GUI_CONTEXT, 0x40005b9c, False)
        ...
        self.GUI_UC_None = StaticVariable(device, self.GUI_UC_ENC_APILIST, 0x624a4, True)
        self.GUI_Font6x8 = StaticVariable(device, self.GUI_FONT, 0x61960, True)
        self.GUI_Pow10 = StaticVariable(device, c_ulong_le * 10, 0x62440, True)
        ...
        ### Functions data ###
        ######################
        self.GUIPROP_GetCharDistX = StaticFunction(device, 0x2e286, thumb=1, name='GUIPROP_GetCharDistX', return_type=c_int_le, size=52, line=98, arg_list=[('c',c_ushort_le)])
        self.GUIPROP_DispChar = StaticFunction(device, 0x2e1c0, thumb=1, name='GUIPROP_DispChar', return_type=None, size=198, line=55, arg_list=[('c',c_ushort_le)])
        self.GUIPROP_IsInFont = StaticFunction(device, 0x2e2c0, thumb=1, name='GUIPROP_IsInFont', return_type=c_byte, size=32, line=116, arg_list=[('pFont',PointerType('GUI_FONT')),('c',c_ushort_le)])
        self.GUIPROP_GetFontInfo = StaticFunction(device, 0x2e2ba, thumb=1, name='GUIPROP_GetFontInfo', return_type=None, size=6, line=107, arg_list=[('pFont',PointerType("GUI_FONT")),('pfi',PointerType('GUI_FONTINFO'))])
