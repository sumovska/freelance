...
class Code(AbstractCode):
    ...
    def GUI_SetTextAlign(self, Align):
        '''
        Arguments:
        -Align - c_int_le
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_SetTextAlign = StaticFunction(device, 0x2fe9c, thumb=1, name='GUI_SetTextAlign', return_type=c_int_le, size=12, line=32, arg_list=[('Align',c_int_le)])
