...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_GetBitsPerPixel = StaticFunction(device, 0x2d284, thumb=1, name='LCD_GetBitsPerPixel', return_type=c_int_le, size=4, line=35, arg_list=[])
        self.LCD_GetYMag = StaticFunction(device, 0x2d28e, thumb=1, name='LCD_GetYMag', return_type=c_int_le, size=4, line=37, arg_list=[])
        self.LCD_GetXSize = StaticFunction(device, 0x2d274, thumb=1, name='LCD_GetXSize', return_type=c_int_le, size=4, line=31, arg_list=[])
        self.LCD_GetYSize = StaticFunction(device, 0x2d278, thumb=1, name='LCD_GetYSize', return_type=c_int_le, size=4, line=32, arg_list=[])
        self.LCD_GetXMag = StaticFunction(device, 0x2d292, thumb=1, name='LCD_GetXMag', return_type=c_int_le, size=4, line=38, arg_list=[])
        self.LCD_GetVXSize = StaticFunction(device, 0x2d27c, thumb=1, name='LCD_GetVXSize', return_type=c_int_le, size=4, line=33, arg_list=[])
        self.LCD_GetFixedPalette = StaticFunction(device, 0x2d296, thumb=1, name='LCD_GetFixedPalette', return_type=c_int_le, size=4, line=39, arg_list=[])
        self.LCD_GetVYSize = StaticFunction(device, 0x2d280, thumb=1, name='LCD_GetVYSize', return_type=c_int_le, size=4, line=34, arg_list=[])
        self.LCD_GetNumColors = StaticFunction(device, 0x2d288, thumb=1, name='LCD_GetNumColors', return_type=c_ulong_le, size=6, line=36, arg_list=[])
