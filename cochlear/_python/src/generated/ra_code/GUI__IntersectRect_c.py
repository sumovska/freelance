...
class Code(AbstractCode):
    ...
    def GUI__IntersectRect(self, pDest, pr0):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI__IntersectRect = StaticFunction(device, 0x30f06, thumb=1, name='GUI__IntersectRect', return_type=None, size=66, line=44, arg_list=[('pDest',PointerType('GUI_RECT')),('pr0',PointerType("GUI_RECT"))])
