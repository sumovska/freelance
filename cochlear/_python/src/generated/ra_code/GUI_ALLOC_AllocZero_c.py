...
class Code(AbstractCode):
    ...
    def GUI_ALLOC_AllocZero(self, Size):
        '''
        Arguments:
        -Size - c_long_le
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_ALLOC_AllocZero = StaticFunction(device, 0x2d31a, thumb=1, name='GUI_ALLOC_AllocZero', return_type=c_ulong_le, size=34, line=37, arg_list=[('Size',c_long_le)])
