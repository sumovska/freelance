...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_DrawPixel = StaticFunction(device, 0x2b5c4, thumb=1, name='GUI_DrawPixel', return_type=None, size=8, line=32, arg_list=[('x',c_int_le),('y',c_int_le)])
