...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_SetBkColor = StaticFunction(device, 0x2b554, thumb=1, name='GUI_SetBkColor', return_type=None, size=12, line=32, arg_list=[('color',GUI_COLOR)])
        self.GUI_SetColor = StaticFunction(device, 0x2b560, thumb=1, name='GUI_SetColor', return_type=None, size=12, line=42, arg_list=[('color',GUI_COLOR)])
