...
class Code(AbstractCode):
    ...
    def GUI_FillRect(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_FillRect = StaticFunction(device, 0x2e2e6, thumb=1, name='GUI_FillRect', return_type=None, size=12, line=32, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
