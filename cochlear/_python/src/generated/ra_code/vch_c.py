...
class uwd_acm_comm_fs_t__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    UWD_ACM_FS_ABSTRACT_STATE = 1
    UWD_ACM_FS_COUNTRY_STATE = 2
...
class uwd_acm_control_line_t(c_ubyte,Enumed):
    _ctype = c_ubyte
    UWD_ACM_CONTROL_SIG_DTR = 1
    UWD_ACM_CONTROL_SIG_RTS = 2
...
class uwd_acm_abstract_state_t(c_ubyte,Enumed):
    _ctype = c_ubyte
    UWD_ACM_COMM_DATA_MULTIPLEXING = 1
    UWD_ACM_COMM_IDLE_SETTING = 2
...
class VCH_P_XferState_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    VCH_USB_XFER_IDLE = 1
    VCH_USB_XFER_ACTIVE = 2

class uwd_acm_lc_data_bits_t(c_ubyte,Enumed):
    _ctype = c_ubyte
    UWD_ACM_LC_DATA_5_BITS = 5
    UWD_ACM_LC_DATA_6_BITS = 6
    UWD_ACM_LC_DATA_7_BITS = 7
    UWD_ACM_LC_DATA_8_BITS = 8
    UWD_ACM_LC_DATA_16_BITS = 16
...
class VCH_P_FrameRead_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    VCH_FRAME_RD_IDLE = 0
    VCH_FRAME_RD_TRIGGERED = 1
    VCH_FRAME_RD_HDR_OK = 2
    VCH_FRAME_RD_DONE = 3
    VCH_FRAME_RD_CANCELLED = 4
    VCH_FRAME_RD_ERROR = 5
    VCH_FRAME_RD_TIMEOUT = 6
...
class uwd_acm_lc_stop_bits_t(c_ubyte,Enumed):
    _ctype = c_ubyte
    UWD_ACM_LC_1_STOP_BITS = 0
    UWD_ACM_LC_1_5_STOP_BITS = 1
    UWD_ACM_LC_2_STOP_BITS = 2
...
class uwd_cdc_iostatus_t__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    UWD_CDC_TRANSFER_ERROR = -1
    UWD_CDC_TRANSFER_OK = 0
    UWD_CDC_TRANSFER_CANCELLED = 1
...
class uwd_acm_lc_parity_t(c_ubyte,Enumed):
    _ctype = c_ubyte
    UWD_ACM_LC_PARITY_NONE = 0
    UWD_ACM_LC_PARITY_ODD = 1
    UWD_ACM_LC_PARITY_EVEN = 2
    UWD_ACM_LC_PARITY_MARK = 3
    UWD_ACM_LC_PARITY_SPACE = 4
...
uwd_acm_set_control_line_state_cb_t = PointerType('Subroutine')
FP32 = c_float_le
uwd_cdc_response_complete_cb_t = PointerType('Subroutine')
U8 = c_ubyte
usb_write_cb_t = PointerType('Subroutine')
uwd_cdc_uninit_cb_t = PointerType('Subroutine')
int16_t = c_short_le
U32 = c_uint_le
...
INT16S = c_short_le
BOOLEAN = c_ubyte
uwd_cdc_read_complete_cb_t = PointerType('Subroutine')
uwd_acm_send_break_cb_t = PointerType('Subroutine')
s16 = c_short_le
uwd_acm_comm_feature_cb_t = PointerType('Subroutine')
byte = c_ubyte
uwd_cdc_write_complete_cb_t = PointerType('Subroutine')
OS_CPU_SR = c_uint_le
s64 = c_longlong_le
uwd_cdc_enabled_cb_t = PointerType('Subroutine')
int32_t = c_long_le
S16 = c_short_le
S64 = c_longlong_le
U16 = c_ushort_le
Status = c_byte
uwd_acm_line_coding_cb_t = PointerType('Subroutine')
usb_audio_cb_t = PointerType('Subroutine')
u8 = c_ubyte
OS_STK = c_uint_le
uwd_cdc_app_h = PointerType('void')
INT8U = c_ubyte
INT8S = c_byte
uint_t = c_uint_le
int_t = c_int_le
...
uwd_cdc_encap_command_cb_t = PointerType('Subroutine')
word = c_ushort_le
uwd_cdc_io_complete_cb_t = PointerType('Subroutine')
BOOL = c_uint_le
...
u64 = c_ulonglong_le
s8 = c_byte
uwd_acm_clear_comm_feature_cb_t = PointerType('Subroutine')
S32 = c_int_le
bool = c_ubyte
INT32S = c_int_le
BIT = c_ubyte
...
uwd_cdc_drv_h = PointerType('void')
bool_t = c_int_le
uwd_cdc_disabled_cb_t = PointerType('Subroutine')
uint32_t = c_ulong_le
...
VCH_P_XferState_t = VCH_P_XferState_tag
uwd_cdc_init_flags_t = uint16_t
...
VCH_P_FrameRead_t = VCH_P_FrameRead_tag
...
uwd_acm_capabilities_t = uint16_t
...
uwd_acm_serial_state_t = uint16_t
...
uwd_acm_comm_fs_t = uwd_acm_comm_fs_t__enumeration
CIP3_ActiveClassification_t = CIP3_ActiveClassification_tag
uwd_cdc_iostatus_t = uwd_cdc_iostatus_t__enumeration
CIP_ButtonStatus_t = CIP_ButtonStatus_tag
class uwd_acm_comm_feature_setting_t(Union):
    abstract_state = uint16_t
    country_code = uint16_t
    _fields_ = [
                ('abstract_state', uint16_t),
                ('country_code', uint16_t),
               ]
...
class _uwd_acm_line_coding_t(Structure):
    dte_rate = uint32_t
    char_format = uint8_t
    parity_type = uint8_t
    data_bits = uint8_t
...
class uwd_cdc_callbacks_t__structure(Structure):
    enabled = uwd_cdc_enabled_cb_t
    disabled = uwd_cdc_disabled_cb_t
    uninit = uwd_cdc_uninit_cb_t
    encap_command = uwd_cdc_encap_command_cb_t
    encap_response_complete = uwd_cdc_response_complete_cb_t
    read_complete = uwd_cdc_read_complete_cb_t
    write_complete = uwd_cdc_write_complete_cb_t
    _pack_ = 1
    _fields_ = [
                ('enabled', uwd_cdc_enabled_cb_t),
                ('disabled', uwd_cdc_disabled_cb_t),
...
class uwd_cdc_init_info_t__structure(Structure):
    flags = uwd_cdc_init_flags_t
    encap_cmd_max_size = uint32_t
    max_segment_size = uint16_t
    _fields_ = [
                ('flags', uwd_cdc_init_flags_t),
                ('encap_cmd_max_size', uint32_t),
                ('max_segment_size', uint16_t),
...
class VCH_P_XferStatusWrite_tag(Structure):
    xferState = VCH_P_XferState_t
    bytesTotal = u16
    _fields_ = [
                ('xferState', VCH_P_XferState_t),
                ('bytesTotal', u16),
...
class VCH_P_Ctx_tag(Structure):
    drv_ctx = uwd_cdc_drv_h
    _pack_ = 1
    _fields_ = [
                ('drv_ctx', uwd_cdc_drv_h),
               ]
...
class VCH_P_UsbIdentifiers_tag(Structure):
    usbIdVendor = u16
    usbIdProduct = u16
    usbDevRelease = u16
    productName = u8 * 61
...
class VCH_P_XferStatusRead_tag(Structure):
    xferState = VCH_P_XferState_t
    frameState = VCH_P_FrameRead_t
    bytesXfered = u16
    bytesTotal = u16
    pData = PointerType('u8')
    _fields_ = [
...
OS_Q = os_q
uwd_cdc_callbacks_t = uwd_cdc_callbacks_t__structure
VCH_P_XferStatusRead_t = VCH_P_XferStatusRead_tag
...
VCH_P_UsbIdentifiers_t = VCH_P_UsbIdentifiers_tag
...
uwd_acm_line_coding_t = _uwd_acm_line_coding_t
OS_FLAG_GRP = os_flag_grp
VCH_P_XferStatusWrite_t = VCH_P_XferStatusWrite_tag
ITC_EvntHdr_t = ITC_EvntHdr_tag
uwd_cdc_init_info_t = uwd_cdc_init_info_t__structure
...
class uwd_acm_callbacks_t__structure(Structure):
    basic = uwd_cdc_callbacks_t
    set_comm_feature = uwd_acm_comm_feature_cb_t
    get_comm_feature = uwd_acm_comm_feature_cb_t
    clear_comm_feature = uwd_acm_clear_comm_feature_cb_t
    set_line_coding = uwd_acm_line_coding_cb_t
    get_line_coding = uwd_acm_line_coding_cb_t
    set_control_line_state = uwd_acm_set_control_line_state_cb_t
    send_break = uwd_acm_send_break_cb_t
    get_comm_feature_complete = uwd_cdc_io_complete_cb_t
    get_line_coding_complete = uwd_cdc_io_complete_cb_t
    notify_net_conn_complete = uwd_cdc_io_complete_cb_t
    notify_serial_state_complete = uwd_cdc_io_complete_cb_t
    _pack_ = 1
    _fields_ = [
                ('basic', uwd_cdc_callbacks_t),
                ('set_comm_feature', uwd_acm_comm_feature_cb_t),
...
class uwd_acm_init_info_t__structure(Structure):
    basic = uwd_cdc_init_info_t
    capabilities = uwd_acm_capabilities_t
    _fields_ = [
                ('basic', uwd_cdc_init_info_t),
                ('capabilities', uwd_acm_capabilities_t),
               ]
...
uwd_acm_init_info_t = uwd_acm_init_info_t__structure
U16_8 = U16_8__union
VCH_P_ItcMsgs_t = WAE_P_ItcMsgs_tag
REQUEST_TYPE = _REQUEST_TYPE
uwd_acm_callbacks_t = uwd_acm_callbacks_t__structure
class VCH_P_ResMsg_tag(Structure):
    data = VCH_P_ItcMsgs_t
    sndrId = INT_ModId_t
    evntId = ITC_EventId_t
    dataLen = u16
    _fields_ = [
...
VCH_P_ResMsg_t = VCH_P_ResMsg_tag
...
class const():
    ...
    UMATCH_NONE = 0
    UMATCH_GENERIC = 1
    UMATCH_IFACECLASS_GENERIC = 2
    UMATCH_IFACECLASS = 3
    UMATCH_IFACECLASS_IFACESUBCLASS = 4
    UMATCH_IFACECLASS_IFACESUBCLASS_IFACEPROTO = 5
    UMATCH_VENDOR_IFACESUBCLASS = 6
    UMATCH_VENDOR_IFACESUBCLASS_IFACEPROTO = 7
    UMATCH_VENDOR_PRODUCT_CONF_IFACE = 8
    UMATCH_VENDOR_PRODUCT_REV_CONF_IFACE = 9
    UMATCH_DEVCLASS_DEVSUBCLASS = 10
    UMATCH_DEVCLASS_DEVSUBCLASS_DEVPROTO = 11
    UMATCH_VENDOR_DEVCLASS_DEVPROTO = 12
    UMATCH_VENDOR_PRODUCT = 13
    UMATCH_VENDOR_PRODUCT_REV = 14
    DRV_IOCTL_NONE = 0
    DRV_IOCTL_PWR_CHILD_SUSPEND = 1
    DRV_IOCTL_PWR_CHILD_RESUME = 2
    DRV_IOCTL_PWR_HUB_REMOTE_WAKEUP = 3
    DRV_IOCTL_DEV_SUSPEND = 4
    DRV_IOCTL_DEV_RESUME = 5
    DRV_IOCTL_DEV_RESET = 6
    DRV_IOCTL_DEV_HNP_ENBL = 7
    DRV_IOCTL_DEV_HNP_ALT_SUPPORTED = 8
    DRV_IOCTL_HOST_SUSPEND = 9
    DRV_IOCTL_HOST_RESUME = 10
    DRV_IOCTL_HOST_IS_PERIPH_SUPPORTED = 11
    DRV_IOCTL_HOST_REMOTE_CONNECTED = 12
    DRV_IOCTL_HOST_REMOTE_DISCONNECTED = 13
    DRV_IOCTL_HOST_PERIPH_PARTIAL_SUPPORTED = 14
    DRV_IOCTL_HOST_PERIPH_NOT_SUPPORTED = 15
    DRV_IOCTL_DEV_ENABLE = 16
    DRV_IOCTL_DEV_DISABLE = 17
    DRV_IOCTL_HOST_PORT_ENABLE = 18
    DRV_IOCTL_HOST_PORT_DISABLE = 19
    DRV_IOCTL_HOST_PORT_SUSPEND = 20
    DRV_IOCTL_HOST_PORT_RESUME = 21
    DRV_IOCTL_HOST_PORT_SET_POWER = 22
    DRV_IOCTL_HOST_ENABLE_HNP = 23
    DRV_IOCTL_HOST_PORT_CHANGE = 24
    DRV_IOCTL_TCD_GET_OPS = 25
    DRV_IOCTL_TCD_SET_CTX = 26
    DRV_IOCTL_SET_ETEST_MODE = 27
    DRV_IOCTL_LAST = 28
    USB_STATUS_OK = 0
    USB_STATUS_ERROR = 1
    CIP_CLIENT_ID_UNDEFINED = 0
    ...
    ### Defines ###
    ###############
    VCH_READ_TMR_NAME = 'vchRecTimer'
    VCH_WRITE_TMR_NAME = 'vchSndTimer'
    VCH_AUDIO_TMR_NAME = 'vchAudTimer'
    VCH_USB_PKT_SIZE = 64
    VCH_FRAME_SOH_IDX = 0
    VCH_FRAME_MLENGTH_IDX = 1
    VCH_FRAME_LLENGTH_IDX = 2
    VCH_FRAME_VCHN_IDX = 3
    VCH_FRAME_PLD_MIN_SIZE = 3
    VCH_FRAME_PLD_MAX_SIZE = 1536
    VCH_FRAME_SOH = 1
    VCH_FRAME_EOT = 4
    VCH_USB_IDENTITY_SIZE = 20
    VCH_USB_NAME_SIZE = 60
    VCH_USB_PID_INTRAOP = 4024
    ...
    UWD_ACM_SERIAL_DCD = 1
    UWD_ACM_SERIAL_DSR = 2
    UWD_ACM_SERIAL_BREAK = 4
    UWD_ACM_SERIAL_RING_SIG = 8
    UWD_ACM_SERIAL_FRAMING_ERROR = 16
    UWD_ACM_SERIAL_PARITY_ERROR = 32
    UWD_ACM_SERIAL_OVERRUN_ERROR = 64
    UWD_ACM_CAP_COMM_FEATURE = 1
    UWD_ACM_CAP_LINE_CODING = 2
    UWD_ACM_CAP_SEND_BREAK = 4
    UWD_ACM_CAP_NETWORK_CONNECTION = 8
    UWD_ACM_CAP_CALL_MGMT = 16
    UWD_ACM_CAP_CALL_MGMT_OVER_DC = 32
    HOST_PORT_ENABLE_NO_RESET = 0
    HOST_PORT_ENABLE_RESET = 1
    DRIVER_CONTROLLER = 1
    DRIVER_USB = 2
    PERF_TEST_LVL_NONE = 0
    PERF_TEST_LVL_USB_TO_RADIO = 1
    PERF_TEST_LVL_RADIO_TO_USB = 2
    PERF_TEST_LVL_WDLP_TIMING = 3
    PERF_TEST_LVL = 0
    DATA_FREQ = 16000
    NUMERIC_VALUE_INVALID = 4294967295
    ...
    DBG_UART = 2
    DBG_LOG = 0
    CPU_LITTLE_ENDIAN = 1234
    CPU_BIG_ENDIAN = 4321
    UWD_CDC_INIT_SINGLE_INTERFACE = 1
    UWD_CDC_INIT_VENDOR_SPECIFIC_CLASS = 2
    UWD_CDC_INIT_NO_CLASS_DESC = 4
    UWD_CDC_INIT_VENDOR_SPECIFIC_PROT = 8
    OS_CPU_FPU_EN = 0
...
class Code(AbstractCode):
    ...
    ### Enums ###
    #############
    uwd_acm_comm_fs_t__enumeration = uwd_acm_comm_fs_t__enumeration
    ...
    VCH_P_XferState_tag = VCH_P_XferState_tag
    uwd_acm_lc_data_bits_t = uwd_acm_lc_data_bits_t
    ...
    VCH_P_FrameRead_tag = VCH_P_FrameRead_tag
    ...
    uwd_acm_lc_parity_t = uwd_acm_lc_parity_t
    ...
    uwd_acm_set_control_line_state_cb_t = uwd_acm_set_control_line_state_cb_t
    FP32 = FP32
    uwd_cdc_response_complete_cb_t = uwd_cdc_response_complete_cb_t
    U8 = U8
    usb_write_cb_t = usb_write_cb_t
    uwd_cdc_uninit_cb_t = uwd_cdc_uninit_cb_t
    int16_t = int16_t
    U32 = U32
    ...
    INT16S = INT16S
    BOOLEAN = BOOLEAN
    uwd_cdc_read_complete_cb_t = uwd_cdc_read_complete_cb_t
    uwd_acm_send_break_cb_t = uwd_acm_send_break_cb_t
    s16 = s16
    uwd_acm_comm_feature_cb_t = uwd_acm_comm_feature_cb_t
    byte = byte
    uwd_cdc_write_complete_cb_t = uwd_cdc_write_complete_cb_t
    OS_CPU_SR = OS_CPU_SR
    s64 = s64
    uwd_cdc_enabled_cb_t = uwd_cdc_enabled_cb_t
    int32_t = int32_t
    S16 = S16
    S64 = S64
    U16 = U16
    Status = Status
    uwd_acm_line_coding_cb_t = uwd_acm_line_coding_cb_t
    usb_audio_cb_t = usb_audio_cb_t
    u8 = u8
    OS_STK = OS_STK
    uwd_cdc_app_h = uwd_cdc_app_h
    INT8U = INT8U
    INT8S = INT8S
    uint_t = uint_t
    int_t = int_t
    ...
    uwd_cdc_encap_command_cb_t = uwd_cdc_encap_command_cb_t
    word = word
    uwd_cdc_io_complete_cb_t = uwd_cdc_io_complete_cb_t
    BOOL = BOOL
    uint16_t = uint16_t
    u16 = u16
    U64 = U64
    u64 = u64
    s8 = s8
    uwd_acm_clear_comm_feature_cb_t = uwd_acm_clear_comm_feature_cb_t
    S32 = S32
    bool = bool
    INT32S = INT32S
    BIT = BIT
    ...
    uwd_cdc_drv_h = uwd_cdc_drv_h
    bool_t = bool_t
    uwd_cdc_disabled_cb_t = uwd_cdc_disabled_cb_t
    uint32_t = uint32_t
    ...
    result_t = result_t
    VCH_P_XferState_t = VCH_P_XferState_t
    uwd_cdc_init_flags_t = uwd_cdc_init_flags_t
    ...
    VCH_P_FrameRead_t = VCH_P_FrameRead_t
    ...
    uwd_acm_capabilities_t = uwd_acm_capabilities_t
    ...
    uwd_acm_serial_state_t = uwd_acm_serial_state_t
    ...
    uwd_acm_comm_fs_t = uwd_acm_comm_fs_t
    CIP3_ActiveClassification_t = CIP3_ActiveClassification_t
    uwd_cdc_iostatus_t = uwd_cdc_iostatus_t
    CIP_ButtonStatus_t = CIP_ButtonStatus_t
    uwd_acm_comm_feature_setting_t = uwd_acm_comm_feature_setting_t
    _USB_DEVICE_QUALIFIER_DESCRIPTOR = _USB_DEVICE_QUALIFIER_DESCRIPTOR
    os_sem_data = os_sem_data
    DEROM_Byte_tag = DEROM_Byte_tag
    os_tcb = os_tcb
    os_mbox_data = os_mbox_data
    _uwd_acm_line_coding_t = _uwd_acm_line_coding_t
    uwd_cdc_callbacks_t__structure = uwd_cdc_callbacks_t__structure
    uwd_cdc_init_info_t__structure = uwd_cdc_init_info_t__structure
    VCH_DataPktReq_tag = VCH_DataPktReq_tag
    VCH_P_XferStatusWrite_tag = VCH_P_XferStatusWrite_tag
    ...
    _BM = _BM
    VCH_P_Ctx_tag = VCH_P_Ctx_tag
    os_mutex_data = os_mutex_data
    VCH_P_UsbIdentifiers_tag = VCH_P_UsbIdentifiers_tag
    os_tmr_wheel = os_tmr_wheel
    ...
    VCH_P_UsbIdentifiers_t = VCH_P_UsbIdentifiers_t
    ...
    uwd_acm_line_coding_t = uwd_acm_line_coding_t
    OS_FLAG_GRP = OS_FLAG_GRP
    VCH_P_XferStatusWrite_t = VCH_P_XferStatusWrite_t
    ITC_EvntHdr_t = ITC_EvntHdr_t
    uwd_cdc_init_info_t = uwd_cdc_init_info_t
    ...
    uwd_acm_callbacks_t__structure = uwd_acm_callbacks_t__structure
    uwd_acm_init_info_t__structure = uwd_acm_init_info_t__structure
    DEROM_FlashInfo_tag = DEROM_FlashInfo_tag
    DEROM_FlashInfo_t = DEROM_FlashInfo_t
    uwd_acm_init_info_t = uwd_acm_init_info_t
    U16_8 = U16_8
    VCH_P_ItcMsgs_t = VCH_P_ItcMsgs_t
    REQUEST_TYPE = REQUEST_TYPE
    uwd_acm_callbacks_t = uwd_acm_callbacks_t
    VCH_P_ResMsg_tag = VCH_P_ResMsg_tag
    _USB_SETUP_PACKET = _USB_SETUP_PACKET
    USB_SETUP_PACKET = USB_SETUP_PACKET
    VCH_P_ResMsg_t = VCH_P_ResMsg_t

    #################
    ### Functions ###
    #################

    def vchVerifyHdr(self, pHdr):
        '''
        Arguments:
        -pHdr - PointerType("u8")
        Return type:
        -u16
        Declaration line: 2144
        '''
        pass

    def vchUsbReadDoneClbk(self, pData, size, status):
        '''
        Arguments:
        -pData - PointerType('U8')
        -size - U32
        ...
        Return type:
        -None
        Declaration line: 1131
        '''
        pass

    def VCH_UsbReconfigurePower(self, requestedPower):
        '''
        Arguments:
        -requestedPower - VCH_UsbPower_t
        Return type:
        -None
    ...
    def vchUsbWriteReq(self, pData, numberOfBytes):
        '''
        Arguments:
        -pData - PointerType("u8")
        -numberOfBytes - u16
        Return type:
        -Status
        Declaration line: 1612
        '''
        pass

    def uwd_acm_app_init(self, drv_ctx, cbs, info, appCtx):
        '''
        Arguments:
        -drv_ctx - uwd_cdc_drv_h
        -cbs - PointerType('uwd_acm_callbacks_t')
        -info - PointerType("uwd_acm_init_info_t")
        -appCtx - PointerType('uwd_cdc_app_h')
        Return type:
        -result_t
    ...
    def vchUsbReadReq(self, pData, numberOfBytes):
        '''
        Arguments:
        -pData - PointerType("u8")
        -numberOfBytes - u16
        Return type:
        -Status
        Declaration line: 1064
        '''
        pass

    def vchUsbWrite(self, pPuResp):
        '''
        Arguments:
        -pPuResp - PointerType('VCH_DataPktRes_t')
        Return type:
        -Status
        Declaration line: 1658
        '''
        pass

    def vchClrClinical(self, flag):
        '''
        Arguments:
        -flag - PointerType("vchClinicalModeFlag_t")
        Return type:
        -None
        Declaration line: 2036
        '''
        pass
    ...
    def vchUsbInit(self, ):
        ...
        Return type:
        -Status
        Declaration line: 888
        '''
        pass

    def vchUsbReconfigDoneClbk(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2005
        '''
        pass

    def VCH_Fini(self, fini_type):
        '''
        Arguments:
        -fini_type - INT_FiniType_t
        Return type:
        -Status
        Declaration line: 671
        '''
        pass

    def vchUsbWriteDoneClbk(self, pData, status):
        '''
        Arguments:
        -pData - PointerType('U8')
        -status - USB_Status_t
        Return type:
        -None
        Declaration line: 1800
        '''
        pass

    def vchUsbReadDoneClbkProcess(self, size):
        '''
        Arguments:
        -size - u32
        Return type:
        -None
        Declaration line: 1225
        '''
        pass

    def vchUsbReadTmrClbk(self, ptmr, callbackArg):
        '''
        Arguments:
        -ptmr - PointerType("void")
        -callbackArg - PointerType('void')
        Return type:
        -None
        Declaration line: 1440
        '''
        pass

    def vchUsbReadStatus(self, usbXferStat):
        '''
        Arguments:
        -usbXferStat - VCH_P_FrameRead_t
        Return type:
        -None
        Declaration line: 1464
        '''
        pass

    def vchCipReqSend(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2051
        '''
        pass

    def VCH_UsbConfigureProductId(self, hwUniqueDeviceNumber):
        '''
        Arguments:
        -hwUniqueDeviceNumber - PointerType("u8")
        Return type:
        -None
    ...
    def vchTask(self, p_arg):
        '''
        Arguments:
        -p_arg - PointerType('void')
        Return type:
        -None
        Declaration line: 753
        '''
        pass

    def VCH_Init(self, init_type):
        '''
        Arguments:
        -init_type - INT_InitType_t
        Return type:
        -Status
        Declaration line: 475
        '''
        pass

    def vchUsbWriteStatus(self, pWriteStat):
        '''
        Arguments:
        -pWriteStat - PointerType("VCH_P_WriteStat_t")
        Return type:
        -None
    ...
    def vchSetClinical(self, flag):
        '''
        Arguments:
        -flag - PointerType('vchClinicalModeFlag_t')
        Return type:
        -None
        Declaration line: 2025
        '''
        pass
    ...
    def vchUsbCfg(self, ):
        ...
        Return type:
        -None
        Declaration line: 961
        '''
        pass

    def VCH_IsUsbSetupInProgress(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 735
        '''
        pass

    def vchUsbWriteTmrClbk(self, ptmr, callbackArg):
        '''
        Arguments:
        -ptmr - PointerType("void")
        -callbackArg - PointerType('void')
    ...
    OSRunning = BOOLEAN
    OSPrioCur = INT8U
    usbManufName = c_byte * 20
    usbVID = u16
    OSTaskCtr = INT8U
    OSTmrTime = INT32U
    vchUsbNames = VCH_P_UsbIdentifiers_t
    OSTCBTbl = OS_TCB * 26
    OSTmrUsed = INT16U
    OSTime = INT32U
    usbProdNameIntraop = c_byte * 60
    vchMsg = VCH_P_ResMsg_t
    usbRel = u16
    OSQTbl = OS_Q * 20
    ...
    vchWrite = VCH_P_XferStatusWrite_t
    OSLockNesting = INT8U
    pVchReadTmr = PointerType('OS_TMR')
    OSMemTbl = OS_MEM * 15
    vchRead = VCH_P_XferStatusRead_t
    InReport = U8 * 64
    ...
    OSPrioHighRdy = INT8U
    vchItcQueue = ITC_Queue_t * 8
    OSTaskIdleStk = OS_STK * 128
    OSTickStepState = INT8U
    OSTCBPrioTbl = PointerType('OS_TCB') * 61
    usbProdName = c_byte * 60
    OSIntNesting = INT8U
    usbPID = u16
    usbSerNo = u8 * 20
    OSTmrFree = INT16U
    vchTaskStack = OS_STK * 512
    pVchWriteTmr = PointerType("OS_TMR")
    OSEventFreeList = PointerType('OS_EVENT')
    OSTCBList = PointerType("OS_TCB")
    vchItcRetryQueue = ITC_Queue_t * 5
    OSTmrSemSignal = PointerType('OS_EVENT')
    vchItcPoolMem = ITC_MemPool_t * 20 * 8
    vchClinModeFlag = vchClinicalModeFlag_t
    pOutReport = PointerType("U8")
    OSRdyTbl = INT8U * 8
    vchItcRetryPoolMem = ITC_MemPool_t * 80 * 5
    ...
    def __init__(self, device):
        ...
        self.usbManufName = StaticVariable(device, c_byte * 20, 0x70b44, True)
        self.usbVID = StaticVariable(device, self.u16, 0x80008882L, False)
        ...
        self.vchUsbNames = StaticVariable(device, self.VCH_P_UsbIdentifiers_t, 0x4000c068, False)
        ...
        self.usbProdNameIntraop = StaticVariable(device, c_byte * 60, 0x70b08, True)
        self.vchMsg = StaticVariable(device, self.VCH_P_ResMsg_t, 0x4000c054, False)
        self.usbRel = StaticVariable(device, self.u16, 0x80008886L, False)
        ...
        self.vchWrite = StaticVariable(device, self.VCH_P_XferStatusWrite_t, 0x8000888cL, False)
        self.OSLockNesting = StaticVariable(device, self.INT8U, 0x40000045, False)
        self.pVchReadTmr = StaticVariable(device, PointerType('OS_TMR'), 0x80008888L, False)
        self.OSMemTbl = StaticVariable(device, OS_MEM * 15, 0x40005014, False)
        self.vchRead = StaticVariable(device, self.VCH_P_XferStatusRead_t, 0x4000c048, False)
        ...
        self.vchItcQueue = StaticVariable(device, ITC_Queue_t * 8, 0x4000bde4, False)
        ...
        self.usbProdName = StaticVariable(device, c_byte * 60, 0x70acc, True)
        self.OSIntNesting = StaticVariable(device, self.INT8U, 0x40000044, False)
        self.usbPID = StaticVariable(device, self.u16, 0x80008884L, False)
        self.usbSerNo = StaticVariable(device, u8 * 20, 0x4000b5d0, False)
        self.OSTmrFree = StaticVariable(device, self.INT16U, 0x40000080, False)
        self.vchTaskStack = StaticVariable(device, OS_STK * 512, 0x4000b5e4, False)
        self.pVchWriteTmr = StaticVariable(device, PointerType("OS_TMR"), 0x80008890L, False)
        ...
        self.vchItcRetryQueue = StaticVariable(device, ITC_Queue_t * 5, 0x4000be04, False)
        self.OSTmrSemSignal = StaticVariable(device, PointerType('OS_EVENT'), 0x4000008c, False)
        self.vchItcPoolMem = StaticVariable(device, ITC_MemPool_t * 20 * 8, 0x4000be18, False)
        self.vchClinModeFlag = StaticVariable(device, self.vchClinicalModeFlag_t, 0x80008880L, False)
        ...
        self.vchItcRetryPoolMem = StaticVariable(device, ITC_MemPool_t * 80 * 5, 0x4000beb8, False)
        ...
        ### Functions data ###
        ######################
        self.vchVerifyHdr = StaticFunction(device, 0x5269e, thumb=1, name='vchVerifyHdr', return_type=u16, size=70, line=2144, arg_list=[('pHdr',PointerType("u8"))])
        self.vchUsbReadDoneClbk = StaticFunction(device, 0x5279e, thumb=1, name='vchUsbReadDoneClbk', return_type=None, size=60, line=1131, arg_list=[('pData',PointerType('U8')),('size',U32),('status',USB_Status_t)])
        self.VCH_UsbReconfigurePower = StaticFunction(device, 0x52dce, thumb=1, name='VCH_UsbReconfigurePower', return_type=None, size=22, line=718, arg_list=[('requestedPower',VCH_UsbPower_t)])
        self.vchUsbWriteReq = StaticFunction(device, 0x52a38, thumb=1, name='vchUsbWriteReq', return_type=Status, size=40, line=1612, arg_list=[('pData',PointerType("u8")),('numberOfBytes',u16)])
        self.uwd_acm_app_init = StaticFunction(device, 0x52664, thumb=1, name='uwd_acm_app_init', return_type=result_t, size=4, line=409, arg_list=[('drv_ctx',uwd_cdc_drv_h),('cbs',PointerType('uwd_acm_callbacks_t')),('info',PointerType("uwd_acm_init_info_t")),('appCtx',PointerType('uwd_cdc_app_h'))])
        self.vchUsbReadReq = StaticFunction(device, 0x527da, thumb=1, name='vchUsbReadReq', return_type=Status, size=16, line=1064, arg_list=[('pData',PointerType("u8")),('numberOfBytes',u16)])
        self.vchUsbWrite = StaticFunction(device, 0x52a60, thumb=1, name='vchUsbWrite', return_type=Status, size=196, line=1658, arg_list=[('pPuResp',PointerType('VCH_DataPktRes_t'))])
        self.vchClrClinical = StaticFunction(device, 0x52b24, thumb=1, name='vchClrClinical', return_type=None, size=6, line=2036, arg_list=[('flag',PointerType("vchClinicalModeFlag_t"))])
        self.vchUsbInit = StaticFunction(device, 0x52b30, thumb=1, name='vchUsbInit', return_type=Status, size=42, line=888, arg_list=[])
        self.vchUsbReconfigDoneClbk = StaticFunction(device, 0x52db2, thumb=1, name='vchUsbReconfigDoneClbk', return_type=None, size=28, line=2005, arg_list=[])
        self.VCH_Fini = StaticFunction(device, 0x52d58, thumb=1, name='VCH_Fini', return_type=Status, size=4, line=671, arg_list=[('fini_type',INT_FiniType_t)])
        self.vchUsbWriteDoneClbk = StaticFunction(device, 0x52a16, thumb=1, name='vchUsbWriteDoneClbk', return_type=None, size=34, line=1800, arg_list=[('pData',PointerType('U8')),('status',USB_Status_t)])
        self.vchUsbReadDoneClbkProcess = StaticFunction(device, 0x526e4, thumb=1, name='vchUsbReadDoneClbkProcess', return_type=None, size=186, line=1225, arg_list=[('size',u32)])
        self.vchUsbReadTmrClbk = StaticFunction(device, 0x52be2, thumb=1, name='vchUsbReadTmrClbk', return_type=None, size=26, line=1440, arg_list=[('ptmr',PointerType("void")),('callbackArg',PointerType('void'))])
        self.vchUsbReadStatus = StaticFunction(device, 0x52954, thumb=1, name='vchUsbReadStatus', return_type=None, size=194, line=1464, arg_list=[('usbXferStat',VCH_P_FrameRead_t)])
        self.vchCipReqSend = StaticFunction(device, 0x528b4, thumb=1, name='vchCipReqSend', return_type=None, size=160, line=2051, arg_list=[])
        self.VCH_UsbConfigureProductId = StaticFunction(device, 0x52d5c, thumb=1, name='VCH_UsbConfigureProductId', return_type=None, size=86, line=685, arg_list=[('hwUniqueDeviceNumber',PointerType("u8"))])
        self.vchTask = StaticFunction(device, 0x52b5a, thumb=1, name='vchTask', return_type=None, size=128, line=753, arg_list=[('p_arg',PointerType('void'))])
        self.VCH_Init = StaticFunction(device, 0x52bfc, thumb=1, name='VCH_Init', return_type=Status, size=348, line=475, arg_list=[('init_type',INT_InitType_t)])
        self.vchUsbWriteStatus = StaticFunction(device, 0x5283e, thumb=1, name='vchUsbWriteStatus', return_type=None, size=118, line=1922, arg_list=[('pWriteStat',PointerType("VCH_P_WriteStat_t"))])
        self.vchUsbReadDoneSignal = StaticFunction(device, 0x52668, thumb=1, name='vchUsbReadDoneSignal', return_type=None, size=54, line=1400, arg_list=[])
        self.vchSetClinical = StaticFunction(device, 0x52b2a, thumb=1, name='vchSetClinical', return_type=None, size=6, line=2025, arg_list=[('flag',PointerType('vchClinicalModeFlag_t'))])
        self.vchUsbCfg = StaticFunction(device, 0x527ea, thumb=1, name='vchUsbCfg', return_type=None, size=84, line=961, arg_list=[])
        self.VCH_IsUsbSetupInProgress = StaticFunction(device, 0x52de4, thumb=1, name='VCH_IsUsbSetupInProgress', return_type=bool, size=12, line=735, arg_list=[])
        self.vchUsbWriteTmrClbk = StaticFunction(device, 0x52bda, thumb=1, name='vchUsbWriteTmrClbk', return_type=None, size=8, line=1904, arg_list=[('ptmr',PointerType("void")),('callbackArg',PointerType('void'))])
