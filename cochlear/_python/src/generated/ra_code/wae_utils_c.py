...
class Code(AbstractCode):
    ...
    def WAE_P_UtilsLogWirelessLink(self, transition, statsValid, numTxRequests, numTxFailed, numRetransmission):
        '''
        Arguments:
        -transition - u8
        -statsValid - u8
    ...
    def UtilsLogActivityBteStateUni(self, bteId, bteState, justPaired):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -bteState - WBST_Value_t
        -justPaired - bool
        Return type:
        -None
    ...
    def WAE_P_UtilsLogWaBattery(self, batteryLvl):
        '''
        Arguments:
        -batteryLvl - u8
        Return type:
    ...
    def WAE_P_UtilsLogFirmwareUpgrade(self, ffAppFwVer):
        '''
        Arguments:
        -ffAppFwVer - PointerType('u8')
        Return type:
        -None
    ...
    def WAE_P_UtilsLogAlarm(self, alarmType, bteSide, alarmMask):
        '''
        Arguments:
        -alarmType - u8
        -bteSide - u8
    ...
    def WAE_P_UtilsLogActivityFromBte(self, bteSettingId, bteId, bteValueOld, bteValueNew):
        '''
        Arguments:
        -bteSettingId - WBST_BteSettingId_t
        -bteId - WBST_BteId_t
        -bteValueOld - WBST_Value_t
        -bteValueNew - WBST_Value_t
        Return type:
        -None
    ...
    def waeUtilsAdjustMapIndexValues(self, bteId, pOldVal, pNewVal):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pOldVal - PointerType("WBST_Value_t")
        -pNewVal - PointerType('WBST_Value_t')
        Return type:
        -None
        Declaration line: 576
        '''
        pass

    def WAE_P_UtilsLogActivityFromWa(self, bteActionId, bteId, bteSettingId, bteValueOld, bteValueNew, bteActionStatus):
        '''
        Arguments:
        -bteActionId - WAE_BteUserActionId_t
        -bteId - WBST_BteId_t
        -bteSettingId - WBST_BteSettingId_t
        -bteValueOld - WBST_Value_t
        -bteValueNew - WBST_Value_t
        -bteActionStatus - LOG_UserActionResult_t
        Return type:
        -None
    ...
    def WAE_P_UtilsLogFirstBtePairing(self, bteSerialNum):
        '''
        Arguments:
        -bteSerialNum - PointerType("u8")
        Return type:
        -None
        Declaration line: 423
        '''
        pass

    def WAE_P_UtilsTurnWAOff(self, transition, waeState, forceTurnOff):
        '''
        Arguments:
        -transition - ELOG_WirelessLinkTransition_t
    ...
    def WAE_P_UtilsLogActivityBteState(self, bteId, bteState, justPaired):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -bteState - WBST_Value_t
    ...
    def WAE_P_MemCmp(self, ptr1, ptr2, len):
        '''
        Arguments:
        -ptr1 - PointerType('u8')
        -ptr2 - PointerType("u8")
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.WAE_P_UtilsLogWirelessLink = StaticFunction(device, 0x477e0, thumb=1, name='WAE_P_UtilsLogWirelessLink', return_type=None, size=42, line=399, arg_list=[('transition',u8),('statsValid',u8),('numTxRequests',u16),('numTxFailed',u16),('numRetransmission',u16)])
        self.UtilsLogActivityBteStateUni = StaticFunction(device, 0x4798a, thumb=1, name='UtilsLogActivityBteStateUni', return_type=None, size=114, line=512, arg_list=[('bteId',WBST_BteId_t),('bteState',WBST_Value_t),('justPaired',bool)])
        self.WAE_P_UtilsLogWaBattery = StaticFunction(device, 0x4789c, thumb=1, name='WAE_P_UtilsLogWaBattery', return_type=None, size=18, line=218, arg_list=[('batteryLvl',u8)])
        self.WAE_P_UtilsLogFirmwareUpgrade = StaticFunction(device, 0x47aac, thumb=1, name='WAE_P_UtilsLogFirmwareUpgrade', return_type=None, size=86, line=457, arg_list=[('ffAppFwVer',PointerType('u8'))])
        self.WAE_P_UtilsLogAlarm = StaticFunction(device, 0x47a2e, thumb=1, name='WAE_P_UtilsLogAlarm', return_type=None, size=34, line=370, arg_list=[('alarmType',u8),('bteSide',u8),('alarmMask',u32)])
        ...
        self.WAE_P_UtilsLogActivityFromBte = StaticFunction(device, 0x47940, thumb=1, name='WAE_P_UtilsLogActivityFromBte', return_type=None, size=74, line=286, arg_list=[('bteSettingId',WBST_BteSettingId_t),('bteId',WBST_BteId_t),('bteValueOld',WBST_Value_t),('bteValueNew',WBST_Value_t)])
        ...
        self.waeUtilsAdjustMapIndexValues = StaticFunction(device, 0x478ae, thumb=1, name='waeUtilsAdjustMapIndexValues', return_type=None, size=62, line=576, arg_list=[('bteId',WBST_BteId_t),('pOldVal',PointerType("WBST_Value_t")),('pNewVal',PointerType('WBST_Value_t'))])
        self.WAE_P_UtilsLogActivityFromWa = StaticFunction(device, 0x478ec, thumb=1, name='WAE_P_UtilsLogActivityFromWa', return_type=None, size=84, line=239, arg_list=[('bteActionId',WAE_BteUserActionId_t),('bteId',WBST_BteId_t),('bteSettingId',WBST_BteSettingId_t),('bteValueOld',WBST_Value_t),('bteValueNew',WBST_Value_t),('bteActionStatus',LOG_UserActionResult_t)])
        ...
        self.WAE_P_UtilsLogFirstBtePairing = StaticFunction(device, 0x47a58, thumb=1, name='WAE_P_UtilsLogFirstBtePairing', return_type=None, size=84, line=423, arg_list=[('bteSerialNum',PointerType("u8"))])
        self.WAE_P_UtilsTurnWAOff = StaticFunction(device, 0x4780a, thumb=1, name='WAE_P_UtilsTurnWAOff', return_type=None, size=146, line=114, arg_list=[('transition',ELOG_WirelessLinkTransition_t),('waeState',WAE_P_State_t),('forceTurnOff',bool)])
        ...
        self.WAE_P_UtilsLogActivityBteState = StaticFunction(device, 0x479fc, thumb=1, name='WAE_P_UtilsLogActivityBteState', return_type=None, size=50, line=326, arg_list=[('bteId',WBST_BteId_t),('bteState',WBST_Value_t),('justPaired',bool)])
        self.WAE_P_MemCmp = StaticFunction(device, 0x47a50, thumb=1, name='WAE_P_MemCmp', return_type=c_int_le, size=8, line=493, arg_list=[('ptr1',PointerType('u8')),('ptr2',PointerType("u8")),('len',u16)])
