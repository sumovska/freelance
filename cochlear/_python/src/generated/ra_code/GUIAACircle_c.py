...
class Code(AbstractCode):
    ...
    def GL_FillCircleAA_HiRes(self, x0, y0, r):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GUI_AA_FillCircle(self, x0, y0, r):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GL_FillCircleAA_HiRes = StaticFunction(device, 0x2e6dc, thumb=1, name='GL_FillCircleAA_HiRes', return_type=None, size=234, line=88, arg_list=[('x0',c_int_le),('y0',c_int_le),('r',c_int_le)])
        self.GUI_AA_FillCircle = StaticFunction(device, 0x2e7c6, thumb=1, name='GUI_AA_FillCircle', return_type=None, size=22, line=101, arg_list=[('x0',c_int_le),('y0',c_int_le),('r',c_int_le)])
