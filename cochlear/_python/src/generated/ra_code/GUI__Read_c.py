...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI__Read16 = StaticFunction(device, 0x2cda8, thumb=1, name='GUI__Read16', return_type=c_ushort_le, size=18, line=32, arg_list=[('ppData',PointerType('PointerType("c_ubyte")'))])
        self.GUI__Read32 = StaticFunction(device, 0x2cdba, thumb=1, name='GUI__Read32', return_type=c_ulong_le, size=30, line=47, arg_list=[('ppData',PointerType("PointerType('c_ubyte')"))])
