...
class Code(AbstractCode):
    ...
    def InterceptBteReq(self, pSm, bteId, actId, interceptFlag):
        '''
        Arguments:
    ...
    def UIE_P_WaePostBteReq(self, pSm, bteId, actId, actValue, statId, interceptFlag):
        '''
        Arguments:
        -pSm - PointerType("UIE_P_Sm_t")
        -bteId - WBST_BteId_t
    ...
    def UIE_P_SnoozeWaeAlarm(self, bteId, alarmBit):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 130
        '''
        pass

    def UIE_P_WaePostWaReq(self, pSm, actId, actValue):
        '''
        Arguments:
        -pSm - PointerType('UIE_P_Sm_t')
        -actId - WAE_WaUserActionId_t
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.InterceptBteReq = StaticFunction(device, 0x420be, thumb=1, name='InterceptBteReq', return_type=Status, size=178, line=166, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('bteId',WBST_BteId_t),('actId',WAE_BteUserActionId_t),('interceptFlag',u32)])
        self.UIE_P_WaePostBteReq = StaticFunction(device, 0x42170, thumb=1, name='UIE_P_WaePostBteReq', return_type=Status, size=64, line=96, arg_list=[('pSm',PointerType("UIE_P_Sm_t")),('bteId',WBST_BteId_t),('actId',WAE_BteUserActionId_t),('actValue',WAE_UserActionValue_t),('statId',WAE_BteStatusId_t),('interceptFlag',u32)])
        self.UIE_P_SnoozeWaeAlarm = StaticFunction(device, 0x421b0, thumb=1, name='UIE_P_SnoozeWaeAlarm', return_type=None, size=30, line=130, arg_list=[('bteId',WBST_BteId_t),('alarmBit',WBST_Value_t)])
        self.UIE_P_WaePostWaReq = StaticFunction(device, 0x4209c, thumb=1, name='UIE_P_WaePostWaReq', return_type=None, size=34, line=69, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('actId',WAE_WaUserActionId_t),('actValue',WAE_UserActionValue_t)])
