...
class Code(AbstractCode):
    ...
    def GUI__memset16(self, p, Fill, NumWords):
        '''
        Arguments:
        -p - PointerType("c_ushort_le")
        -Fill - c_ushort_le
        -NumWords - c_int_le
        Return type:
        -None
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI__memset16 = StaticFunction(device, 0x2d2a0, thumb=1, name='GUI__memset16', return_type=None, size=122, line=36, arg_list=[('p',PointerType("c_ushort_le")),('Fill',c_ushort_le),('NumWords',c_int_le)])
