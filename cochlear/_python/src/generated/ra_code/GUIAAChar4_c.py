...
class Code(AbstractCode):
    ...
    def GUIPROP_AA4_DispChar(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
    ...
    def GUIPROP_AA4_GetFontInfo(self, pFont, pfi):
        '''
        Arguments:
    ...
    def GUIPROP_AA4_GetCharDistX(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
    ...
    def GUIPROP_AA4_IsInFont(self, pFont, c):
        '''
        Arguments:
        -pFont - PointerType("GUI_FONT")
        -c - c_ushort_le
    ...
    def GUI_AA__DrawCharAA4(self, x0, y0, XSize, YSize, BytesPerLine, pData):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUIPROP_AA4_DispChar = StaticFunction(device, 0x2fada, thumb=1, name='GUIPROP_AA4_DispChar', return_type=None, size=266, line=93, arg_list=[('c',c_ushort_le)])
        self.GUIPROP_AA4_GetFontInfo = StaticFunction(device, 0x2fc14, thumb=1, name='GUIPROP_AA4_GetFontInfo', return_type=None, size=6, line=125, arg_list=[('pFont',PointerType("GUI_FONT")),('pfi',PointerType('GUI_FONTINFO'))])
        self.GUIPROP_AA4_GetCharDistX = StaticFunction(device, 0x2fbe4, thumb=1, name='GUIPROP_AA4_GetCharDistX', return_type=c_int_le, size=48, line=116, arg_list=[('c',c_ushort_le)])
        self.GUIPROP_AA4_IsInFont = StaticFunction(device, 0x2fc1a, thumb=1, name='GUIPROP_AA4_IsInFont', return_type=c_byte, size=36, line=134, arg_list=[('pFont',PointerType("GUI_FONT")),('c',c_ushort_le)])
        self.GUI_AA__DrawCharAA4 = StaticFunction(device, 0x2fa38, thumb=1, name='GUI_AA__DrawCharAA4', return_type=None, size=162, line=55, arg_list=[('x0',c_int_le),('y0',c_int_le),('XSize',c_int_le),('YSize',c_int_le),('BytesPerLine',c_int_le),('pData',PointerType('c_ubyte'))])
