...
class Code(AbstractCode):
    ...
    def GUI_MEMDEV_Write(self, hMem):
        '''
        Arguments:
    ...
    def GUI_MEMDEV_WriteAt(self, hMem, x, y):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        -x - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_MEMDEV_Write = StaticFunction(device, 0x30e9c, thumb=1, name='GUI_MEMDEV_Write', return_type=None, size=34, line=68, arg_list=[('hMem',GUI_MEMDEV_Handle)])
        self.GUI_MEMDEV_WriteAt = StaticFunction(device, 0x30e6c, thumb=1, name='GUI_MEMDEV_WriteAt', return_type=None, size=48, line=37, arg_list=[('hMem',GUI_MEMDEV_Handle),('x',c_int_le),('y',c_int_le)])
