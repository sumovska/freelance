...
class Code(AbstractCode):
    ...
    def CIP_ProcServerMsgFill(self, outMessage, procedure, callback):
        '''
        Arguments:
        -outMessage - PointerType('PointerType("CIP_Msg_t")')
        -procedure - CIP_ProcGenericFunctionPtr_t
        -callback - CIP_ProcGenericCallbackPtr_t
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcServerQSend(self, message):
        '''
        Arguments:
        -message - PointerType("CIP_Msg_t")
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcServerTask(self, param):
        '''
        Arguments:
        -param - PointerType('void')
        Return type:
        -None
        Declaration line: 79
        '''
    ...
    def CIP_ProcServerInit(self, initType):
        '''
        Arguments:
    ...
    def CIP_ProcServerMsgAlloc(self, ):
        '''
        Arguments:
        Return type:
        -PointerType("CIP_Msg_t")
        Declaration line: 164
        '''
        pass

    def CIP_ProcServerFini(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def CIP_ProcServerMsgFree(self, message):
        '''
        Arguments:
        -message - PointerType('CIP_Msg_t')
        Return type:
    ...
    def __init__(self, device):
        ...
        self.cipProcServerStack = StaticVariable(device, OS_STK * 256, 0x4000c150, False)
        ...
        ### Functions data ###
        ######################
        self.CIP_ProcServerMsgFill = StaticFunction(device, 0x590c4, thumb=1, name='CIP_ProcServerMsgFill', return_type=CIP_ProcResult_t, size=54, line=182, arg_list=[('outMessage',PointerType('PointerType("CIP_Msg_t")')),('procedure',CIP_ProcGenericFunctionPtr_t),('callback',CIP_ProcGenericCallbackPtr_t)])
        self.CIP_ProcServerQSend = StaticFunction(device, 0x59074, thumb=1, name='CIP_ProcServerQSend', return_type=CIP_ProcResult_t, size=46, line=148, arg_list=[('message',PointerType("CIP_Msg_t"))])
        self.CIP_ProcServerTask = StaticFunction(device, 0x58fbe, thumb=1, name='CIP_ProcServerTask', return_type=None, size=84, line=79, arg_list=[('param',PointerType('void'))])
        self.CIP_ProcServerInit = StaticFunction(device, 0x59012, thumb=1, name='CIP_ProcServerInit', return_type=Status, size=96, line=47, arg_list=[('initType',INT_InitType_t)])
        self.CIP_ProcServerMsgAlloc = StaticFunction(device, 0x590a2, thumb=1, name='CIP_ProcServerMsgAlloc', return_type=PointerType("CIP_Msg_t"), size=34, line=164, arg_list=[])
        self.CIP_ProcServerFini = StaticFunction(device, 0x59072, thumb=1, name='CIP_ProcServerFini', return_type=None, size=2, line=74, arg_list=[])
        self.CIP_ProcServerMsgFree = StaticFunction(device, 0x58fac, thumb=1, name='CIP_ProcServerMsgFree', return_type=None, size=18, line=177, arg_list=[('message',PointerType('CIP_Msg_t'))])
