...
class Code(AbstractCode):
    ...
    def UIE_P_ChangePollingMode(self, newMode):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.UIE_P_ChangePollingMode = StaticFunction(device, 0x39c68, thumb=1, name='UIE_P_ChangePollingMode', return_type=None, size=58, line=73, arg_list=[('newMode',WAE_PollingMode_t)])
