...
class Code(AbstractCode):
    ...
    def GUI_DispStringAt(self, s, x, y):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_DispStringAt = StaticFunction(device, 0x2e1a8, thumb=1, name='GUI_DispStringAt', return_type=None, size=18, line=32, arg_list=[('s',PointerType("c_byte")),('x',c_int_le),('y',c_int_le)])
