...
class WDLP_State_t__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    WDLP_IS_PAIRING_NORMALLY = 0
    WDLP_IS_PAIRING_CLINICALLY = 1
    WDLP_IS_SENDING_COMMAND = 2
    WDLP_IS_CANCELED = 3
    WDLP_IS_IDLE = 4
...
WDLP_State_t = WDLP_State_t__enumeration
...
class const():
    ...
    ### Defines ###
    ###############
    WDLP_PAIRING_TIMEOUT = 30000
    WDLP_BRIDGE_Q_ID = 15
    WDLP_MODULE_ID = 20
    WDLP_CMD_TIMEOUT_DEFAULT = 739
    INT_MODULE = 165
    ERROR = -1
    SUCCESS = 0
    FALSE = 0
...
class Code(AbstractCode):
    ...
    WDLP_State_t__enumeration = WDLP_State_t__enumeration
    ...
    def WDLP_State(self, ):
        ...
        Return type:
        -WDLP_State_t
        Declaration line: 350
        '''
        pass

    def WDLP_BridgeInit(self, initType):
        '''
        Arguments:
    ...
    def WDLP_SendCommand(self, dstBte, payload, payloadSize, outResult):
        '''
        Arguments:
        -dstBte - INT_Bte_t
        -payload - PointerType("byte")
        -payloadSize - u8
        -outResult - PointerType('WdlpCommandResult_t')
        Return type:
        -WDLP_Status_t
    ...
    def WDLP_SetState(self, state):
        '''
        Arguments:
        -state - WDLP_State_t
        Return type:
        -None
        Declaration line: 364
        '''
        pass

    def WDLP_QReceive(self, senderId, eventId, len, eventData, timeout):
        '''
        Arguments:
        -senderId - PointerType("INT_ModId_t")
        -eventId - PointerType('ITC_EventId_t')
        -len - PointerType("u16")
        -eventData - PointerType('void')
        -timeout - u32
        Return type:
        -WDLP_Status_t
        Declaration line: 393
        '''
        pass

    def WDLP_Unlock(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 344
        '''
        pass

    def WDLP_ResetPairing(self, dstBte, pairingType):
        '''
        Arguments:
        -dstBte - INT_Bte_t
        -pairingType - WdlpPairingType_t
        Return type:
        -WDLP_Status_t
        Declaration line: 171
        '''
        pass

    def WDLP_SendCommandEx(self, dstBte, timeout, retryNum, payload, payloadSize, outResult):
        '''
        Arguments:
        -dstBte - INT_Bte_t
        -timeout - u16
        ...
        Return type:
        -WDLP_Status_t
        Declaration line: 230
        '''
        pass

    def WDLP_Pair(self, pairingType):
        '''
        Arguments:
        -pairingType - WdlpPairingType_t
        Return type:
    ...
    def WDLP_QFlush(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 321
        '''
        pass

    def WDLP_QSend(self, newState, eventId, length, eventData):
        '''
        Arguments:
        -newState - WDLP_State_t
    ...
    WDLP_stateGuard = PointerType("OS_EVENT")
    OSTmrFree = INT16U
    WDLP_state = WDLP_State_t
    OSTCBList = PointerType('OS_TCB')
    OSTmrSemSignal = PointerType("OS_EVENT")
    OSTime = INT32U
    OSRdyTbl = INT8U * 8
    OSTCBHighRdy = PointerType('OS_TCB')
    WDLP_whichCancelMessage = ITC_EventId_t * 4
    ...
    def __init__(self, device):
        ...
        self.WDLP_stateGuard = StaticVariable(device, PointerType("OS_EVENT"), 0x8000894cL, False)
        self.OSTmrFree = StaticVariable(device, self.INT16U, 0x40000080, False)
        self.WDLP_state = StaticVariable(device, self.WDLP_State_t, 0x80008948L, False)
        ...
        self.WDLP_whichCancelMessage = StaticVariable(device, ITC_EventId_t * 4, 0x70eb8, True)
        self.OSUnMapTbl = StaticVariable(device, INT8U * 256, 0x61154, True)

        ######################
        ### Functions data ###
        ######################
        self.WDLP_SetIdle = StaticFunction(device, 0x5949a, thumb=1, name='WDLP_SetIdle', return_type=None, size=4, line=316, arg_list=[])
        self.WDLP_State = StaticFunction(device, 0x593a6, thumb=1, name='WDLP_State', return_type=WDLP_State_t, size=26, line=350, arg_list=[])
        self.WDLP_BridgeInit = StaticFunction(device, 0x591dc, thumb=1, name='WDLP_BridgeInit', return_type=Status, size=42, line=103, arg_list=[('initType',INT_InitType_t)])
        self.WDLP_Lock = StaticFunction(device, 0x59242, thumb=1, name='WDLP_Lock', return_type=None, size=20, line=337, arg_list=[])
        self.WDLP_Cancel = StaticFunction(device, 0x59464, thumb=1, name='WDLP_Cancel', return_type=None, size=54, line=285, arg_list=[])
        self.WDLP_SendCommand = StaticFunction(device, 0x5944c, thumb=1, name='WDLP_SendCommand', return_type=WDLP_Status_t, size=24, line=224, arg_list=[('dstBte',INT_Bte_t),('payload',PointerType("byte")),('payloadSize',u8),('outResult',PointerType('WdlpCommandResult_t'))])
        self.WDLP_SetState = StaticFunction(device, 0x592c0, thumb=1, name='WDLP_SetState', return_type=None, size=30, line=364, arg_list=[('state',WDLP_State_t)])
        self.WDLP_QReceive = StaticFunction(device, 0x59206, thumb=1, name='WDLP_QReceive', return_type=WDLP_Status_t, size=44, line=393, arg_list=[('senderId',PointerType("INT_ModId_t")),('eventId',PointerType('ITC_EventId_t')),('len',PointerType("u16")),('eventData',PointerType('void')),('timeout',u32)])
        self.WDLP_Unlock = StaticFunction(device, 0x59232, thumb=1, name='WDLP_Unlock', return_type=None, size=16, line=344, arg_list=[])
        self.WDLP_ResetPairing = StaticFunction(device, 0x5933a, thumb=1, name='WDLP_ResetPairing', return_type=WDLP_Status_t, size=108, line=171, arg_list=[('dstBte',INT_Bte_t),('pairingType',WdlpPairingType_t)])
        self.WDLP_SendCommandEx = StaticFunction(device, 0x593c0, thumb=1, name='WDLP_SendCommandEx', return_type=WDLP_Status_t, size=140, line=230, arg_list=[('dstBte',INT_Bte_t),('timeout',u16),('retryNum',u8),('payload',PointerType("byte")),('payloadSize',u8),('outResult',PointerType('WdlpCommandResult_t'))])
        self.WDLP_Pair = StaticFunction(device, 0x592de, thumb=1, name='WDLP_Pair', return_type=WDLP_Status_t, size=92, line=122, arg_list=[('pairingType',WdlpPairingType_t)])
        self.WDLP_QFlush = StaticFunction(device, 0x59294, thumb=1, name='WDLP_QFlush', return_type=None, size=44, line=321, arg_list=[])
        self.WDLP_QSend = StaticFunction(device, 0x59256, thumb=1, name='WDLP_QSend', return_type=WDLP_Status_t, size=62, line=375, arg_list=[('newState',WDLP_State_t),('eventId',ITC_EventId_t),('length',u16),('eventData',PointerType("void"))])
