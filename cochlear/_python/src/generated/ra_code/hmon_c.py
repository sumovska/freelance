...
class HMON_P_TempThreasholds_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    E_HMON_TEMP_LVL_WA_OFF_LOW = 0
    E_HMON_TEMP_LVL_WA_OFF_HIGH = 1
    E_HMON_TEMP_LVL_ALL = 2
...
class HMON_P_Hysteresis_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    E_HMON_HYST_MIN = 0
    E_HMON_HYST_NOMINAL = 1
    E_HMON_HYST_MAX = 2
    E_HMON_HYST_ALL = 3
...
HMON_P_TempThreasholds_t = HMON_P_TempThreasholds_tag
ITC_MemPool_t = u8
...
HMON_P_Hysteresis_t = HMON_P_Hysteresis_tag
...
class const():
    ...
    HMON_VBAT_CHANNEL = 0
    HMON_TEMP_CHANNEL = 7
    HMON_TEMP_CHANNEL_LM20 = 5
    HMON_COIL_CHANNEL = 6
    HMON_TIMER_FLAG = 1
    HMON_USB_FLAG = 2
    HMON_COIL_FLAG = 4
    HMON_U16_MAX_VALUE = 65535
...
class Code(AbstractCode):
    ...
    HMON_P_TempThreasholds_tag = HMON_P_TempThreasholds_tag
    ...
    HMON_P_Hysteresis_tag = HMON_P_Hysteresis_tag
    ...
    ITC_QId_t = ITC_QId_t
    HMON_P_TempThreasholds_t = HMON_P_TempThreasholds_t
    ...
    HMON_P_Hysteresis_t = HMON_P_Hysteresis_t
    ...
    def HmonCheckCoilStatus(self, coilVol, stimStopVol, stimStartVol, coilStatus):
        '''
        Arguments:
        -coilVol - u16
        -stimStopVol - u16
        -stimStartVol - u16
        -coilStatus - PointerType('HMON_CoilStimulStatus_t')
        Return type:
        -bool
        Declaration line: 1172
        '''
        pass

    def hmonCoilMeasEnable(self, measPeriod):
        '''
        Arguments:
        -measPeriod - u8
        Return type:
        -Status
        Declaration line: 1124
        '''
        pass

    def HMON_LockBat(self, timeout):
        '''
        Arguments:
        -timeout - u16
        Return type:
        -bool
        Declaration line: 756
        '''
        pass

    def HmonGetBatteryLevel(self, batteryVoltage):
        '''
        Arguments:
        -batteryVoltage - u16
        Return type:
    ...
    def HMON_UsbGetStatus(self, ):
        '''
        Arguments:
        Return type:
        -HMON_UsbConnectStatus_t
        Declaration line: 635
        '''
        pass

    def HMON_GetBatVoltValue(self, refresh):
        '''
        Arguments:
        -refresh - bool
        Return type:
        -u16
        Declaration line: 549
        '''
        pass

    def HMON_Init(self, init_type):
        '''
        Arguments:
        -init_type - INT_InitType_t
        Return type:
        -Status
        Declaration line: 235
        '''
        pass

    def HMON_GetBatVoltLevel(self, refresh):
        '''
        Arguments:
        -refresh - bool
        Return type:
        -HMON_BatLevel_t
        Declaration line: 578
        '''
        pass

    def HmonGetTempLevel(self, tempVoltage):
        '''
        Arguments:
        -tempVoltage - u16
        Return type:
        -HMON_TempLevel_t
        Declaration line: 1091
        '''
        pass

    def HMON_UnlockBat(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 770
        '''
        pass

    def HMON_Fini(self, fini_type):
        '''
        Arguments:
    ...
    def HmonTmrService(self, ptmr, callback_arg):
        '''
        Arguments:
        -ptmr - PointerType("void")
        -callback_arg - PointerType('void')
        Return type:
        -None
    ...
    def HMON_SetWaModeInfo(self, waMode):
        '''
        Arguments:
        -waMode - HMON_WA_Mode_t
        Return type:
        -Status
    ...
    def HmonCoilStimulationCheck(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 679
        '''
        pass

    def HMON_GetBatTempValue(self, refresh):
        '''
        Arguments:
        -refresh - bool
        Return type:
    ...
    def HMON_UsbIsr(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 734
        '''
        pass

    def HMON_GetBatTempLevel(self, refresh):
        '''
        Arguments:
        -refresh - bool
        Return type:
    ...
    def HmonBatMeasEnable(self, measPeriod):
        '''
        Arguments:
        -measPeriod - u8
        Return type:
        -Status
        Declaration line: 1047
        '''
        pass

    def HmonAdjustVoltage(self, batteryVoltage):
        '''
        Arguments:
        -batteryVoltage - u16
        Return type:
        -u16
        Declaration line: 1210
        '''
        pass

    def HMON_ContinuousCoilCheck(self, timeInTicks):
        '''
        Arguments:
        -timeInTicks - u16
        Return type:
    ...
    OSCtxSwCtr = INT32U
    hmonBatCoEffM = u16
    hmonUsbConnectStat = HMON_UsbConnectStatus_t
    ...
    OSLockNesting = INT8U
    OSMemTbl = OS_MEM * 15
    hmonCoilTmr = PointerType('OS_TMR')
    hmonWaMode = HMON_WA_Mode_t
    hmonBatLevelTab = word * 8 * 3
    OSTmrFreeList = PointerType("OS_TMR")
    OSRunning = BOOLEAN
    OSTmrSem = PointerType('OS_EVENT')
    OSTmrFree = INT16U
    hmonTempLevel = HMON_TempLevel_t
    OSMemFreeList = PointerType("OS_MEM")
    OSTmrTbl = OS_TMR * 26
    hmonTaskStk = OS_STK * 128
    OSTmrTaskStk = OS_STK * 128
    OSTaskCtr = INT8U
    OSTaskIdleStk = OS_STK * 128
    hmonFlags = PointerType('OS_FLAG_GRP')
    OSPrioCur = INT8U
    hmonCoilLevelTab = u16 * 2
    OSIntNesting = INT8U
    OSTCBPrioTbl = PointerType("OS_TCB") * 61
    continuousCoilCheckTime = u16
    hmonTmr = PointerType('OS_TMR')
    OSTickStepState = INT8U
    hmonCoilStatus = HMON_CoilStimulStatus_t
    OSTCBList = PointerType("OS_TCB")
    OSTmrSemSignal = PointerType('OS_EVENT')
    OSTime = INT32U
    OSRdyTbl = INT8U * 8
    OSTCBHighRdy = PointerType("OS_TCB")
    hmonBatSem = PointerType('OS_EVENT')
    hmonBatLevel = HMON_BatLevel_t
    OSEventTbl = OS_EVENT * 80
    hmonUsbDetSem = PointerType("OS_EVENT")
    ...
    def __init__(self, device):
        ...
        self.hmonBatCoEffC = StaticVariable(device, self.s16, 0x80008346L, False)
        ...
        self.hmonBatCoEffM = StaticVariable(device, self.u16, 0x80008344L, False)
        self.hmonUsbConnectStat = StaticVariable(device, self.HMON_UsbConnectStatus_t, 0x8000833cL, False)
        ...
        self.coilVoltage = StaticVariable(device, self.u16, 0x80008348L, False)
        ...
        self.hmonCoilTmr = StaticVariable(device, PointerType('OS_TMR'), 0x8000835cL, False)
        self.hmonWaMode = StaticVariable(device, self.HMON_WA_Mode_t, 0x80008335L, False)
        self.hmonBatLevelTab = StaticVariable(device, word * 8 * 3, 0x40007d48, False)
        ...
        self.hmonTempLevel = StaticVariable(device, self.HMON_TempLevel_t, 0x80008334L, False)
        ...
        self.hmonTaskStk = StaticVariable(device, OS_STK * 128, 0x40007b48, False)
        ...
        self.hmonFlags = StaticVariable(device, PointerType('OS_FLAG_GRP'), 0x80008354L, False)
        self.OSPrioCur = StaticVariable(device, self.INT8U, 0x40000046, False)
        self.hmonCoilLevelTab = StaticVariable(device, u16 * 2, 0x80008360L, False)
        ...
        self.continuousCoilCheckTime = StaticVariable(device, self.u16, 0x8000833eL, False)
        self.hmonTmr = StaticVariable(device, PointerType('OS_TMR'), 0x80008358L, False)
        self.OSTickStepState = StaticVariable(device, self.INT8U, 0x4000004b, False)
        self.hmonCoilStatus = StaticVariable(device, self.HMON_CoilStimulStatus_t, 0x80008330L, False)
        ...
        self.hmonBatSem = StaticVariable(device, PointerType('OS_EVENT'), 0x80008350L, False)
        self.hmonBatLevel = StaticVariable(device, self.HMON_BatLevel_t, 0x80008338L, False)
        self.OSEventTbl = StaticVariable(device, OS_EVENT * 80, 0x40003864, False)
        self.hmonUsbDetSem = StaticVariable(device, PointerType("OS_EVENT"), 0x8000834cL, False)

        ######################
        ### Functions data ###
        ######################
        self.HmonCheckCoilStatus = StaticFunction(device, 0x33aca, thumb=1, name='HmonCheckCoilStatus', return_type=bool, size=40, line=1172, arg_list=[('coilVol',u16),('stimStopVol',u16),('stimStartVol',u16),('coilStatus',PointerType('HMON_CoilStimulStatus_t'))])
        self.hmonCoilMeasEnable = StaticFunction(device, 0x33a38, thumb=1, name='hmonCoilMeasEnable', return_type=Status, size=74, line=1124, arg_list=[('measPeriod',u8)])
        self.HMON_LockBat = StaticFunction(device, 0x33bac, thumb=1, name='HMON_LockBat', return_type=bool, size=36, line=756, arg_list=[('timeout',u16)])
        self.HmonGetBatteryLevel = StaticFunction(device, 0x33c4e, thumb=1, name='HmonGetBatteryLevel', return_type=HMON_BatLevel_t, size=120, line=975, arg_list=[('batteryVoltage',u16)])
        self.HMON_UsbGetStatus = StaticFunction(device, 0x33cd2, thumb=1, name='HMON_UsbGetStatus', return_type=HMON_UsbConnectStatus_t, size=44, line=635, arg_list=[])
        self.HMON_GetBatVoltValue = StaticFunction(device, 0x33bd0, thumb=1, name='HMON_GetBatVoltValue', return_type=u16, size=46, line=549, arg_list=[('refresh',bool)])
        self.HMON_Init = StaticFunction(device, 0x33e68, thumb=1, name='HMON_Init', return_type=Status, size=554, line=235, arg_list=[('init_type',INT_InitType_t)])
        self.HMON_GetBatVoltLevel = StaticFunction(device, 0x33cc6, thumb=1, name='HMON_GetBatVoltLevel', return_type=HMON_BatLevel_t, size=12, line=578, arg_list=[('refresh',bool)])
        self.HmonGetTempLevel = StaticFunction(device, 0x33c28, thumb=1, name='HmonGetTempLevel', return_type=HMON_TempLevel_t, size=26, line=1091, arg_list=[('tempVoltage',u16)])
        self.HMON_UnlockBat = StaticFunction(device, 0x33b76, thumb=1, name='HMON_UnlockBat', return_type=None, size=16, line=770, arg_list=[])
        self.HMON_Fini = StaticFunction(device, 0x34092, thumb=1, name='HMON_Fini', return_type=Status, size=26, line=494, arg_list=[('fini_type',INT_FiniType_t)])
        self.HmonTmrService = StaticFunction(device, 0x33a20, thumb=1, name='HmonTmrService', return_type=None, size=24, line=949, arg_list=[('ptmr',PointerType("void")),('callback_arg',PointerType('void'))])
        self.HMON_SetWaModeInfo = StaticFunction(device, 0x340ac, thumb=1, name='HMON_SetWaModeInfo', return_type=Status, size=36, line=519, arg_list=[('waMode',HMON_WA_Mode_t)])
        self.HmonTask = StaticFunction(device, 0x33cfe, thumb=1, name='HmonTask', return_type=None, size=362, line=793, arg_list=[('p_arg',PointerType("void"))])
        self.HmonCoilStimulationCheck = StaticFunction(device, 0x33af2, thumb=1, name='HmonCoilStimulationCheck', return_type=None, size=132, line=679, arg_list=[])
        self.HMON_GetBatTempValue = StaticFunction(device, 0x33bfe, thumb=1, name='HMON_GetBatTempValue', return_type=u16, size=42, line=592, arg_list=[('refresh',bool)])
        self.HMON_UsbIsr = StaticFunction(device, 0x340e6, thumb=1, name='HMON_UsbIsr', return_type=None, size=32, line=734, arg_list=[])
        self.HMON_GetBatTempLevel = StaticFunction(device, 0x33c42, thumb=1, name='HMON_GetBatTempLevel', return_type=HMON_TempLevel_t, size=12, line=621, arg_list=[('refresh',bool)])
        self.HmonBatMeasEnable = StaticFunction(device, 0x33a82, thumb=1, name='HmonBatMeasEnable', return_type=Status, size=72, line=1047, arg_list=[('measPeriod',u8)])
        self.HmonAdjustVoltage = StaticFunction(device, 0x33b86, thumb=1, name='HmonAdjustVoltage', return_type=u16, size=38, line=1210, arg_list=[('batteryVoltage',u16)])
        self.HMON_ContinuousCoilCheck = StaticFunction(device, 0x340d0, thumb=1, name='HMON_ContinuousCoilCheck', return_type=None, size=22, line=667, arg_list=[('timeInTicks',u16)])
