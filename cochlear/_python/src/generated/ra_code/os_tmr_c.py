...
class Code(AbstractCode):
    ...
    def OSTmrStateGet(self, ptmr, perr):
        '''
        Arguments:
        -ptmr - PointerType("OS_TMR")
    ...
    def OSTmrCreate(self, dly, period, opt, callback, callback_arg, pname, perr):
        '''
        Arguments:
        -dly - INT32U
        -period - INT32U
        -opt - INT8U
        -callback - OS_TMR_CALLBACK
    ...
    def OSTmrSignal(self, ):
        '''
        Arguments:
        Return type:
        -INT8U
        Declaration line: 716
        '''
        pass

    def OSTmr_Task(self, p_arg):
        '''
        Arguments:
        -p_arg - PointerType("void")
        Return type:
        -None
        Declaration line: 1083
        '''
        pass

    def OSTmr_Free(self, ptmr):
        '''
        Arguments:
        -ptmr - PointerType('OS_TMR')
        Return type:
        -None
        Declaration line: 772
        '''
        pass

    def OSTmr_Unlock(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def OSTmrRemainGet(self, ptmr, perr):
        '''
        Arguments:
        -ptmr - PointerType("OS_TMR")
        -perr - PointerType('INT8U')
    ...
    def OSTmrStop(self, ptmr, opt, callback_arg, perr):
        '''
        Arguments:
        -ptmr - PointerType("OS_TMR")
        -opt - INT8U
    ...
    def OSTmr_Lock(self, ):
        ...
        Return type:
        -None
        Declaration line: 1050
        '''
        pass

    def OSTmrNameGet(self, ptmr, pdest, perr):
        '''
        Arguments:
        -ptmr - PointerType('OS_TMR')
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.OSTmrStateGet = StaticFunction(device, 0x2ac60, thumb=1, name='OSTmrStateGet', return_type=INT8U, size=72, line=460, arg_list=[('ptmr',PointerType("OS_TMR")),('perr',PointerType('INT8U'))])
        self.OSTmrCreate = StaticFunction(device, 0x2aa04, thumb=1, name='OSTmrCreate', return_type=PointerType('OS_TMR'), size=160, line=113, arg_list=[('dly',INT32U),('period',INT32U),('opt',INT8U),('callback',OS_TMR_CALLBACK),('callback_arg',PointerType("void")),('pname',PointerType('INT8U')),('perr',PointerType("INT8U"))])
        self.OSTmr_Init = StaticFunction(device, 0x2ae7c, thumb=1, name='OSTmr_Init', return_type=None, size=184, line=809, arg_list=[])
        self.OSTmrSignal = StaticFunction(device, 0x2ae04, thumb=1, name='OSTmrSignal', return_type=INT8U, size=16, line=716, arg_list=[])
        self.OSTmr_Task = StaticFunction(device, 0x2ae14, thumb=1, name='OSTmr_Task', return_type=None, size=104, line=1083, arg_list=[('p_arg',PointerType("void"))])
        self.OSTmr_Free = StaticFunction(device, 0x2aaa4, thumb=1, name='OSTmr_Free', return_type=None, size=52, line=772, arg_list=[('ptmr',PointerType('OS_TMR'))])
        self.OSTmr_Unlock = StaticFunction(device, 0x2af34, thumb=1, name='OSTmr_Unlock', return_type=None, size=12, line=1063, arg_list=[])
        self.OSTmrRemainGet = StaticFunction(device, 0x2abda, thumb=1, name='OSTmrRemainGet', return_type=INT32U, size=134, line=363, arg_list=[('ptmr',PointerType("OS_TMR")),('perr',PointerType('INT8U'))])
        self.OSTmrStop = StaticFunction(device, 0x2ad4a, thumb=1, name='OSTmrStop', return_type=BOOLEAN, size=186, line=612, arg_list=[('ptmr',PointerType("OS_TMR")),('opt',INT8U),('callback_arg',PointerType('void')),('perr',PointerType("INT8U"))])
        self.OSTmr_Unlink = StaticFunction(device, 0x2aad8, thumb=1, name='OSTmr_Unlink', return_type=None, size=62, line=1004, arg_list=[('ptmr',PointerType('OS_TMR'))])
        self.OSTmr_Link = StaticFunction(device, 0x2aca8, thumb=1, name='OSTmr_Link', return_type=None, size=64, line=955, arg_list=[('ptmr',PointerType("OS_TMR")),('type',INT8U)])
        self.OSTmr_Lock = StaticFunction(device, 0x2af40, thumb=1, name='OSTmr_Lock', return_type=None, size=20, line=1050, arg_list=[])
        self.OSTmrNameGet = StaticFunction(device, 0x2ab7a, thumb=1, name='OSTmrNameGet', return_type=INT8U, size=96, line=288, arg_list=[('ptmr',PointerType('OS_TMR')),('pdest',PointerType("INT8U")),('perr',PointerType('INT8U'))])
        self.OSTmrDel = StaticFunction(device, 0x2ab16, thumb=1, name='OSTmrDel', return_type=BOOLEAN, size=100, line=213, arg_list=[('ptmr',PointerType("OS_TMR")),('perr',PointerType('INT8U'))])
        self.OSTmrStart = StaticFunction(device, 0x2ace8, thumb=1, name='OSTmrStart', return_type=BOOLEAN, size=98, line=525, arg_list=[('ptmr',PointerType("OS_TMR")),('perr',PointerType('INT8U'))])
