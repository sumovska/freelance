...
class Code(AbstractCode):
    ...
    def GUI_RectsIntersect(self, pr0, pr1):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_RectsIntersect = StaticFunction(device, 0x2d1e4, thumb=1, name='GUI_RectsIntersect', return_type=c_int_le, size=56, line=40, arg_list=[('pr0',PointerType("GUI_RECT")),('pr1',PointerType('GUI_RECT'))])
