...
GUI_RECT = LCD_RECT
class AlarmInfo_tag(Structure):
    alarmBit = WBST_Value_t
    title = WAGUI_P_TextId_t
    desc = WAGUI_P_TextId_t
    iconL = WAGUI_P_Res_t
    iconR = WAGUI_P_Res_t
    _pack_ = 1
    _fields_ = [
...
class BteStatusIconS_tag(Structure):
    status = WAGUI_P_Res_t
    side = WAGUI_P_Res_t
    _pack_ = 1
    _fields_ = [
                ('status', WAGUI_P_Res_t),
...
class BteAlarmSegment_tag(Structure):
    alarmBit = WBST_Value_t
    segments = c_int_le
    _fields_ = [
                ('alarmBit', WBST_Value_t),
...
class BteStatusIconLR_tag(Structure):
    left = BteStatusIconS_t
    right = BteStatusIconS_t
    _pack_ = 1
    _fields_ = [
                ('left', BteStatusIconS_t),
                ('right', BteStatusIconS_t),
...
BteStatusIconLR_t = BteStatusIconLR_tag
...
class BteStatusIconRS_tag(Structure):
    recipient = BteStatusIconLR_t
    surgical = BteStatusIconLR_t
    _pack_ = 1
    _fields_ = [
                ('recipient', BteStatusIconLR_t),
                ('surgical', BteStatusIconLR_t),
...
BteStatusIconRS_t = BteStatusIconRS_tag
class BteStatusIcon_tag(Structure):
    regular = BteStatusIconRS_t
    alarm = BteStatusIconRS_t
    _pack_ = 1
    _fields_ = [
                ('regular', BteStatusIconRS_t),
                ('alarm', BteStatusIconRS_t),
...
BteStatusIcon_t = BteStatusIcon_tag
...
class Code(AbstractCode):
    ...
    GUI_RECT = GUI_RECT
    AlarmInfo_tag = AlarmInfo_tag
    WAGUI_BottomPane_tag = WAGUI_BottomPane_tag
    BteStatusIconS_tag = BteStatusIconS_tag
    ...
    BteAlarmSegment_tag = BteAlarmSegment_tag
    ...
    def WAGUI_ShowStGreenAnimFrame(self, bteId, frame):
        ...
        Return type:
        -c_int_le
        Declaration line: 649
        '''
        pass

    def DrawAlarmLockBackground(self, cover):
        '''
        Arguments:
    ...
    def isMM(self, pParams):
        '''
        Arguments:
        -pParams - PointerType('WAGUI_StatusParams_t')
        Return type:
        -bool
    ...
    def DrawWaAlarm(self, x, y, icon, frame, updateMode):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 1217
        '''
        pass

    def DrawBteBatteryLevel(self, x, y, flags, level, waMode, alarmMode, frame):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 1060
        '''
        pass

    def WAGUI_OverlayCoilOffBar(self, bteCoilOff, btePaired):
        '''
        Arguments:
        -bteCoilOff - WBST_BteId_t
        -btePaired - WBST_BteId_t
        Return type:
        -None
        Declaration line: 865
        '''
        pass

    def DrawBteStatus(self, x, y, bteId, pairedBtes, waMode, alarmMode, alarms, frame):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def isFM(self, pParams):
        '''
        Arguments:
        -pParams - PointerType("WAGUI_StatusParams_t")
        Return type:
        -bool
        Declaration line: 875
        '''
        pass

    def DrawBteAlarm(self, x, y, bteId, showSide, icon, frame, updateMode):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def WAGUI_ShowOutOfRange(self, availableBtes, pairedBtes):
        '''
        Arguments:
        -availableBtes - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
    ...
    def GetStatusAccIcon(self, tcoil, acc, accType, stream, streamType, alarmMode, bilateral):
        '''
        Arguments:
        -tcoil - WBST_Value_t
        -acc - WBST_Value_t
    ...
    def DrawAudioLevel(self, x, y, flags, level, bteId, alarmMode, showRef):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 1238
        '''
        pass

    def WAGUI_ShowStatus(self, pairedBtes, availableBtes, bteSettingsValid, pParamsL, pParamsR, waMode, alarmMode, updateMode, frame):
        '''
        Arguments:
        -pairedBtes - WBST_BteId_t
        -availableBtes - WBST_BteId_t
        -bteSettingsValid - bool
    ...
    def WAGUI_ShowFmAdvantage(self, pairedBtes, availableBtes, pParamsL, pParamsR, updateMode):
        '''
        Arguments:
        -pairedBtes - WBST_BteId_t
        -availableBtes - WBST_BteId_t
    ...
    def WAGUI_ShowWaAlarm(self, alarmBit, updateMode, frame, coverMode):
        '''
        Arguments:
        -alarmBit - WBST_Value_t
        -updateMode - WAGUI_UpdateMode_t
        -frame - u32
        -coverMode - WAGUI_CoverMode_t
        Return type:
        -None
    ...
    def WAGUI_ShowBteAlarm(self, alarmBit, bteId, pairedBtes, updateMode, frame, coverMode):
        '''
        Arguments:
        -alarmBit - WBST_Value_t
        -bteId - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 721
        '''
        pass

    def WAGUI_OverlayOutOfRangeBar(self, bteAvailable, btePaired):
        '''
        Arguments:
        -bteAvailable - WBST_BteId_t
        -btePaired - WBST_BteId_t
    ...
    waAlarmInfo = AlarmInfo_t * 6
    bteAlarmSegment = BteAlarmSegment_t * 12
    bteStatusIcon = BteStatusIcon_t
    GUI_MEMDEV__APIList16 = tLCDDEV_APIList_struct
    bteAlarmInfo = AlarmInfo_t * 12
    ...
    def __init__(self, device):
        ...
        self.waAlarmInfo = StaticVariable(device, AlarmInfo_t * 6, 0x70a90, True)
        self.bteAlarmSegment = StaticVariable(device, BteAlarmSegment_t * 12, 0x709b8, True)
        self.bteStatusIcon = StaticVariable(device, self.BteStatusIcon_t, 0x70998, True)
        self.GUI_MEMDEV__APIList16 = StaticVariable(device, self.tLCDDEV_APIList_struct, 0x61b4c, True)
        self.bteAlarmInfo = StaticVariable(device, AlarmInfo_t * 12, 0x70a18, True)

        ######################
        ### Functions data ###
        ######################
        self.WAGUI_ShowStGreenAnimFrame = StaticFunction(device, 0x4f7a2, thumb=1, name='WAGUI_ShowStGreenAnimFrame', return_type=c_int_le, size=220, line=649, arg_list=[('bteId',WBST_BteId_t),('frame',u32)])
        self.DrawAlarmLockBackground = StaticFunction(device, 0x4f87e, thumb=1, name='DrawAlarmLockBackground', return_type=None, size=78, line=701, arg_list=[('cover',WAGUI_CoverMode_t)])
        self.isMM = StaticFunction(device, 0x4fb56, thumb=1, name='isMM', return_type=bool, size=26, line=881, arg_list=[('pParams',PointerType('WAGUI_StatusParams_t'))])
        self.DrawWaAlarm = StaticFunction(device, 0x4f9d0, thumb=1, name='DrawWaAlarm', return_type=None, size=68, line=1217, arg_list=[('x',c_int_le),('y',c_int_le),('icon',WAGUI_P_Res_t),('frame',u32),('updateMode',WAGUI_UpdateMode_t)])
        self.DrawBteBatteryLevel = StaticFunction(device, 0x4f228, thumb=1, name='DrawBteBatteryLevel', return_type=None, size=136, line=1060, arg_list=[('x',c_int_le),('y',c_int_le),('flags',c_int_le),('level',WBST_Value_t),('waMode',WBST_Value_t),('alarmMode',bool),('frame',u32)])
        self.WAGUI_OverlayCoilOffBar = StaticFunction(device, 0x4fb22, thumb=1, name='WAGUI_OverlayCoilOffBar', return_type=None, size=26, line=865, arg_list=[('bteCoilOff',WBST_BteId_t),('btePaired',WBST_BteId_t)])
        self.DrawBteStatus = StaticFunction(device, 0x4f2b0, thumb=1, name='DrawBteStatus', return_type=None, size=350, line=1099, arg_list=[('x',c_int_le),('y',c_int_le),('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('waMode',WBST_Value_t),('alarmMode',bool),('alarms',WBST_Value_t),('frame',u32)])
        self.isFM = StaticFunction(device, 0x4fb3c, thumb=1, name='isFM', return_type=bool, size=26, line=875, arg_list=[('pParams',PointerType("WAGUI_StatusParams_t"))])
        self.DrawBteAlarm = StaticFunction(device, 0x4eec8, thumb=1, name='DrawBteAlarm', return_type=None, size=152, line=1175, arg_list=[('x',c_int_le),('y',c_int_le),('bteId',WBST_BteId_t),('showSide',bool),('icon',WAGUI_P_Res_t),('frame',u32),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowOutOfRange = StaticFunction(device, 0x4ef60, thumb=1, name='WAGUI_ShowOutOfRange', return_type=None, size=162, line=327, arg_list=[('availableBtes',WBST_BteId_t),('pairedBtes',WBST_BteId_t)])
        self.GetStatusAccIcon = StaticFunction(device, 0x4f002, thumb=1, name='GetStatusAccIcon', return_type=WAGUI_P_Res_t, size=202, line=359, arg_list=[('tcoil',WBST_Value_t),('acc',WBST_Value_t),('accType',WBST_Value_t),('stream',WBST_Value_t),('streamType',WBST_Value_t),('alarmMode',bool),('bilateral',bool)])
        self.DrawAudioLevel = StaticFunction(device, 0x4f0cc, thumb=1, name='DrawAudioLevel', return_type=None, size=348, line=1238, arg_list=[('x',c_int_le),('y',c_int_le),('flags',c_int_le),('level',WBST_Value_t),('bteId',WBST_BteId_t),('alarmMode',bool),('showRef',bool)])
        self.WAGUI_ShowStatus = StaticFunction(device, 0x4f40e, thumb=1, name='WAGUI_ShowStatus', return_type=None, size=916, line=405, arg_list=[('pairedBtes',WBST_BteId_t),('availableBtes',WBST_BteId_t),('bteSettingsValid',bool),('pParamsL',PointerType('WAGUI_StatusParams_t')),('pParamsR',PointerType("WAGUI_StatusParams_t")),('waMode',WBST_Value_t),('alarmMode',bool),('updateMode',WAGUI_UpdateMode_t),('frame',u32)])
        self.WAGUI_ShowFmAdvantage = StaticFunction(device, 0x4fb70, thumb=1, name='WAGUI_ShowFmAdvantage', return_type=None, size=1056, line=887, arg_list=[('pairedBtes',WBST_BteId_t),('availableBtes',WBST_BteId_t),('pParamsL',PointerType('WAGUI_StatusParams_t')),('pParamsR',PointerType("WAGUI_StatusParams_t")),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowWaAlarm = StaticFunction(device, 0x4fa14, thumb=1, name='WAGUI_ShowWaAlarm', return_type=None, size=240, line=789, arg_list=[('alarmBit',WBST_Value_t),('updateMode',WAGUI_UpdateMode_t),('frame',u32),('coverMode',WAGUI_CoverMode_t)])
        self.WAGUI_ShowBteAlarm = StaticFunction(device, 0x4f8cc, thumb=1, name='WAGUI_ShowBteAlarm', return_type=None, size=260, line=721, arg_list=[('alarmBit',WBST_Value_t),('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('updateMode',WAGUI_UpdateMode_t),('frame',u32),('coverMode',WAGUI_CoverMode_t)])
        self.WAGUI_OverlayOutOfRangeBar = StaticFunction(device, 0x4fb04, thumb=1, name='WAGUI_OverlayOutOfRangeBar', return_type=None, size=30, line=855, arg_list=[('bteAvailable',WBST_BteId_t),('btePaired',WBST_BteId_t)])
