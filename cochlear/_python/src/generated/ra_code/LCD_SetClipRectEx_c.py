...
class Code(AbstractCode):
    ...
    def LCD_SetClipRectEx(self, pRect):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_SetClipRectEx = StaticFunction(device, 0x2e234, thumb=1, name='LCD_SetClipRectEx', return_type=None, size=36, line=41, arg_list=[('pRect',PointerType("GUI_RECT"))])
