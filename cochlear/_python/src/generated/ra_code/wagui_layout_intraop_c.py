...
class ElectrodeViewMode_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    ELECTRODE_VIEW_DIAG = 0
    ELECTRODE_VIEW_DIAG_RESULT = 1
    ELECTRODE_VIEW_NRT = 2
    ELECTRODE_VIEW__COUNT = 3
...
ElectrodeViewMode_t = ElectrodeViewMode_tag
...
class Code(AbstractCode):
    ...
    ElectrodeViewMode_tag = ElectrodeViewMode_tag
    ...
    ElectrodeViewMode_t = ElectrodeViewMode_t
    ...
    def WAGUI_ShowIntraOpNrtProgress(self, fmcState, updateMode, viewMode, electrodeData, nrtTraceData, ecapProfile, stim, animFrame):
        '''
        Arguments:
    ...
    def WAGUI_ShowIntraOpNrtConfirmation(self, electrodeData):
        '''
        Arguments:
        -electrodeData - PointerType("WBST_ElectrodeData_t")
        Return type:
        -None
        Declaration line: 906
        '''
        pass

    def DrawIntraOpNrtProfileCanvas(self, rect, yel0, inProgress, updateMode):
        '''
        Arguments:
        -rect - PointerType('GUI_RECT')
        -yel0 - c_int_le
        -inProgress - bool
        -updateMode - WAGUI_UpdateMode_t
        Return type:
        -None
        Declaration line: 392
        '''
        pass

    def WAGUI_ShowIntraOpNrtInitInstruction(self, viewMode):
        '''
        Arguments:
        -viewMode - WAGUI_IntraOpNrtMode_t
        Return type:
    ...
    def WAGUI_ShowIntraOpNrtPauseSelection(self, selection, selected):
        '''
        Arguments:
    ...
    def GetElectrodeColor(self, status):
        '''
        Arguments:
        -status - WBST_ElectrodeStatus_t
        Return type:
        -GUI_COLOR
        Declaration line: 436
        '''
        pass

    def DrawIntraOpElectrodeView(self, electrodeData, viewMode, updateMode):
        '''
        Arguments:
        -electrodeData - PointerType('WBST_ElectrodeData_t')
        -viewMode - ElectrodeViewMode_t
        -updateMode - WAGUI_UpdateMode_t
        Return type:
        -None
    ...
    def DrawIntraOpNrtTraceCanvas(self, rect, inProgress):
        '''
        Arguments:
        -rect - PointerType("GUI_RECT")
        -inProgress - bool
    ...
    def WAGUI_ShowIntraOpNrtNotWritten(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1014
        '''
        pass

    def DrawIntraOpNrtCurrentLevel(self, currentLvl, stim, inProgress):
        '''
        Arguments:
        -currentLvl - c_int_le
        -stim - bool
    ...
    def DrawIntraOpNrtProgress(self, electrodeData):
        '''
        Arguments:
        -electrodeData - PointerType('WBST_ElectrodeData_t')
        Return type:
    ...
    def DrawIntraOpPrompt(self, bteId, prompt, diagOrNrt):
        '''
        Arguments:
        -bteId - WBST_BteId_t
    ...
    def OverlayPopUpPrompt(self, icon, text):
        '''
        Arguments:
        -icon - WAGUI_P_Res_t
        -text - WAGUI_P_TextId_t
        Return type:
        -None
        Declaration line: 1085
        '''
        pass

    def WAGUI_ShowIntraOpDiagResult(self, bteId, electrodeData, prompt):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -electrodeData - PointerType("WBST_ElectrodeData_t")
        ...
        Return type:
        -None
        Declaration line: 159
        '''
        pass

    def WAGUI_ShowIntraOpNrtNotPossible(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 983
        '''
        pass

    def WAGUI_ShowIntraOpDiagInProgress(self, electrodeData, stopping):
        '''
        Arguments:
        -electrodeData - PointerType('WBST_ElectrodeData_t')
        -stopping - bool
        Return type:
        -None
        Declaration line: 190
        '''
        pass

    def DrawIntraOpFmcEcapProfile(self, electrodeData, ecapProfile, nrtTraceData, stim, inProgress, updateMode):
        '''
        Arguments:
        -electrodeData - PointerType("WBST_ElectrodeData_t")
        -ecapProfile - PointerType('WBST_EcapProfile_t')
    ...
    def WAGUI_ShowIntraOpHome(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAGUI_ShowIntraOpNrtCanceled(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 952
        '''
        pass

    def WAGUI_ShowIntraOpSideSelection(self, selection, selected):
        '''
        Arguments:
        -selection - PointerType('WAGUI_Selection_t')
        -selected - c_int_le
    ...
    def WAGUI_ShowIntraOpNrtResult(self, bteId, viewMode, electrodeData, nrtTraceData, ecapProfile, prompt):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -viewMode - WAGUI_IntraOpNrtMode_t
    ...
    def WAGUI_ShowIntraOpNrtVolumeControlSelection(self, selection, selected):
        '''
        Arguments:
        -selection - PointerType('WAGUI_Selection_t')
        -selected - c_int_le
    ...
    def WAGUI_ShowIntraOpWarning(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAGUI_ShowIntraOpSettingsEntry(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def DrawIntraOpFmcTrace(self, nrtTraceData, inProgress):
        '''
        Arguments:
        -nrtTraceData - PointerType("WBST_NrtTraceData_t")
        -inProgress - bool
    ...
    def DrawIntraOpNrtElNum(self, elNum, inProgress, browsing):
        '''
        Arguments:
        -elNum - c_int_le
        -inProgress - bool
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.WAGUI_ShowIntraOpNrtProgress = StaticFunction(device, 0x4c988, thumb=1, name='WAGUI_ShowIntraOpNrtProgress', return_type=None, size=574, line=737, arg_list=[('fmcState',WBST_Value_t),('updateMode',WAGUI_UpdateMode_t),('viewMode',WAGUI_IntraOpNrtMode_t),('electrodeData',PointerType('WBST_ElectrodeData_t')),('nrtTraceData',PointerType("WBST_NrtTraceData_t")),('ecapProfile',PointerType('WBST_EcapProfile_t')),('stim',bool),('animFrame',u8)])
        self.WAGUI_ShowIntraOpNrtConfirmation = StaticFunction(device, 0x4cc3e, thumb=1, name='WAGUI_ShowIntraOpNrtConfirmation', return_type=None, size=162, line=906, arg_list=[('electrodeData',PointerType("WBST_ElectrodeData_t"))])
        self.DrawIntraOpNrtProfileCanvas = StaticFunction(device, 0x4c378, thumb=1, name='DrawIntraOpNrtProfileCanvas', return_type=None, size=242, line=392, arg_list=[('rect',PointerType('GUI_RECT')),('yel0',c_int_le),('inProgress',bool),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowIntraOpNrtInitInstruction = StaticFunction(device, 0x4c174, thumb=1, name='WAGUI_ShowIntraOpNrtInitInstruction', return_type=None, size=72, line=232, arg_list=[('viewMode',WAGUI_IntraOpNrtMode_t)])
        self.WAGUI_ShowIntraOpNrtPauseSelection = StaticFunction(device, 0x4cbc6, thumb=1, name='WAGUI_ShowIntraOpNrtPauseSelection', return_type=None, size=62, line=870, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le)])
        self.GetElectrodeColor = StaticFunction(device, 0x4c46a, thumb=1, name='GetElectrodeColor', return_type=GUI_COLOR, size=42, line=436, arg_list=[('status',WBST_ElectrodeStatus_t)])
        self.DrawIntraOpElectrodeView = StaticFunction(device, 0x4bf96, thumb=1, name='DrawIntraOpElectrodeView', return_type=None, size=148, line=1099, arg_list=[('electrodeData',PointerType('WBST_ElectrodeData_t')),('viewMode',ElectrodeViewMode_t),('updateMode',WAGUI_UpdateMode_t)])
        self.DrawIntraOpNrtTraceCanvas = StaticFunction(device, 0x4c5f4, thumb=1, name='DrawIntraOpNrtTraceCanvas', return_type=None, size=140, line=555, arg_list=[('rect',PointerType("GUI_RECT")),('inProgress',bool)])
        self.WAGUI_ShowIntraOpNrtNotWritten = StaticFunction(device, 0x4cde6, thumb=1, name='WAGUI_ShowIntraOpNrtNotWritten', return_type=None, size=128, line=1014, arg_list=[])
        self.DrawIntraOpNrtCurrentLevel = StaticFunction(device, 0x4c1bc, thumb=1, name='DrawIntraOpNrtCurrentLevel', return_type=None, size=164, line=267, arg_list=[('currentLvl',c_int_le),('stim',bool),('inProgress',bool)])
        self.DrawIntraOpNrtProgress = StaticFunction(device, 0x4c2fc, thumb=1, name='DrawIntraOpNrtProgress', return_type=None, size=124, line=340, arg_list=[('electrodeData',PointerType('WBST_ElectrodeData_t'))])
        self.DrawIntraOpPrompt = StaticFunction(device, 0x4bed8, thumb=1, name='DrawIntraOpPrompt', return_type=None, size=190, line=115, arg_list=[('bteId',WBST_BteId_t),('prompt',WAGUI_IntraOpPrompt_t),('diagOrNrt',bool)])
        self.OverlayPopUpPrompt = StaticFunction(device, 0x4be8e, thumb=1, name='OverlayPopUpPrompt', return_type=None, size=74, line=1085, arg_list=[('icon',WAGUI_P_Res_t),('text',WAGUI_P_TextId_t)])
        self.WAGUI_ShowIntraOpDiagResult = StaticFunction(device, 0x4c02a, thumb=1, name='WAGUI_ShowIntraOpDiagResult', return_type=None, size=124, line=159, arg_list=[('bteId',WBST_BteId_t),('electrodeData',PointerType("WBST_ElectrodeData_t")),('prompt',WAGUI_IntraOpPrompt_t)])
        self.WAGUI_ShowIntraOpNrtNotPossible = StaticFunction(device, 0x4cd66, thumb=1, name='WAGUI_ShowIntraOpNrtNotPossible', return_type=None, size=128, line=983, arg_list=[])
        self.WAGUI_ShowIntraOpDiagInProgress = StaticFunction(device, 0x4c0a6, thumb=1, name='WAGUI_ShowIntraOpDiagInProgress', return_type=None, size=206, line=190, arg_list=[('electrodeData',PointerType('WBST_ElectrodeData_t')),('stopping',bool)])
        self.DrawIntraOpFmcEcapProfile = StaticFunction(device, 0x4c494, thumb=1, name='DrawIntraOpFmcEcapProfile', return_type=None, size=352, line=464, arg_list=[('electrodeData',PointerType("WBST_ElectrodeData_t")),('ecapProfile',PointerType('WBST_EcapProfile_t')),('nrtTraceData',PointerType("WBST_NrtTraceData_t")),('stim',bool),('inProgress',bool),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowIntraOpHome = StaticFunction(device, 0x4be58, thumb=1, name='WAGUI_ShowIntraOpHome', return_type=None, size=54, line=103, arg_list=[])
        self.WAGUI_ShowIntraOpNrtCanceled = StaticFunction(device, 0x4cce0, thumb=1, name='WAGUI_ShowIntraOpNrtCanceled', return_type=None, size=134, line=952, arg_list=[])
        self.WAGUI_ShowIntraOpSideSelection = StaticFunction(device, 0x4ceb4, thumb=1, name='WAGUI_ShowIntraOpSideSelection', return_type=None, size=56, line=1062, arg_list=[('selection',PointerType('WAGUI_Selection_t')),('selected',c_int_le)])
        self.WAGUI_ShowIntraOpNrtResult = StaticFunction(device, 0x4c85e, thumb=1, name='WAGUI_ShowIntraOpNrtResult', return_type=None, size=298, line=673, arg_list=[('bteId',WBST_BteId_t),('viewMode',WAGUI_IntraOpNrtMode_t),('electrodeData',PointerType("WBST_ElectrodeData_t")),('nrtTraceData',PointerType('WBST_NrtTraceData_t')),('ecapProfile',PointerType("WBST_EcapProfile_t")),('prompt',WAGUI_IntraOpPrompt_t)])
        self.WAGUI_ShowIntraOpNrtVolumeControlSelection = StaticFunction(device, 0x4cc04, thumb=1, name='WAGUI_ShowIntraOpNrtVolumeControlSelection', return_type=None, size=58, line=888, arg_list=[('selection',PointerType('WAGUI_Selection_t')),('selected',c_int_le)])
        self.WAGUI_ShowIntraOpWarning = StaticFunction(device, 0x4be00, thumb=1, name='WAGUI_ShowIntraOpWarning', return_type=None, size=88, line=80, arg_list=[])
        self.WAGUI_ShowIntraOpSettingsEntry = StaticFunction(device, 0x4ce66, thumb=1, name='WAGUI_ShowIntraOpSettingsEntry', return_type=None, size=78, line=1045, arg_list=[])
        self.DrawIntraOpFmcTrace = StaticFunction(device, 0x4c680, thumb=1, name='DrawIntraOpFmcTrace', return_type=None, size=478, line=579, arg_list=[('nrtTraceData',PointerType("WBST_NrtTraceData_t")),('inProgress',bool)])
        self.DrawIntraOpNrtElNum = StaticFunction(device, 0x4c260, thumb=1, name='DrawIntraOpNrtElNum', return_type=None, size=156, line=300, arg_list=[('elNum',c_int_le),('inProgress',bool),('browsing',bool)])
