...
class const():
    ...
    CODE_SUPER_ONE = 149
    CODE_MASCULINE = 150
    CODE_RIGHT_QUOTE = 151
    CODE_ONE_FOURTH = 152
    CODE_ONE_HALF = 153
    CODE_THREE_FOURTH = 154
    CODE_MULTIPLY = 155
    CODE_DIVISION = 156
    CODE_ARROW_LEFT = 157
    CODE_ARROW_RIGHT = 158
    CODE_ARROW_UP = 159
    CODE_ARROW_DOWN = 160
    CODE_ENTER = 161
    CODE_CHECKMARK = 162
...
class Code(AbstractCode):
    ...
    GUI_F6x8_TL8859_1 = GUI_FONT_TRANSLIST * 112
    GUI_Font6x8 = GUI_FONT
    GUI_F6x8_Mono = GUI_FONT_MONO
    GUI_XBF_APIList_Prop_Ext = tGUI_XBF_APIList
    GUI_F6x8_TI8859_1 = GUI_FONT_TRANSINFO
    GUI_MEMDEV__APIList16 = tLCDDEV_APIList_struct
    GUI_acFont6x8 = c_ubyte * 8 * 163
    ...
    def __init__(self, device):
        ...
        self.GUI_F6x8_TL8859_1 = StaticVariable(device, GUI_FONT_TRANSLIST * 112, 0x617d4, True)
        self.GUI_Font6x8 = StaticVariable(device, self.GUI_FONT, 0x619b0, True)
        self.GUI_F6x8_Mono = StaticVariable(device, self.GUI_FONT_MONO, 0x6199c, True)
        self.GUI_XBF_APIList_Prop_Ext = StaticVariable(device, self.tGUI_XBF_APIList, 0x61c08, True)
        self.GUI_F6x8_TI8859_1 = StaticVariable(device, self.GUI_FONT_TRANSINFO, 0x61994, True)
        self.GUI_MEMDEV__APIList16 = StaticVariable(device, self.tLCDDEV_APIList_struct, 0x61b4c, True)
        self.GUI_acFont6x8 = StaticVariable(device, c_ubyte * 8 * 163, 0x612bc, True)
