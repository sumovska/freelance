...
class Code(AbstractCode):
    ...
    def GUI_UC_SetEncodeUTF8(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 149
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self._API_Table = StaticVariable(device, self.GUI_UC_ENC_APILIST, 0x61c28, True)
        ...
        ### Functions data ###
        ######################
        self._GetCharCode = StaticFunction(device, 0x312f8, thumb=1, name='_GetCharCode', return_type=c_ushort_le, size=4, line=36, arg_list=[('s',PointerType("c_byte"))])
        self._Encode = StaticFunction(device, 0x31366, thumb=1, name='_Encode', return_type=c_int_le, size=6, line=107, arg_list=[('s',PointerType('c_byte')),('Char',c_ushort_le)])
        self._CalcSizeOfChar = StaticFunction(device, 0x31352, thumb=1, name='_CalcSizeOfChar', return_type=c_int_le, size=4, line=88, arg_list=[('Char',c_ushort_le)])
        self._GetCharSize = StaticFunction(device, 0x31334, thumb=1, name='_GetCharSize', return_type=c_int_le, size=4, line=68, arg_list=[('s',PointerType("c_byte"))])
        self.GUI_UC_SetEncodeUTF8 = StaticFunction(device, 0x313b2, thumb=1, name='GUI_UC_SetEncodeUTF8', return_type=None, size=8, line=149, arg_list=[])
