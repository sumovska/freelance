...
class Code(AbstractCode):
    ...
    def LCD_UpdateColorIndices(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_UpdateColorIndices = StaticFunction(device, 0x2cd84, thumb=1, name='LCD_UpdateColorIndices', return_type=None, size=30, line=33, arg_list=[])
