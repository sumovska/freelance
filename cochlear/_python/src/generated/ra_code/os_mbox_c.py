...
class Code(AbstractCode):
    ...
    def OSMboxDel(self, pevent, opt, err):
        '''
        Arguments:
    ...
    def OSMboxQuery(self, pevent, p_mbox_data):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -p_mbox_data - PointerType("OS_MBOX_DATA")
        Return type:
        -INT8U
    ...
    def OSMboxPend(self, pevent, timeout, err):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -timeout - INT16U
    ...
    def OSMboxPost(self, pevent, msg):
        '''
        Arguments:
        -pevent - PointerType("OS_EVENT")
    ...
    def OSMboxPostOpt(self, pevent, msg, opt):
        '''
        Arguments:
        -pevent - PointerType("OS_EVENT")
        -msg - PointerType('void')
        ...
        Return type:
        -INT8U
        Declaration line: 523
        '''
        pass

    def OSMboxPendAbort(self, pevent, opt, err):
        '''
        Arguments:
        -pevent - PointerType("OS_EVENT")
        -opt - INT8U
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.OSMboxDel = StaticFunction(device, 0x2914e, thumb=1, name='OSMboxDel', return_type=PointerType("OS_EVENT"), size=178, line=156, arg_list=[('pevent',PointerType("OS_EVENT")),('opt',INT8U),('err',PointerType('INT8U'))])
        self.OSMboxQuery = StaticFunction(device, 0x293e4, thumb=1, name='OSMboxQuery', return_type=INT8U, size=62, line=587, arg_list=[('pevent',PointerType('OS_EVENT')),('p_mbox_data',PointerType("OS_MBOX_DATA"))])
        self.OSMboxAccept = StaticFunction(device, 0x290e8, thumb=1, name='OSMboxAccept', return_type=PointerType("void"), size=36, line=47, arg_list=[('pevent',PointerType('OS_EVENT'))])
        self.OSMboxPend = StaticFunction(device, 0x29200, thumb=1, name='OSMboxPend', return_type=PointerType('void'), size=182, line=274, arg_list=[('pevent',PointerType('OS_EVENT')),('timeout',INT16U),('err',PointerType("INT8U"))])
        self.OSMboxPost = StaticFunction(device, 0x29326, thumb=1, name='OSMboxPost', return_type=INT8U, size=80, line=452, arg_list=[('pevent',PointerType("OS_EVENT")),('msg',PointerType('void'))])
        self.OSMboxPostOpt = StaticFunction(device, 0x29376, thumb=1, name='OSMboxPostOpt', return_type=INT8U, size=110, line=523, arg_list=[('pevent',PointerType("OS_EVENT")),('msg',PointerType('void')),('opt',INT8U)])
        self.OSMboxPendAbort = StaticFunction(device, 0x292b6, thumb=1, name='OSMboxPendAbort', return_type=INT8U, size=112, line=378, arg_list=[('pevent',PointerType("OS_EVENT")),('opt',INT8U),('err',PointerType('INT8U'))])
        self.OSMboxCreate = StaticFunction(device, 0x2910c, thumb=1, name='OSMboxCreate', return_type=PointerType('OS_EVENT'), size=66, line=88, arg_list=[('msg',PointerType("void"))])
