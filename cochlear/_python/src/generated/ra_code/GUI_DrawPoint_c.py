...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GL_DrawPoint = StaticFunction(device, 0x2f1e4, thumb=1, name='GL_DrawPoint', return_type=None, size=42, line=28, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.GUI_DrawPoint = StaticFunction(device, 0x2f20e, thumb=1, name='GUI_DrawPoint', return_type=None, size=42, line=40, arg_list=[('x',c_int_le),('y',c_int_le)])
