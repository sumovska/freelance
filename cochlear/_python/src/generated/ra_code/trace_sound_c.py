...
class Code(AbstractCode):
    ...
    def TRACE_sound(self, sound, times):
        '''
        Arguments:
        -sound - PointerType('DAUDIO_SoundID_t')
        -times - PointerType("u8")
        Return type:
        -None
        Declaration line: 59
        '''
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.TRACE_sound = StaticFunction(device, 0x51220, thumb=1, name='TRACE_sound', return_type=None, size=42, line=59, arg_list=[('sound',PointerType('DAUDIO_SoundID_t')),('times',PointerType("u8"))])
