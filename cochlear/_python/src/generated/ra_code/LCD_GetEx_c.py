...
class Code(AbstractCode):
    ...
    def LCD_GetSwapXYEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetNumColorsEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetXMagEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
        -c_int_le
        Declaration line: 323
        '''
        pass

    def GUI_GetpfIndex2ColorEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetVYSizeEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetMirrorYEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
        -c_int_le
        Declaration line: 431
        '''
        pass

    def LCD_GetDeltaModeEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
        -c_int_le
        Declaration line: 539
        '''
        pass

    def LCD_GetYSizeEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetBitsPerPixelEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
        -c_int_le
        Declaration line: 179
        '''
        pass

    def LCD_GetFixedPaletteEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetXSizeEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetMirrorXEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetSwapRBEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
        -c_int_le
        Declaration line: 503
        '''
        pass

    def LCD_GetYMagEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
        -c_int_le
        Declaration line: 287
        '''
        pass

    def LCD_GetVXSizeEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetpfColor2IndexEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
        -PointerType("tLCDDEV_Color2Index")
        Declaration line: 631
        '''
        pass

    def GUI_GetpfColor2IndexEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetpfIndex2ColorEx(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def LCD_GetBitsPerPixel_L0Ex(self, LayerIndex):
        '''
        Arguments:
        -LayerIndex - c_int_le
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_GetSwapXYEx = StaticFunction(device, 0x2d43a, thumb=1, name='LCD_GetSwapXYEx', return_type=c_int_le, size=4, line=467, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetNumColorsEx = StaticFunction(device, 0x2d3f0, thumb=1, name='LCD_GetNumColorsEx', return_type=c_ulong_le, size=14, line=251, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetXMagEx = StaticFunction(device, 0x2d40a, thumb=1, name='LCD_GetXMagEx', return_type=c_int_le, size=12, line=323, arg_list=[('LayerIndex',c_int_le)])
        self.GUI_GetpfIndex2ColorEx = StaticFunction(device, 0x2d466, thumb=1, name='GUI_GetpfIndex2ColorEx', return_type=PointerType('tLCDDEV_Index2Color'), size=46, line=611, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetVYSizeEx = StaticFunction(device, 0x2d3cc, thumb=1, name='LCD_GetVYSizeEx', return_type=c_int_le, size=12, line=143, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetMirrorYEx = StaticFunction(device, 0x2d42e, thumb=1, name='LCD_GetMirrorYEx', return_type=c_int_le, size=12, line=431, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetDeltaModeEx = StaticFunction(device, 0x2d44a, thumb=1, name='LCD_GetDeltaModeEx', return_type=c_int_le, size=4, line=539, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetYSizeEx = StaticFunction(device, 0x2d3b4, thumb=1, name='LCD_GetYSizeEx', return_type=c_int_le, size=12, line=71, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetBitsPerPixelEx = StaticFunction(device, 0x2d3d8, thumb=1, name='LCD_GetBitsPerPixelEx', return_type=c_int_le, size=12, line=179, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetFixedPaletteEx = StaticFunction(device, 0x2d416, thumb=1, name='LCD_GetFixedPaletteEx', return_type=c_long_le, size=12, line=359, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetXSizeEx = StaticFunction(device, 0x2d3a8, thumb=1, name='LCD_GetXSizeEx', return_type=c_int_le, size=12, line=35, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetMirrorXEx = StaticFunction(device, 0x2d422, thumb=1, name='LCD_GetMirrorXEx', return_type=c_int_le, size=12, line=395, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetSwapRBEx = StaticFunction(device, 0x2d43e, thumb=1, name='LCD_GetSwapRBEx', return_type=c_int_le, size=12, line=503, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetYMagEx = StaticFunction(device, 0x2d3fe, thumb=1, name='LCD_GetYMagEx', return_type=c_int_le, size=12, line=287, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetVXSizeEx = StaticFunction(device, 0x2d3c0, thumb=1, name='LCD_GetVXSizeEx', return_type=c_int_le, size=12, line=107, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetpfColor2IndexEx = StaticFunction(device, 0x2d494, thumb=1, name='LCD_GetpfColor2IndexEx', return_type=PointerType("tLCDDEV_Color2Index"), size=24, line=631, arg_list=[('LayerIndex',c_int_le)])
        self.GUI_GetpfColor2IndexEx = StaticFunction(device, 0x2d4ac, thumb=1, name='GUI_GetpfColor2IndexEx', return_type=PointerType('tLCDDEV_Color2Index'), size=46, line=667, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetpfIndex2ColorEx = StaticFunction(device, 0x2d44e, thumb=1, name='LCD_GetpfIndex2ColorEx', return_type=PointerType("tLCDDEV_Index2Color"), size=24, line=575, arg_list=[('LayerIndex',c_int_le)])
        self.LCD_GetBitsPerPixel_L0Ex = StaticFunction(device, 0x2d3e4, thumb=1, name='LCD_GetBitsPerPixel_L0Ex', return_type=c_int_le, size=12, line=215, arg_list=[('LayerIndex',c_int_le)])
