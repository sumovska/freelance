...
class Code(AbstractCode):
    ...
    def GUI_UC__GetCharCodeInc(self, ps):
        '''
        Arguments:
        -ps - PointerType('PointerType("c_byte")')
        Return type:
        -c_ushort_le
        Declaration line: 99
        '''
    ...
    def GUI_UC__NumBytes2NumChars(self, s, NumBytes):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -NumBytes - c_int_le
    ...
    def GUI_UC__CalcSizeOfChar(self, Char):
        '''
        Arguments:
        -Char - c_ushort_le
        Return type:
    ...
    def GUI_UC__NumChars2NumBytes(self, s, NumChars):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -NumChars - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_UC_GetCharSize = StaticFunction(device, 0x2cfc0, thumb=1, name='GUI_UC_GetCharSize', return_type=c_int_le, size=8, line=32, arg_list=[('s',PointerType("c_byte"))])
        self.GUI_UC__GetCharCodeInc = StaticFunction(device, 0x2cfe0, thumb=1, name='GUI_UC__GetCharCodeInc', return_type=c_ushort_le, size=42, line=99, arg_list=[('ps',PointerType('PointerType("c_byte")'))])
        self.GUI_UC_GetCharCode = StaticFunction(device, 0x2cfc8, thumb=1, name='GUI_UC_GetCharCode', return_type=c_ushort_le, size=8, line=48, arg_list=[('s',PointerType("c_byte"))])
        self.GUI_UC__NumBytes2NumChars = StaticFunction(device, 0x2d034, thumb=1, name='GUI_UC__NumBytes2NumChars', return_type=c_int_le, size=42, line=135, arg_list=[('s',PointerType('c_byte')),('NumBytes',c_int_le)])
        self.GUI_UC_Encode = StaticFunction(device, 0x2cfd0, thumb=1, name='GUI_UC_Encode', return_type=c_int_le, size=8, line=64, arg_list=[('s',PointerType("c_byte")),('Char',c_ushort_le)])
        self.GUI_UC__CalcSizeOfChar = StaticFunction(device, 0x2cfd8, thumb=1, name='GUI_UC__CalcSizeOfChar', return_type=c_int_le, size=8, line=87, arg_list=[('Char',c_ushort_le)])
        self.GUI_UC__NumChars2NumBytes = StaticFunction(device, 0x2d00a, thumb=1, name='GUI_UC__NumChars2NumBytes', return_type=c_int_le, size=42, line=117, arg_list=[('s',PointerType('c_byte')),('NumChars',c_int_le)])
