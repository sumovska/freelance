...
class Code(AbstractCode):
    ...
    def GUI_DrawRect(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_DrawRect = StaticFunction(device, 0x2b58c, thumb=1, name='GUI_DrawRect', return_type=None, size=50, line=84, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.GL_MoveTo = StaticFunction(device, 0x2b57c, thumb=1, name='GL_MoveTo', return_type=None, size=8, line=45, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.GUI_MoveTo = StaticFunction(device, 0x2b584, thumb=1, name='GUI_MoveTo', return_type=None, size=8, line=54, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.GUI_MoveRel = StaticFunction(device, 0x2b56c, thumb=1, name='GUI_MoveRel', return_type=None, size=16, line=34, arg_list=[('dx',c_int_le),('dy',c_int_le)])
