...
class BLM_CmdState_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    BLM_NO_CMD = 0
    BLM_CMD_RECEIVED = 1
    BLM_REQ_PROCESSING = 2
    BLM_WAITING_RESP = 3
    BLM_RESP_PROCESSING = 4
    BLM_CMD_COMPLETED = 5
...
class BLM_IdlcState_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    BLM_DISCONNECTED = 0
    BLM_CONNECTING = 1
    BLM_CONNECTED = 2
...
BLM_IdlcState_t = BLM_IdlcState_tag
...
BLM_CmdState_t = BLM_CmdState_tag
...
class BLM_IdlcCommand_tag(Structure):
    vSend = u32
    vReceive = u32
    idlcState = BLM_IdlcState_t
    retransCo = u8
    retransTimeout = u16
    _pack_ = 1
    _fields_ = [
...
class BLM_Timers_tag(Structure):
    cipTmr = bool
    idlcTmr = bool
    _pack_ = 1
    _fields_ = [
...
class BLM_CipCommand_tag(Structure):
    bteId = BLM_BteId_t
    cmdState = BLM_CmdState_t
...
BLM_CipCommand_t = BLM_CipCommand_tag
...
BLM_IdlcCommand_t = BLM_IdlcCommand_tag
OS_Q = os_q
...
class BlmIntMaxEventPayload_tag(Union):
...
BlmIntMaxEventPayload_t = BlmIntMaxEventPayload_tag
class BlmMaxEventPayload_tag(Union):
    evUnpairingReq = BLM_UnpairingReq_t
    evResetReq = BLM_ResetPairReq_t
    evPairingAck = WDLP_PairAck_t
    evUnpairingAck = WDLP_UnpairAck_t
    evCancelAck = WDLP_CancelAck_t
    evResetAck = WDLP_ResetPairAck_t
    evPktSendAck = WDLP_PktSendAck_t
    evSysPrgAck = WDLP_SysPrgAck_t
    evDataPktReq = VCH_DataPktReq_t
    _fields_ = [
                ('evUnpairingReq', BLM_UnpairingReq_t),
                ('evResetReq', BLM_ResetPairReq_t),
...
BlmMaxEventPayload_t = BlmMaxEventPayload_tag
...
class const():
    ...
    PERF_TEST_LVL = 0
    IDLC_FLAG_SEQUENCE = 126
    IDLC_CONTROL_ESCAPE = 125
    IDLC_TRANSPARENCY_COMPLEMENT = 2
    IDLC_SNRM_CMD = 147
    IDLC_DISC_CMD = 83
    IDLC_TEST_CMD = 243
    IDLC_INFO_CMD = 16
    IDLC_INFO_OFF_CMD = 0
    IDLC_UNNUMBERED_FRAME = 19
    IDLC_UA_CMD = 115
    IDLC_DM_CMD = 31
    IDLC_UA_OFF_CMD = 99
    IDLC_DM_OFF_CMD = 15
    IDLC_TEST_OFF_CMD = 227
    IDLC_MAX_I_FRAME_INFO_FIELD_LENGTH = 64
    IDLC_MIN_FRAME_LENGTH = 5
    IDLC_I_FRAME_COUNTER = 8
    IDLC_MAX_FCS_LENGTH = 2
    IDLC_MAX_FLAG_LENGTH = 1
    IDLC_MAX_CTRL_LENGTH = 1
    IDLC_NR_MASK = 224
    IDLC_NS_MASK = 14
    IDLC_NR_SHIFT = 5
    IDLC_NS_SHIFT = 1
    IDLC_OPEN_FLAG_IDX = 0
    IDLC_CTRL_IDX = 1
    IDLC_DATA_IDX = 2
    CIP_CMD_IDX = 0
    CIP_LENGTH_IDX = 1
    ...
    BLM_QUEUE_SIZE = 5
    BLM_MAX_FRAME_RETRANSMISSION = 2
    BLM_MAX_SYS_PRG_RETRANSMISSION = 2
    BLM_LINK_ESTABLISH_TIMEOUT = 2560
    BLM_LINK_DISC_TIMEOUT = 2560
    BLM_MIN_LINK_DISC_TIMEOUT = 40
    BLM_MAX_LINK_DISC_TIMEOUT = 240
    BLM_SNRM_RETRANSMIT_TIMEOUT = 853
    BLM_FRAME_RETRANSMIT_TIMEOUT = 853
    BLM_CIP_TIMEOUT = 7
    BLM_Q_RCV_TIMEOUT = 300
    BLM_INT_QUEUE_SIZE = 5
    DUART_ON = 1
...
class Code(AbstractCode):
    ...
    ### Enums ###
    #############
    BLM_CmdState_tag = BLM_CmdState_tag
    ...
    BLM_IdlcState_tag = BLM_IdlcState_tag
    ...
    BLM_IdlcState_t = BLM_IdlcState_t
    ...
    os_sem_data = os_sem_data
    os_flag_grp = os_flag_grp
    BLM_IdlcCommand_tag = BLM_IdlcCommand_tag
    os_tcb = os_tcb
    os_mbox_data = os_mbox_data
    ...
    BLM_CipCommand_t = BLM_CipCommand_t
    OS_MBOX_DATA = OS_MBOX_DATA
    OS_FLAG_NODE = OS_FLAG_NODE
    ...
    BLM_IdlcCommand_t = BLM_IdlcCommand_t
    OS_Q = OS_Q
    ...
    BlmIntMaxEventPayload_tag = BlmIntMaxEventPayload_tag
    ...
    BlmIntMaxEventPayload_t = BlmIntMaxEventPayload_t
    BlmMaxEventPayload_tag = BlmMaxEventPayload_tag
    BlmMaxEventPayload_t = BlmMaxEventPayload_t

    #################
    ### Functions ###
    #################

    def BLM_P_CreateVchErrorResponse(self, statusCode, pDataPktRes):
        '''
        Arguments:
        -statusCode - BLM_Status_t
    ...
    def BLM_P_StartTimers(self, tmr):
        '''
        Arguments:
        -tmr - BLM_Timers_t
        Return type:
        -BLM_Status_t
        Declaration line: 808
        '''
        pass

    def BLM_P_ProcessIdlcPktRequest(self, pPayload, pTmrStatus):
        '''
        Arguments:
        -pPayload - PointerType('byte')
        -pTmrStatus - PointerType("BLM_Timers_t")
        Return type:
        -BLM_Status_t
        Declaration line: 372
        '''
        pass

    def BLM_P_ParseIdlcInformationFrame(self, pData, length, pRetransmit):
        '''
        Arguments:
        -pData - PointerType('byte')
        -length - u16
        -pRetransmit - PointerType("bool")
        Return type:
        -BLM_Status_t
        Declaration line: 1216
        '''
        pass

    def BLM_P_CreateDataPktResponse(self, pDataPktRes):
        '''
        Arguments:
        -pDataPktRes - PointerType('VCH_DataPktRes_t')
        Return type:
    ...
    def BLM_P_CreateIdlcUnnumberedFrame(self, control, pPayload):
        '''
        Arguments:
        -control - u8
        -pPayload - PointerType("byte")
        Return type:
        -BLM_Status_t
        Declaration line: 1069
        '''
        pass

    def BLM_P_RemoveTransparency(self, pPayload, pLength):
        '''
        Arguments:
        -pPayload - PointerType('byte')
        ...
        Return type:
        -None
        Declaration line: 1045
        '''
        pass

    def BLM_P_ProcessCmdResponse(self, pRes, pDataPktRes):
        '''
        Arguments:
        -pRes - PointerType('WDLP_CmdSendAck_t')
        -pDataPktRes - PointerType("VCH_DataPktRes_t")
        Return type:
        -BLM_Status_t
        Declaration line: 1414
        '''
        pass

    def BLM_P_RetransmitIdlcFrame(self, ):
        '''
        Arguments:
        Return type:
        -BLM_Status_t
    ...
    def BLM_P_CreateSysPrgRequest(self, bteId, pSysPrgReq):
        '''
        Arguments:
        -bteId - BLM_BteId_t
    ...
    def BLM_P_ClearCurrentCmd(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 786
        '''
        pass

    def BLM_P_CalculateTimeout(self, tmrVal):
        '''
        Arguments:
        -tmrVal - u8
        Return type:
        -u16
        Declaration line: 1369
        '''
        pass

    def BLM_P_CreatePktSendRequest(self, pData, pPktSendReq):
        '''
        Arguments:
        -pData - PointerType("byte")
    ...
    def BLM_P_CreateCmdSendRequest(self, bteId, pData, pCmdSendReq, timeout):
        '''
        Arguments:
        -bteId - BLM_BteId_t
        -pData - PointerType("byte")
        -pCmdSendReq - PointerType('WDLP_CmdSendReq_t')
        -timeout - u16
        Return type:
        -BLM_Status_t
        Declaration line: 1388
        '''
        pass

    def BLM_P_ConvertToSystemError(self, errorId):
        '''
        Arguments:
        -errorId - WDLP_Status_t
        Return type:
        -BLM_Status_t
    ...
    def BLM_P_ConvertSystemToVchBte(self, bteId, pValue):
        '''
        Arguments:
        -bteId - BLM_BteId_t
        -pValue - PointerType("VCH_OriginatorId_t")
        Return type:
        -BLM_Status_t
    ...
    def BLM_P_ConvertWdlpToSystemBte(self, bteId, pValue):
        '''
        Arguments:
        -bteId - INT_Bte_t
        -pValue - PointerType('BLM_BteId_t')
        Return type:
        -BLM_Status_t
    ...
    def BLM_P_CalculateFCS16(self, fcs, pBuffer, len):
        '''
        Arguments:
        -fcs - u16
        -pBuffer - PointerType("byte")
        -len - u32
        Return type:
        -u16
        Declaration line: 1006
        '''
        pass

    def BLM_P_ConvertVchToSystemBte(self, bteId, pValue):
        '''
        Arguments:
        -bteId - VCH_OriginatorId_t
        -pValue - PointerType('BLM_BteId_t')
        Return type:
        -BLM_Status_t
    ...
    def BLM_P_InsertTransparency(self, pPayload, length):
        '''
        Arguments:
        -pPayload - PointerType("byte")
        -length - u16
        Return type:
        -None
        Declaration line: 1019
        '''
        pass

    def BLM_P_ConvertSystemToWdlpBte(self, bteId, pValue):
        '''
        Arguments:
        -bteId - BLM_BteId_t
        -pValue - PointerType('INT_Bte_t')
        Return type:
        -BLM_Status_t
        Declaration line: 982
        '''
        pass

    def BLM_P_CreateIdlcInformationFrame(self, pPayload, isRetransmission):
        '''
        Arguments:
        -pPayload - PointerType("byte")
        ...
        Return type:
        -BLM_Status_t
        Declaration line: 1104
        '''
        pass

    def BLM_P_ProcessIdlcPktResponse(self, pData):
        '''
        Arguments:
        -pData - PointerType('byte')
        Return type:
    ...
    def BLM_P_CreatePairingResponse(self, pEventData, pPairingRes):
        '''
        Arguments:
        -pEventData - PointerType("WDLP_PairAck_t")
        -pPairingRes - PointerType('BLM_PairingRes_t')
        Return type:
        -BLM_Status_t
    ...
    def BLM_P_CreateUnpairingRequest(self, pEventData, pUnpairReq):
        '''
        Arguments:
        -pEventData - PointerType("BLM_UnpairingReq_t")
        -pUnpairReq - PointerType('WDLP_UnpairReq_t')
        Return type:
        -BLM_Status_t
        Declaration line: 269
        '''
        pass
    ...
    OSIdleCtr = INT32U
    blmRetransmissionTimeout = u16
    OSCtxSwCtr = INT32U
    OSRunning = BOOLEAN
    OSTaskCtr = INT8U
    blmCipTmrCfg = ITC_TimerResult_t
    OSTmrTime = INT32U
    ...
    blmFcsTab = u16 * 256
    blmIdlcTmrCfg = ITC_TimerResult_t
    OSTaskIdleStk = OS_STK * 128
    OSTickStepState = INT8U
    OSPrioCur = INT8U
    blmCurrentCmd = BLM_CipCommand_t
    OSIntNesting = INT8U
    OSTCBPrioTbl = PointerType("OS_TCB") * 61
    OSTmrFree = INT16U
    OSTCBList = PointerType('OS_TCB')
    OSTmrSemSignal = PointerType("OS_EVENT")
    blmIdlcCmd = BLM_IdlcCommand_t
    blmAreTimersInitialized = bool
    OSTime = INT32U
    blmIdlcTmr = PointerType('OS_TMR')
    OSRdyTbl = INT8U * 8
    OSTCBHighRdy = PointerType("OS_TCB")
    blmCipTmr = PointerType('OS_TMR')
    ...
    def __init__(self, device):
        ...
        self.blmRetransmissionTimeout = StaticVariable(device, self.u16, 0x81008032L, False)
        ...
        self.blmCipTmrCfg = StaticVariable(device, self.ITC_TimerResult_t, 0x81008044L, False)
        ...
        self.blmIsClinical = StaticVariable(device, self.bool, 0x81008030L, False)
        ...
        self.blmRoData = StaticVariable(device, self.BLM_NVM_RO_t, 0x810094a4L, False)
        ...
        self.blmFcsTab = StaticVariable(device, u16 * 256, 0x81008054L, False)
        self.blmIdlcTmrCfg = StaticVariable(device, self.ITC_TimerResult_t, 0x8100804cL, False)
        ...
        self.blmCurrentCmd = StaticVariable(device, self.BLM_CipCommand_t, 0x8100948cL, False)
        ...
        self.blmIdlcCmd = StaticVariable(device, self.BLM_IdlcCommand_t, 0x81009480L, False)
        self.blmAreTimersInitialized = StaticVariable(device, self.bool, 0x81008031L, False)
        self.OSTime = StaticVariable(device, self.INT32U, 0x40000068, False)
        self.blmIdlcTmr = StaticVariable(device, PointerType('OS_TMR'), 0x8100803cL, False)
        ...
        self.blmCipTmr = StaticVariable(device, PointerType('OS_TMR'), 0x81008038L, False)
        ...
        ### Functions data ###
        ######################
        self.BLM_P_CreateVchErrorResponse = StaticFunction(device, 0x5257c, thumb=1, name='BLM_P_CreateVchErrorResponse', return_type=BLM_Status_t, size=54, line=1475, arg_list=[('statusCode',BLM_Status_t),('pDataPktRes',PointerType("VCH_DataPktRes_t"))])
        self.BLM_P_StartTimers = StaticFunction(device, 0x52502, thumb=1, name='BLM_P_StartTimers', return_type=BLM_Status_t, size=70, line=808, arg_list=[('tmr',BLM_Timers_t)])
        self.BLM_P_ProcessIdlcPktRequest = StaticFunction(device, 0x5200e, thumb=1, name='BLM_P_ProcessIdlcPktRequest', return_type=BLM_Status_t, size=194, line=372, arg_list=[('pPayload',PointerType('byte')),('pTmrStatus',PointerType("BLM_Timers_t"))])
        self.BLM_P_ParseIdlcInformationFrame = StaticFunction(device, 0x52182, thumb=1, name='BLM_P_ParseIdlcInformationFrame', return_type=BLM_Status_t, size=296, line=1216, arg_list=[('pData',PointerType('byte')),('length',u16),('pRetransmit',PointerType("bool"))])
        self.BLM_P_CreateDataPktResponse = StaticFunction(device, 0x51e40, thumb=1, name='BLM_P_CreateDataPktResponse', return_type=BLM_Status_t, size=18, line=314, arg_list=[('pDataPktRes',PointerType('VCH_DataPktRes_t'))])
        self.BLM_P_CreateIdlcUnnumberedFrame = StaticFunction(device, 0x51ece, thumb=1, name='BLM_P_CreateIdlcUnnumberedFrame', return_type=BLM_Status_t, size=80, line=1069, arg_list=[('control',u8),('pPayload',PointerType("byte"))])
        self.BLM_P_RemoveTransparency = StaticFunction(device, 0x522d2, thumb=1, name='BLM_P_RemoveTransparency', return_type=None, size=64, line=1045, arg_list=[('pPayload',PointerType('byte')),('pLength',PointerType("u16"))])
        self.BLM_P_ProcessCmdResponse = StaticFunction(device, 0x525b2, thumb=1, name='BLM_P_ProcessCmdResponse', return_type=BLM_Status_t, size=176, line=1414, arg_list=[('pRes',PointerType('WDLP_CmdSendAck_t')),('pDataPktRes',PointerType("VCH_DataPktRes_t"))])
        self.BLM_P_RetransmitIdlcFrame = StaticFunction(device, 0x520f0, thumb=1, name='BLM_P_RetransmitIdlcFrame', return_type=BLM_Status_t, size=146, line=845, arg_list=[])
        self.BLM_P_CreateSysPrgRequest = StaticFunction(device, 0x51e52, thumb=1, name='BLM_P_CreateSysPrgRequest', return_type=BLM_Status_t, size=26, line=341, arg_list=[('bteId',BLM_BteId_t),('pSysPrgReq',PointerType('WDLP_SysPrgReq_t'))])
        self.BLM_P_ClearCurrentCmd = StaticFunction(device, 0x520d0, thumb=1, name='BLM_P_ClearCurrentCmd', return_type=None, size=32, line=786, arg_list=[])
        self.BLM_P_CalculateTimeout = StaticFunction(device, 0x522aa, thumb=1, name='BLM_P_CalculateTimeout', return_type=u16, size=40, line=1369, arg_list=[('tmrVal',u8)])
        self.BLM_P_CreatePktSendRequest = StaticFunction(device, 0x51e0a, thumb=1, name='BLM_P_CreatePktSendRequest', return_type=BLM_Status_t, size=28, line=293, arg_list=[('pData',PointerType("byte")),('pPktSendReq',PointerType('WDLP_PktSendReq_t'))])
        self.BLM_P_CreateCmdSendRequest = StaticFunction(device, 0x52548, thumb=1, name='BLM_P_CreateCmdSendRequest', return_type=BLM_Status_t, size=52, line=1388, arg_list=[('bteId',BLM_BteId_t),('pData',PointerType("byte")),('pCmdSendReq',PointerType('WDLP_CmdSendReq_t')),('timeout',u16)])
        self.BLM_P_ConvertToSystemError = StaticFunction(device, 0x51d9e, thumb=1, name='BLM_P_ConvertToSystemError', return_type=BLM_Status_t, size=36, line=196, arg_list=[('errorId',WDLP_Status_t)])
        self.BLM_P_ConvertSystemToVchBte = StaticFunction(device, 0x51e26, thumb=1, name='BLM_P_ConvertSystemToVchBte', return_type=BLM_Status_t, size=26, line=961, arg_list=[('bteId',BLM_BteId_t),('pValue',PointerType("VCH_OriginatorId_t"))])
        self.BLM_P_ConvertWdlpToSystemBte = StaticFunction(device, 0x51d82, thumb=1, name='BLM_P_ConvertWdlpToSystemBte', return_type=BLM_Status_t, size=28, line=166, arg_list=[('bteId',INT_Bte_t),('pValue',PointerType('BLM_BteId_t'))])
        self.BLM_P_CalculateFCS16 = StaticFunction(device, 0x51eb2, thumb=1, name='BLM_P_CalculateFCS16', return_type=u16, size=28, line=1006, arg_list=[('fcs',u16),('pBuffer',PointerType("byte")),('len',u32)])
        self.BLM_P_ConvertVchToSystemBte = StaticFunction(device, 0x51d68, thumb=1, name='BLM_P_ConvertVchToSystemBte', return_type=BLM_Status_t, size=26, line=135, arg_list=[('bteId',VCH_OriginatorId_t),('pValue',PointerType('BLM_BteId_t'))])
        self.BLM_P_InsertTransparency = StaticFunction(device, 0x51e6c, thumb=1, name='BLM_P_InsertTransparency', return_type=None, size=70, line=1019, arg_list=[('pPayload',PointerType("byte")),('length',u16)])
        self.BLM_P_ConvertSystemToWdlpBte = StaticFunction(device, 0x51de0, thumb=1, name='BLM_P_ConvertSystemToWdlpBte', return_type=BLM_Status_t, size=38, line=982, arg_list=[('bteId',BLM_BteId_t),('pValue',PointerType('INT_Bte_t'))])
        self.BLM_P_CreateIdlcInformationFrame = StaticFunction(device, 0x51f1e, thumb=1, name='BLM_P_CreateIdlcInformationFrame', return_type=BLM_Status_t, size=240, line=1104, arg_list=[('pPayload',PointerType("byte")),('isRetransmission',bool)])
        self.BLM_P_ProcessIdlcPktResponse = StaticFunction(device, 0x52312, thumb=1, name='BLM_P_ProcessIdlcPktResponse', return_type=BLM_Status_t, size=496, line=513, arg_list=[('pData',PointerType('byte'))])
        self.BLM_P_CreatePairingResponse = StaticFunction(device, 0x51dc2, thumb=1, name='BLM_P_CreatePairingResponse', return_type=BLM_Status_t, size=30, line=237, arg_list=[('pEventData',PointerType("WDLP_PairAck_t")),('pPairingRes',PointerType('BLM_PairingRes_t'))])
        self.BLM_P_CreateUnpairingRequest = StaticFunction(device, 0x51e06, thumb=1, name='BLM_P_CreateUnpairingRequest', return_type=BLM_Status_t, size=4, line=269, arg_list=[('pEventData',PointerType("BLM_UnpairingReq_t")),('pUnpairReq',PointerType('WDLP_UnpairReq_t'))])
