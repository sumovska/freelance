...
class Code(AbstractCode):
    ...
    def GUI__GetLineNumChars(self, s, MaxNumChars):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -MaxNumChars - c_int_le
        Return type:
        -c_int_le
        Declaration line: 73
        '''
    ...
    def GUI__DispLine(self, s, MaxNumChars, pr):
        '''
        Arguments:
        -s - PointerType("c_byte")
        -MaxNumChars - c_int_le
        -pr - PointerType('GUI_RECT')
        Return type:
        -None
    ...
    def GUI__GetLineDistX(self, s, MaxNumChars):
        '''
        Arguments:
        -s - PointerType("c_byte")
        -MaxNumChars - c_int_le
    ...
    def _DispLine(self, s, MaxNumChars, pRect):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -MaxNumChars - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI__GetLineNumChars = StaticFunction(device, 0x2cb84, thumb=1, name='GUI__GetLineNumChars', return_type=c_int_le, size=76, line=73, arg_list=[('s',PointerType('c_byte')),('MaxNumChars',c_int_le)])
        self.GUI__DispLine = StaticFunction(device, 0x2cc24, thumb=1, name='GUI__DispLine', return_type=None, size=232, line=128, arg_list=[('s',PointerType("c_byte")),('MaxNumChars',c_int_le),('pr',PointerType('GUI_RECT'))])
        self.GUI__GetLineDistX = StaticFunction(device, 0x2cbd0, thumb=1, name='GUI__GetLineDistX', return_type=c_int_le, size=84, line=99, arg_list=[('s',PointerType("c_byte")),('MaxNumChars',c_int_le)])
        self._DispLine = StaticFunction(device, 0x30c48, thumb=1, name='_DispLine', return_type=None, size=36, line=34, arg_list=[('s',PointerType('c_byte')),('MaxNumChars',c_int_le),('pRect',PointerType("GUI_RECT"))])
