...
class Code(AbstractCode):
    ...
    def GUI_MEMDEV_GetDataPtr(self, hMem):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_MEMDEV_GetDataPtr = StaticFunction(device, 0x2e2b6, thumb=1, name='GUI_MEMDEV_GetDataPtr', return_type=PointerType("void"), size=14, line=34, arg_list=[('hMem',GUI_MEMDEV_Handle)])
