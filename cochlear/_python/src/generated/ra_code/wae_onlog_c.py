...
class const():
    ...
    ### Defines ###
    ###############
    WAE_ONLOG_TMR_NAME = 'waeOnLogTmr'
    WAE_ONLOG_BUF_SIZE = 8
    WAE_ONLOG_FLASH_OK = 0
    WAE_ONLOG_FLASH_ERR = 4294967295
    WAE_ONLOG_MEM_VAL_OFFSET = 6
    WAE_ONLOG_MEM_VAL_ADDR = 2147752934
    WAE_ONLOG_MEM_VAL_BUF_SIZE = 2
    WAE_ONLOG_MEM_VAL_CORRECT = 42390
    WAE_ONLOG_MEM_VAL_OK = 0
    WAE_ONLOG_MEM_VAL_NOK = 1
    WDOG_ON = 1
    WDOG_DURATION = 9000
...
class Code(AbstractCode):
    ...
    def WAE_P_OnLogTmrHandler(self, pTmr, pArg):
        '''
        Arguments:
    ...
    def waeOnLogMemValidCheck(self, ):
        '''
        Arguments:
        Return type:
        -u32
        Declaration line: 458
        '''
        pass

    def WAE_P_OnLogStart(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAE_P_OnLogUpdate(self, minStoreDiff):
        '''
        Arguments:
        -minStoreDiff - u16
        Return type:
    ...
    waeOnLogWaOnTime = u32
    pWaeOnLogTmr = PointerType("OS_TMR")
    OSTCBList = PointerType('OS_TCB')
    waeOnLogRtcTime = u8 * 5
    ...
    def __init__(self, device):
        ...
        self.waeOnLogWaOnTime = StaticVariable(device, self.u32, 0x7fe00098, False)
        self.pWaeOnLogTmr = StaticVariable(device, PointerType("OS_TMR"), 0x7fe0009c, False)
        self.OSTCBList = StaticVariable(device, PointerType('OS_TCB'), 0x40000064, False)
        self.waeOnLogRtcTime = StaticVariable(device, u8 * 5, 0x7fe000a0, False)
        ...
        self.waeOnLogBuf = StaticVariable(device, u8 * 8, 0x7fe000a5, False)
        ...
        ### Functions data ###
        ######################
        self.waeOnLogStore = StaticFunction(device, 0x45fe0, thumb=1, name='waeOnLogStore', return_type=u32, size=90, line=340, arg_list=[])
        self.WAE_P_OnLogInit = StaticFunction(device, 0x46068, thumb=1, name='WAE_P_OnLogInit', return_type=Status, size=100, line=108, arg_list=[])
        self.waeOnLogRead = StaticFunction(device, 0x45f9a, thumb=1, name='waeOnLogRead', return_type=u32, size=70, line=397, arg_list=[])
        self.WAE_P_OnLogTmrHandler = StaticFunction(device, 0x45f80, thumb=1, name='WAE_P_OnLogTmrHandler', return_type=None, size=26, line=305, arg_list=[('pTmr',PointerType("void")),('pArg',PointerType('void'))])
        self.waeOnLogMemValidCheck = StaticFunction(device, 0x4603a, thumb=1, name='waeOnLogMemValidCheck', return_type=u32, size=46, line=458, arg_list=[])
        self.WAE_P_OnLogStart = StaticFunction(device, 0x460dc, thumb=1, name='WAE_P_OnLogStart', return_type=None, size=20, line=189, arg_list=[])
        self.WAE_P_OnLogTmrStart = StaticFunction(device, 0x460cc, thumb=1, name='WAE_P_OnLogTmrStart', return_type=None, size=16, line=208, arg_list=[])
        self.WAE_P_OnLogTmrStop = StaticFunction(device, 0x460f0, thumb=1, name='WAE_P_OnLogTmrStop', return_type=None, size=20, line=234, arg_list=[])
        self.WAE_P_OnLogUpdate = StaticFunction(device, 0x46104, thumb=1, name='WAE_P_OnLogUpdate', return_type=None, size=56, line=262, arg_list=[('minStoreDiff',u16)])
