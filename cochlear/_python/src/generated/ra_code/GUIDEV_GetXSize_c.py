...
class Code(AbstractCode):
    ...
    def GUI_MEMDEV_GetXSize(self, hMem):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_MEMDEV_GetXSize = StaticFunction(device, 0x30ec4, thumb=1, name='GUI_MEMDEV_GetXSize', return_type=c_int_le, size=32, line=37, arg_list=[('hMem',GUI_MEMDEV_Handle)])
