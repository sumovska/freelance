...
class Code(AbstractCode):
    ...
    def GUI__IntersectRects(self, pDest, pr0, pr1):
        '''
        Arguments:
        -pDest - PointerType('GUI_RECT')
        -pr0 - PointerType("GUI_RECT")
        -pr1 - PointerType('GUI_RECT')
        Return type:
        -c_int_le
        Declaration line: 54
        '''
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI__IntersectRects = StaticFunction(device, 0x2e260, thumb=1, name='GUI__IntersectRects', return_type=c_int_le, size=86, line=54, arg_list=[('pDest',PointerType('GUI_RECT')),('pr0',PointerType("GUI_RECT")),('pr1',PointerType('GUI_RECT'))])
