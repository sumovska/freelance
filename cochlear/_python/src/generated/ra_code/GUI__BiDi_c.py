...
class TYPE__structure(Structure):
    Code = c_ushort_le
    Type = c_ubyte
    _fields_ = [
                ('Code', c_ushort_le),
...
class PAIR__structure(Structure):
    Code = c_ushort_le
    CodeM = c_ushort_le
    _pack_ = 1
    _fields_ = [
...
class Code(AbstractCode):
    ...
    TYPE__structure = TYPE__structure
    ...
    PAIR__structure = PAIR__structure
    ...
    def GUI__BIDI_Log2Vis(self, s, NumChars, pBuffer, BufferSize):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -NumChars - c_int_le
        -pBuffer - PointerType("c_byte")
        -BufferSize - c_int_le
        Return type:
        -c_int_le
        Declaration line: 14270
        '''
        pass

    def _BiDiReorder(self, pChars, pLevels, NumChars, BaseLevel):
        '''
        Arguments:
        -pChars - PointerType('c_ushort_le')
        -pLevels - PointerType("c_ubyte")
        -NumChars - c_int_le
        -BaseLevel - c_ubyte
        Return type:
        -None
        Declaration line: 14141
        '''
        pass

    def _ReorderLevel(self, pChars, pLevels, NumChars, Level, Reverse):
        '''
        Arguments:
        -pChars - PointerType('c_ushort_le')
        -pLevels - PointerType("c_ubyte")
        ...
        Return type:
        -c_int_le
        Declaration line: 14112
        '''
        pass

    def GUI__BIDI_IsNSM(self, Char):
        '''
        Arguments:
        -Char - c_ushort_le
        Return type:
        -c_int_le
        Declaration line: 14495
        '''
        pass

    def GUI__BIDI_GetLogChar(self, s, NumChars, Index):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -NumChars - c_int_le
        ...
        Return type:
        -c_ushort_le
        Declaration line: 14430
        '''
        pass

    def GUI__BIDI_GetCursorPosX(self, s, NumChars, Index):
        '''
        Arguments:
        -s - PointerType("c_byte")
        -NumChars - c_int_le
        ...
        Return type:
        -c_int_le
        Declaration line: 14306
        '''
        pass

    def _DoJoiningAndDecoding(self, s, NumChars, aChars, FillIgnored):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -NumChars - c_int_le
        -aChars - PointerType("c_ushort_le")
        -FillIgnored - c_int_le
        Return type:
        -c_int_le
        Declaration line: 13822
        '''
        pass

    def GUI__BIDI_GetCursorPosChar(self, s, NumChars, x):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -NumChars - c_int_le
        ...
        Return type:
        -c_int_le
        Declaration line: 14366
        '''
        pass

    def GUI__BIDI_GetCharDir(self, s, NumChars, Index):
        '''
        Arguments:
        -s - PointerType("c_byte")
        -NumChars - c_int_le
        ...
        Return type:
        -c_int_le
        Declaration line: 14460
        '''
        pass

    def _BiDiResolveExplicit(self, pLevels, pTypes, NumChars, Level, Dir, Nest):
        '''
        Arguments:
        -pLevels - PointerType('c_ubyte')
        -pTypes - PointerType("c_ubyte")
        -NumChars - c_int_le
        -Level - c_ubyte
        -Dir - c_ubyte
        -Nest - c_ubyte
        Return type:
        -c_int_le
        Declaration line: 13907
        '''
        pass

    def _BiDiDoTransformations(self, pChars, pTypes, pLevels, NumChars, DoMirroring):
        '''
        Arguments:
        -pChars - PointerType('c_ushort_le')
        -pTypes - PointerType("c_ubyte")
        -pLevels - PointerType('c_ubyte')
        -NumChars - c_int_le
        -DoMirroring - c_int_le
        Return type:
        -c_int_le
        Declaration line: 14223
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self._aMappedTypes = StaticVariable(device, c_ubyte * 20, 0x6ee20, True)
        self._aaActionWeak = StaticVariable(device, c_int_le * 10 * 20, 0x6f154, True)
        ...
        self._aaAddLevels = StaticVariable(device, c_ubyte * 4 * 2, 0x61c48, True)
        self.GUI_XBF_APIList_Prop_Ext = StaticVariable(device, self.tGUI_XBF_APIList, 0x61c08, True)
        self._aaStateNeutrals = StaticVariable(device, c_int_le * 5 * 6, 0x6f4ec, True)
        self.GUI_UC_None = StaticVariable(device, self.GUI_UC_ENC_APILIST, 0x61c38, True)
        self._aaActionNeutrals = StaticVariable(device, c_int_le * 5 * 6, 0x6f474, True)
        ...
        self._aPairs = StaticVariable(device, PAIR * 352, 0x6e8a0, True)
        self._aTypes = StaticVariable(device, TYPE * 13076, 0x61c50, True)
        self._aaStateWeak = StaticVariable(device, c_int_le * 10 * 20, 0x6ee34, True)
        self.GUI_Context = StaticVariable(device, self.GUI_CONTEXT, 0x40005b98, False)

        ######################
        ### Functions data ###
        ######################
        self.GUI__BIDI_Log2Vis = StaticFunction(device, 0x31892, thumb=1, name='GUI__BIDI_Log2Vis', return_type=c_int_le, size=218, line=14270, arg_list=[('s',PointerType('c_byte')),('NumChars',c_int_le),('pBuffer',PointerType("c_byte")),('BufferSize',c_int_le)])
        self._BiDiReorder = StaticFunction(device, 0x3156e, thumb=1, name='_BiDiReorder', return_type=None, size=150, line=14141, arg_list=[('pChars',PointerType('c_ushort_le')),('pLevels',PointerType("c_ubyte")),('NumChars',c_int_le),('BaseLevel',c_ubyte)])
        self._ReorderLevel = StaticFunction(device, 0x31de0, thumb=1, name='_ReorderLevel', return_type=c_int_le, size=120, line=14112, arg_list=[('pChars',PointerType('c_ushort_le')),('pLevels',PointerType("c_ubyte")),('NumChars',c_int_le),('Level',c_ubyte),('Reverse',c_int_le)])
        self.GUI__BIDI_IsNSM = StaticFunction(device, 0x31da8, thumb=1, name='GUI__BIDI_IsNSM', return_type=c_int_le, size=56, line=14495, arg_list=[('Char',c_ushort_le)])
        self.GUI__BIDI_GetLogChar = StaticFunction(device, 0x31ca2, thumb=1, name='GUI__BIDI_GetLogChar', return_type=c_ushort_le, size=62, line=14430, arg_list=[('s',PointerType('c_byte')),('NumChars',c_int_le),('Index',c_int_le)])
        self.GUI__BIDI_GetCursorPosX = StaticFunction(device, 0x3196c, thumb=1, name='GUI__BIDI_GetCursorPosX', return_type=c_int_le, size=420, line=14306, arg_list=[('s',PointerType("c_byte")),('NumChars',c_int_le),('Index',c_int_le)])
        self._DoJoiningAndDecoding = StaticFunction(device, 0x313e8, thumb=1, name='_DoJoiningAndDecoding', return_type=c_int_le, size=138, line=13822, arg_list=[('s',PointerType('c_byte')),('NumChars',c_int_le),('aChars',PointerType("c_ushort_le")),('FillIgnored',c_int_le)])
        self.GUI__BIDI_GetCursorPosChar = StaticFunction(device, 0x31b10, thumb=1, name='GUI__BIDI_GetCursorPosChar', return_type=c_int_le, size=402, line=14366, arg_list=[('s',PointerType('c_byte')),('NumChars',c_int_le),('x',c_int_le)])
        self.GUI__BIDI_GetCharDir = StaticFunction(device, 0x31ce0, thumb=1, name='GUI__BIDI_GetCharDir', return_type=c_int_le, size=200, line=14460, arg_list=[('s',PointerType("c_byte")),('NumChars',c_int_le),('Index',c_int_le)])
        self._BiDiResolveExplicit = StaticFunction(device, 0x31472, thumb=1, name='_BiDiResolveExplicit', return_type=c_int_le, size=252, line=13907, arg_list=[('pLevels',PointerType('c_ubyte')),('pTypes',PointerType("c_ubyte")),('NumChars',c_int_le),('Level',c_ubyte),('Dir',c_ubyte),('Nest',c_ubyte)])
        self._BiDiDoTransformations = StaticFunction(device, 0x31604, thumb=1, name='_BiDiDoTransformations', return_type=c_int_le, size=654, line=14223, arg_list=[('pChars',PointerType('c_ushort_le')),('pTypes',PointerType("c_ubyte")),('pLevels',PointerType('c_ubyte')),('NumChars',c_int_le),('DoMirroring',c_int_le)])
