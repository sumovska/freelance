...
class RTC_P_Timestamp_tag__struct0__struct1(Structure):
    year2 = u8
    res = u8
    _fields_ = [
                ('year2', u8),
...
class RTC_P_Timestamp_tag__struct0__struct0(Structure):
    sec = u32
    min = u32
    hour = u32
    doy = u32
...
class RTC_P_Timestamp_tag__struct0(Structure):
    lw = RTC_P_Timestamp_tag__struct0__struct0
    hb = RTC_P_Timestamp_tag__struct0__struct1
    _pack_ = 1
    _fields_ = [
                ('lw', RTC_P_Timestamp_tag__struct0__struct0),
                ('hb', RTC_P_Timestamp_tag__struct0__struct1),
...
OS_TCB = os_tcb
class RTC_P_Timestamp_tag(Union):
    fields = RTC_P_Timestamp_tag__struct0
    stamp = u8 * 5
    _fields_ = [
                ('fields', RTC_P_Timestamp_tag__struct0),
                ('stamp', u8 * 5),
...
RTC_P_Timestamp_t = RTC_P_Timestamp_tag
...
class const():
    ...
    RTC_ILR_RTCALF = 2
    RTC_ILR_RTSSF = 4
    RTC_SLEEP_DLY_SECOND_MIN = 1
    RTC_SLEEP_DLY_SECOND_MAX = 86399
    RTC_TIME_SEC_IN_MIN = 60
    RTC_TIME_SEC_IN_HR = 3600
    RTC_TIME_MIN_IN_HR = 60
    RTC_TIME_MIN_IN_DAY = 1440
    RTC_TIME_MIN_IN_YEAR_COMMON = 525600
    RTC_TIME_MIN_IN_YEAR_LEAP = 527040
    RTC_AMR_CFG = 88
    RTC_AMR_DISABLE = 255
    RTC_INIT_KNOWN_VALUE = 2781058650
    RTC_TIMESTAMP_MASK_SEC = 63
    RTC_TIMESTAMP_MASK_MIN = 63
    RTC_TIMESTAMP_MASK_HOUR = 31
    RTC_TIMESTAMP_MASK_DOY = 511
    RTC_TIMESTAMP_MASK_YEAR = 4095
    RTC_TIMESTAMP_MASK_YEAR1 = 63
    RTC_TIMESTAMP_MASK_YEAR2 = 63
    RTC_TIMESTAMP_SHIFT_YEAR2 = 6
    INT_MODULE = 165
    ERROR = -1
    SUCCESS = 0
    FALSE = 0
...
class Code(AbstractCode):
    ...
    os_q = os_q
    os_event = os_event
    RTC_P_Timestamp_tag__struct0__struct1 = RTC_P_Timestamp_tag__struct0__struct1
    os_q_data = os_q_data
    os_mutex_data = os_mutex_data
    RTC_P_Timestamp_tag__struct0__struct0 = RTC_P_Timestamp_tag__struct0__struct0
    ITC_TimerEvent_tag = ITC_TimerEvent_tag
    os_tmr_wheel = os_tmr_wheel
    RTC_P_Timestamp_tag__struct0 = RTC_P_Timestamp_tag__struct0
    os_mem = os_mem
    os_tmr = os_tmr
    OS_EVENT = OS_EVENT
    OS_Q_DATA = OS_Q_DATA
    ...
    OS_FLAG_NODE = OS_FLAG_NODE
    OS_TCB = OS_TCB
    RTC_P_Timestamp_tag = RTC_P_Timestamp_tag
    RTC_P_Timestamp_t = RTC_P_Timestamp_t

    #################
    ### Functions ###
    #################

    def RTC_GetCurrentTime(self, pTime):
        '''
        Arguments:
        -pTime - PointerType('u8')
        Return type:
        -None
    ...
    def RTC_TimeCompare(self, pTime1, pTime2):
        '''
        Arguments:
        -pTime1 - PointerType("u8")
        -pTime2 - PointerType('u8')
        Return type:
        -s8
    ...
    def RTC_TimeCompareCurrent(self, pTime):
        '''
        Arguments:
        -pTime - PointerType("u8")
        Return type:
        -s8
        Declaration line: 598
        '''
        pass

    def RTC_Start(self, delaySec):
        '''
        Arguments:
        -delaySec - u32
        Return type:
    ...
    def RTC_TimeDiffMin(self, pTime, pTimeDiff):
        '''
        Arguments:
        -pTime - PointerType('u8')
        -pTimeDiff - PointerType("u32")
        Return type:
        -None
        Declaration line: 622
        '''
        pass
    ...
    def rtcIsLeapYear(self, year):
        '''
        Arguments:
        -year - u16
        Return type:
        -bool
        Declaration line: 728
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self.rtcInitType = StaticVariable(device, self.u32, 0xe00847fcL, False)
        ...
        ### Functions data ###
        ######################
        self.RTC_GetCurrentTime = StaticFunction(device, 0x5c1ae, thumb=1, name='RTC_GetCurrentTime', return_type=None, size=156, line=476, arg_list=[('pTime',PointerType('u8'))])
        self.RTC_TimeCompare = StaticFunction(device, 0x5c24a, thumb=1, name='RTC_TimeCompare', return_type=s8, size=194, line=508, arg_list=[('pTime1',PointerType("u8")),('pTime2',PointerType('u8'))])
        self.RTC_TimeCompareCurrent = StaticFunction(device, 0x5c30c, thumb=1, name='RTC_TimeCompareCurrent', return_type=s8, size=24, line=598, arg_list=[('pTime',PointerType("u8"))])
        self.RTC_Start = StaticFunction(device, 0x5c06a, thumb=1, name='RTC_Start', return_type=Status, size=250, line=312, arg_list=[('delaySec',u32)])
        self.RTC_Init = StaticFunction(device, 0x5bf8a, thumb=1, name='RTC_Init', return_type=None, size=170, line=213, arg_list=[])
        self.RTC_Stop = StaticFunction(device, 0x5c164, thumb=1, name='RTC_Stop', return_type=None, size=26, line=422, arg_list=[])
        self.RTC_TimeDiffMin = StaticFunction(device, 0x5c324, thumb=1, name='RTC_TimeDiffMin', return_type=None, size=296, line=622, arg_list=[('pTime',PointerType('u8')),('pTimeDiff',PointerType("u32"))])
        self.rtcISR = StaticFunction(device, 0x5bf7c, thumb=1, name='rtcISR', return_type=None, size=14, line=706, arg_list=[])
        self.RTC_AlarmDisable = StaticFunction(device, 0x5c17e, thumb=1, name='RTC_AlarmDisable', return_type=None, size=48, line=441, arg_list=[])
        self.rtcIsLeapYear = StaticFunction(device, 0x5c034, thumb=1, name='rtcIsLeapYear', return_type=bool, size=54, line=728, arg_list=[('year',u16)])
