...
class CIP2_CommandId_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    CIP2_WHOISTHERE_REQ = 31
    CIP2_WHOISTHERE_ACK = 159
    CIP2_GETSTATUS_S45_ACK = 238
    CIP2_GETSTATUS_S45_REQ = 110
    CIP2_ACTION_SPWA_REQ = 100
    CIP2_ACTION_SPWA_ACK = 228
    CIP2_ERRORMSG_ACK = 128
...
CIP2_Coefficient_t = u16
CIP_PrivateAlarmStatus_t = CIP_PrivateAlarmStatus_tag
CIP2_CommandId_t = CIP2_CommandId_tag
...
class CIP2_CoefficientsAndSizes_t__structure(Structure):
    coefficient = CIP2_Coefficient_t
    size = CIP2_CoefficientSize_t
    _fields_ = [
                ('coefficient', CIP2_Coefficient_t),
                ('size', CIP2_CoefficientSize_t),
               ]
...
class CIP_WhoIsThereResponsePacket_t__structure(Structure):
    id = u8
    size = u8 * 2
...
class CIP2_GenericResponsePacket_t__structure(Structure):
    id = u8
    size = u8 * 2
    _pack_ = 1
    _fields_ = [
...
class CIP2_GetStatusResp_tag(Structure):
    id = u8
    size = u8 * 2
    data = u8 * 28
    _pack_ = 1
...
class CIP2_StatusTokensAndSizes_t__structure(Structure):
    token = CIP2_StatusToken_t
    size = CIP2_StatusTokenSize_t
    _fields_ = [
                ('token', CIP2_StatusToken_t),
                ('size', CIP2_StatusTokenSize_t),
               ]
...
CIP2_CoefficientsAndSizes_t = CIP2_CoefficientsAndSizes_t__structure
WDLP_UnpairReq_t = WDLP_UnpairReq_tag
OS_EVENT = os_event
ITC_TimerResult_t = ITC_TimerResult_tag
OS_MBOX_DATA = os_mbox_data
CIP2_Packet_t = CIP2_GetStatusResp_tag
...
CIP2_Status_t = CIP_ProcResult_t
WBST_BteSettings_t = WBST_BteSettings_tag
CIP_WhoIsThereResponsePacket_t = CIP_WhoIsThereResponsePacket_t__structure
...
CIP2_ReadCoefficientResponse_t = CIP2_Packet_t
WDLP_ResetPairAck_t = WDLP_ResStatus_t
CIP_EcapProfile_t = CIP_EcapProfile_tag
OS_TCB = os_tcb
WDLP_CmdSendReq_t = WDLP_CmdSendReq_tag
CIP2_StatusTokensAndSizes_t = CIP2_StatusTokensAndSizes_t__structure
...
CIP2_GenericResponsePacket_t = CIP2_GenericResponsePacket_t__structure
...
class Code(AbstractCode):
    ...
    CIP2_CommandId_tag = CIP2_CommandId_tag
    ...
    CIP2_CoefficientSize_t = CIP2_CoefficientSize_t
    ...
    CIP2_Coefficient_t = CIP2_Coefficient_t
    CIP_PrivateAlarmStatus_t = CIP_PrivateAlarmStatus_t
    CIP2_CommandId_t = CIP2_CommandId_t
    ...
    os_sem_data = os_sem_data
    CIP2_CoefficientsAndSizes_t__structure = CIP2_CoefficientsAndSizes_t__structure
    WDLP_PktSendReq_tag = WDLP_PktSendReq_tag
    os_mbox_data = os_mbox_data
    CIP_WhoIsThereResponsePacket_t__structure = CIP_WhoIsThereResponsePacket_t__structure
    ...
    CIP2_GenericResponsePacket_t__structure = CIP2_GenericResponsePacket_t__structure
    ...
    os_tcb = os_tcb
    CIP2_GetStatusResp_tag = CIP2_GetStatusResp_tag
    ...
    CIP2_StatusTokensAndSizes_t__structure = CIP2_StatusTokensAndSizes_t__structure
    ...
    CIP2_ReadCoefficientResponse_t = CIP2_ReadCoefficientResponse_t
    WDLP_ResetPairAck_t = WDLP_ResetPairAck_t
    CIP_EcapProfile_t = CIP_EcapProfile_t
    OS_TCB = OS_TCB
    WDLP_CmdSendReq_t = WDLP_CmdSendReq_t
    CIP2_StatusTokensAndSizes_t = CIP2_StatusTokensAndSizes_t
    ...
    CIP2_GenericResponsePacket_t = CIP2_GenericResponsePacket_t
    ...
    def CIP2_SendGetStatus(self, bte, tokens, outTokens, outValues):
        '''
        Arguments:
        -bte - INT_Bte_t
        -tokens - u32
        -outTokens - PointerType("u32")
        -outValues - PointerType('u8')
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP2_SendReadCoefficient(self, bte, retryNum, coefficients, coefficientsCount, outValues, outSizes):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        -coefficients - PointerType("CIP2_CoefficientId_t")
        -coefficientsCount - u8
        -outValues - PointerType('u8')
        -outSizes - PointerType("u8")
        Return type:
        -CIP_ProcResult_t
        Declaration line: 225
        '''
        pass

    def CIP2_SendAction(self, bte, action, parameters, parametersSize):
        '''
        Arguments:
        -bte - INT_Bte_t
        -action - u8
        -parameters - PointerType('u8')
        -parametersSize - u8
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP2_SendMeasureImplantID(self, bte, retryNum, implantType, implantId):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        -implantType - PointerType("u8")
        -implantId - PointerType('u32')
        Return type:
        -CIP_ProcResult_t
    ...
    def GetElectrodeStatusPos(self, electrode):
        '''
        Arguments:
        -electrode - u8
        Return type:
    ...
    def CIP2_SendMeasureNrtTrace(self, bte, retryNum, pCipRequest, timeout, probeElectrode, recordingElectrode, currentLevel, probeRate, sample, gain, scale):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        -pCipRequest - PointerType("u8")
        -timeout - u16
        -probeElectrode - u8
        ...
        -gain - PointerType("u16")
        -scale - PointerType('u16')
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP2_SendWriteCoefficient(self, bte, retryNum, coefficients, coefficientsCount, values):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def CIP2_GetTokenSize(self, token):
        '''
        Arguments:
        -token - CIP2_StatusToken_t
        Return type:
        -CIP2_StatusTokenSize_t
        Declaration line: 387
        '''
        pass

    def CIP2_SendStopFitting(self, bte, retryNum, pCipRequest):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        ...
        Return type:
        -CIP_ProcResult_t
        Declaration line: 580
        '''
        pass

    def CIP2_SendMeasureImpedance(self, bte, retryNum, runCommonGround, runMP1, runMP2, runMP1plus2, flaggedElAuto, flaggedElManual):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        ...
        -runMP2 - bool
        -runMP1plus2 - bool
        -flaggedElAuto - PointerType('u32')
        -flaggedElManual - PointerType("u32")
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP2_SendStartFitting(self, bte, retryNum, sftClientId):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        ...
        Return type:
        -CIP_ProcResult_t
        Declaration line: 543
        '''
        pass

    def CIP_ResetPairing(self, bte, pairingType):
        '''
        Arguments:
        -bte - INT_Bte_t
    ...
    def CIP2_GetCoefficientSize(self, coefficient):
        '''
        Arguments:
        -coefficient - CIP2_Coefficient_t
        Return type:
        -CIP2_CoefficientSize_t
        Declaration line: 435
        '''
        pass

    def CIP_Pair(self, pairingType):
        '''
        Arguments:
        -pairingType - WdlpPairingType_t
        Return type:
    ...
    def CIP2_SendMeasureLink(self, bte, retryNum, pCipRequest, linkVoltageInfo, measureLinkStatus):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        ...
        -measureLinkStatus - PointerType('CIP_MeasureLinkStatus_t')
        Return type:
        -CIP_ProcResult_t
        Declaration line: 931
        '''
        pass

    def CIP_SetIdle(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 429
        '''
        pass

    def CIP2_SendElectrodeCondition(self, bte, retryNum, pCipRequest, conditioningCL, electrode, lastVoltageTelemetryMeasure, conditioningStatus):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        ...
        -conditioningCL - u8
        -electrode - u8
        -lastVoltageTelemetryMeasure - PointerType('u16')
        -conditioningStatus - PointerType("CIP_ConditioningStatus_t")
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP2_CheckBteCompatibility(self, wirelessFwVer):
        '''
        Arguments:
        -wirelessFwVer - PointerType('u8')
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP2_SortTokens(self, outTokens, tokenCount):
        '''
        Arguments:
        -outTokens - PointerType("u32")
        -tokenCount - u8
    ...
    def CIP_SendWhoIsThere(self, bte, outResult):
        '''
        Arguments:
        -bte - INT_Bte_t
        -outResult - PointerType('CIP_WhoIsThereResult_t')
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP2_SendReboot(self, bte, retryNum, rebootType):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.CIP2_SendGetStatus = StaticFunction(device, 0x55fbc, thumb=1, name='CIP2_SendGetStatus', return_type=CIP_ProcResult_t, size=176, line=163, arg_list=[('bte',INT_Bte_t),('tokens',u32),('outTokens',PointerType("u32")),('outValues',PointerType('u8'))])
        self.CIP2_SendReadCoefficient = StaticFunction(device, 0x5608e, thumb=1, name='CIP2_SendReadCoefficient', return_type=CIP_ProcResult_t, size=198, line=225, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('coefficients',PointerType("CIP2_CoefficientId_t")),('coefficientsCount',u8),('outValues',PointerType('u8')),('outSizes',PointerType("u8"))])
        self.CIP2_SendAction = StaticFunction(device, 0x5622c, thumb=1, name='CIP2_SendAction', return_type=CIP_ProcResult_t, size=112, line=344, arg_list=[('bte',INT_Bte_t),('action',u8),('parameters',PointerType('u8')),('parametersSize',u8)])
        self.CIP2_SendMeasureImplantID = StaticFunction(device, 0x5643e, thumb=1, name='CIP2_SendMeasureImplantID', return_type=CIP_ProcResult_t, size=134, line=620, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('implantType',PointerType("u8")),('implantId',PointerType('u32'))])
        self.GetElectrodeStatusPos = StaticFunction(device, 0x564c4, thumb=1, name='GetElectrodeStatusPos', return_type=u16, size=60, line=667, arg_list=[('electrode',u8)])
        self.CIP2_SendMeasureNrtTrace = StaticFunction(device, 0x5668a, thumb=1, name='CIP2_SendMeasureNrtTrace', return_type=CIP_ProcResult_t, size=298, line=824, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('pCipRequest',PointerType("u8")),('timeout',u16),('probeElectrode',u8),('recordingElectrode',u8),('currentLevel',u8),('probeRate',u8),('sample',PointerType('u8')),('gain',PointerType("u16")),('scale',PointerType('u16'))])
        self.CIP2_SendWriteCoefficient = StaticFunction(device, 0x56154, thumb=1, name='CIP2_SendWriteCoefficient', return_type=CIP_ProcResult_t, size=216, line=286, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('coefficients',PointerType("CIP2_CoefficientId_t")),('coefficientsCount',u8),('values',PointerType('u8'))])
        self.CIP2_GetTokenSize = StaticFunction(device, 0x55f98, thumb=1, name='CIP2_GetTokenSize', return_type=CIP2_StatusTokenSize_t, size=36, line=387, arg_list=[('token',CIP2_StatusToken_t)])
        self.CIP2_SendStopFitting = StaticFunction(device, 0x563b2, thumb=1, name='CIP2_SendStopFitting', return_type=CIP_ProcResult_t, size=140, line=580, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('pCipRequest',PointerType("u8"))])
        self.CIP2_SendMeasureImpedance = StaticFunction(device, 0x56500, thumb=1, name='CIP2_SendMeasureImpedance', return_type=CIP_ProcResult_t, size=230, line=698, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('runCommonGround',bool),('runMP1',bool),('runMP2',bool),('runMP1plus2',bool),('flaggedElAuto',PointerType('u32')),('flaggedElManual',PointerType("u32"))])
        self.CIP2_SendStartFitting = StaticFunction(device, 0x56348, thumb=1, name='CIP2_SendStartFitting', return_type=CIP_ProcResult_t, size=106, line=543, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('sftClientId',CIP_StartFittingSessionClientId_t)])
        self.CIP_ResetPairing = StaticFunction(device, 0x55ec4, thumb=1, name='CIP_ResetPairing', return_type=CIP_ProcResult_t, size=12, line=119, arg_list=[('bte',INT_Bte_t),('pairingType',WdlpPairingType_t)])
        self.CIP_Cancel = StaticFunction(device, 0x5629c, thumb=1, name='CIP_Cancel', return_type=None, size=8, line=381, arg_list=[])
        self.CIP2_GetCoefficientSize = StaticFunction(device, 0x5606c, thumb=1, name='CIP2_GetCoefficientSize', return_type=CIP2_CoefficientSize_t, size=34, line=435, arg_list=[('coefficient',CIP2_Coefficient_t)])
        self.CIP_Pair = StaticFunction(device, 0x55eb4, thumb=1, name='CIP_Pair', return_type=CIP_ProcResult_t, size=16, line=114, arg_list=[('pairingType',WdlpPairingType_t)])
        self.CIP2_SendMeasureLink = StaticFunction(device, 0x567b4, thumb=1, name='CIP2_SendMeasureLink', return_type=CIP_ProcResult_t, size=168, line=931, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('pCipRequest',PointerType('u8')),('linkVoltageInfo',PointerType("u16")),('measureLinkStatus',PointerType('CIP_MeasureLinkStatus_t'))])
        self.CIP_SetIdle = StaticFunction(device, 0x562a4, thumb=1, name='CIP_SetIdle', return_type=None, size=8, line=429, arg_list=[])
        self.CIP2_SendElectrodeCondition = StaticFunction(device, 0x565e6, thumb=1, name='CIP2_SendElectrodeCondition', return_type=CIP_ProcResult_t, size=164, line=770, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('pCipRequest',PointerType("u8")),('conditioningCL',u8),('electrode',u8),('lastVoltageTelemetryMeasure',PointerType('u16')),('conditioningStatus',PointerType("CIP_ConditioningStatus_t"))])
        self.CIP2_CheckBteCompatibility = StaticFunction(device, 0x5685c, thumb=1, name='CIP2_CheckBteCompatibility', return_type=CIP_ProcResult_t, size=20, line=984, arg_list=[('wirelessFwVer',PointerType('u8'))])
        self.CIP2_SortTokens = StaticFunction(device, 0x55f50, thumb=1, name='CIP2_SortTokens', return_type=None, size=72, line=472, arg_list=[('outTokens',PointerType("u32")),('tokenCount',u8)])
        self.CIP_SendWhoIsThere = StaticFunction(device, 0x55ed0, thumb=1, name='CIP_SendWhoIsThere', return_type=CIP_ProcResult_t, size=128, line=124, arg_list=[('bte',INT_Bte_t),('outResult',PointerType('CIP_WhoIsThereResult_t'))])
        self.CIP2_SendReboot = StaticFunction(device, 0x562ac, thumb=1, name='CIP2_SendReboot', return_type=CIP_ProcResult_t, size=156, line=494, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('rebootType',CIP_RebootType_t)])
