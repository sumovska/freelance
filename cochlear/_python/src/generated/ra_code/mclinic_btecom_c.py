...
class Code(AbstractCode):
    ...
    def MCL_P_BteComWriteLinkConstProfileMeanMeasuredReq(self, bte, retryNum, constK, constA, constB, profileMean, measuredElectrodes, resetVdd):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def mclProcElectrodeCondition_res(self, bte, result, cipRequest, lastVoltageTelemetryMeasure, conditioningStatus):
        '''
        Arguments:
        -bte - INT_Bte_t
        ...
        Return type:
        -None
        Declaration line: 390
        '''
        pass

    def MCL_P_BteComMeasureImpedanceReq(self, bte, runCommonGround, runMP1, runMP2, runMP1plus2, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
    ...
    def mclProcMeasureImpedance_res(self, bte, result, flaggedElAuto, flaggedElManual):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def mclProcWriteLinkConstProfileMeanMeasured_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def MCL_P_BteComReadImpedanceReq(self, bte, part, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
        -part - u8
    ...
    def MCL_P_BteComWriteProfileReq(self, bte, retryNum, profileType, profileData):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        -profileType - CIP_EcapProfileType_t
        -profileData - PointerType("s8")
        Return type:
        -Status
    ...
    def mclProcMeasureNrtTrace_res(self, bte, result, cipRequest, sample, gain, scale):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        -cipRequest - PointerType('u8')
        -sample - PointerType("u8")
        -gain - u16
        -scale - u16
        Return type:
        -None
    ...
    def MCL_P_BteComMVBTGetReq(self, bte, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def MCL_P_BteComWriteLinkConstReq(self, bte, retryNum, constK, constA, constB):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        ...
        Return type:
        -Status
        Declaration line: 691
        '''
        pass

    def MCL_P_BteComRebootReq(self, bte, retryNum, rebootType):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        -rebootType - CIP_RebootType_t
        Return type:
        -Status
    ...
    def MCL_P_BteComElectrodeConditionReq(self, bte, retryNum, conditioningCL, electrode):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def mclProcReadProfile_res(self, bte, result, profileType, profileData):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        ...
        Return type:
        -None
        Declaration line: 806
        '''
        pass

    def MCL_P_BteComMVBTSetReq(self, bte, retryNum, mv, bass, treble, selector):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def MCL_P_BteComReadMclinicMapTypeReq(self, bte, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def mclProcReadImpedance_res(self, bte, result, part, data):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        -part - u8
        -data - PointerType("u16")
        Return type:
        -None
        Declaration line: 435
        '''
        pass

    def mclProcReadMclinicMapType_res(self, bte, result, intraOrPost, flatOrProfile, implantType, iid):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def mclProcStartFitting_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def mclProcReboot_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def MCL_P_BteComMeasureLinkReq(self, bte, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def mclBteComErrorRes(self, bteId, errorCode, cipRequest):
        '''
        Arguments:
        -bteId - INT_Bte_t
        -errorCode - CIP_ProcResult_t
    ...
    def mclProcWriteLinkConst_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def MCL_P_BteComMeasureNrtTraceReq(self, bte, retryNum, timeout, probeElectrode, recordingElectrode, currentLevel, probeRate):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def mclBteComRes(self, mclEventId, bteId, pData, dataLength):
        '''
        Arguments:
        -mclEventId - MCL_P_Event_t
        -bteId - INT_Bte_t
    ...
    def mclProcMVBTSet_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        Return type:
        -None
        Declaration line: 210
        '''
        pass

    def MCL_P_BteComStopFittingReq(self, bte, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def mclProcMeasureLink_res(self, bte, result, cipRequest, linkVoltageInfo, status):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        -cipRequest - PointerType('u8')
        -linkVoltageInfo - PointerType("u16")
        -status - CIP_MeasureLinkStatus_t
        Return type:
        -None
    ...
    def mclProcMeasureImplantID_res(self, bte, result, implantType, implantId):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def mclProcMVBTGet_res(self, bte, result, masterVolume, bass, treble, selector, intraVsPost, flatVsProfile, profileMean):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def mclProcStopFitting_res(self, bte, result, cipRequest):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        ...
        Return type:
        -None
        Declaration line: 276
        '''
        pass

    def mclProcReadProfileMeanMeasured_res(self, bte, result, profileMean, profileMeas):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        -profileMean - u8
        -profileMeas - PointerType("u8")
        Return type:
        -None
        Declaration line: 720
        '''
        pass

    def mclProcWriteProfile_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
    ...
    def MCL_P_BteComReadProfileReq(self, bte, retryNum, profileType):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        ...
        Return type:
        -Status
        Declaration line: 833
        '''
        pass

    def MCL_P_BteComReadProfileMeanMeasuredReq(self, bte, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        Return type:
        -Status
        Declaration line: 742
        '''
        pass

    def MCL_P_BteComStartFittingReq(self, bte, retryNum, sftClientId):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
        -sftClientId - CIP_StartFittingSessionClientId_t
        Return type:
        -Status
    ...
    def MCL_P_BteComMeasureImplantIDReq(self, bte, retryNum):
        '''
        Arguments:
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.MCL_P_BteComWriteLinkConstProfileMeanMeasuredReq = StaticFunction(device, 0x35008, thumb=1, name='MCL_P_BteComWriteLinkConstProfileMeanMeasuredReq', return_type=Status, size=42, line=642, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('constK',u16),('constA',u16),('constB',u16),('profileMean',u8),('measuredElectrodes',u32),('resetVdd',bool)])
        self.mclProcElectrodeCondition_res = StaticFunction(device, 0x34e6c, thumb=1, name='mclProcElectrodeCondition_res', return_type=None, size=40, line=390, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('cipRequest',PointerType('u8')),('lastVoltageTelemetryMeasure',u16),('conditioningStatus',CIP_ConditioningStatus_t)])
        self.MCL_P_BteComMeasureImpedanceReq = StaticFunction(device, 0x34e4a, thumb=1, name='MCL_P_BteComMeasureImpedanceReq', return_type=Status, size=34, line=364, arg_list=[('bte',INT_Bte_t),('runCommonGround',bool),('runMP1',bool),('runMP2',bool),('runMP1plus2',bool),('retryNum',u8)])
        self.mclProcMeasureImpedance_res = StaticFunction(device, 0x34e2a, thumb=1, name='mclProcMeasureImpedance_res', return_type=None, size=32, line=344, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('flaggedElAuto',u32),('flaggedElManual',u32)])
        self.mclProcWriteLinkConstProfileMeanMeasured_res = StaticFunction(device, 0x34ff6, thumb=1, name='mclProcWriteLinkConstProfileMeanMeasured_res', return_type=None, size=18, line=630, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.MCL_P_BteComReadImpedanceReq = StaticFunction(device, 0x34efe, thumb=1, name='MCL_P_BteComReadImpedanceReq', return_type=Status, size=16, line=468, arg_list=[('bte',INT_Bte_t),('part',u8),('retryNum',u8)])
        self.MCL_P_BteComWriteProfileReq = StaticFunction(device, 0x350d8, thumb=1, name='MCL_P_BteComWriteProfileReq', return_type=Status, size=104, line=779, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('profileType',CIP_EcapProfileType_t),('profileData',PointerType("s8"))])
        self.mclProcMeasureNrtTrace_res = StaticFunction(device, 0x34f5a, thumb=1, name='mclProcMeasureNrtTrace_res', return_type=None, size=54, line=536, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('cipRequest',PointerType('u8')),('sample',PointerType("u8")),('gain',u16),('scale',u16)])
        self.MCL_P_BteComMVBTGetReq = StaticFunction(device, 0x34d5e, thumb=1, name='MCL_P_BteComMVBTGetReq', return_type=Status, size=16, line=188, arg_list=[('bte',INT_Bte_t),('retryNum',u8)])
        self.MCL_P_BteComWriteLinkConstReq = StaticFunction(device, 0x3504e, thumb=1, name='MCL_P_BteComWriteLinkConstReq', return_type=Status, size=34, line=691, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('constK',u16),('constA',u16),('constB',u16)])
        self.MCL_P_BteComRebootReq = StaticFunction(device, 0x34d04, thumb=1, name='MCL_P_BteComRebootReq', return_type=Status, size=18, line=136, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('rebootType',CIP_RebootType_t)])
        self.MCL_P_BteComElectrodeConditionReq = StaticFunction(device, 0x34e94, thumb=1, name='MCL_P_BteComElectrodeConditionReq', return_type=Status, size=24, line=411, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('conditioningCL',u8),('electrode',u8)])
        self.mclProcReadProfile_res = StaticFunction(device, 0x35140, thumb=1, name='mclProcReadProfile_res', return_type=None, size=66, line=806, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('profileType',CIP_EcapProfileType_t),('profileData',PointerType('s8'))])
        self.MCL_P_BteComMVBTSetReq = StaticFunction(device, 0x34d80, thumb=1, name='MCL_P_BteComMVBTSetReq', return_type=Status, size=38, line=222, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('mv',u8),('bass',s8),('treble',s8),('selector',u8)])
        self.MCL_P_BteComReadMclinicMapTypeReq = StaticFunction(device, 0x34f4a, thumb=1, name='MCL_P_BteComReadMclinicMapTypeReq', return_type=Status, size=16, line=511, arg_list=[('bte',INT_Bte_t),('retryNum',u8)])
        self.mclProcReadImpedance_res = StaticFunction(device, 0x34eac, thumb=1, name='mclProcReadImpedance_res', return_type=None, size=82, line=435, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('part',u8),('data',PointerType("u16"))])
        self.mclProcReadMclinicMapType_res = StaticFunction(device, 0x34f0e, thumb=1, name='mclProcReadMclinicMapType_res', return_type=None, size=60, line=486, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('intraOrPost',u8),('flatOrProfile',u8),('implantType',u8),('iid',u32)])
        self.mclProcStartFitting_res = StaticFunction(device, 0x34da6, thumb=1, name='mclProcStartFitting_res', return_type=None, size=18, line=246, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.mclProcReboot_res = StaticFunction(device, 0x34cf2, thumb=1, name='mclProcReboot_res', return_type=None, size=18, line=124, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.MCL_P_BteComMeasureLinkReq = StaticFunction(device, 0x34fe6, thumb=1, name='MCL_P_BteComMeasureLinkReq', return_type=Status, size=16, line=605, arg_list=[('bte',INT_Bte_t),('retryNum',u8)])
        self.mclBteComErrorRes = StaticFunction(device, 0x34cc8, thumb=1, name='mclBteComErrorRes', return_type=MCL_Status_t, size=42, line=100, arg_list=[('bteId',INT_Bte_t),('errorCode',CIP_ProcResult_t),('cipRequest',PointerType('u8'))])
        self.mclProcWriteLinkConst_res = StaticFunction(device, 0x35032, thumb=1, name='mclProcWriteLinkConst_res', return_type=None, size=28, line=679, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.MCL_P_BteComMeasureNrtTraceReq = StaticFunction(device, 0x34f90, thumb=1, name='MCL_P_BteComMeasureNrtTraceReq', return_type=Status, size=36, line=559, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('timeout',u16),('probeElectrode',u8),('recordingElectrode',u8),('currentLevel',u8),('probeRate',u8)])
        self.mclBteComRes = StaticFunction(device, 0x34c68, thumb=1, name='mclBteComRes', return_type=MCL_Status_t, size=96, line=60, arg_list=[('mclEventId',MCL_P_Event_t),('bteId',INT_Bte_t),('pData',PointerType("void")),('dataLength',u32)])
        self.mclProcMVBTSet_res = StaticFunction(device, 0x34d6e, thumb=1, name='mclProcMVBTSet_res', return_type=None, size=18, line=210, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.MCL_P_BteComStopFittingReq = StaticFunction(device, 0x34dda, thumb=1, name='MCL_P_BteComStopFittingReq', return_type=Status, size=16, line=288, arg_list=[('bte',INT_Bte_t),('retryNum',u8)])
        self.mclProcMeasureLink_res = StaticFunction(device, 0x34fb4, thumb=1, name='mclProcMeasureLink_res', return_type=None, size=50, line=584, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('cipRequest',PointerType('u8')),('linkVoltageInfo',PointerType("u16")),('status',CIP_MeasureLinkStatus_t)])
        self.mclProcMeasureImplantID_res = StaticFunction(device, 0x34dea, thumb=1, name='mclProcMeasureImplantID_res', return_type=None, size=48, line=306, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('implantType',u8),('implantId',u32)])
        self.mclProcMVBTGet_res = StaticFunction(device, 0x34d16, thumb=1, name='mclProcMVBTGet_res', return_type=None, size=72, line=157, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('masterVolume',u8),('bass',s8),('treble',s8),('selector',u8),('intraVsPost',u8),('flatVsProfile',u8),('profileMean',u8)])
        self.mclProcStopFitting_res = StaticFunction(device, 0x34dca, thumb=1, name='mclProcStopFitting_res', return_type=None, size=16, line=276, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('cipRequest',PointerType('u8'))])
        self.mclProcReadProfileMeanMeasured_res = StaticFunction(device, 0x35070, thumb=1, name='mclProcReadProfileMeanMeasured_res', return_type=None, size=60, line=720, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('profileMean',u8),('profileMeas',PointerType("u8"))])
        self.mclProcWriteProfile_res = StaticFunction(device, 0x350bc, thumb=1, name='mclProcWriteProfile_res', return_type=None, size=28, line=767, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.MCL_P_BteComReadProfileReq = StaticFunction(device, 0x35182, thumb=1, name='MCL_P_BteComReadProfileReq', return_type=Status, size=18, line=833, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('profileType',CIP_EcapProfileType_t)])
        self.MCL_P_BteComReadProfileMeanMeasuredReq = StaticFunction(device, 0x350ac, thumb=1, name='MCL_P_BteComReadProfileMeanMeasuredReq', return_type=Status, size=16, line=742, arg_list=[('bte',INT_Bte_t),('retryNum',u8)])
        self.MCL_P_BteComStartFittingReq = StaticFunction(device, 0x34db8, thumb=1, name='MCL_P_BteComStartFittingReq', return_type=Status, size=18, line=258, arg_list=[('bte',INT_Bte_t),('retryNum',u8),('sftClientId',CIP_StartFittingSessionClientId_t)])
        self.MCL_P_BteComMeasureImplantIDReq = StaticFunction(device, 0x34e1a, thumb=1, name='MCL_P_BteComMeasureImplantIDReq', return_type=Status, size=16, line=326, arg_list=[('bte',INT_Bte_t),('retryNum',u8)])
