...
class Code(AbstractCode):
    ...
    def GUI_DispDecSpace(self, v, MaxDigits):
        '''
        Arguments:
        -v - c_long_le
        -MaxDigits - c_ubyte
    ...
    def GUI_DispDecAt(self, v, x, y, Len):
        '''
        Arguments:
        -v - c_long_le
        -x - c_short_le
    ...
    def GUI_DispDecShift(self, v, Len, Shift):
        '''
        Arguments:
        -v - c_long_le
        -Len - c_ubyte
    ...
    def GUI_DispSDecShift(self, v, Len, Shift):
        '''
        Arguments:
        -v - c_long_le
        -Len - c_ubyte
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_DispDecMin = StaticFunction(device, 0x2fc9e, thumb=1, name='GUI_DispDecMin', return_type=None, size=26, line=60, arg_list=[('v',c_long_le)])
        self.GUI_DispDec = StaticFunction(device, 0x2fd36, thumb=1, name='GUI_DispDec', return_type=None, size=28, line=95, arg_list=[('v',c_long_le),('Len',c_ubyte)])
        self.GUI_DispSDec = StaticFunction(device, 0x2fd04, thumb=1, name='GUI_DispSDec', return_type=None, size=50, line=87, arg_list=[('v',c_long_le),('Len',c_ubyte)])
        self.GUI_DispDecSpace = StaticFunction(device, 0x2fcb8, thumb=1, name='GUI_DispDecSpace', return_type=None, size=76, line=71, arg_list=[('v',c_long_le),('MaxDigits',c_ubyte)])
        self.GUI_DispDecAt = StaticFunction(device, 0x2fd52, thumb=1, name='GUI_DispDecAt', return_type=None, size=40, line=103, arg_list=[('v',c_long_le),('x',c_short_le),('y',c_short_le),('Len',c_ubyte)])
        self.GUI_DispDecShift = StaticFunction(device, 0x2fc50, thumb=1, name='GUI_DispDecShift', return_type=None, size=26, line=34, arg_list=[('v',c_long_le),('Len',c_ubyte),('Shift',c_ubyte)])
        self.GUI_DispSDecShift = StaticFunction(device, 0x2fc6a, thumb=1, name='GUI_DispSDecShift', return_type=None, size=52, line=45, arg_list=[('v',c_long_le),('Len',c_ubyte),('Shift',c_ubyte)])
