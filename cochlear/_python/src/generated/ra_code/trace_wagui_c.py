...
class Code(AbstractCode):
    ...
    def TRACE_waguiBassTreble(self, name, bteId, pairedBtes, hint, value):
        '''
        Arguments:
        -name - PointerType('c_byte')
        -bteId - PointerType("WBST_BteId_t")
        -pairedBtes - PointerType('WBST_BteId_t')
        -hint - PointerType("WBST_Value_t")
        -value - PointerType('WBST_Value_t')
        Return type:
        -None
    ...
    def TRACE_waguiNoParam(self, name):
        '''
        Arguments:
        -name - PointerType("c_byte")
        Return type:
        -None
        Declaration line: 420
        '''
        pass

    def TRACE_waguiBassTrebleBi(self, name, hintLeft, valueLeft, hintRight, valueRight):
        '''
        Arguments:
        -name - PointerType('c_byte')
        -hintLeft - PointerType("WBST_Value_t")
        -valueLeft - PointerType('WBST_Value_t')
        -hintRight - PointerType("WBST_Value_t")
        -valueRight - PointerType('WBST_Value_t')
        Return type:
        -None
        Declaration line: 444
        '''
        pass

    def TRACE_waguiShowWarningBar(self, name, availableBtes, pairedBtes):
        '''
        Arguments:
        -name - PointerType("c_byte")
        -availableBtes - PointerType('WBST_BteId_t')
        -pairedBtes - PointerType("WBST_BteId_t")
        Return type:
        -None
    ...
    def TRACE_waguiShowBteVersionInfo(self, pairedBtes, identBteLeft, identBteRight):
        '''
        Arguments:
        -pairedBtes - PointerType('WBST_BteId_t')
    ...
    def TRACE_waguiShowNrtProgress(self, fmcState, segfill, currentLvl, stim):
        '''
        Arguments:
        -fmcState - PointerType("WBST_Value_t")
        -segfill - PointerType('u8')
        -currentLvl - PointerType("u8")
        -stim - PointerType('bool')
        Return type:
        -None
        Declaration line: 342
        '''
        pass

    def TRACE_waguiShowIntraOpNrtProgress(self, fmcState, updateMode, viewMode, electrodeData, nrtTraceData, ecapProfile, stim, animFrame):
        '''
        Arguments:
        -fmcState - PointerType("WBST_Value_t")
        -updateMode - PointerType('WAGUI_UpdateMode_t')
        -viewMode - PointerType("WAGUI_IntraOpNrtMode_t")
        ...
        -stim - PointerType("bool")
        -animFrame - PointerType('u8')
        Return type:
        -None
        Declaration line: 385
        '''
        pass

    def TRACE_waguiOverlayModePopup(self, mode):
        '''
        Arguments:
        -mode - PointerType("WAGUI_CoverMode_t")
        Return type:
        -None
    ...
    def TRACE_waguiShowTelecoilMixing(self, value):
        '''
        Arguments:
        -value - PointerType('WBST_Value_t')
        Return type:
    ...
    def TRACE_waguiShowWarningPopup(self, name, availableBtes, pairedBtes):
        '''
        Arguments:
        -name - PointerType("c_byte")
        -availableBtes - PointerType('WBST_BteId_t')
    ...
    def TRACE_waguiOverlayAudioInputPopup(self, mode, audioInput):
        '''
        Arguments:
        -mode - PointerType('WAGUI_CoverMode_t')
        -audioInput - PointerType("WAGUI_CoverAudioInput_t")
        Return type:
        -None
        Declaration line: 77
        '''
    ...
    def TRACE_waguiShowIntraOpDiagResult(self, bteId, electrodeData, prompt):
        '''
        Arguments:
        -bteId - PointerType('WBST_BteId_t')
        -electrodeData - PointerType("WBST_ElectrodeData_t")
        -prompt - PointerType('WAGUI_IntraOpPrompt_t')
        Return type:
        -None
        Declaration line: 352
        '''
        pass

    def TRACE_waguiShowPairingConfirmation(self, bteId):
        '''
        Arguments:
        -bteId - PointerType("WBST_BteId_t")
        Return type:
    ...
    def TRACE_waguiShowStGreenAnimFrame(self, bteId):
        '''
        Arguments:
        -bteId - PointerType('WBST_BteId_t')
        Return type:
    ...
    def TRACE_waguiMasterVolume(self, name, bteId, pairedBtes, hint, value, expectedMin, expectedMax):
        '''
        Arguments:
        -name - PointerType("c_byte")
        -bteId - PointerType('WBST_BteId_t')
        ...
        -hint - PointerType('WBST_Value_t')
        -value - PointerType("WBST_Value_t")
        -expectedMin - PointerType('WBST_Value_t')
        -expectedMax - PointerType("WBST_Value_t")
        Return type:
        -None
        Declaration line: 454
        '''
        pass

    def TRACE_waguiShowRaVersionInfo(self, identRa):
        '''
        Arguments:
    ...
    def TRACE_waguiShowSensitivity(self, name, sens):
        '''
        Arguments:
        -name - PointerType("c_byte")
        -sens - PointerType('WAGUI_VolSensInfo_t')
        Return type:
        -None
    ...
    def TRACE_waguiShowBteAlarm(self, alarmBit, bteId, pairedBtes, coverMode):
        '''
        Arguments:
        -alarmBit - PointerType("WBST_Value_t")
        -bteId - PointerType('WBST_BteId_t')
        -pairedBtes - PointerType("WBST_BteId_t")
        -coverMode - PointerType('WAGUI_CoverMode_t')
        Return type:
        -None
        Declaration line: 268
        '''
        pass

    def TRACE_waguiShowOutOfRange(self, unavailableBtes):
        '''
        Arguments:
        -unavailableBtes - PointerType("WBST_BteId_t")
        Return type:
        -None
    ...
    def TRACE_waguiShowIntraOpNrtConfirmation(self, electrodeData):
        '''
        Arguments:
        -electrodeData - PointerType('WBST_ElectrodeData_t')
        Return type:
    ...
    def TRACE_waguiShowAccessoryMixing(self, value):
        '''
        Arguments:
        -value - PointerType("WBST_Value_t")
        Return type:
        -None
        Declaration line: 286
        '''
        pass

    def TRACE_waguiShowVolume(self, name, vol):
        '''
        Arguments:
        -name - PointerType('c_byte')
        -vol - PointerType("WAGUI_VolSensInfo_t")
        Return type:
        -None
    ...
    def TRACE_waguiShowStatus(self, paired, available, pParamsL, pParamsR, alarmMode):
        '''
        Arguments:
        -paired - PointerType('WBST_BteId_t')
        -available - PointerType("WBST_BteId_t")
        -pParamsL - PointerType('WAGUI_StatusParams_t')
        -pParamsR - PointerType("WAGUI_StatusParams_t")
        -alarmMode - PointerType('bool')
        Return type:
        -None
    ...
    def TRACE_waguiSideSettingsEntry(self, name, bteId, pairedBtes):
        '''
        Arguments:
        -name - PointerType("c_byte")
        -bteId - PointerType('WBST_BteId_t')
    ...
    def TRACE_waguiShowStreamSelection(self, bteId, stream, streamType, actSlot, selSlot, selected, active):
        '''
        Arguments:
        -bteId - PointerType('WBST_BteId_t')
        -stream - PointerType("WBST_Value_t")
        -streamType - PointerType('WBST_Value_t')
        -actSlot - c_int_le
        -selSlot - c_int_le
        -selected - c_int_le
        -active - c_int_le
    ...
    def TRACE_waguiOverlayWaBatteryLevel(self, level, plugged, charging):
        '''
        Arguments:
        -level - PointerType("u8")
        -plugged - PointerType('bool')
        -charging - PointerType("bool")
        Return type:
        -None
        Declaration line: 58
        '''
    ...
    def TRACE_waguiShowIntraOpNrtResult(self, bteId, viewMode, electrodeData, nrtTraceData, ecapProfile, prompt):
        '''
        Arguments:
        -bteId - PointerType('WBST_BteId_t')
        -viewMode - PointerType("WAGUI_IntraOpNrtMode_t")
    ...
    def TRACE_waguiShowFmAdvantage(self, paired, available, shown, levL, levR, levRefL, levRefR):
        '''
        Arguments:
        -paired - PointerType('WBST_BteId_t')
        -available - PointerType("WBST_BteId_t")
        -shown - PointerType('WBST_BteId_t')
        -levL - WBST_Value_t
        -levR - WBST_Value_t
        -levRefL - WBST_Value_t
        -levRefR - WBST_Value_t
        Return type:
        -None
        Declaration line: 234
        '''
        pass

    def TRACE_waguiShowHome(self, pHomeInfo):
        '''
        Arguments:
        -pHomeInfo - PointerType("WAGUI_HomeInfo_t")
        Return type:
        -None
        Declaration line: 133
        '''
        pass

    def TRACE_waguiShowIntraOpDiagInProgress(self, electrodeData, stopping):
        '''
        Arguments:
        -electrodeData - PointerType('WBST_ElectrodeData_t')
        -stopping - PointerType("bool")
        Return type:
        -None
    ...
    def TRACE_waguiOverlayDemoPopup(self, mode):
        '''
        Arguments:
        -mode - PointerType('WAGUI_CoverMode_t')
        Return type:
        -None
        Declaration line: 119
        '''
        pass

    def TRACE_waguiShowWaAlarm(self, alarmBit, coverMode):
        '''
        Arguments:
        -alarmBit - PointerType("WBST_Value_t")
        -coverMode - PointerType('WAGUI_CoverMode_t')
    ...
    def TRACE_waguiShowNrtRemoveContralateralInstruction(self, nrtBteId):
        '''
        Arguments:
        -nrtBteId - PointerType("WBST_BteId_t")
        Return type:
        -None
    ...
    def TRACE_waguiOverlayKeyLock(self, level, unlocked, plugged, charging):
        '''
        Arguments:
        -level - PointerType('u8')
        -unlocked - PointerType("bool")
        -plugged - PointerType('bool')
        -charging - PointerType("bool")
        Return type:
        -None
    ...
    def TRACE_waguiSelection(self, name, selected, active):
        '''
        Arguments:
        -name - PointerType('c_byte')
        -selected - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.TRACE_waguiBassTreble = StaticFunction(device, 0x5109a, thumb=1, name='TRACE_waguiBassTreble', return_type=None, size=60, line=434, arg_list=[('name',PointerType('c_byte')),('bteId',PointerType("WBST_BteId_t")),('pairedBtes',PointerType('WBST_BteId_t')),('hint',PointerType("WBST_Value_t")),('value',PointerType('WBST_Value_t'))])
        self.TRACE_waguiNoParam = StaticFunction(device, 0x5106a, thumb=1, name='TRACE_waguiNoParam', return_type=None, size=12, line=420, arg_list=[('name',PointerType("c_byte"))])
        self.TRACE_waguiBassTrebleBi = StaticFunction(device, 0x510d6, thumb=1, name='TRACE_waguiBassTrebleBi', return_type=None, size=60, line=444, arg_list=[('name',PointerType('c_byte')),('hintLeft',PointerType("WBST_Value_t")),('valueLeft',PointerType('WBST_Value_t')),('hintRight',PointerType("WBST_Value_t")),('valueRight',PointerType('WBST_Value_t'))])
        self.TRACE_waguiShowWarningBar = StaticFunction(device, 0x51186, thumb=1, name='TRACE_waguiShowWarningBar', return_type=None, size=36, line=474, arg_list=[('name',PointerType("c_byte")),('availableBtes',PointerType('WBST_BteId_t')),('pairedBtes',PointerType("WBST_BteId_t"))])
        self.TRACE_waguiShowBteVersionInfo = StaticFunction(device, 0x50cbe, thumb=1, name='TRACE_waguiShowBteVersionInfo', return_type=None, size=114, line=300, arg_list=[('pairedBtes',PointerType('WBST_BteId_t')),('identBteLeft',PointerType("WBST_BteIdentifiers_t")),('identBteRight',PointerType('WBST_BteIdentifiers_t'))])
        self.TRACE_waguiShowNrtProgress = StaticFunction(device, 0x50d6c, thumb=1, name='TRACE_waguiShowNrtProgress', return_type=None, size=62, line=342, arg_list=[('fmcState',PointerType("WBST_Value_t")),('segfill',PointerType('u8')),('currentLvl',PointerType("u8")),('stim',PointerType('bool'))])
        self.TRACE_waguiShowIntraOpNrtProgress = StaticFunction(device, 0x50e76, thumb=1, name='TRACE_waguiShowIntraOpNrtProgress', return_type=None, size=448, line=385, arg_list=[('fmcState',PointerType("WBST_Value_t")),('updateMode',PointerType('WAGUI_UpdateMode_t')),('viewMode',PointerType("WAGUI_IntraOpNrtMode_t")),('electrodeData',PointerType('WBST_ElectrodeData_t')),('nrtTraceData',PointerType("WBST_NrtTraceData_t")),('ecapProfile',PointerType('WBST_EcapProfile_t')),('stim',PointerType("bool")),('animFrame',PointerType('u8'))])
        self.TRACE_waguiOverlayModePopup = StaticFunction(device, 0x5076e, thumb=1, name='TRACE_waguiOverlayModePopup', return_type=None, size=26, line=126, arg_list=[('mode',PointerType("WAGUI_CoverMode_t"))])
        self.TRACE_waguiShowTelecoilMixing = StaticFunction(device, 0x50ca4, thumb=1, name='TRACE_waguiShowTelecoilMixing', return_type=None, size=26, line=293, arg_list=[('value',PointerType('WBST_Value_t'))])
        self.TRACE_waguiShowWarningPopup = StaticFunction(device, 0x511aa, thumb=1, name='TRACE_waguiShowWarningPopup', return_type=None, size=36, line=482, arg_list=[('name',PointerType("c_byte")),('availableBtes',PointerType('WBST_BteId_t')),('pairedBtes',PointerType("WBST_BteId_t"))])
        self.TRACE_waguiOverlayAudioInputPopup = StaticFunction(device, 0x5065c, thumb=1, name='TRACE_waguiOverlayAudioInputPopup', return_type=None, size=244, line=77, arg_list=[('mode',PointerType('WAGUI_CoverMode_t')),('audioInput',PointerType("WAGUI_CoverAudioInput_t"))])
        self.TRACE_waguiShowIntraOpDiagResult = StaticFunction(device, 0x50daa, thumb=1, name='TRACE_waguiShowIntraOpDiagResult', return_type=None, size=50, line=352, arg_list=[('bteId',PointerType('WBST_BteId_t')),('electrodeData',PointerType("WBST_ElectrodeData_t")),('prompt',PointerType('WAGUI_IntraOpPrompt_t'))])
        self.TRACE_waguiShowPairingConfirmation = StaticFunction(device, 0x508a2, thumb=1, name='TRACE_waguiShowPairingConfirmation', return_type=None, size=26, line=168, arg_list=[('bteId',PointerType("WBST_BteId_t"))])
        self.TRACE_waguiShowStGreenAnimFrame = StaticFunction(device, 0x51050, thumb=1, name='TRACE_waguiShowStGreenAnimFrame', return_type=None, size=26, line=411, arg_list=[('bteId',PointerType('WBST_BteId_t'))])
        self.TRACE_waguiMasterVolume = StaticFunction(device, 0x51112, thumb=1, name='TRACE_waguiMasterVolume', return_type=None, size=80, line=454, arg_list=[('name',PointerType("c_byte")),('bteId',PointerType('WBST_BteId_t')),('pairedBtes',PointerType("WBST_BteId_t")),('hint',PointerType('WBST_Value_t')),('value',PointerType("WBST_Value_t")),('expectedMin',PointerType('WBST_Value_t')),('expectedMax',PointerType("WBST_Value_t"))])
        self.TRACE_waguiShowRaVersionInfo = StaticFunction(device, 0x50d30, thumb=1, name='TRACE_waguiShowRaVersionInfo', return_type=None, size=34, line=327, arg_list=[('identRa',PointerType('WBST_RaIdentifiers_t'))])
        self.TRACE_waguiShowSensitivity = StaticFunction(device, 0x50920, thumb=1, name='TRACE_waguiShowSensitivity', return_type=None, size=100, line=189, arg_list=[('name',PointerType("c_byte")),('sens',PointerType('WAGUI_VolSensInfo_t'))])
        self.TRACE_waguiShowBteAlarm = StaticFunction(device, 0x50c26, thumb=1, name='TRACE_waguiShowBteAlarm', return_type=None, size=62, line=268, arg_list=[('alarmBit',PointerType("WBST_Value_t")),('bteId',PointerType('WBST_BteId_t')),('pairedBtes',PointerType("WBST_BteId_t")),('coverMode',PointerType('WAGUI_CoverMode_t'))])
        self.TRACE_waguiShowOutOfRange = StaticFunction(device, 0x50888, thumb=1, name='TRACE_waguiShowOutOfRange', return_type=None, size=26, line=161, arg_list=[('unavailableBtes',PointerType("WBST_BteId_t"))])
        self.TRACE_waguiShowIntraOpNrtConfirmation = StaticFunction(device, 0x51036, thumb=1, name='TRACE_waguiShowIntraOpNrtConfirmation', return_type=None, size=26, line=404, arg_list=[('electrodeData',PointerType('WBST_ElectrodeData_t'))])
        self.TRACE_waguiShowAccessoryMixing = StaticFunction(device, 0x50c8a, thumb=1, name='TRACE_waguiShowAccessoryMixing', return_type=None, size=26, line=286, arg_list=[('value',PointerType("WBST_Value_t"))])
        self.TRACE_waguiShowVolume = StaticFunction(device, 0x508bc, thumb=1, name='TRACE_waguiShowVolume', return_type=None, size=100, line=175, arg_list=[('name',PointerType('c_byte')),('vol',PointerType("WAGUI_VolSensInfo_t"))])
        self.TRACE_waguiShowStatus = StaticFunction(device, 0x50984, thumb=1, name='TRACE_waguiShowStatus', return_type=None, size=490, line=203, arg_list=[('paired',PointerType('WBST_BteId_t')),('available',PointerType("WBST_BteId_t")),('pParamsL',PointerType('WAGUI_StatusParams_t')),('pParamsR',PointerType("WAGUI_StatusParams_t")),('alarmMode',PointerType('bool'))])
        self.TRACE_waguiSideSettingsEntry = StaticFunction(device, 0x51162, thumb=1, name='TRACE_waguiSideSettingsEntry', return_type=None, size=36, line=466, arg_list=[('name',PointerType("c_byte")),('bteId',PointerType('WBST_BteId_t')),('pairedBtes',PointerType("WBST_BteId_t"))])
        self.TRACE_waguiShowStreamSelection = StaticFunction(device, 0x50bcc, thumb=1, name='TRACE_waguiShowStreamSelection', return_type=None, size=90, line=255, arg_list=[('bteId',PointerType('WBST_BteId_t')),('stream',PointerType("WBST_Value_t")),('streamType',PointerType('WBST_Value_t')),('actSlot',c_int_le),('selSlot',c_int_le),('selected',c_int_le),('active',c_int_le)])
        self.TRACE_waguiOverlayWaBatteryLevel = StaticFunction(device, 0x505e4, thumb=1, name='TRACE_waguiOverlayWaBatteryLevel', return_type=None, size=54, line=58, arg_list=[('level',PointerType("u8")),('plugged',PointerType('bool')),('charging',PointerType("bool"))])
        self.TRACE_waguiShowIntraOpNrtResult = StaticFunction(device, 0x50e02, thumb=1, name='TRACE_waguiShowIntraOpNrtResult', return_type=None, size=116, line=369, arg_list=[('bteId',PointerType('WBST_BteId_t')),('viewMode',PointerType("WAGUI_IntraOpNrtMode_t")),('electrodeData',PointerType('WBST_ElectrodeData_t')),('nrtTraceData',PointerType("WBST_NrtTraceData_t")),('ecapProfile',PointerType('WBST_EcapProfile_t')),('prompt',PointerType("WAGUI_IntraOpPrompt_t"))])
        self.TRACE_waguiShowFmAdvantage = StaticFunction(device, 0x50b6e, thumb=1, name='TRACE_waguiShowFmAdvantage', return_type=None, size=94, line=234, arg_list=[('paired',PointerType('WBST_BteId_t')),('available',PointerType("WBST_BteId_t")),('shown',PointerType('WBST_BteId_t')),('levL',WBST_Value_t),('levR',WBST_Value_t),('levRefL',WBST_Value_t),('levRefR',WBST_Value_t)])
        self.TRACE_waguiShowHome = StaticFunction(device, 0x50788, thumb=1, name='TRACE_waguiShowHome', return_type=None, size=256, line=133, arg_list=[('pHomeInfo',PointerType("WAGUI_HomeInfo_t"))])
        self.TRACE_waguiShowIntraOpDiagInProgress = StaticFunction(device, 0x50ddc, thumb=1, name='TRACE_waguiShowIntraOpDiagInProgress', return_type=None, size=38, line=361, arg_list=[('electrodeData',PointerType('WBST_ElectrodeData_t')),('stopping',PointerType("bool"))])
        self.TRACE_waguiOverlayDemoPopup = StaticFunction(device, 0x50750, thumb=1, name='TRACE_waguiOverlayDemoPopup', return_type=None, size=30, line=119, arg_list=[('mode',PointerType('WAGUI_CoverMode_t'))])
        self.TRACE_waguiShowWaAlarm = StaticFunction(device, 0x50c64, thumb=1, name='TRACE_waguiShowWaAlarm', return_type=None, size=38, line=278, arg_list=[('alarmBit',PointerType("WBST_Value_t")),('coverMode',PointerType('WAGUI_CoverMode_t'))])
        self.TRACE_waguiShowNrtRemoveContralateralInstruction = StaticFunction(device, 0x50d52, thumb=1, name='TRACE_waguiShowNrtRemoveContralateralInstruction', return_type=None, size=26, line=335, arg_list=[('nrtBteId',PointerType("WBST_BteId_t"))])
        self.TRACE_waguiOverlayKeyLock = StaticFunction(device, 0x5061a, thumb=1, name='TRACE_waguiOverlayKeyLock', return_type=None, size=66, line=67, arg_list=[('level',PointerType('u8')),('unlocked',PointerType("bool")),('plugged',PointerType('bool')),('charging',PointerType("bool"))])
        self.TRACE_waguiSelection = StaticFunction(device, 0x51076, thumb=1, name='TRACE_waguiSelection', return_type=None, size=36, line=426, arg_list=[('name',PointerType('c_byte')),('selected',c_int_le),('active',c_int_le)])
