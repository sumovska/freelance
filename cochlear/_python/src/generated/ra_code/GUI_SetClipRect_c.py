...
class Code(AbstractCode):
    ...
    def GUI_SetClipRect(self, pRect):
        '''
        Arguments:
        -pRect - PointerType('GUI_RECT')
        Return type:
        -PointerType("GUI_RECT")
        Declaration line: 45
        '''
        pass
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_SetClipRect = StaticFunction(device, 0x2e208, thumb=1, name='GUI_SetClipRect', return_type=PointerType("GUI_RECT"), size=40, line=45, arg_list=[('pRect',PointerType('GUI_RECT'))])
