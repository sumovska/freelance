...
class MCL_P_NrtDir_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_A_NRT_DIR_ASCENDING = 0
    MCL_A_NRT_DIR_DESCENDING_FAST_DROP = 1
    MCL_A_NRT_DIR_DESCENDING_SLOW_DROP = 2
...
class MCL_P_NrtTraceIdx_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    MCL_NRT_TRACE_PREV = 0
    MCL_NRT_TRACE_CURR = 1
    MCL_NRT_TRACE_TOTAL = 2
...
MCL_P_NrtDir_t = MCL_P_NrtDir_tag
...
MCL_P_NrtTraceIdx_t = MCL_P_NrtTraceIdx_tag
...
class MCL_P_NrtCtx_tag(Structure):
    aNrtTraceNum = u8
    aNrtElDir = MCL_P_NrtDir_t
    aNrtElConsYesNo = u8
    aNrtElAbsCLLimitMax = u8
    aNrtElAbsCLLimitMin = u8
    aNrtElTmpCLLimitMin = u8
    tNrtCLMax = u8
    tNrtCLMin = u8
    slowDropNoHappened = bool
    _pack_ = 1
    _fields_ = [
                ('aNrtTraceNum', u8),
                ('aNrtElDir', MCL_P_NrtDir_t),
...
MCL_P_NrtCtx_t = MCL_P_NrtCtx_tag
OS_EVENT = os_event
...
class const():
    ...
    ### Defines ###
    ###############
    MCL_RESP_CALC_IDX_MIN = 0
    MCL_RESP_CALC_IDX_MAX = 24
    MCL_A_NRT_CONS_YES_REQUIRED = 2
    MCL_A_NRT_ASC_CL_INCREASE_NO = 6
    MCL_A_NRT_ASC_CL_INCREASE_YES = 3
    MCL_A_NRT_DSC_CL_DECREASE_SLOW = 3
    MCL_A_NRT_DSC_CL_DECREASE_FAST = 6
    OS_VERSION = 284
    OS_FALSE = 0
    OS_TRUE = 1
    OS_PRIO_SELF = 255
...
class Code(AbstractCode):
    ...
    MCL_P_NrtDir_tag = MCL_P_NrtDir_tag
    ...
    MCL_P_NrtTraceIdx_tag = MCL_P_NrtTraceIdx_tag
    ...
    MCL_P_NrtTraceIdx_t = MCL_P_NrtTraceIdx_t
    ...
    MCL_P_NrtCtx_tag = MCL_P_NrtCtx_tag
    ...
    def mclNrtCalcN1P1Amplitude(self, pNrtTrace):
        '''
        Arguments:
        -pNrtTrace - PointerType("MCL_P_NrtTrace_t")
        Return type:
        -u8
    ...
    def mclNrtExpertSystem2(self, pNrtTrace):
        '''
        Arguments:
        -pNrtTrace - PointerType('MCL_P_NrtTrace_t')
        Return type:
        -u8
        Declaration line: 1532
        '''
        pass

    def mclNrtExpertSystem1(self, pNrtTrace):
        '''
        Arguments:
        -pNrtTrace - PointerType("MCL_P_NrtTrace_t")
        Return type:
    ...
    def mclNrtAscendingES(self, pNrtTraceCurr, pNrtTracePrev):
        '''
        Arguments:
        -pNrtTraceCurr - PointerType('MCL_P_NrtTrace_t')
        -pNrtTracePrev - PointerType("MCL_P_NrtTrace_t")
        Return type:
        -u8
    ...
    def mclNrtClassify(self, pCtx, pNrtTraceCL):
        '''
        Arguments:
        -pCtx - PointerType('MCL_P_NrtCtx_t')
        -pNrtTraceCL - PointerType("u8")
        Return type:
        -MCL_P_NrtStatus_t
    ...
    def mclNrtCalcDecisionParams(self, pNrtTraceCurr):
        '''
        Arguments:
        -pNrtTraceCurr - PointerType('MCL_P_NrtTrace_t')
        Return type:
    ...
    def mclNrtAscendingSeries(self, pCtx, pNrtTraceCL):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_NrtCtx_t")
        -pNrtTraceCL - PointerType('u8')
        Return type:
        -MCL_P_NrtStatus_t
        Declaration line: 623
        '''
        pass

    def mclNrtDescendingES(self, pNrtTraceCurr, pNrtTracePrev):
        '''
        Arguments:
        -pNrtTraceCurr - PointerType("MCL_P_NrtTrace_t")
        -pNrtTracePrev - PointerType('MCL_P_NrtTrace_t')
    ...
    def mclNrtDescendingSeries(self, pCtx, pNrtTraceCL):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_NrtCtx_t")
        -pNrtTraceCL - PointerType('u8')
    ...
    def mclNrtCalcResponse(self, aNrtTraceCurrent, aNrtTraceSample, pResponse):
        '''
        Arguments:
        -aNrtTraceCurrent - PointerType("c_float_le")
        -aNrtTraceSample - PointerType('c_float_le')
        -pResponse - PointerType("c_float_le")
        Return type:
        -u8
        Declaration line: 1244
        '''
        pass

    def MCL_P_NrtInit(self, stimCLMin, stimCLMax):
        '''
        Arguments:
        -stimCLMin - u8
        -stimCLMax - u8
    ...
    def mclNrtCalcNoise(self, pNrtTrace):
        '''
        Arguments:
        -pNrtTrace - PointerType('MCL_P_NrtTrace_t')
        Return type:
        -u8
        Declaration line: 1155
        '''
        pass

    def MCL_P_NrtProcess(self, probeElectrode, recordingElectrode, probeRate, traceGain, traceScale, pNrtTraceMicroS, pNrtTraceCL):
        '''
        Arguments:
        -probeElectrode - u8
        -recordingElectrode - u8
        ...
        -traceGain - u16
        -traceScale - u16
        -pNrtTraceMicroS - PointerType("u8")
        -pNrtTraceCL - PointerType('u8')
        Return type:
        -MCL_P_NrtStatus_t
    ...
    OSIdleCtr = INT32U
    mclNrtCtx = MCL_P_NrtCtx_t
    OSCtxSwCtr = INT32U
    OSRunning = BOOLEAN
    OSTaskCtr = INT8U
    mclPrevNrtTracesLogData = MCL_P_NrtTraceLogData_t
    OSTmrTime = INT32U
    ...
    mclSampleNeuralResponsePlusArtefact = c_float_le * 30
    OSTmrTaskStk = OS_STK * 128
    mclSampleGoodNeuralResponse = c_float_le * 30
    ...
    mclNrtTraces = MCL_P_NrtTrace_t * 2
    ...
    def __init__(self, device):
        ...
        self.mclNrtCtx = StaticVariable(device, self.MCL_P_NrtCtx_t, 0x4000a850, False)
        ...
        self.mclPrevNrtTracesLogData = StaticVariable(device, self.MCL_P_NrtTraceLogData_t, 0x4000a828, False)
        ...
        self.mclSampleNeuralResponsePlusArtefact = StaticVariable(device, c_float_le * 30, 0x6f794, True)
        self.OSTmrTaskStk = StaticVariable(device, OS_STK * 128, 0x40005958, False)
        self.mclSampleGoodNeuralResponse = StaticVariable(device, c_float_le * 30, 0x6f71c, True)
        ...
        self.mclNrtTraces = StaticVariable(device, MCL_P_NrtTrace_t * 2, 0x4000a6f8, False)
        ...
        ### Functions data ###
        ######################
        self.mclNrtCalcN1P1Amplitude = StaticFunction(device, 0x37bac, thumb=1, name='mclNrtCalcN1P1Amplitude', return_type=u8, size=414, line=1027, arg_list=[('pNrtTrace',PointerType("MCL_P_NrtTrace_t"))])
        self.mclNrtExpertSystem2 = StaticFunction(device, 0x376ae, thumb=1, name='mclNrtExpertSystem2', return_type=u8, size=184, line=1532, arg_list=[('pNrtTrace',PointerType('MCL_P_NrtTrace_t'))])
        self.mclNrtExpertSystem1 = StaticFunction(device, 0x37eb0, thumb=1, name='mclNrtExpertSystem1', return_type=u8, size=160, line=1455, arg_list=[('pNrtTrace',PointerType("MCL_P_NrtTrace_t"))])
        self.mclNrtSetCurrAsPrev = StaticFunction(device, 0x37ff0, thumb=1, name='mclNrtSetCurrAsPrev', return_type=None, size=30, line=1612, arg_list=[])
        self.mclNrtAscendingES = StaticFunction(device, 0x37f50, thumb=1, name='mclNrtAscendingES', return_type=u8, size=102, line=709, arg_list=[('pNrtTraceCurr',PointerType('MCL_P_NrtTrace_t')),('pNrtTracePrev',PointerType("MCL_P_NrtTrace_t"))])
        self.mclNrtClassify = StaticFunction(device, 0x37fb6, thumb=1, name='mclNrtClassify', return_type=MCL_P_NrtStatus_t, size=58, line=577, arg_list=[('pCtx',PointerType('MCL_P_NrtCtx_t')),('pNrtTraceCL',PointerType("u8"))])
        self.mclNrtCalcDecisionParams = StaticFunction(device, 0x37d4a, thumb=1, name='mclNrtCalcDecisionParams', return_type=u8, size=138, line=472, arg_list=[('pNrtTraceCurr',PointerType('MCL_P_NrtTrace_t'))])
        self.mclNrtAscendingSeries = StaticFunction(device, 0x37e5c, thumb=1, name='mclNrtAscendingSeries', return_type=MCL_P_NrtStatus_t, size=84, line=623, arg_list=[('pCtx',PointerType("MCL_P_NrtCtx_t")),('pNrtTraceCL',PointerType('u8'))])
        self.mclNrtDescendingES = StaticFunction(device, 0x37dd4, thumb=1, name='mclNrtDescendingES', return_type=u8, size=136, line=937, arg_list=[('pNrtTraceCurr',PointerType("MCL_P_NrtTrace_t")),('pNrtTracePrev',PointerType('MCL_P_NrtTrace_t'))])
        self.mclNrtDescendingSeries = StaticFunction(device, 0x375ea, thumb=1, name='mclNrtDescendingSeries', return_type=MCL_P_NrtStatus_t, size=196, line=786, arg_list=[('pCtx',PointerType("MCL_P_NrtCtx_t")),('pNrtTraceCL',PointerType('u8'))])
        self.mclNrtCalcResponse = StaticFunction(device, 0x37766, thumb=1, name='mclNrtCalcResponse', return_type=u8, size=474, line=1244, arg_list=[('aNrtTraceCurrent',PointerType("c_float_le")),('aNrtTraceSample',PointerType('c_float_le')),('pResponse',PointerType("c_float_le"))])
        self.MCL_P_NrtInit = StaticFunction(device, 0x375b0, thumb=1, name='MCL_P_NrtInit', return_type=None, size=58, line=285, arg_list=[('stimCLMin',u8),('stimCLMax',u8)])
        self.mclNrtCalcNoise = StaticFunction(device, 0x37940, thumb=1, name='mclNrtCalcNoise', return_type=u8, size=620, line=1155, arg_list=[('pNrtTrace',PointerType('MCL_P_NrtTrace_t'))])
        self.MCL_P_NrtProcess = StaticFunction(device, 0x3800e, thumb=1, name='MCL_P_NrtProcess', return_type=MCL_P_NrtStatus_t, size=376, line=327, arg_list=[('probeElectrode',u8),('recordingElectrode',u8),('probeRate',u8),('traceGain',u16),('traceScale',u16),('pNrtTraceMicroS',PointerType("u8")),('pNrtTraceCL',PointerType('u8'))])
