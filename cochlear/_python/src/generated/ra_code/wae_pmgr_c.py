...
class Code(AbstractCode):
    ...
    def WAE_P_ModeEnterPowerDown(self, rtcWakeUpDelay):
        '''
        Arguments:
        -rtcWakeUpDelay - u32
        Return type:
    ...
    def WAE_P_ModeEnterNormal(self, ):
        '''
        Arguments:
        Return type:
    ...
    def __init__(self, device):
        ...
        self.waePmgrFIO2DIR = StaticVariable(device, self.u32, 0x7fe000e4, False)
        ...
        self.waePmgrFIO4DIR = StaticVariable(device, self.u32, 0x7fe000ec, False)
        ...
        self.waePmgrPINSEL6 = StaticVariable(device, self.u32, 0x7fe00108, False)
        self.waePmgrPINSEL7 = StaticVariable(device, self.u32, 0x7fe0010c, False)
        self.waePmgrPINSEL4 = StaticVariable(device, self.u32, 0x7fe00100, False)
        self.waePmgrPINSEL5 = StaticVariable(device, self.u32, 0x7fe00104, False)
        self.waePmgrPINSEL2 = StaticVariable(device, self.u32, 0x7fe000f8, False)
        self.waePmgrPINSEL3 = StaticVariable(device, self.u32, 0x7fe000fc, False)
        self.waePmgrPINSEL0 = StaticVariable(device, self.u32, 0x7fe000f0, False)
        self.waePmgrPINSEL1 = StaticVariable(device, self.u32, 0x7fe000f4, False)
        ...
        self.waePmgrPINSEL8 = StaticVariable(device, self.u32, 0x7fe00110, False)
        self.waePmgrPINSEL9 = StaticVariable(device, self.u32, 0x7fe00114, False)
        ...
        self.waePmgrVICIntEnable = StaticVariable(device, self.u32, 0x7fe00118, False)
        ...
        self.waePmgrFIO1DIR = StaticVariable(device, self.u32, 0x7fe000e0, False)
        ...
        self.waePmgrFIO3DIR = StaticVariable(device, self.u32, 0x7fe000e8, False)
        ...
        self.waePmgrFIO0DIR = StaticVariable(device, self.u32, 0x7fe000dc, False)
        ...
        ### Functions data ###
        ######################
        self.DNRF_CePinClr = StaticFunction(device, 0x5dc40, thumb=1, name='DNRF_CePinClr', return_type=None, size=38, line=732, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_IrqStatus = StaticFunction(device, 0x5dd74, thumb=1, name='DNRF_IrqStatus', return_type=c_ulong_le, size=34, line=802, arg_list=[('chipNo',c_ubyte)])
        self.WAE_P_ModeEnterPowerDown = StaticFunction(device, 0x46c64, thumb=1, name='WAE_P_ModeEnterPowerDown', return_type=None, size=216, line=121, arg_list=[('rtcWakeUpDelay',u32)])
        self.DNRF_IrqDisable = StaticFunction(device, 0x5dd24, thumb=1, name='DNRF_IrqDisable', return_type=None, size=34, line=774, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_CePinSet = StaticFunction(device, 0x5dcf8, thumb=1, name='DNRF_CePinSet', return_type=None, size=38, line=718, arg_list=[('chipNo',c_ubyte)])
        self.DNRF_IrqEnable = StaticFunction(device, 0x5dd4c, thumb=1, name='DNRF_IrqEnable', return_type=None, size=34, line=760, arg_list=[('chipNo',c_ubyte)])
        self.WAE_P_ModeEnterNormal = StaticFunction(device, 0x46d3c, thumb=1, name='WAE_P_ModeEnterNormal', return_type=WAE_P_PmgrWakeUpSource_t, size=174, line=223, arg_list=[])
