...
class Code(AbstractCode):
    ...
    def GUI_AA_DrawArc(self, x0, y0, rx, ry, a0, a1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_AA_DrawArc = StaticFunction(device, 0x321a0, thumb=1, name='GUI_AA_DrawArc', return_type=None, size=108, line=69, arg_list=[('x0',c_int_le),('y0',c_int_le),('rx',c_int_le),('ry',c_int_le),('a0',c_int_le),('a1',c_int_le)])
