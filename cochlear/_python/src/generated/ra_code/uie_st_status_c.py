...
class Code(AbstractCode):
    ...
    def UIE_P_StStatus(self, me, pEvt):
        '''
        Arguments:
    ...
    def UIE_P_StStatusHome(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def ShowStStatusHome(self, me, updateMode, alarmMode, frame, animTimerParam):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
    ...
    def UIE_P_StStatusGreenAnim(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def __init__(self, device):
        ...
        self.statusAnimFrame = StaticVariable(device, self.u32, 0x80008770L, False)
        self.OSTCBHighRdy = StaticVariable(device, PointerType('OS_TCB'), 0x40000060, False)

        ######################
        ### Functions data ###
        ######################
        self.UIE_P_StStatus = StaticFunction(device, 0x42002, thumb=1, name='UIE_P_StStatus', return_type=HSM_StateRet_t, size=84, line=68, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StStatusHome = StaticFunction(device, 0x41e00, thumb=1, name='UIE_P_StStatusHome', return_type=HSM_StateRet_t, size=330, line=175, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.ShowStStatusHome = StaticFunction(device, 0x41c68, thumb=1, name='ShowStStatusHome', return_type=bool, size=408, line=107, arg_list=[('me',PointerType("UIE_P_Sm_t")),('updateMode',WAGUI_UpdateMode_t),('alarmMode',bool),('frame',u32),('animTimerParam',u32)])
        self.UIE_P_StStatusGreenAnim = StaticFunction(device, 0x41f4a, thumb=1, name='UIE_P_StStatusGreenAnim', return_type=HSM_StateRet_t, size=184, line=313, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
