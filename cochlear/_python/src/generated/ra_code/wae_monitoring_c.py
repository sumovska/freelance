...
class WAE_P_MonitBtePairStatus_tag(Structure):
    bte = WBST_BteId_t
    pair = WBST_Value_t
    _fields_ = [
                ('bte', WBST_BteId_t),
...
WAE_P_MonitBtePairStatus_t = WAE_P_MonitBtePairStatus_tag
...
class Code(AbstractCode):
    ...
    WAE_P_MonitBtePairStatus_tag = WAE_P_MonitBtePairStatus_tag
    ...
    WAE_P_MonitBtePairStatus_t = WAE_P_MonitBtePairStatus_t
    ...
    def WAE_P_MonitoringInit(self, pWaeNvm):
        '''
        Arguments:
    ...
    def WAE_P_MonitoringProcess(self, pWaeState, pKhdlEvnt, pollType):
        '''
        Arguments:
        -pWaeState - PointerType('WAE_P_State_t')
        -pKhdlEvnt - PointerType("OS_EVENT")
    ...
    def WAE_P_MonitoringHandleUiEvents(self, pollContinue):
        '''
        Arguments:
        -pollContinue - bool
        Return type:
    ...
    def waeMonitoringPowerSaving(self, ):
        '''
        Arguments:
        Return type:
        -WAE_P_PmgrWakeUpSource_t
        Declaration line: 590
        '''
        pass

    def WAE_P_MonitoringExit(self, pWaeState, pKhdlEvnt, pollType, keyPressed):
        '''
        Arguments:
        -pWaeState - PointerType('WAE_P_State_t')
        -pKhdlEvnt - PointerType("OS_EVENT")
        ...
        Return type:
        -None
        Declaration line: 450
        '''
        pass

    def WAE_P_MonitoringEnter(self, pEvent, pWaeState, pExpectedEventId, pKhdlEvnt):
        '''
        Arguments:
    ...
    def waeMonitoringPowerDownEnter(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def waeMonitoringPowerDownLeave(self, pWakeUpStatus):
        '''
        Arguments:
        -pWakeUpStatus - PointerType('WAE_P_PmgrWakeUpSource_t')
        Return type:
        -None
    ...
    OSCtxSwCtr = INT32U
    waeMonitoringBatLevel = HMON_BatLevel_t
    OSRunning = BOOLEAN
    WAE_P_InitFun = INT_InitFun_t * 23
    OSTaskCtr = INT8U
    OSTmrTime = INT32U
    waeMonitorPollTimeoutData = WAE_P_PollTimeoutData_t
    OSTCBTbl = OS_TCB * 26
    OSTmrUsed = INT16U
    ...
    pWaeMonitoringNvm = PointerType('WAE_NVM_RO_t')
    OSLockNesting = INT8U
    OSMemTbl = OS_MEM * 15
    ...
    waeMonitorPairStatus = WAE_P_MonitBtePairStatus_t * 2
    OSTime = INT32U
    OSRdyTbl = INT8U * 8
    waeMonitorAlarm = bool
    ...
    def __init__(self, device):
        ...
        self.waeMonitoringBatLevel = StaticVariable(device, self.HMON_BatLevel_t, 0x7fe00084, False)
        ...
        self.waeMonitorPollTimeoutData = StaticVariable(device, self.WAE_P_PollTimeoutData_t, 0x7fe0008c, False)
        ...
        self.pWaeMonitoringNvm = StaticVariable(device, PointerType('WAE_NVM_RO_t'), 0x7fe00088, False)
        ...
        self.waeMonitorPairStatus = StaticVariable(device, WAE_P_MonitBtePairStatus_t * 2, 0x7fe00090, False)
        ...
        self.waeMonitorAlarm = StaticVariable(device, self.bool, 0x7fe00085, False)
        ...
        ### Functions data ###
        ######################
        self.WAE_P_MonitoringInit = StaticFunction(device, 0x45b94, thumb=1, name='WAE_P_MonitoringInit', return_type=None, size=42, line=123, arg_list=[('pWaeNvm',PointerType("WAE_NVM_RO_t"))])
        self.WAE_P_MonitoringProcess = StaticFunction(device, 0x45e48, thumb=1, name='WAE_P_MonitoringProcess', return_type=None, size=262, line=263, arg_list=[('pWaeState',PointerType('WAE_P_State_t')),('pKhdlEvnt',PointerType("OS_EVENT")),('pollType',WAE_P_PollType_t)])
        self.WAE_P_MonitoringHandleUiEvents = StaticFunction(device, 0x45f4e, thumb=1, name='WAE_P_MonitoringHandleUiEvents', return_type=None, size=50, line=414, arg_list=[('pollContinue',bool)])
        self.waeMonitoringPowerSaving = StaticFunction(device, 0x45e32, thumb=1, name='waeMonitoringPowerSaving', return_type=WAE_P_PmgrWakeUpSource_t, size=22, line=590, arg_list=[])
        self.WAE_P_MonitoringExit = StaticFunction(device, 0x45ca6, thumb=1, name='WAE_P_MonitoringExit', return_type=None, size=262, line=450, arg_list=[('pWaeState',PointerType('WAE_P_State_t')),('pKhdlEvnt',PointerType("OS_EVENT")),('pollType',WAE_P_PollType_t),('keyPressed',bool)])
        self.WAE_P_MonitoringEnter = StaticFunction(device, 0x45bbe, thumb=1, name='WAE_P_MonitoringEnter', return_type=None, size=232, line=159, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t')),('pKhdlEvnt',PointerType("OS_EVENT"))])
        self.waeMonitoringPowerDownEnter = StaticFunction(device, 0x45de0, thumb=1, name='waeMonitoringPowerDownEnter', return_type=None, size=82, line=611, arg_list=[])
        self.waeMonitoringPowerDownLeave = StaticFunction(device, 0x45dac, thumb=1, name='waeMonitoringPowerDownLeave', return_type=None, size=52, line=678, arg_list=[('pWakeUpStatus',PointerType('WAE_P_PmgrWakeUpSource_t'))])
