...
class Code(AbstractCode):
    ...
    def CIP2_ErrorToCipProcResult(self, cipError):
        '''
        Arguments:
        -cipError - u8
        Return type:
    ...
    def CIP3_ErrorToCipProcResult(self, cipError):
        '''
        Arguments:
        -cipError - u8
        Return type:
    ...
    def CIP_Cip3AlarmToWbstAlarm(self, cip3alarm):
        '''
        Arguments:
        -cip3alarm - PointerType("u8")
        Return type:
        -u16
    ...
    def CIP3_BatteryStateToWbst(self, battery):
        '''
        Arguments:
        -battery - CIP3_BatteryStatus_t
        Return type:
        -WBST_Value_t
        Declaration line: 95
        '''
    ...
    def CIP_WdlpToCipProcResult(self, wdlpStatus):
        '''
        Arguments:
        -wdlpStatus - WDLP_Status_t
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_WbstMixingRatioToCip(self, ratio):
        '''
        Arguments:
        -ratio - WBST_Value_t
        Return type:
    ...
    def CIP2_BatteryStateToWbst(self, battery):
        '''
        Arguments:
        -battery - u8
        Return type:
    ...
    def CIP_SetConversionError(self, error):
        '''
        Arguments:
        -error - CIP2_Status_t
        Return type:
    ...
    def CIP_Cip2AlarmToWbstAlarm(self, cip2alarm):
        '''
        Arguments:
        -cip2alarm - PointerType('u8')
        Return type:
        -u16
        Declaration line: 68
        '''
    ...
    def CIP_MixingRatioToWbst(self, ratio):
        '''
        Arguments:
        -ratio - u8
        Return type:
    ...
    CIP_conversionError = CIP2_Status_t
    ...
    def __init__(self, device):
        ...
        self.CIP_conversionError = StaticVariable(device, self.CIP2_Status_t, 0x8000892aL, False)
        ...
        ### Functions data ###
        ######################
        self.CIP2_ErrorToCipProcResult = StaticFunction(device, 0x57176, thumb=1, name='CIP2_ErrorToCipProcResult', return_type=CIP_ProcResult_t, size=114, line=241, arg_list=[('cipError',u8)])
        self.CIP3_ErrorToCipProcResult = StaticFunction(device, 0x571e8, thumb=1, name='CIP3_ErrorToCipProcResult', return_type=CIP_ProcResult_t, size=90, line=279, arg_list=[('cipError',u8)])
        self.CIP_Cip3AlarmToWbstAlarm = StaticFunction(device, 0x5705e, thumb=1, name='CIP_Cip3AlarmToWbstAlarm', return_type=u16, size=106, line=126, arg_list=[('cip3alarm',PointerType("u8"))])
        self.CIP3_BatteryStateToWbst = StaticFunction(device, 0x5702c, thumb=1, name='CIP3_BatteryStateToWbst', return_type=WBST_Value_t, size=50, line=95, arg_list=[('battery',CIP3_BatteryStatus_t)])
        self.CIP_WdlpToCipProcResult = StaticFunction(device, 0x57148, thumb=1, name='CIP_WdlpToCipProcResult', return_type=CIP_ProcResult_t, size=46, line=215, arg_list=[('wdlpStatus',WDLP_Status_t)])
        self.CIP_ConversionError = StaticFunction(device, 0x56f7c, thumb=1, name='CIP_ConversionError', return_type=CIP2_Status_t, size=12, line=19, arg_list=[])
        self.CIP_WbstMixingRatioToCip = StaticFunction(device, 0x5710e, thumb=1, name='CIP_WbstMixingRatioToCip', return_type=u8, size=58, line=194, arg_list=[('ratio',WBST_Value_t)])
        self.CIP2_BatteryStateToWbst = StaticFunction(device, 0x56f92, thumb=1, name='CIP2_BatteryStateToWbst', return_type=WBST_Value_t, size=72, line=34, arg_list=[('battery',u8)])
        self.CIP_SetConversionError = StaticFunction(device, 0x56f88, thumb=1, name='CIP_SetConversionError', return_type=None, size=10, line=29, arg_list=[('error',CIP2_Status_t)])
        self.CIP_Cip2AlarmToWbstAlarm = StaticFunction(device, 0x56fda, thumb=1, name='CIP_Cip2AlarmToWbstAlarm', return_type=u16, size=82, line=68, arg_list=[('cip2alarm',PointerType('u8'))])
        self.CIP_MixingRatioToWbst = StaticFunction(device, 0x570c8, thumb=1, name='CIP_MixingRatioToWbst', return_type=WBST_Value_t, size=70, line=156, arg_list=[('ratio',u8)])
