...
class Code(AbstractCode):
    ...
    def GetNextStreamerToSetUni(self, bteId, actSlot):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -actSlot - WBST_Value_t
        Return type:
        -WBST_Value_t
        Declaration line: 1552
        '''
        pass

    def UIE_P_StActive(self, me, pEvt):
        '''
        Arguments:
    ...
    def ResetRASettings(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1780
        '''
        pass

    def UIE_P_StRaVersionPopup(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 1206
        '''
        pass

    def UIE_P_StDemoSelection(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 937
        '''
        pass

    def UIE_P_StOperational(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_StSplash(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 512
        '''
        pass

    def UIE_P_StTempCoilOff(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 432
        '''
        pass

    def GetNextStreamerToSetBi(self, actSlotL, actSlotR, lastActSlotL, lastActSlotR):
        '''
        Arguments:
        -actSlotL - WBST_Value_t
        -actSlotR - WBST_Value_t
        -lastActSlotL - PointerType('WBST_Value_t')
        -lastActSlotR - PointerType("WBST_Value_t")
        Return type:
        -WBST_Value_t
        Declaration line: 1608
        '''
        pass

    def SetMicOnNonBTBBte(self, me, bteActive, streamIdxL, streamIdxR):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -bteActive - WBST_BteId_t
        -streamIdxL - WBST_Value_t
        -streamIdxR - WBST_Value_t
        Return type:
        -bool
        Declaration line: 1725
        '''
        pass

    def UIE_P_StActivePaired(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StSwitchSelection(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StPairingPrompt(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1055
        '''
        pass

    def GetBteActionSupport(self, bteId, act):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -act - WBST_Value_t
        Return type:
        -WBST_BteId_t
        Declaration line: 1246
        '''
        pass

    def GetBteIdToSetBi(self, ):
        '''
        Arguments:
        Return type:
        -WBST_BteId_t
        Declaration line: 1699
        '''
        pass

    def UIE_P_StInitialOutOfRange(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 476
        '''
        pass

    def UIE_P_StLanguageSelection(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1138
        '''
        pass

    def HandleUtilButton(self, me, pEvt, longPress):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def __init__(self, device):
        ...
        self.bteEverAvailable = StaticVariable(device, self.WBST_BteId_t, 0x80008491L, False)
        ...
        self.initNotPaired = StaticVariable(device, self.bool, 0x80008490L, False)
        self.OSTCBHighRdy = StaticVariable(device, PointerType("OS_TCB"), 0x40000060, False)

        ######################
        ### Functions data ###
        ######################
        self.GetNextStreamerToSetUni = StaticFunction(device, 0x3b842, thumb=1, name='GetNextStreamerToSetUni', return_type=WBST_Value_t, size=184, line=1552, arg_list=[('bteId',WBST_BteId_t),('actSlot',WBST_Value_t)])
        self.UIE_P_StActive = StaticFunction(device, 0x3b412, thumb=1, name='UIE_P_StActive', return_type=HSM_StateRet_t, size=378, line=97, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.ResetRASettings = StaticFunction(device, 0x3ac7a, thumb=1, name='ResetRASettings', return_type=None, size=36, line=1780, arg_list=[])
        self.UIE_P_StRaVersionPopup = StaticFunction(device, 0x3ac2a, thumb=1, name='UIE_P_StRaVersionPopup', return_type=HSM_StateRet_t, size=80, line=1206, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StDemoSelection = StaticFunction(device, 0x3aadc, thumb=1, name='UIE_P_StDemoSelection', return_type=HSM_StateRet_t, size=334, line=937, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StOperational = StaticFunction(device, 0x3be66, thumb=1, name='UIE_P_StOperational', return_type=HSM_StateRet_t, size=270, line=329, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StSplash = StaticFunction(device, 0x3b346, thumb=1, name='UIE_P_StSplash', return_type=HSM_StateRet_t, size=204, line=512, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StTempCoilOff = StaticFunction(device, 0x3b58c, thumb=1, name='UIE_P_StTempCoilOff', return_type=HSM_StateRet_t, size=164, line=432, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.GetNextStreamerToSetBi = StaticFunction(device, 0x3b8fa, thumb=1, name='GetNextStreamerToSetBi', return_type=WBST_Value_t, size=340, line=1608, arg_list=[('actSlotL',WBST_Value_t),('actSlotR',WBST_Value_t),('lastActSlotL',PointerType('WBST_Value_t')),('lastActSlotR',PointerType("WBST_Value_t"))])
        self.SetMicOnNonBTBBte = StaticFunction(device, 0x3b7a2, thumb=1, name='SetMicOnNonBTBBte', return_type=bool, size=160, line=1725, arg_list=[('me',PointerType('UIE_P_Sm_t')),('bteActive',WBST_BteId_t),('streamIdxL',WBST_Value_t),('streamIdxR',WBST_Value_t)])
        self.UIE_P_StActivePaired = StaticFunction(device, 0x3b630, thumb=1, name='UIE_P_StActivePaired', return_type=HSM_StateRet_t, size=320, line=239, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StSwitchSelection = StaticFunction(device, 0x3ac9e, thumb=1, name='UIE_P_StSwitchSelection', return_type=HSM_StateRet_t, size=1184, line=575, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StPairingPrompt = StaticFunction(device, 0x3b196, thumb=1, name='UIE_P_StPairingPrompt', return_type=HSM_StateRet_t, size=214, line=1055, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.GetBteActionSupport = StaticFunction(device, 0x3b770, thumb=1, name='GetBteActionSupport', return_type=WBST_BteId_t, size=50, line=1246, arg_list=[('bteId',WBST_BteId_t),('act',WBST_Value_t)])
        self.GetBteIdToSetBi = StaticFunction(device, 0x3ba4e, thumb=1, name='GetBteIdToSetBi', return_type=WBST_BteId_t, size=126, line=1699, arg_list=[])
        self.UIE_P_StInitialOutOfRange = StaticFunction(device, 0x3b13e, thumb=1, name='UIE_P_StInitialOutOfRange', return_type=HSM_StateRet_t, size=88, line=476, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StLanguageSelection = StaticFunction(device, 0x3b26c, thumb=1, name='UIE_P_StLanguageSelection', return_type=HSM_StateRet_t, size=218, line=1138, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.HandleUtilButton = StaticFunction(device, 0x3bacc, thumb=1, name='HandleUtilButton', return_type=None, size=922, line=1264, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t')),('longPress',bool)])
