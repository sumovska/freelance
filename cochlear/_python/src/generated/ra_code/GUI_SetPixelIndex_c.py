...
class Code(AbstractCode):
    ...
    def LCD_SetPixelIndex(self, x, y, ColorIndex):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_SetPixelIndex = StaticFunction(device, 0x2cefc, thumb=1, name='LCD_SetPixelIndex', return_type=None, size=48, line=52, arg_list=[('x',c_int_le),('y',c_int_le),('ColorIndex',c_int_le)])
