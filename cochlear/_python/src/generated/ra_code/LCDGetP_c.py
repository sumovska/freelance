...
class Code(AbstractCode):
    ...
    def LCD_GetPixelIndex(self, x, y):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_GetPixelIndex = StaticFunction(device, 0x2f9e0, thumb=1, name='LCD_GetPixelIndex', return_type=c_uint_le, size=84, line=42, arg_list=[('x',c_int_le),('y',c_int_le)])
