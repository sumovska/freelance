...
class Code(AbstractCode):
    ...
    def WAE_P_WACIP_SendResponseGen(self, itcResponse, status):
        '''
        Arguments:
        -itcResponse - ITC_EventId_t
        -status - WACIP_Status_t
        Return type:
        -None
    ...
    def WAE_P_WACIP_SendClinicalReq(self, clinicalReq):
        '''
        Arguments:
    ...
    def WAE_P_WACIP_SendResponse(self, itcResponse, pData, dataLen):
        '''
        Arguments:
        -itcResponse - ITC_EventId_t
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.WAE_P_WACIP_SendResponseGen = StaticFunction(device, 0x47b3c, thumb=1, name='WAE_P_WACIP_SendResponseGen', return_type=None, size=30, line=165, arg_list=[('itcResponse',ITC_EventId_t),('status',WACIP_Status_t)])
        self.WAE_P_WACIP_SendClinicalReq = StaticFunction(device, 0x47b0c, thumb=1, name='WAE_P_WACIP_SendClinicalReq', return_type=None, size=26, line=71, arg_list=[('clinicalReq',ITC_EventId_t)])
        self.WAE_P_WACIP_SendResponse = StaticFunction(device, 0x47b26, thumb=1, name='WAE_P_WACIP_SendResponse', return_type=None, size=22, line=113, arg_list=[('itcResponse',ITC_EventId_t),('pData',PointerType('void')),('dataLen',u16)])
