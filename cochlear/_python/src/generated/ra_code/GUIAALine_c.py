...
class Code(AbstractCode):
    ...
    def GUI_AA_DrawLine(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_AA_DrawLine = StaticFunction(device, 0x2e2f4, thumb=1, name='GUI_AA_DrawLine', return_type=None, size=194, line=90, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
