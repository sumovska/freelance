...
class Code(AbstractCode):
    ...
    def UIE_P_NotificationSound(self, sound):
        '''
        Arguments:
        -sound - DAUDIO_SoundID_t
        Return type:
        -None
        Declaration line: 87
        '''
    ...
    def UIE_P_ElectrodeSound(self, electrodeNo):
        '''
        Arguments:
        -electrodeNo - u8
        Return type:
        -None
        Declaration line: 112
        '''
        pass

    def UIE_P_SetNotificationSoundVolume(self, volume):
        '''
        Arguments:
        -volume - u8
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.UIE_P_NotificationSound = StaticFunction(device, 0x39e3c, thumb=1, name='UIE_P_NotificationSound', return_type=None, size=62, line=87, arg_list=[('sound',DAUDIO_SoundID_t)])
        self.UIE_P_ElectrodeSound = StaticFunction(device, 0x39e7a, thumb=1, name='UIE_P_ElectrodeSound', return_type=None, size=20, line=112, arg_list=[('electrodeNo',u8)])
        self.UIE_P_SetNotificationSoundVolume = StaticFunction(device, 0x39e28, thumb=1, name='UIE_P_SetNotificationSoundVolume', return_type=None, size=20, line=69, arg_list=[('volume',u8)])
        self.UIE_P_StopSound = StaticFunction(device, 0x39e8e, thumb=1, name='UIE_P_StopSound', return_type=None, size=8, line=125, arg_list=[])
