...
class mode__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    M_AWAKE = 0
    M_BEFORE_SLEEP = 1
    M_WAKING_UP = 2
...
class UIE_P_MapSwitchTrans_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    UIE_P_MAP_SWITCH_NONE = 0
    UIE_P_MAP_SWITCH_START = 1
    UIE_P_MAP_SWITCH_END = 2
    UIE_P_MAP_SWITCH_CLASS = 3
    UIE_P_MAP_INPUT_CHANGE = 4
...
WBST_Value_t = s16
UIE_P_MapSwitchTrans_t = UIE_P_MapSwitchTrans_tag
GUI_RECT = LCD_RECT
...
class expectedEvent__structure(Structure):
    eventId = ITC_EventId_t
    bteStatus = WAE_BteStatus_t
    showProgressInd = bool
    waitingTimeLeft = c_int_le
    _fields_ = [
                ('eventId', ITC_EventId_t),
                ('bteStatus', WAE_BteStatus_t),
                ('showProgressInd', bool),
...
class Code(AbstractCode):
    ...
    mode__enumeration = mode__enumeration
    ...
    UIE_P_MapSwitchTrans_tag = UIE_P_MapSwitchTrans_tag
    ...
    UIE_P_MapSwitchTrans_t = UIE_P_MapSwitchTrans_t
    GUI_RECT = GUI_RECT
    ...
    expectedEvent__structure = expectedEvent__structure
    ...
    def UIE_P_StopGuiTimer(self, timerId):
        '''
        Arguments:
        -timerId - UIE_P_TimerId_t
        Return type:
        -None
    ...
    def UIE_WritePersistentConfig(self, ):
        '''
        Arguments:
        Return type:
        -Status
        Declaration line: 1198
        '''
        pass

    def UIE_P_StartGuiTimer(self, timerId, delay, param):
        '''
        Arguments:
        -timerId - UIE_P_TimerId_t
        -delay - u32
        ...
        Return type:
        -None
        Declaration line: 789
        '''
        pass

    def OnInactivityTimeout(self, timerParam):
        '''
        Arguments:
        -timerParam - u32
        Return type:
        -None
        Declaration line: 1476
        '''
        pass

    def UIE_P_HideProgressInd(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def UIE_P_GetSupportedBtes(self, supId):
        '''
        Arguments:
        -supId - WBST_Value_t
        Return type:
    ...
    def UIE_P_GetRealPairedBtes(self, ):
        '''
        Arguments:
        Return type:
        -WBST_BteId_t
        Declaration line: 954
        '''
        pass

    def HandleKeyLock(self, onWakeUp):
        '''
        Arguments:
        -onWakeUp - bool
        Return type:
        -bool
        Declaration line: 1511
        '''
        pass

    def UIE_P_IsKeypadLocked(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1559
        '''
        pass

    def GetAudioInputCoverData(self, bteId, audioInputData):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -audioInputData - PointerType('WAGUI_CoverAudioInputSide_t')
        Return type:
        -None
        Declaration line: 1573
        '''
        pass

    def UIE_P_IsMapUnset(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
    ...
    def UIE_P_EnableKeyLockPresentation(self, enabled):
        '''
        Arguments:
        -enabled - bool
        Return type:
    ...
    def UIE_P_IsNonMclinicMvbt(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -bool
        Declaration line: 1567
        '''
        pass

    def UIE_ReadPersistentConfig(self, ):
        '''
        Arguments:
        Return type:
        -Status
        Declaration line: 1165
        '''
        pass

    def UIE_P_TriggerOutOfRangeAlarm(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1430
        '''
        pass

    def UIE_P_SetShownBtes(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1022
        '''
        pass

    def UIE_P_GetStreamerType(self, bteId, activeStreamer):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -activeStreamer - WBST_Value_t
        Return type:
        -WBST_Value_t
        Declaration line: 1123
        '''
        pass

    def UIE_P_GetPairedBtes(self, ):
        '''
        Arguments:
        Return type:
        -WBST_BteId_t
    ...
    def UIE_P_GetShownBtes(self, ):
        '''
        Arguments:
        Return type:
        -WBST_BteId_t
        Declaration line: 1016
        '''
        pass

    def UIE_P_ShowProgressInd(self, progressIndDelay):
        '''
        Arguments:
        -progressIndDelay - u32
        Return type:
        -None
        Declaration line: 883
        '''
        pass

    def UIE_P_IsSurgical(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1159
        '''
        pass

    def UIE_P_GetMClinicBteId(self, ):
        '''
        Arguments:
        Return type:
        -WBST_BteId_t
        Declaration line: 1366
        '''
        pass

    def SmBeforeEvent(self, pSm, pEvt):
        '''
        Arguments:
        -pSm - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -bool
        Declaration line: 516
        '''
        pass

    def UIE_P_SmInit(self, pSm):
        '''
        Arguments:
        -pSm - PointerType("UIE_P_Sm_t")
        Return type:
    ...
    def UIE_P_GetAvailableBtes(self, ):
        '''
        Arguments:
        Return type:
        -WBST_BteId_t
        Declaration line: 975
        '''
        pass

    def UIE_P_StopMClinic(self, me, waitForStatus):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 1345
        '''
        pass

    def UIE_P_IsWaBatteryStatusValid(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1269
        '''
        pass

    def UIE_P_GetBteWithAlarmSet(self, alarmMask):
        '''
        Arguments:
        -alarmMask - WBST_Value_t
        Return type:
        -WBST_BteId_t
        Declaration line: 1061
        '''
        pass

    def UIE_P_SelectMap(self, me, key, bteId):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -key - KHDL_KeyId_t
        ...
        Return type:
        -bool
        Declaration line: 1278
        '''
        pass

    def UIE_P_CoverDisplay(self, mode, bteId):
        '''
        Arguments:
    ...
    def UIE_P_PwrModeSet(self, newPwrMode):
        '''
        Arguments:
        -newPwrMode - UIE_PwrMode_t
        Return type:
        -None
        Declaration line: 1245
        '''
        pass

    def UIE_P_IgnoreWakeUpKeyPress(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def UIE_P_SetStateLogId(self, logId):
        '''
        Arguments:
        -logId - ELOG_UiScreenType_t
        Return type:
        -None
        Declaration line: 1230
        '''
        pass

    def SmAfterTrans(self, pSm, pEvt):
        '''
        Arguments:
        -pSm - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_RestartGuiTimer(self, timerId):
        '''
        Arguments:
        -timerId - UIE_P_TimerId_t
        Return type:
    ...
    def OnActivity(self, ):
        ...
        Return type:
        -None
        Declaration line: 1452
        '''
        pass

    def UIE_P_PwrModeGet(self, ):
        '''
        Arguments:
        Return type:
        -UIE_PwrMode_t
        Declaration line: 1260
        '''
        pass

    def UIE_P_EnableDisplayDimming(self, enabled):
        '''
        Arguments:
        -enabled - bool
        Return type:
        -None
        Declaration line: 663
        '''
        pass

    def SmAfterEvent(self, pSm, pEvt):
        '''
        Arguments:
        -pSm - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -None
        Declaration line: 597
        '''
        pass

    def UIE_P_StartMClinic(self, me, bteId):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -bteId - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1326
        '''
        pass

    def UIE_P_IsInSimplifiedMode(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1146
        '''
        pass

    def UIE_P_SmWakeUp(self, pSm):
        '''
        Arguments:
        -pSm - PointerType("UIE_P_Sm_t")
        Return type:
        -None
        Declaration line: 205
        '''
        pass

    def UIE_P_CanPairNextBte(self, ):
        '''
        Arguments:
        Return type:
        -bool
    ...
    def UIE_P_AreBteSettingsValid(self, ):
        '''
        Arguments:
        Return type:
        -bool
    ...
    def OnDisplayCoverTimeout(self, timerParam):
        '''
        Arguments:
        -timerParam - u32
        Return type:
        -None
        Declaration line: 1490
        '''
        pass

    def UIE_P_WaitForBteStatus(self, bteId, statId, progressIndDelay):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -statId - WAE_BteStatusId_t
        ...
        Return type:
        -None
        Declaration line: 914
        '''
        pass

    def UIE_P_GetMapCategory(self, bteId, mapIndex):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -mapIndex - WBST_Value_t
        Return type:
        -WBST_Value_t
        Declaration line: 1098
        '''
        pass

    def UIE_P_SetBteSideStateLogId(self, bteId, bteShown, unknownOrBi, leftSide, rightSide):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -bteShown - WBST_BteId_t
        -unknownOrBi - ELOG_UiScreenType_t
        -leftSide - ELOG_UiScreenType_t
        -rightSide - ELOG_UiScreenType_t
        Return type:
        -None
        Declaration line: 1386
        '''
        pass

    def UIE_P_SmProcess(self, pSm, pEvt, itcSenderId):
        '''
        Arguments:
        -pSm - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        -itcSenderId - INT_ModId_t
        Return type:
        -None
    ...
    OSTmrFree = INT16U
    stateLogId = ELOG_UiScreenType_t
    OSTmrSemSignal = PointerType('OS_EVENT')
    OSRdyTbl = INT8U * 8
    OSIdleCtr = INT32U
    OSPrioHighRdy = INT8U
    keyLockPresentationEnabled = bool
    ...
    expectedEvent = expectedEvent__structure
    OSTmrTbl = OS_TMR * 26
    uieWaPwrMode = UIE_PwrMode_t
    OSTaskIdleStk = OS_STK * 128
    OSIntNesting = INT8U
    coverAnimComplete = bool
    guiTimerResults = ITC_TimerResult_t * 6
    OSTCBList = PointerType('OS_TCB')
    GUI_Font6x8 = GUI_FONT
    OSTmrWheelTbl = OS_TMR_WHEEL * 8
    OSQTbl = OS_Q * 20
    OSCtxSwCtr = INT32U
    guiTimer = PointerType("OS_TMR") * 6
    waBatteryStatusValid = bool
    OSTmrTime = INT32U
    OSTmrUsed = INT16U
    OSRdyGrp = INT8U
    ignoreWakeUpKey = bool
    OSFlagTbl = OS_FLAG_GRP * 5
    OSMemFreeList = PointerType('OS_MEM')
    OSTmrTaskStk = OS_STK * 128
    coverAnimFrame = u32
    wasKeypadLocked = bool
    timeBeforeSleep = u8 * 5
    ...
    def __init__(self, device):
        ...
        self.lastActivityId = StaticVariable(device, c_int_le, 0x80008454L, False)
        ...
        self.lastDisplayCoverId = StaticVariable(device, c_int_le, 0x8000844cL, False)
        self.dimmingEnabled = StaticVariable(device, self.bool, 0x8000843dL, False)
        self.GUI_XBF_APIList_Prop_Ext = StaticVariable(device, self.tGUI_XBF_APIList, 0x61c08, True)
        self.mode = StaticVariable(device, mode__enumeration, 0x80008445L, False)
        self.bteShown = StaticVariable(device, self.WBST_BteId_t, 0x80008443L, False)
        ...
        self.prevStateLogId = StaticVariable(device, self.ELOG_UiScreenType_t, 0x80008446L, False)
        ...
        self.stateLogId = StaticVariable(device, self.ELOG_UiScreenType_t, 0x80008448L, False)
        ...
        self.keyLockPresentationEnabled = StaticVariable(device, self.bool, 0x8000843eL, False)
        ...
        self.expectedEvent = StaticVariable(device, self.expectedEvent__structure, 0x8000e204L, False)
        self.OSTmrTbl = StaticVariable(device, OS_TMR * 26, 0x40005410, False)
        self.uieWaPwrMode = StaticVariable(device, self.UIE_PwrMode_t, 0x80008441L, False)
        ...
        self.coverAnimComplete = StaticVariable(device, self.bool, 0x8000843fL, False)
        self.guiTimerResults = StaticVariable(device, ITC_TimerResult_t * 6, 0x80008460L, False)
        ...
        self.guiTimer = StaticVariable(device, PointerType("OS_TMR") * 6, 0x8000e25cL, False)
        self.waBatteryStatusValid = StaticVariable(device, self.bool, 0x80008442L, False)
        ...
        self.ignoreWakeUpKey = StaticVariable(device, self.bool, 0x8000843cL, False)
        ...
        self.coverAnimFrame = StaticVariable(device, self.u32, 0x80008450L, False)
        self.wasKeypadLocked = StaticVariable(device, self.bool, 0x80008440L, False)
        self.timeBeforeSleep = StaticVariable(device, u8 * 5, 0x80008458L, False)
        self.OSTCBHighRdy = StaticVariable(device, PointerType("OS_TCB"), 0x40000060, False)

        ######################
        ### Functions data ###
        ######################
        self.UIE_P_StopGuiTimer = StaticFunction(device, 0x3a040, thumb=1, name='UIE_P_StopGuiTimer', return_type=None, size=52, line=852, arg_list=[('timerId',UIE_P_TimerId_t)])
        self.UIE_WritePersistentConfig = StaticFunction(device, 0x3a912, thumb=1, name='UIE_WritePersistentConfig', return_type=Status, size=26, line=1198, arg_list=[])
        self.UIE_P_StartGuiTimer = StaticFunction(device, 0x39ea0, thumb=1, name='UIE_P_StartGuiTimer', return_type=None, size=86, line=789, arg_list=[('timerId',UIE_P_TimerId_t),('delay',u32),('param',u32)])
        self.OnInactivityTimeout = StaticFunction(device, 0x3a478, thumb=1, name='OnInactivityTimeout', return_type=None, size=32, line=1476, arg_list=[('timerParam',u32)])
        self.UIE_P_HideProgressInd = StaticFunction(device, 0x3a410, thumb=1, name='UIE_P_HideProgressInd', return_type=None, size=24, line=898, arg_list=[])
        self.UIE_P_GetSupportedBtes = StaticFunction(device, 0x3a7ae, thumb=1, name='UIE_P_GetSupportedBtes', return_type=WBST_BteId_t, size=54, line=996, arg_list=[('supId',WBST_Value_t)])
        self.UIE_P_GetRealPairedBtes = StaticFunction(device, 0x3a780, thumb=1, name='UIE_P_GetRealPairedBtes', return_type=WBST_BteId_t, size=46, line=954, arg_list=[])
        self.HandleKeyLock = StaticFunction(device, 0x3a356, thumb=1, name='HandleKeyLock', return_type=bool, size=100, line=1511, arg_list=[('onWakeUp',bool)])
        self.UIE_P_IsKeypadLocked = StaticFunction(device, 0x3a182, thumb=1, name='UIE_P_IsKeypadLocked', return_type=bool, size=20, line=1559, arg_list=[])
        self.GetAudioInputCoverData = StaticFunction(device, 0x3a074, thumb=1, name='GetAudioInputCoverData', return_type=None, size=162, line=1573, arg_list=[('bteId',WBST_BteId_t),('audioInputData',PointerType('WAGUI_CoverAudioInputSide_t'))])
        self.UIE_P_IsMapUnset = StaticFunction(device, 0x3a7ea, thumb=1, name='UIE_P_IsMapUnset', return_type=bool, size=56, line=1035, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_EnableKeyLockPresentation = StaticFunction(device, 0x3a740, thumb=1, name='UIE_P_EnableKeyLockPresentation', return_type=None, size=6, line=676, arg_list=[('enabled',bool)])
        self.UIE_P_IsNonMclinicMvbt = StaticFunction(device, 0x3aac4, thumb=1, name='UIE_P_IsNonMclinicMvbt', return_type=bool, size=14, line=1567, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_ReadPersistentConfig = StaticFunction(device, 0x3a8d2, thumb=1, name='UIE_ReadPersistentConfig', return_type=Status, size=64, line=1165, arg_list=[])
        self.UIE_P_TriggerOutOfRangeAlarm = StaticFunction(device, 0x3aa9e, thumb=1, name='UIE_P_TriggerOutOfRangeAlarm', return_type=None, size=38, line=1430, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_SetShownBtes = StaticFunction(device, 0x3a7e4, thumb=1, name='UIE_P_SetShownBtes', return_type=None, size=6, line=1022, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_GetStreamerType = StaticFunction(device, 0x3a888, thumb=1, name='UIE_P_GetStreamerType', return_type=WBST_Value_t, size=50, line=1123, arg_list=[('bteId',WBST_BteId_t),('activeStreamer',WBST_Value_t)])
        self.UIE_P_GetPairedBtes = StaticFunction(device, 0x3a116, thumb=1, name='UIE_P_GetPairedBtes', return_type=WBST_BteId_t, size=46, line=929, arg_list=[])
        self.UIE_P_GetShownBtes = StaticFunction(device, 0x3a144, thumb=1, name='UIE_P_GetShownBtes', return_type=WBST_BteId_t, size=16, line=1016, arg_list=[])
        self.UIE_P_ShowProgressInd = StaticFunction(device, 0x3a746, thumb=1, name='UIE_P_ShowProgressInd', return_type=None, size=38, line=883, arg_list=[('progressIndDelay',u32)])
        self.UIE_P_IsSurgical = StaticFunction(device, 0x3a822, thumb=1, name='UIE_P_IsSurgical', return_type=bool, size=16, line=1159, arg_list=[])
        self.UIE_P_GetMClinicBteId = StaticFunction(device, 0x3a300, thumb=1, name='UIE_P_GetMClinicBteId', return_type=WBST_BteId_t, size=38, line=1366, arg_list=[])
        self.SmBeforeEvent = StaticFunction(device, 0x39f60, thumb=1, name='SmBeforeEvent', return_type=bool, size=190, line=516, arg_list=[('pSm',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_SmInit = StaticFunction(device, 0x3a01e, thumb=1, name='UIE_P_SmInit', return_type=None, size=34, line=186, arg_list=[('pSm',PointerType("UIE_P_Sm_t"))])
        self.UIE_P_GetAvailableBtes = StaticFunction(device, 0x3a154, thumb=1, name='UIE_P_GetAvailableBtes', return_type=WBST_BteId_t, size=46, line=975, arg_list=[])
        self.UIE_P_StopMClinic = StaticFunction(device, 0x3aa2a, thumb=1, name='UIE_P_StopMClinic', return_type=None, size=54, line=1345, arg_list=[('me',PointerType('UIE_P_Sm_t')),('waitForStatus',bool)])
        self.UIE_P_IsWaBatteryStatusValid = StaticFunction(device, 0x3a40a, thumb=1, name='UIE_P_IsWaBatteryStatusValid', return_type=bool, size=6, line=1269, arg_list=[])
        self.UIE_P_GetBteWithAlarmSet = StaticFunction(device, 0x39f34, thumb=1, name='UIE_P_GetBteWithAlarmSet', return_type=WBST_BteId_t, size=44, line=1061, arg_list=[('alarmMask',WBST_Value_t)])
        self.UIE_P_SelectMap = StaticFunction(device, 0x3a95a, thumb=1, name='UIE_P_SelectMap', return_type=bool, size=152, line=1278, arg_list=[('me',PointerType("UIE_P_Sm_t")),('key',KHDL_KeyId_t),('bteId',WBST_BteId_t)])
        self.UIE_P_CoverDisplay = StaticFunction(device, 0x3a196, thumb=1, name='UIE_P_CoverDisplay', return_type=None, size=342, line=685, arg_list=[('mode',WAGUI_CoverMode_t),('bteId',WBST_BteId_t)])
        self.UIE_P_PwrModeSet = StaticFunction(device, 0x3a94e, thumb=1, name='UIE_P_PwrModeSet', return_type=None, size=6, line=1245, arg_list=[('newPwrMode',UIE_PwrMode_t)])
        self.UIE_P_IgnoreWakeUpKeyPress = StaticFunction(device, 0x3a2f8, thumb=1, name='UIE_P_IgnoreWakeUpKeyPress', return_type=None, size=8, line=218, arg_list=[])
        self.UIE_P_SetStateLogId = StaticFunction(device, 0x3a948, thumb=1, name='UIE_P_SetStateLogId', return_type=None, size=6, line=1230, arg_list=[('logId',ELOG_UiScreenType_t)])
        self.SmAfterTrans = StaticFunction(device, 0x3a3ba, thumb=1, name='SmAfterTrans', return_type=None, size=80, line=627, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_RestartGuiTimer = StaticFunction(device, 0x3a428, thumb=1, name='UIE_P_RestartGuiTimer', return_type=None, size=22, line=832, arg_list=[('timerId',UIE_P_TimerId_t)])
        self.OnActivity = StaticFunction(device, 0x3a326, thumb=1, name='OnActivity', return_type=None, size=48, line=1452, arg_list=[])
        self.UIE_P_PwrModeGet = StaticFunction(device, 0x3a954, thumb=1, name='UIE_P_PwrModeGet', return_type=UIE_PwrMode_t, size=6, line=1260, arg_list=[])
        self.UIE_P_EnableDisplayDimming = StaticFunction(device, 0x3a724, thumb=1, name='UIE_P_EnableDisplayDimming', return_type=None, size=28, line=663, arg_list=[('enabled',bool)])
        self.SmAfterEvent = StaticFunction(device, 0x39ef6, thumb=1, name='SmAfterEvent', return_type=None, size=62, line=597, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StartMClinic = StaticFunction(device, 0x3a9f2, thumb=1, name='UIE_P_StartMClinic', return_type=None, size=56, line=1326, arg_list=[('me',PointerType('UIE_P_Sm_t')),('bteId',WBST_BteId_t)])
        self.UIE_P_IsInSimplifiedMode = StaticFunction(device, 0x3a8ba, thumb=1, name='UIE_P_IsInSimplifiedMode', return_type=bool, size=24, line=1146, arg_list=[])
        self.UIE_P_SmWakeUp = StaticFunction(device, 0x3a2ec, thumb=1, name='UIE_P_SmWakeUp', return_type=None, size=12, line=205, arg_list=[('pSm',PointerType("UIE_P_Sm_t"))])
        self.UIE_P_CanPairNextBte = StaticFunction(device, 0x3a832, thumb=1, name='UIE_P_CanPairNextBte', return_type=bool, size=42, line=1082, arg_list=[])
        self.UIE_P_AreBteSettingsValid = StaticFunction(device, 0x3a92c, thumb=1, name='UIE_P_AreBteSettingsValid', return_type=bool, size=28, line=1220, arg_list=[])
        self.OnDisplayCoverTimeout = StaticFunction(device, 0x3a43e, thumb=1, name='OnDisplayCoverTimeout', return_type=None, size=58, line=1490, arg_list=[('timerParam',u32)])
        self.UIE_P_WaitForBteStatus = StaticFunction(device, 0x3a76c, thumb=1, name='UIE_P_WaitForBteStatus', return_type=None, size=20, line=914, arg_list=[('bteId',WBST_BteId_t),('statId',WAE_BteStatusId_t),('progressIndDelay',u32)])
        self.UIE_P_GetMapCategory = StaticFunction(device, 0x3a85c, thumb=1, name='UIE_P_GetMapCategory', return_type=WBST_Value_t, size=44, line=1098, arg_list=[('bteId',WBST_BteId_t),('mapIndex',WBST_Value_t)])
        self.UIE_P_SetBteSideStateLogId = StaticFunction(device, 0x3aa60, thumb=1, name='UIE_P_SetBteSideStateLogId', return_type=None, size=62, line=1386, arg_list=[('bteId',WBST_BteId_t),('bteShown',WBST_BteId_t),('unknownOrBi',ELOG_UiScreenType_t),('leftSide',ELOG_UiScreenType_t),('rightSide',ELOG_UiScreenType_t)])
        self.UIE_P_SmProcess = StaticFunction(device, 0x3a498, thumb=1, name='UIE_P_SmProcess', return_type=None, size=652, line=241, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t")),('itcSenderId',INT_ModId_t)])
