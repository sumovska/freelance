...
class Code(AbstractCode):
    ...
    def LCD_SetPixelAA(self, x, y, Intens):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def LCD_SetPixelAA_NoTrans(self, x, y, Intens):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def LCD_AA_MixColors(self, Color, BkColor, Intens):
        '''
        Arguments:
        -Color - LCD_COLOR
        -BkColor - LCD_COLOR
    ...
    def LCD_SetPixelAA_Xor(self, x, y, Intens):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_SetPixelAA = StaticFunction(device, 0x2ef94, thumb=1, name='LCD_SetPixelAA', return_type=None, size=200, line=103, arg_list=[('x',c_int_le),('y',c_int_le),('Intens',c_ubyte)])
        self.LCD_SetPixelAA_NoTrans = StaticFunction(device, 0x2f0f6, thumb=1, name='LCD_SetPixelAA_NoTrans', return_type=None, size=228, line=141, arg_list=[('x',c_int_le),('y',c_int_le),('Intens',c_ubyte)])
        self.LCD_AA_MixColors = StaticFunction(device, 0x2ef38, thumb=1, name='LCD_AA_MixColors', return_type=LCD_COLOR, size=92, line=82, arg_list=[('Color',LCD_COLOR),('BkColor',LCD_COLOR),('Intens',c_ubyte)])
        self.LCD_SetPixelAA_Xor = StaticFunction(device, 0x2f05c, thumb=1, name='LCD_SetPixelAA_Xor', return_type=None, size=154, line=124, arg_list=[('x',c_int_le),('y',c_int_le),('Intens',c_ubyte)])
