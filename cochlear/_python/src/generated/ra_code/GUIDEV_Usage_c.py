...
class Code(AbstractCode):
    ...
    def GUI_USAGE_DecUseCnt(self, hUsage):
        '''
        Arguments:
        -hUsage - GUI_USAGE_Handle
        Return type:
        -None
        Declaration line: 53
        '''
    ...
    def GUI_USAGE_AddRect(self, pUsage, x0, y0, xSize, ySize):
        '''
        Arguments:
        -pUsage - PointerType('GUI_USAGE')
        -x0 - c_int_le
        -y0 - c_int_le
        -xSize - c_int_le
        -ySize - c_int_le
    ...
    def GUI_USAGE_Select(self, hUsage):
        '''
        Arguments:
        -hUsage - GUI_USAGE_Handle
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_USAGE_DecUseCnt = StaticFunction(device, 0x2e148, thumb=1, name='GUI_USAGE_DecUseCnt', return_type=None, size=32, line=53, arg_list=[('hUsage',GUI_USAGE_Handle)])
        self.GUI_USAGE_AddRect = StaticFunction(device, 0x2e168, thumb=1, name='GUI_USAGE_AddRect', return_type=None, size=40, line=70, arg_list=[('pUsage',PointerType('GUI_USAGE')),('x0',c_int_le),('y0',c_int_le),('xSize',c_int_le),('ySize',c_int_le)])
        self.GUI_USAGE_Select = StaticFunction(device, 0x2e134, thumb=1, name='GUI_USAGE_Select', return_type=None, size=20, line=38, arg_list=[('hUsage',GUI_USAGE_Handle)])
