...
class Code(AbstractCode):
    ...
    def GUI_DispStringInRectWrap(self, s, pRect, TextAlign, WrapMode):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_DispStringInRectWrap = StaticFunction(device, 0x30f48, thumb=1, name='GUI_DispStringInRectWrap', return_type=None, size=360, line=32, arg_list=[('s',PointerType('c_byte')),('pRect',PointerType("GUI_RECT")),('TextAlign',c_int_le),('WrapMode',GUI_WRAPMODE)])
