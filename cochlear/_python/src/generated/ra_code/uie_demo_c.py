...
class stubMclinicElConditioning__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    E_EL_COND_START = 0
    E_EL_COND_IN_PROGRESS = 1
    E_EL_COND_DONE = 2
...
class VolSensSetting_tag(Structure):
    vol = WBST_Value_t
    volDef = WBST_Value_t
    sens = WBST_Value_t
    sensDef = WBST_Value_t
    _pack_ = 1
    _fields_ = [
                ('vol', WBST_Value_t),
                ('volDef', WBST_Value_t),
...
class UIE_P_BteActions_tag(Structure):
...
UIE_P_BteActions_t = UIE_P_BteActions_tag
...
VolSensSetting_t = VolSensSetting_tag
...
class statusEvent__structure(Structure):
    bteStatus = WAE_BteStatus_t
...
class const():
    ...
    ### Defines ###
    ###############
    UIE_DEMO_TIMEOUT_DEFAULT = 2
    UIE_DEMO_TIMEOUT_MAP_ACTIVE_CHANGE = 2
    UIE_DEMO_TIMEOUT_RESET_MAP_DEFAULTS = 2
    UIE_DEMO_TIMEOUT_RESET_ALL_DEFAULTS = 2
    UIE_DEMO_MCL_MVBT_CHANGE = 2
    UIE_DEMO_TIMEOUT_DIAG = 10
    UIE_DEMO_TIMEOUT_DIAG_STOP = 30
    UIE_DEMO_MCL_FMC_INIT = 3
    UIE_DEMO_MCL_FMC_FINISHING = 5
    UIE_DEMO_AUDIO_TIMER_PERIOD_UNI = 5
    UIE_DEMO_AUDIO_TIMER_PERIOD_BI = 7
    UIE_DEMO_INVALID_ACTION_IDX = 255
    NUM_OF_MAPS = 4
    MCL_POST_FMC_TRACE_REQ_MAX = 24
    MCL_PFMC_MAX_SKIPS = 3
    MCL_IFMC_MAX_SKIPS = 3
    MCL_FMC_STUB_ELECTRODES = 5
    MCL_POST_FMC_PROGRESS_DLY = 10
    MCL_POST_FMC_EL_COND_STEPS = 3
    GUI_OS = 0
    GUI_SUPPORT_TOUCH = 0
    GUI_SUPPORT_MOUSE = 0
    ...
    MCL_FMC_ELECTRODES = 22
    MCL_FMC_INVALID_NRT = 0
    GUI_KEY_BACKSPACE = 8
    GUI_KEY_TAB = 9
    GUI_KEY_BACKTAB = 10
    GUI_KEY_ENTER = 13
...
class Code(AbstractCode):
    ...
    stubMclinicElConditioning__enumeration = stubMclinicElConditioning__enumeration
    ...
    VolSensSetting_tag = VolSensSetting_tag
    UIE_P_BteActions_tag = UIE_P_BteActions_tag
    ...
    UIE_P_BteActions_t = UIE_P_BteActions_t
    ...
    VolSensSetting_t = VolSensSetting_t
    ...
    statusEvent__structure = statusEvent__structure
    ...
    def UIE_P_IsDemoOn(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 648
        '''
        pass

    def UIE_P_DemoTimerHandler(self, ptmr, p_arg):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 739
        '''
        pass

    def demoMClinicDiagTimerHandler(self, ptmr, p_arg):
        '''
        Arguments:
        -ptmr - PointerType("void")
        -p_arg - PointerType('void')
        Return type:
        -None
        Declaration line: 1456
        '''
        pass

    def UIE_P_DemoGetBteLastNrtTraceData(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -PointerType("WBST_NrtTraceData_t")
        Declaration line: 1973
        '''
        pass

    def actionMClinicFMC(self, bteId, reqId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        ...
        Return type:
        -WAE_StatusCode_t
        Declaration line: 1488
        '''
        pass

    def UIE_P_DemoBteIdentifiersValid(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
    ...
    def UIE_P_DemoAudioTimerDelete(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 887
        '''
        pass

    def getVolSensSetting(self, bteId, settingId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -settingId - WBST_BteSettingId_t
        Return type:
        -WBST_Value_t
        Declaration line: 1079
        '''
        pass

    def UIE_P_DemoGetBteEcapProfile(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -PointerType('WBST_EcapProfile_t')
        Declaration line: 1979
        '''
        pass

    def UIE_P_DemoGetBteDiagElectrodeData(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -PointerType("WBST_ElectrodeData_t")
        Declaration line: 1905
        '''
        pass

    def UIE_P_DemoGetBteNrtTraceData(self, bteId, elNum):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -elNum - c_int_le
        Return type:
        -PointerType('WBST_NrtTraceData_t')
        Declaration line: 1920
        '''
        pass

    def getIndexForBteAction(self, actionId):
        '''
        Arguments:
        -actionId - WAE_BteUserActionId_t
        Return type:
        -u8
        Declaration line: 1367
        '''
        pass

    def handleBteAction(self, bteId, actId, value):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -actId - WAE_BteUserActionId_t
        -value - WAE_UserActionValue_t
        Return type:
        -WAE_StatusCode_t
        Declaration line: 1175
        '''
        pass

    def UIE_P_DemoSetWaMode(self, waMode):
        '''
        Arguments:
        -waMode - WBST_Value_t
        Return type:
        -c_int_le
        Declaration line: 2038
        '''
        pass

    def UIE_P_ShowDemoMode(self, show):
        '''
        Arguments:
        -show - bool
        Return type:
        -None
        Declaration line: 704
        '''
        pass

    def UIE_P_DemoGetBteNrtElectrodeData(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -PointerType("WBST_ElectrodeData_t")
        Declaration line: 1911
        '''
        pass

    def demoMClinicPostFmcTimerCreate(self, bteId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1839
        '''
        pass

    def UIE_P_DemoReinitBteSettings(self, bilateral):
        '''
        Arguments:
        -bilateral - bool
        Return type:
    ...
    def UIE_P_DemoAudioTimerStart(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 854
        '''
        pass

    def UIE_P_ExitDemoMode(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def UIE_P_IsDemoModeUnilateral(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 658
        '''
        pass

    def UIE_P_EnterDemoMode(self, bilateral):
        '''
        Arguments:
        -bilateral - bool
        Return type:
    ...
    def actionResetBteSettings(self, ):
        '''
        Arguments:
        Return type:
        -WAE_StatusCode_t
        Declaration line: 1134
        '''
        pass

    def demoMClinicPostFmcTimerDelete(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1888
        '''
        pass

    def UIE_P_DemoGetBteSetting(self, bteId, settingId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -settingId - WBST_BteSettingId_t
        Return type:
        -WBST_Value_t
        Declaration line: 972
        '''
        pass

    def UIE_P_DemoPostBteReq(self, pSm, bteId, actId, actValue, statId):
        '''
        Arguments:
    ...
    def demoMClinicPostFmcTimerStart(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1865
        '''
        pass

    def UIE_P_DemoGetBteIdentifiers(self, bteId, pIdent):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        ...
        Return type:
        -Status
        Declaration line: 940
        '''
        pass

    def actionVolSensChange(self, bteId, settingId, value, min, max):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -settingId - WBST_BteSettingId_t
        ...
        Return type:
        -WAE_StatusCode_t
        Declaration line: 1002
        '''
        pass

    def demoMClinicPostFmcTimerStop(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1876
        '''
        pass

    def UIE_P_DemoAudioTimerHandler(self, ptmr, p_arg):
        '''
        Arguments:
        -ptmr - PointerType('void')
        -p_arg - PointerType("void")
        Return type:
        -None
        Declaration line: 758
        '''
        pass

    def demoMClinicPostFmcTimerHandler(self, ptmr, p_arg):
        '''
        Arguments:
        -ptmr - PointerType('void')
        -p_arg - PointerType("void")
        Return type:
        -None
        Declaration line: 1660
        '''
        pass

    def actionMClinicDiag(self, bteId, action, continuous):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -action - WAE_BteUserActionId_t
        -continuous - bool
        Return type:
        -WAE_StatusCode_t
        Declaration line: 1415
        '''
        pass

    def getBteSetting(self, bteId, settingId):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -settingId - WBST_BteSettingId_t
    ...
    bteActions = UIE_P_BteActions_t * 24
    stubWbstBteIdent = WBST_BteIdentifiers_t * 2
    GUI_ENC_APIList_EXT = tGUI_ENC_APIList
    OSLockNesting = INT8U
    OSMemTbl = OS_MEM * 15
    OSTmrSem = PointerType("OS_EVENT")
    OSTaskCtr = INT8U
    stubDiagElectrodeData = WBST_ElectrodeData_t
    stubVolSensSettings = VolSensSetting_t * 4 * 2
    OSEventTbl = OS_EVENT * 80
    GUI_XBF_APIList_Prop_Ext = tGUI_XBF_APIList
    stubMclinicElOrder = u8 * 22
    stubMclinicAutoNRTCL = u8 * 24 * 5
    OSTCBCur = PointerType('OS_TCB')
    stubNrtElectrodeData = WBST_ElectrodeData_t
    GUI_MEMDEV__APIList16 = tLCDDEV_APIList_struct
    fmcStepMax = WBST_Value_t
    OSRunning = BOOLEAN
    OSFlagTbl = OS_FLAG_GRP * 5
    OSQFreeList = PointerType("OS_Q")
    OSTime = INT32U
    demoAudioTimer = PointerType('OS_TMR')
    OSTCBFreeList = PointerType("OS_TCB")
    fmcMaxSkips = WBST_Value_t
    stubMclinicElNum = u8
    stubMclinicDiagTimer = PointerType('OS_TMR')
    stubMclinicSkips = u8
    ...
    OSTmrFree = INT16U
    bteSettings = WBST_Value_t * 48 * 2
    OSTmrSemSignal = PointerType('OS_EVENT')
    OSRdyTbl = INT8U * 8
    stubMclinicFmcTimer = PointerType("OS_TMR")
    demoModeBilateral = bool
    OSIdleCtr = INT32U
    OSPrioHighRdy = INT8U
    OSUnMapTbl = INT8U * 256
    stubEcapProfile = WBST_EcapProfile_t
    stubWaMode = WBST_Value_t
    OSTCBPrioTbl = PointerType('OS_TCB') * 61
    OSFlagFreeList = PointerType("OS_FLAG_GRP")
    statusEvent = statusEvent__structure
    ...
    stubWbstBteSetting = WBST_Value_t * 48 * 2
    GUI_Font6x8 = GUI_FONT
    OSQTbl = OS_Q * 20
    volSensSettings = VolSensSetting_t * 4 * 2
    OSCtxSwCtr = INT32U
    demoTimer = PointerType("OS_TMR")
    OSTmrTime = INT32U
    OSTmrUsed = INT16U
    OSRdyGrp = INT8U
    UIE_P_info = UIE_Info_t
    OSMemFreeList = PointerType('OS_MEM')
    stubMclinicAutoNRT = s16 * 30 * 24
    OSTmrTaskStk = OS_STK * 128
    stubMclinicElConditioningStep = u8
    stubMclinicCurrentLvlIdx = u8
    stubMclinicElConditioning = stubMclinicElConditioning__enumeration
    ...
    def __init__(self, device):
        ...
        ### Variables ###
        #################
        self.bteActions = StaticVariable(device, UIE_P_BteActions_t * 24, 0x6fbcc, True)
        self.stubWbstBteIdent = StaticVariable(device, WBST_BteIdentifiers_t * 2, 0x6fc44, True)
        ...
        self.stubDiagElectrodeData = StaticVariable(device, self.WBST_ElectrodeData_t, 0x8000dfd2L, False)
        self.stubVolSensSettings = StaticVariable(device, VolSensSetting_t * 4 * 2, 0x8000debcL, False)
        ...
        self.stubMclinicElOrder = StaticVariable(device, u8 * 22, 0x8000dfbcL, False)
        self.stubMclinicAutoNRTCL = StaticVariable(device, u8 * 24 * 5, 0x6fc80, True)
        self.OSTCBCur = StaticVariable(device, PointerType('OS_TCB'), 0x40000058, False)
        self.stubNrtElectrodeData = StaticVariable(device, self.WBST_ElectrodeData_t, 0x8000dfebL, False)
        self.GUI_MEMDEV__APIList16 = StaticVariable(device, self.tLCDDEV_APIList_struct, 0x61b4c, True)
        self.fmcStepMax = StaticVariable(device, self.WBST_Value_t, 0x800083c0L, False)
        ...
        self.demoAudioTimer = StaticVariable(device, PointerType('OS_TMR'), 0x800083ccL, False)
        self.OSTCBFreeList = StaticVariable(device, PointerType("OS_TCB"), 0x4000005c, False)
        self.fmcMaxSkips = StaticVariable(device, self.WBST_Value_t, 0x800083c2L, False)
        self.stubMclinicElNum = StaticVariable(device, self.u8, 0x800083baL, False)
        self.stubMclinicDiagTimer = StaticVariable(device, PointerType('OS_TMR'), 0x800083d4L, False)
        self.stubMclinicSkips = StaticVariable(device, self.u8, 0x800083beL, False)
        ...
        self.bteSettings = StaticVariable(device, WBST_Value_t * 48 * 2, 0x6facc, True)
        ...
        self.stubMclinicFmcTimer = StaticVariable(device, PointerType("OS_TMR"), 0x800083d0L, False)
        self.demoModeBilateral = StaticVariable(device, self.bool, 0x800083b9L, False)
        ...
        self.stubEcapProfile = StaticVariable(device, self.WBST_EcapProfile_t, 0x800083eaL, False)
        self.stubWaMode = StaticVariable(device, self.WBST_Value_t, 0x800083c4L, False)
        ...
        self.statusEvent = StaticVariable(device, self.statusEvent__structure, 0x800083e4L, False)
        ...
        self.demoModeOn = StaticVariable(device, self.bool, 0x800083b8L, False)
        self.OSTmrWheelTbl = StaticVariable(device, OS_TMR_WHEEL * 8, 0x40005b58, False)
        self.stubWbstBteSetting = StaticVariable(device, WBST_Value_t * 48 * 2, 0x8000defcL, False)
        ...
        self.volSensSettings = StaticVariable(device, VolSensSetting_t * 4 * 2, 0x6fb8c, True)
        self.OSCtxSwCtr = StaticVariable(device, self.INT32U, 0x4000004c, False)
        self.demoTimer = StaticVariable(device, PointerType("OS_TMR"), 0x800083c8L, False)
        ...
        self.stubMclinicAutoNRT = StaticVariable(device, s16 * 30 * 24, 0x6fcf8, True)
        self.OSTmrTaskStk = StaticVariable(device, OS_STK * 128, 0x40005958, False)
        self.stubMclinicElConditioningStep = StaticVariable(device, self.u8, 0x800083bdL, False)
        self.stubMclinicCurrentLvlIdx = StaticVariable(device, self.u8, 0x800083bbL, False)
        self.stubMclinicElConditioning = StaticVariable(device, stubMclinicElConditioning__enumeration, 0x800083bcL, False)
        self.OSTaskIdleStk = StaticVariable(device, OS_STK * 128, 0x400043a4, False)

        ######################
        ### Functions data ###
        ######################
        self.UIE_P_IsDemoOn = StaticFunction(device, 0x394b0, thumb=1, name='UIE_P_IsDemoOn', return_type=bool, size=6, line=648, arg_list=[])
        self.UIE_P_DemoTimerHandler = StaticFunction(device, 0x38d3c, thumb=1, name='UIE_P_DemoTimerHandler', return_type=None, size=32, line=739, arg_list=[('ptmr',PointerType("void")),('p_arg',PointerType('void'))])
        self.demoMClinicDiagTimerHandler = StaticFunction(device, 0x39096, thumb=1, name='demoMClinicDiagTimerHandler', return_type=None, size=132, line=1456, arg_list=[('ptmr',PointerType("void")),('p_arg',PointerType('void'))])
        self.UIE_P_DemoGetBteLastNrtTraceData = StaticFunction(device, 0x398b2, thumb=1, name='UIE_P_DemoGetBteLastNrtTraceData', return_type=PointerType("WBST_NrtTraceData_t"), size=12, line=1973, arg_list=[('bteId',WBST_BteId_t)])
        self.actionMClinicFMC = StaticFunction(device, 0x38f5c, thumb=1, name='actionMClinicFMC', return_type=WAE_StatusCode_t, size=314, line=1488, arg_list=[('bteId',WBST_BteId_t),('reqId',WAE_BteUserActionId_t)])
        self.UIE_P_DemoBteIdentifiersValid = StaticFunction(device, 0x396fa, thumb=1, name='UIE_P_DemoBteIdentifiersValid', return_type=bool, size=10, line=912, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_DemoAudioTimerDelete = StaticFunction(device, 0x396ce, thumb=1, name='UIE_P_DemoAudioTimerDelete', return_type=None, size=26, line=887, arg_list=[])
        self.getVolSensSetting = StaticFunction(device, 0x39726, thumb=1, name='getVolSensSetting', return_type=WBST_Value_t, size=124, line=1079, arg_list=[('bteId',WBST_BteId_t),('settingId',WBST_BteSettingId_t)])
        self.UIE_P_DemoGetBteEcapProfile = StaticFunction(device, 0x398be, thumb=1, name='UIE_P_DemoGetBteEcapProfile', return_type=PointerType('WBST_EcapProfile_t'), size=278, line=1979, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_DemoGetBteDiagElectrodeData = StaticFunction(device, 0x397c0, thumb=1, name='UIE_P_DemoGetBteDiagElectrodeData', return_type=PointerType("WBST_ElectrodeData_t"), size=6, line=1905, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_DemoGetBteNrtTraceData = StaticFunction(device, 0x397cc, thumb=1, name='UIE_P_DemoGetBteNrtTraceData', return_type=PointerType('WBST_NrtTraceData_t'), size=230, line=1920, arg_list=[('bteId',WBST_BteId_t),('elNum',c_int_le)])
        self.getIndexForBteAction = StaticFunction(device, 0x39246, thumb=1, name='getIndexForBteAction', return_type=u8, size=42, line=1367, arg_list=[('actionId',WAE_BteUserActionId_t)])
        self.handleBteAction = StaticFunction(device, 0x39270, thumb=1, name='handleBteAction', return_type=WAE_StatusCode_t, size=456, line=1175, arg_list=[('bteId',WBST_BteId_t),('actId',WAE_BteUserActionId_t),('value',WAE_UserActionValue_t)])
        self.UIE_P_DemoSetWaMode = StaticFunction(device, 0x3966c, thumb=1, name='UIE_P_DemoSetWaMode', return_type=c_int_le, size=58, line=2038, arg_list=[('waMode',WBST_Value_t)])
        self.UIE_P_ShowDemoMode = StaticFunction(device, 0x3963a, thumb=1, name='UIE_P_ShowDemoMode', return_type=None, size=50, line=704, arg_list=[('show',bool)])
        self.UIE_P_DemoGetBteNrtElectrodeData = StaticFunction(device, 0x397c6, thumb=1, name='UIE_P_DemoGetBteNrtElectrodeData', return_type=PointerType("WBST_ElectrodeData_t"), size=6, line=1911, arg_list=[('bteId',WBST_BteId_t)])
        self.demoMClinicPostFmcTimerCreate = StaticFunction(device, 0x38f24, thumb=1, name='demoMClinicPostFmcTimerCreate', return_type=None, size=56, line=1839, arg_list=[('bteId',WBST_BteId_t)])
        self.UIE_P_DemoReinitBteSettings = StaticFunction(device, 0x38cb4, thumb=1, name='UIE_P_DemoReinitBteSettings', return_type=None, size=136, line=524, arg_list=[('bilateral',bool)])
        self.UIE_P_DemoAudioTimerStart = StaticFunction(device, 0x39606, thumb=1, name='UIE_P_DemoAudioTimerStart', return_type=None, size=52, line=854, arg_list=[])
        self.UIE_P_ExitDemoMode = StaticFunction(device, 0x396e8, thumb=1, name='UIE_P_ExitDemoMode', return_type=None, size=18, line=692, arg_list=[])
        self.UIE_P_IsDemoModeUnilateral = StaticFunction(device, 0x394b6, thumb=1, name='UIE_P_IsDemoModeUnilateral', return_type=bool, size=20, line=658, arg_list=[])
        self.UIE_P_EnterDemoMode = StaticFunction(device, 0x396a6, thumb=1, name='UIE_P_EnterDemoMode', return_type=None, size=40, line=669, arg_list=[('bilateral',bool)])
        self.actionResetBteSettings = StaticFunction(device, 0x39178, thumb=1, name='actionResetBteSettings', return_type=WAE_StatusCode_t, size=50, line=1134, arg_list=[])
        self.demoMClinicPostFmcTimerDelete = StaticFunction(device, 0x38d5c, thumb=1, name='demoMClinicPostFmcTimerDelete', return_type=None, size=28, line=1888, arg_list=[])
        self.UIE_P_DemoGetBteSetting = StaticFunction(device, 0x397a2, thumb=1, name='UIE_P_DemoGetBteSetting', return_type=WBST_Value_t, size=30, line=972, arg_list=[('bteId',WBST_BteId_t),('settingId',WBST_BteSettingId_t)])
        self.UIE_P_DemoPostBteReq = StaticFunction(device, 0x39438, thumb=1, name='UIE_P_DemoPostBteReq', return_type=None, size=120, line=589, arg_list=[('pSm',PointerType('UIE_P_Sm_t')),('bteId',WBST_BteId_t),('actId',WAE_BteUserActionId_t),('actValue',WAE_UserActionValue_t),('statId',WAE_BteStatusId_t)])
        self.demoMClinicPostFmcTimerStart = StaticFunction(device, 0x38d78, thumb=1, name='demoMClinicPostFmcTimerStart', return_type=None, size=20, line=1865, arg_list=[])
        self.UIE_P_DemoGetBteIdentifiers = StaticFunction(device, 0x39704, thumb=1, name='UIE_P_DemoGetBteIdentifiers', return_type=Status, size=34, line=940, arg_list=[('bteId',WBST_BteId_t),('pIdent',PointerType("PointerType('WBST_BteIdentifiers_t')"))])
        self.actionVolSensChange = StaticFunction(device, 0x391cc, thumb=1, name='actionVolSensChange', return_type=WAE_StatusCode_t, size=122, line=1002, arg_list=[('bteId',WBST_BteId_t),('settingId',WBST_BteSettingId_t),('value',WBST_Value_t),('min',u8),('max',u8)])
        self.demoMClinicPostFmcTimerStop = StaticFunction(device, 0x38d8c, thumb=1, name='demoMClinicPostFmcTimerStop', return_type=None, size=20, line=1876, arg_list=[])
        self.UIE_P_DemoAudioTimerHandler = StaticFunction(device, 0x394ca, thumb=1, name='UIE_P_DemoAudioTimerHandler', return_type=None, size=316, line=758, arg_list=[('ptmr',PointerType('void')),('p_arg',PointerType("void"))])
        self.demoMClinicPostFmcTimerHandler = StaticFunction(device, 0x38da0, thumb=1, name='demoMClinicPostFmcTimerHandler', return_type=None, size=388, line=1660, arg_list=[('ptmr',PointerType('void')),('p_arg',PointerType("void"))])
        self.actionMClinicDiag = StaticFunction(device, 0x3911a, thumb=1, name='actionMClinicDiag', return_type=WAE_StatusCode_t, size=94, line=1415, arg_list=[('bteId',WBST_BteId_t),('action',WAE_BteUserActionId_t),('continuous',bool)])
        self.getBteSetting = StaticFunction(device, 0x391aa, thumb=1, name='getBteSetting', return_type=WBST_Value_t, size=34, line=1393, arg_list=[('bteId',WBST_BteId_t),('settingId',WBST_BteSettingId_t)])
