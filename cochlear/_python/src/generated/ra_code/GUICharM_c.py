...
class Code(AbstractCode):
    ...
    def GUIMONO_IsInFont(self, pFont, c):
        '''
        Arguments:
    ...
    def GUIMONO_GetFontInfo(self, pFont, pfi):
        '''
        Arguments:
        -pFont - PointerType('GUI_FONT')
    ...
    def GUIMONO_GetCharDistX(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUIMONO_IsInFont = StaticFunction(device, 0x2d1a6, thumb=1, name='GUIMONO_IsInFont', return_type=c_byte, size=58, line=142, arg_list=[('pFont',PointerType("GUI_FONT")),('c',c_ushort_le)])
        self.GUIMONO_DispChar = StaticFunction(device, 0x2d064, thumb=1, name='GUIMONO_DispChar', return_type=None, size=306, line=39, arg_list=[('c',c_ushort_le)])
        self.GUIMONO_GetFontInfo = StaticFunction(device, 0x2d1a0, thumb=1, name='GUIMONO_GetFontInfo', return_type=None, size=6, line=133, arg_list=[('pFont',PointerType('GUI_FONT')),('pfi',PointerType("GUI_FONTINFO"))])
        self.GUIMONO_GetCharDistX = StaticFunction(device, 0x2d196, thumb=1, name='GUIMONO_GetCharDistX', return_type=c_int_le, size=10, line=123, arg_list=[('c',c_ushort_le)])
