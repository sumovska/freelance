...
class CIP3_CoefficientsAndSizes_t__structure(Structure):
    coefficient = CIP3_CoefficientId_t
    size = CIP3_CoefficientSize_t
    _fields_ = [
                ('coefficient', CIP3_CoefficientId_t),
                ('size', CIP3_CoefficientSize_t),
               ]
...
class CIP3_ActionResponsePacket_t__structure(Structure):
    id = u8
    size = u8 * 2
    data = u8 * 28
    _pack_ = 1
...
class CIP3_StatusTokensAndSizes_t__structure(Structure):
    token = CIP3_StatusToken_t
    size = CIP3_StatusTokenSize_t
    _pack_ = 1
    _fields_ = [
                ('token', CIP3_StatusToken_t),
                ('size', CIP3_StatusTokenSize_t),
...
class CIP3_Packet_t__structure(Structure):
    id = u8
    size = u8 * 2
    data = u8 * 28
    _pack_ = 1
...
CIP3_CoefficientsAndSizes_t = CIP3_CoefficientsAndSizes_t__structure
...
CIP3_ActionResponsePacket_t = CIP3_ActionResponsePacket_t__structure
...
CIP3_StatusTokensAndSizes_t = CIP3_StatusTokensAndSizes_t__structure
WDLP_PairAck_t = WDLP_PairAck_tag
CIP3_Packet_t = CIP3_Packet_t__structure
...
class Code(AbstractCode):
    ...
    CIP3_CoefficientsAndSizes_t__structure = CIP3_CoefficientsAndSizes_t__structure
    os_sem_data = os_sem_data
    ...
    CIP3_ActionResponsePacket_t__structure = CIP3_ActionResponsePacket_t__structure
    ITC_EvntHdr_tag = ITC_EvntHdr_tag
    ITC_TimerResult_tag = ITC_TimerResult_tag
    CIP3_StatusTokensAndSizes_t__structure = CIP3_StatusTokensAndSizes_t__structure
    ...
    CIP3_Packet_t__structure = CIP3_Packet_t__structure
    os_mutex_data = os_mutex_data
    ...
    CIP3_CoefficientsAndSizes_t = CIP3_CoefficientsAndSizes_t
    OS_SEM_DATA = OS_SEM_DATA
    ...
    CIP3_ActionResponsePacket_t = CIP3_ActionResponsePacket_t
    ...
    CIP3_StatusTokensAndSizes_t = CIP3_StatusTokensAndSizes_t
    WDLP_PairAck_t = WDLP_PairAck_t
    CIP3_Packet_t = CIP3_Packet_t
    ...
    def CIP3_SendWriteCoefficient(self, bte, coefficients, coefficientsCount, values):
        '''
        Arguments:
        -bte - INT_Bte_t
        -coefficients - PointerType("CIP3_CoefficientId_t")
    ...
    def CIP3_CheckBteCompatibility(self, standaloneIntVer, requiredVer):
        '''
        Arguments:
        -standaloneIntVer - PointerType("u8")
        -requiredVer - PointerType('u8')
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP3_GetTokenSize(self, token):
        '''
        Arguments:
        -token - CIP3_StatusToken_t
        Return type:
        -CIP3_StatusTokenSize_t
        Declaration line: 285
        '''
        pass

    def CIP3_SendGetStatus(self, bte, tokens, outTokens, noOfTokens, outValues, outLength):
        '''
        Arguments:
        -bte - INT_Bte_t
        -tokens - PointerType("u8")
        -outTokens - PointerType('u8')
        -noOfTokens - u8
        -outValues - PointerType("u8")
        -outLength - PointerType('u8')
        Return type:
        -CIP_ProcResult_t
        Declaration line: 63
        '''
    ...
    def CIP3_SendAction(self, bte, action, parameters, parametersSize):
        '''
        Arguments:
        -bte - INT_Bte_t
        -action - u8
    ...
    def CIP3_GetCoefficientSize(self, coefficient):
        '''
        Arguments:
        -coefficient - CIP3_CoefficientId_t
        Return type:
        -CIP3_CoefficientSize_t
        Declaration line: 312
        '''
        pass

    def CIP3_SendReadCoefficient(self, bte, coefficients, coefficientsCount, outValues, outLength):
        '''
        Arguments:
        -bte - INT_Bte_t
        -coefficients - PointerType('CIP3_CoefficientId_t')
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.CIP3_SendWriteCoefficient = StaticFunction(device, 0x56a78, thumb=1, name='CIP3_SendWriteCoefficient', return_type=CIP_ProcResult_t, size=222, line=194, arg_list=[('bte',INT_Bte_t),('coefficients',PointerType("CIP3_CoefficientId_t")),('coefficientsCount',u8),('values',PointerType('u8'))])
        self.CIP3_CheckBteCompatibility = StaticFunction(device, 0x56bbe, thumb=1, name='CIP3_CheckBteCompatibility', return_type=CIP_ProcResult_t, size=40, line=375, arg_list=[('standaloneIntVer',PointerType("u8")),('requiredVer',PointerType('u8'))])
        self.CIP3_GetTokenSize = StaticFunction(device, 0x5687c, thumb=1, name='CIP3_GetTokenSize', return_type=CIP3_StatusTokenSize_t, size=34, line=285, arg_list=[('token',CIP3_StatusToken_t)])
        self.CIP3_SendGetStatus = StaticFunction(device, 0x5689e, thumb=1, name='CIP3_SendGetStatus', return_type=CIP_ProcResult_t, size=252, line=63, arg_list=[('bte',INT_Bte_t),('tokens',PointerType("u8")),('outTokens',PointerType('u8')),('noOfTokens',u8),('outValues',PointerType("u8")),('outLength',PointerType('u8'))])
        self.CIP3_SendAction = StaticFunction(device, 0x56b56, thumb=1, name='CIP3_SendAction', return_type=CIP_ProcResult_t, size=104, line=254, arg_list=[('bte',INT_Bte_t),('action',u8),('parameters',PointerType("u8")),('parametersSize',u8)])
        self.CIP3_GetCoefficientSize = StaticFunction(device, 0x5699a, thumb=1, name='CIP3_GetCoefficientSize', return_type=CIP3_CoefficientSize_t, size=36, line=312, arg_list=[('coefficient',CIP3_CoefficientId_t)])
        self.CIP3_SendReadCoefficient = StaticFunction(device, 0x569be, thumb=1, name='CIP3_SendReadCoefficient', return_type=CIP_ProcResult_t, size=186, line=143, arg_list=[('bte',INT_Bte_t),('coefficients',PointerType('CIP3_CoefficientId_t')),('coefficientsCount',u8),('outValues',PointerType("u8")),('outLength',PointerType('u8'))])
