...
class Code(AbstractCode):
    ...
    def GUI_DrawLineRel(self, dx, dy):
        '''
        Arguments:
        -dx - c_int_le
        -dy - c_int_le
    ...
    def GUI_DrawLineTo(self, x, y):
        ...
        Return type:
        -None
        Declaration line: 527
        '''
        pass

    def GL_DrawLine(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_DrawLineTo(self, x, y):
        ...
        Return type:
        -None
        Declaration line: 517
        '''
        pass

    def GUI_DrawLine(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_DrawLineEx(self, x0, y0, x1, y1, pPixelCnt):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        -x1 - c_int_le
        -y1 - c_int_le
        -pPixelCnt - PointerType("c_uint_le")
        Return type:
        -None
    ...
    def GL_DrawLine1(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_DrawLine1Ex(self, x0, y0, x1, y1, pPixelCnt):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GL_DrawLineToEx(self, x, y, pPixelCnt):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def __init__(self, device):
        ...
        self.aSin = StaticVariable(device, c_ushort_le * 17, 0x61b90, True)
        self.aTan = StaticVariable(device, c_short_le * 17, 0x61bb2, True)
        ...
        ### Functions data ###
        ######################
        self.GUI_DrawLineRel = StaticFunction(device, 0x2ee6c, thumb=1, name='GUI_DrawLineRel', return_type=None, size=52, line=489, arg_list=[('dx',c_int_le),('dy',c_int_le)])
        self.GUI_DrawLineTo = StaticFunction(device, 0x2eef2, thumb=1, name='GUI_DrawLineTo', return_type=None, size=50, line=527, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.GL_DrawLine = StaticFunction(device, 0x2ee34, thumb=1, name='GL_DrawLine', return_type=None, size=28, line=455, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.GL_DrawLineTo = StaticFunction(device, 0x2eec4, thumb=1, name='GL_DrawLineTo', return_type=None, size=46, line=517, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.GUI_DrawLine = StaticFunction(device, 0x2ee50, thumb=1, name='GUI_DrawLine', return_type=None, size=28, line=465, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.GUI_cos = StaticFunction(device, 0x2e856, thumb=1, name='GUI_cos', return_type=c_int_le, size=78, line=136, arg_list=[('angle',c_int_le)])
        self.GUI_sin = StaticFunction(device, 0x2e808, thumb=1, name='GUI_sin', return_type=c_int_le, size=78, line=106, arg_list=[('angle',c_int_le)])
        self.GL_DrawLineEx = StaticFunction(device, 0x2ec06, thumb=1, name='GL_DrawLineEx', return_type=None, size=558, line=409, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le),('pPixelCnt',PointerType("c_uint_le"))])
        self.GL_DrawLine1 = StaticFunction(device, 0x2ebea, thumb=1, name='GL_DrawLine1', return_type=None, size=28, line=399, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.GL_DrawLine1Ex = StaticFunction(device, 0x2e8a4, thumb=1, name='GL_DrawLine1Ex', return_type=None, size=838, line=300, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le),('pPixelCnt',PointerType('c_uint_le'))])
        self.GL_DrawLineToEx = StaticFunction(device, 0x2eea0, thumb=1, name='GL_DrawLineToEx', return_type=None, size=36, line=507, arg_list=[('x',c_int_le),('y',c_int_le),('pPixelCnt',PointerType("c_uint_le"))])
