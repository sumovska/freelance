...
class Code(AbstractCode):
    ...
    def OSSemSet(self, pevent, cnt, err):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -cnt - INT16U
    ...
    def OSSemQuery(self, pevent, p_sem_data):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -p_sem_data - PointerType("OS_SEM_DATA")
        Return type:
        -INT8U
        Declaration line: 505
        '''
        pass

    def OSSemPendAbort(self, pevent, opt, err):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -opt - INT8U
    ...
    def OSSemPend(self, pevent, timeout, err):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -timeout - INT16U
    ...
    def OSSemDel(self, pevent, opt, err):
        '''
        Arguments:
        -pevent - PointerType("OS_EVENT")
        -opt - INT8U
    ...
    def OSSemPost(self, pevent):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        Return type:
        -INT8U
        Declaration line: 451
        '''
        pass
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.OSSemAccept = StaticFunction(device, 0x29f94, thumb=1, name='OSSemAccept', return_type=INT16U, size=40, line=49, arg_list=[('pevent',PointerType("OS_EVENT"))])
        self.OSSemSet = StaticFunction(device, 0x2a252, thumb=1, name='OSSemSet', return_type=None, size=54, line=571, arg_list=[('pevent',PointerType('OS_EVENT')),('cnt',INT16U),('err',PointerType("INT8U"))])
        self.OSSemQuery = StaticFunction(device, 0x2a214, thumb=1, name='OSSemQuery', return_type=INT8U, size=62, line=505, arg_list=[('pevent',PointerType('OS_EVENT')),('p_sem_data',PointerType("OS_SEM_DATA"))])
        self.OSSemPendAbort = StaticFunction(device, 0x2a152, thumb=1, name='OSSemPendAbort', return_type=INT8U, size=112, line=382, arg_list=[('pevent',PointerType('OS_EVENT')),('opt',INT8U),('err',PointerType("INT8U"))])
        self.OSSemPend = StaticFunction(device, 0x2a0b0, thumb=1, name='OSSemPend', return_type=None, size=162, line=281, arg_list=[('pevent',PointerType('OS_EVENT')),('timeout',INT16U),('err',PointerType("INT8U"))])
        self.OSSemCreate = StaticFunction(device, 0x29fbc, thumb=1, name='OSSemCreate', return_type=PointerType('OS_EVENT'), size=66, line=94, arg_list=[('cnt',INT16U)])
        self.OSSemDel = StaticFunction(device, 0x29ffe, thumb=1, name='OSSemDel', return_type=PointerType("OS_EVENT"), size=178, line=164, arg_list=[('pevent',PointerType("OS_EVENT")),('opt',INT8U),('err',PointerType('INT8U'))])
        self.OSSemPost = StaticFunction(device, 0x2a1c2, thumb=1, name='OSSemPost', return_type=INT8U, size=82, line=451, arg_list=[('pevent',PointerType('OS_EVENT'))])
