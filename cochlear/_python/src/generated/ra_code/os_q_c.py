...
class Code(AbstractCode):
    ...
    def OSQPostOpt(self, pevent, msg, opt):
        '''
        Arguments:
    ...
    def OSQPost(self, pevent, msg):
        ...
        Return type:
        -INT8U
        Declaration line: 568
        '''
        pass

    def OSQPend(self, pevent, timeout, err):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -timeout - INT16U
    ...
    def OSQPostFront(self, pevent, msg):
        '''
        Arguments:
        -pevent - PointerType("OS_EVENT")
        -msg - PointerType('void')
        Return type:
        -INT8U
        Declaration line: 630
        '''
        pass

    def OSQCreate(self, start, size):
        '''
        Arguments:
        -start - PointerType("PointerType('void')")
        -size - INT16U
        Return type:
        -PointerType('OS_EVENT')
        Declaration line: 121
        '''
        pass

    def OSQDel(self, pevent, opt, err):
        '''
        Arguments:
        -pevent - PointerType("OS_EVENT")
        -opt - INT8U
    ...
    def OSQQuery(self, pevent, p_q_data):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -p_q_data - PointerType("OS_Q_DATA")
        Return type:
        -INT8U
        Declaration line: 775
        '''
        pass
    ...
    def OSQPendAbort(self, pevent, opt, err):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        -opt - INT8U
        ...
        Return type:
        -INT8U
        Declaration line: 497
        '''
        pass

    def OSQFlush(self, pevent):
        '''
        Arguments:
        -pevent - PointerType('OS_EVENT')
        Return type:
        -INT8U
        Declaration line: 324
        '''
        pass

    def OSQAccept(self, pevent, err):
        '''
        Arguments:
        -pevent - PointerType("OS_EVENT")
        -err - PointerType('INT8U')
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.OSQPostOpt = StaticFunction(device, 0x29e52, thumb=1, name='OSQPostOpt', return_type=INT8U, size=182, line=701, arg_list=[('pevent',PointerType('OS_EVENT')),('msg',PointerType("void")),('opt',INT8U)])
        self.OSQPost = StaticFunction(device, 0x29d7c, thumb=1, name='OSQPost', return_type=INT8U, size=108, line=568, arg_list=[('pevent',PointerType('OS_EVENT')),('msg',PointerType("void"))])
        self.OSQPend = StaticFunction(device, 0x29c5c, thumb=1, name='OSQPend', return_type=PointerType('void'), size=176, line=388, arg_list=[('pevent',PointerType('OS_EVENT')),('timeout',INT16U),('err',PointerType("INT8U"))])
        self.OSQPostFront = StaticFunction(device, 0x29de8, thumb=1, name='OSQPostFront', return_type=INT8U, size=106, line=630, arg_list=[('pevent',PointerType("OS_EVENT")),('msg',PointerType('void'))])
        self.OSQCreate = StaticFunction(device, 0x29afc, thumb=1, name='OSQCreate', return_type=PointerType('OS_EVENT'), size=126, line=121, arg_list=[('start',PointerType("PointerType('void')")),('size',INT16U)])
        self.OSQDel = StaticFunction(device, 0x29b7a, thumb=1, name='OSQDel', return_type=PointerType("OS_EVENT"), size=194, line=212, arg_list=[('pevent',PointerType("OS_EVENT")),('opt',INT8U),('err',PointerType('INT8U'))])
        self.OSQQuery = StaticFunction(device, 0x29f08, thumb=1, name='OSQQuery', return_type=INT8U, size=82, line=775, arg_list=[('pevent',PointerType('OS_EVENT')),('p_q_data',PointerType("OS_Q_DATA"))])
        self.OS_QInit = StaticFunction(device, 0x29f5a, thumb=1, name='OS_QInit', return_type=None, size=48, line=839, arg_list=[])
        self.OSQPendAbort = StaticFunction(device, 0x29d0c, thumb=1, name='OSQPendAbort', return_type=INT8U, size=112, line=497, arg_list=[('pevent',PointerType('OS_EVENT')),('opt',INT8U),('err',PointerType("INT8U"))])
        self.OSQFlush = StaticFunction(device, 0x29c3c, thumb=1, name='OSQFlush', return_type=INT8U, size=32, line=324, arg_list=[('pevent',PointerType('OS_EVENT'))])
        self.OSQAccept = StaticFunction(device, 0x29aac, thumb=1, name='OSQAccept', return_type=PointerType("void"), size=80, line=61, arg_list=[('pevent',PointerType("OS_EVENT")),('err',PointerType('INT8U'))])
