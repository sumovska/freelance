...
class WAE_P_ActionStatus_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    WAE_ACTION_STATUS_NONE = 0
    WAE_ACTION_STATUS_EXECUTED = 1
    WAE_ACTION_STATUS_SUCCEEDED = 2
    WAE_ACTION_STATUS_FAILED = 3
...
WAE_P_ActionStatus_t = WAE_P_ActionStatus_tag
...
class WAE_P_ActionState_tag(Structure):
    pBteLink = PointerType('WAE_P_BteLink_t')
    settingId = WBST_BteSettingId_t
    newValue = WBST_Value_t
    status = WAE_P_ActionStatus_t
    pollReq = bool
    retries = u16
    _fields_ = [
                ('pBteLink', PointerType('WAE_P_BteLink_t')),
...
WAE_P_ActionState_t = WAE_P_ActionState_tag
...
class Code(AbstractCode):
    ...
    WAE_P_ActionStatus_tag = WAE_P_ActionStatus_tag
    ...
    WAE_P_ActionStatus_t = WAE_P_ActionStatus_t
    ...
    WAE_P_ActionState_tag = WAE_P_ActionState_tag
    ...
    WAE_P_ActionState_t = WAE_P_ActionState_t
    ...
    def waeActionValidateRequest(self, bteIdx, pBteAction):
        '''
        Arguments:
        -bteIdx - WAE_P_BteIdx_t
        -pBteAction - PointerType("WAE_BteUserAction_t")
        Return type:
        -Status
    ...
    def waeActionSendPollReq(self, bteStatusId):
        '''
        Arguments:
        -bteStatusId - WAE_BteStatusId_t
        Return type:
        -None
    ...
    def waeActionNotifyUie(self, waeActionReq):
        '''
        Arguments:
        -waeActionReq - WAE_BteUserActionId_t
        Return type:
        -WAE_BteStatusId_t
        Declaration line: 974
        '''
        pass

    def WAE_P_GetMaxActionTime(self, ):
        '''
        Arguments:
        Return type:
        -u16
    ...
    def WAE_P_ActionRequest(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
    ...
    def WAE_P_ActionConfigure(self, bteIdx1st, bteIdx2nd):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 167
        '''
        pass

    def WAE_P_ActionProcess(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
    ...
    def waeActionTranslateUieReqToStatusId(self, bteActionReqId):
        '''
        Arguments:
        -bteActionReqId - WAE_BteUserActionId_t
        Return type:
        -WAE_BteStatusId_t
    ...
    def waeActionUpdate(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pWaeState - PointerType('WAE_P_State_t')
        -pExpectedEventId - PointerType("ITC_EventId_t")
    ...
    def waeActionSetUp(self, pBteAction):
        '''
        Arguments:
        -pBteAction - PointerType('WAE_BteUserAction_t')
        Return type:
    ...
    def waeActionRespError(self, pWaeState, pExpectedEventId, cipProcResult):
        '''
        Arguments:
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
        -cipProcResult - CIP_ProcResult_t
        Return type:
        -None
    ...
    def waeActionMvbtSendToBte(self, ):
        '''
        Arguments:
        Return type:
        -Status
    ...
    def waeActionRespSuccess(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
        Return type:
        -None
        Declaration line: 554
        '''
        pass

    def WAE_P_ActionInit(self, actionRetries):
        '''
        Arguments:
        -actionRetries - u16
        Return type:
    ...
    def waeActionProcAction_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
    ...
    waeActionCurrent = WAE_BteUserActionId_t
    waeActionRetries = u16
    OSTmrTime = INT32U
    ...
    OSTmrTbl = OS_TMR * 26
    waeActionBteInfo = WAE_P_ActionState_t * 2
    OSTmrTaskStk = OS_STK * 128
    DAUDIO_SoundNumberOfRepetitions_t = u16 * 7
    OSTaskCtr = INT8U
    waeActionBteIdx = WAE_P_BteIdx_t
    ...
    def __init__(self, device):
        ...
        self.waeActionCurrent = StaticVariable(device, self.WAE_BteUserActionId_t, 0x7fe00069, False)
        self.waeActionRetries = StaticVariable(device, self.u16, 0x7fe0006a, False)
        ...
        self.waeActionBteInfo = StaticVariable(device, WAE_P_ActionState_t * 2, 0x7fe00a54, False)
        ...
        self.waeActionBteIdx = StaticVariable(device, self.WAE_P_BteIdx_t, 0x7fe00068, False)
        ...
        ### Functions data ###
        ######################
        self.waeActionValidateRequest = StaticFunction(device, 0x4276a, thumb=1, name='waeActionValidateRequest', return_type=Status, size=336, line=812, arg_list=[('bteIdx',WAE_P_BteIdx_t),('pBteAction',PointerType("WAE_BteUserAction_t"))])
        self.waeActionFindBte = StaticFunction(device, 0x426c0, thumb=1, name='waeActionFindBte', return_type=WAE_P_BteIdx_t, size=66, line=361, arg_list=[])
        self.waeActionSendPollReq = StaticFunction(device, 0x42956, thumb=1, name='waeActionSendPollReq', return_type=None, size=60, line=1102, arg_list=[('bteStatusId',WAE_BteStatusId_t)])
        self.waeActionNotifyUie = StaticFunction(device, 0x42992, thumb=1, name='waeActionNotifyUie', return_type=WAE_BteStatusId_t, size=114, line=974, arg_list=[('waeActionReq',WAE_BteUserActionId_t)])
        self.WAE_P_GetMaxActionTime = StaticFunction(device, 0x42c1a, thumb=1, name='WAE_P_GetMaxActionTime', return_type=u16, size=16, line=295, arg_list=[])
        self.WAE_P_ActionRequest = StaticFunction(device, 0x42908, thumb=1, name='WAE_P_ActionRequest', return_type=None, size=78, line=206, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.WAE_P_ActionConfigure = StaticFunction(device, 0x42552, thumb=1, name='WAE_P_ActionConfigure', return_type=None, size=36, line=167, arg_list=[('bteIdx1st',PointerType("WAE_P_BteLink_t")),('bteIdx2nd',PointerType('WAE_P_BteLink_t'))])
        self.WAE_P_ActionProcess = StaticFunction(device, 0x42bfe, thumb=1, name='WAE_P_ActionProcess', return_type=None, size=28, line=263, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waeActionTranslateUieReqToStatusId = StaticFunction(device, 0x42702, thumb=1, name='waeActionTranslateUieReqToStatusId', return_type=WAE_BteStatusId_t, size=104, line=1031, arg_list=[('bteActionReqId',WAE_BteUserActionId_t)])
        self.waeActionUpdate = StaticFunction(device, 0x42a04, thumb=1, name='waeActionUpdate', return_type=None, size=86, line=744, arg_list=[('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waeActionSendToBte = StaticFunction(device, 0x42616, thumb=1, name='waeActionSendToBte', return_type=Status, size=170, line=409, arg_list=[])
        self.waeActionSetUp = StaticFunction(device, 0x428ba, thumb=1, name='waeActionSetUp', return_type=None, size=78, line=318, arg_list=[('pBteAction',PointerType('WAE_BteUserAction_t'))])
        self.waeActionRespError = StaticFunction(device, 0x42a5a, thumb=1, name='waeActionRespError', return_type=None, size=310, line=604, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t')),('cipProcResult',CIP_ProcResult_t)])
        self.waeActionMvbtSendToBte = StaticFunction(device, 0x42594, thumb=1, name='waeActionMvbtSendToBte', return_type=Status, size=130, line=505, arg_list=[])
        self.waeActionRespSuccess = StaticFunction(device, 0x42b90, thumb=1, name='waeActionRespSuccess', return_type=None, size=110, line=554, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.WAE_P_ActionInit = StaticFunction(device, 0x4254c, thumb=1, name='WAE_P_ActionInit', return_type=None, size=6, line=149, arg_list=[('actionRetries',u16)])
        self.waeActionProcAction_res = StaticFunction(device, 0x42576, thumb=1, name='waeActionProcAction_res', return_type=None, size=30, line=390, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
