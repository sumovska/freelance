...
class Code(AbstractCode):
    ...
    def GUI_AddDecShift(self, v, Len, Shift, ps):
        '''
        Arguments:
        -v - c_long_le
        -Len - c_ubyte
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_Long2Len = StaticFunction(device, 0x2fd98, thumb=1, name='GUI_Long2Len', return_type=c_int_le, size=40, line=81, arg_list=[('vSign',c_long_le)])
        self.GUI_AddDecShift = StaticFunction(device, 0x2fddc, thumb=1, name='GUI_AddDecShift', return_type=None, size=184, line=115, arg_list=[('v',c_long_le),('Len',c_ubyte),('Shift',c_ubyte),('ps',PointerType("PointerType('c_byte')"))])
        self.GUI_AddSign = StaticFunction(device, 0x2fdc0, thumb=1, name='GUI_AddSign', return_type=c_long_le, size=28, line=97, arg_list=[('v',c_long_le),('ps',PointerType('PointerType("c_byte")'))])
