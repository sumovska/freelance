...
class Code(AbstractCode):
    ...
    def LCD_GetpPalConvTableUncached(self, pLogPal):
        '''
        Arguments:
        -pLogPal - PointerType("LCD_LOGPALETTE")
        Return type:
        -PointerType('c_ushort_le')
        Declaration line: 60
        '''
        pass

    def LCD_InitLUT(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def LCD_GetpPalConvTable(self, pLogPal):
        '''
        Arguments:
        -pLogPal - PointerType("LCD_LOGPALETTE")
        Return type:
    ...
    LCD__aConvTable = c_ushort_le * 256
    ...
    def __init__(self, device):
        ...
        self.LCD__aConvTable = StaticVariable(device, c_ushort_le * 256, 0x40005bec, False)
        ...
        ### Functions data ###
        ######################
        self.LCD_GetpPalConvTableUncached = StaticFunction(device, 0x2ce74, thumb=1, name='LCD_GetpPalConvTableUncached', return_type=PointerType('c_ushort_le'), size=64, line=60, arg_list=[('pLogPal',PointerType("LCD_LOGPALETTE"))])
        self.LCD_InitLUT = StaticFunction(device, 0x2cef6, thumb=1, name='LCD_InitLUT', return_type=None, size=2, line=102, arg_list=[])
        self.LCD_GetpPalConvTable = StaticFunction(device, 0x2ceb4, thumb=1, name='LCD_GetpPalConvTable', return_type=PointerType('c_ushort_le'), size=66, line=87, arg_list=[('pLogPal',PointerType("LCD_LOGPALETTE"))])
