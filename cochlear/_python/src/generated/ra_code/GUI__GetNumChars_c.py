...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI__GetNumChars = StaticFunction(device, 0x3217e, thumb=1, name='GUI__GetNumChars', return_type=c_int_le, size=32, line=34, arg_list=[('s',PointerType("c_byte"))])
