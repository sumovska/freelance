...
class INFO__structure__union0(Union):
    Size = c_long_le
    Dummy = c_int_le
    _fields_ = [
                ('Size', c_long_le),
...
GUI_RECT = LCD_RECT
class INFO__structure(Structure):
    Info = INFO__structure__union0
    _pack_ = 1
    _fields_ = [
                ('Info', INFO__structure__union0),
               ]
...
class Code(AbstractCode):
    ...
    INFO__structure__union0 = INFO__structure__union0
    ...
    GUI_RECT = GUI_RECT
    INFO__structure = INFO__structure
    ...
    def GUI_ALLOC_h2p(self, hMem):
        '''
        Arguments:
        -hMem - c_ulong_le
        Return type:
        -PointerType("void")
        Declaration line: 827
        '''
        pass

    def GUI_ALLOC_Unlock(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 861
        '''
        pass

    def GUI_ALLOC_GetSize(self, hMem):
        '''
        Arguments:
        -hMem - c_ulong_le
        Return type:
    ...
    def GUI_ALLOC_FreePtrArray(self, pArray, NumElems):
        '''
        Arguments:
        -pArray - PointerType('c_ulong_le')
        -NumElems - c_int_le
        Return type:
        -None
        Declaration line: 919
        '''
        pass

    def GUI_ALLOC_AllocNoInit(self, Size):
        '''
        Arguments:
        -Size - c_long_le
        Return type:
    ...
    def GUI_ALLOC_FreePtr(self, ph):
        '''
        Arguments:
        -ph - PointerType("c_ulong_le")
        Return type:
        -None
        Declaration line: 908
        '''
        pass

    def GUI_ALLOC_Free(self, hMem):
        '''
        Arguments:
        -hMem - c_ulong_le
        Return type:
        -None
        Declaration line: 893
        '''
        pass

    def GUI_ALLOC_RequestSize(self, ):
        '''
        Arguments:
        Return type:
        -c_long_le
        Declaration line: 846
        '''
        pass
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_ALLOC_h2p = StaticFunction(device, 0x2d358, thumb=1, name='GUI_ALLOC_h2p', return_type=PointerType("void"), size=4, line=827, arg_list=[('hMem',c_ulong_le)])
        self.GUI_ALLOC_Unlock = StaticFunction(device, 0x2d376, thumb=1, name='GUI_ALLOC_Unlock', return_type=None, size=2, line=861, arg_list=[])
        self.GUI_ALLOC_GetSize = StaticFunction(device, 0x2d378, thumb=1, name='GUI_ALLOC_GetSize', return_type=c_long_le, size=12, line=879, arg_list=[('hMem',c_ulong_le)])
        self.GUI_ALLOC_FreePtrArray = StaticFunction(device, 0x2d38c, thumb=1, name='GUI_ALLOC_FreePtrArray', return_type=None, size=28, line=919, arg_list=[('pArray',PointerType('c_ulong_le')),('NumElems',c_int_le)])
        self.GUI_ALLOC_AllocNoInit = StaticFunction(device, 0x2d33c, thumb=1, name='GUI_ALLOC_AllocNoInit', return_type=c_ulong_le, size=28, line=808, arg_list=[('Size',c_long_le)])
        self.GUI_ALLOC_GetMaxSize = StaticFunction(device, 0x2d35c, thumb=1, name='GUI_ALLOC_GetMaxSize', return_type=c_long_le, size=12, line=838, arg_list=[])
        self.GUI_ALLOC_Lock = StaticFunction(device, 0x2d374, thumb=1, name='GUI_ALLOC_Lock', return_type=None, size=2, line=854, arg_list=[])
        self.GUI_ALLOC_FreePtr = StaticFunction(device, 0x2d386, thumb=1, name='GUI_ALLOC_FreePtr', return_type=None, size=6, line=908, arg_list=[('ph',PointerType("c_ulong_le"))])
        self.GUI_ALLOC_Free = StaticFunction(device, 0x2d384, thumb=1, name='GUI_ALLOC_Free', return_type=None, size=2, line=893, arg_list=[('hMem',c_ulong_le)])
        self.GUI_ALLOC_RequestSize = StaticFunction(device, 0x2d368, thumb=1, name='GUI_ALLOC_RequestSize', return_type=c_long_le, size=12, line=846, arg_list=[])
