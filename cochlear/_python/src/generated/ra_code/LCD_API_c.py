...
class Code(AbstractCode):
    ...
    LCD_L0_APIList = tLCDDEV_APIList
    ...
    LCD_aAPI = PointerType("tLCDDEV_APIList_struct") * 1
    ...
    def __init__(self, device):
        ...
        self.LCD_L0_APIList = StaticVariable(device, self.tLCDDEV_APIList, 0x619d0, True)
        ...
        self.LCD_aAPI = StaticVariable(device, PointerType("tLCDDEV_APIList_struct") * 1, 0x8000803cL, False)
