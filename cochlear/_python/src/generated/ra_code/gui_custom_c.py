...
class Code(AbstractCode):
    ...
    def GUI_MEMDEV_GetSelected(self, ):
        '''
        Arguments:
        Return type:
        -GUI_MEMDEV_Handle
    ...
    def GUI_MEMDEV_WriteCorner(self, hMem, x0, y0, size, align):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 298
        '''
        pass

    def GUI_MEMDEV_WriteRect(self, hMem, x0, y0, x1, y1):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        -x0 - c_int_le
    ...
    def GUI_MEMDEV_WriteRectAt(self, x, y, hMem, x0, y0, x1, y1):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def GUI_CUSTOM_GetMaxSize(self, ):
        '''
        Arguments:
        Return type:
        -c_int_le
    ...
    def GUI_CUSTOM_Alloc(self, size):
        '''
        Arguments:
        -size - c_int_le
        Return type:
    ...
    def GUI_MEMDEV_GetColorAt(self, hMem, x, y):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        -x - c_int_le
        ...
        Return type:
        -GUI_COLOR
        Declaration line: 259
        '''
        pass

    def GUI_MEMDEV_HCopyCompatibleToLCDAt(self, hMem, x, y):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        -x - c_int_le
    ...
    def GUI_MEMDEV_CopyCompatibleToLCDAt(self, hMem, x, y):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        -x - c_int_le
    ...
    GUI_memDevMain = GUI_MEMDEV_Handle
    guiMemDev1 = c_ubyte * 32816
    guiMemDev2 = c_ubyte * 32816
    ...
    def __init__(self, device):
        ...
        self.GUI_memDevMain = StaticVariable(device, self.GUI_MEMDEV_Handle, 0x80008868L, False)
        self.guiMemDev1 = StaticVariable(device, c_ubyte * 32816, 0x80000000L, False)
        self.guiMemDev2 = StaticVariable(device, c_ubyte * 32816, 0x81000000L, False)
        ...
        self.nextFreeAddr = StaticVariable(device, c_ulong_le, 0x80008870L, False)
        ...
        self.GUI_memDevTemp = StaticVariable(device, self.GUI_MEMDEV_Handle, 0x8000886cL, False)
        ...
        ### Functions data ###
        ######################
        self.GUI_MEMDEV_GetSelected = StaticFunction(device, 0x502d8, thumb=1, name='GUI_MEMDEV_GetSelected', return_type=GUI_MEMDEV_Handle, size=6, line=253, arg_list=[])
        self.GUI_MEMDEV_WriteCorner = StaticFunction(device, 0x5037c, thumb=1, name='GUI_MEMDEV_WriteCorner', return_type=None, size=94, line=298, arg_list=[('hMem',GUI_MEMDEV_Handle),('x0',c_int_le),('y0',c_int_le),('size',c_int_le),('align',c_int_le)])
        self.GUI_MEMDEV_WriteRect = StaticFunction(device, 0x50358, thumb=1, name='GUI_MEMDEV_WriteRect', return_type=None, size=36, line=268, arg_list=[('hMem',GUI_MEMDEV_Handle),('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.GUI_MEMDEV_WriteRectAt = StaticFunction(device, 0x5030e, thumb=1, name='GUI_MEMDEV_WriteRectAt', return_type=None, size=74, line=274, arg_list=[('x',c_int_le),('y',c_int_le),('hMem',GUI_MEMDEV_Handle),('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.GUI_CUSTOM_GetMaxSize = StaticFunction(device, 0x4ffd2, thumb=1, name='GUI_CUSTOM_GetMaxSize', return_type=c_int_le, size=14, line=100, arg_list=[])
        self.GUI_CUSTOM_Alloc = StaticFunction(device, 0x4ffac, thumb=1, name='GUI_CUSTOM_Alloc', return_type=c_ulong_le, size=38, line=76, arg_list=[('size',c_int_le)])
        self.GUI_GetColorAt = StaticFunction(device, 0x503da, thumb=1, name='GUI_GetColorAt', return_type=GUI_COLOR, size=30, line=326, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.GUI_X_Init = StaticFunction(device, 0x4ffe0, thumb=1, name='GUI_X_Init', return_type=None, size=2, line=110, arg_list=[])
        self.GUI_MEMDEV_GetColorAt = StaticFunction(device, 0x502de, thumb=1, name='GUI_MEMDEV_GetColorAt', return_type=GUI_COLOR, size=48, line=259, arg_list=[('hMem',GUI_MEMDEV_Handle),('x',c_int_le),('y',c_int_le)])
        self.GUI_MEMDEV_HCopyCompatibleToLCDAt = StaticFunction(device, 0x50150, thumb=1, name='GUI_MEMDEV_HCopyCompatibleToLCDAt', return_type=None, size=392, line=184, arg_list=[('hMem',GUI_MEMDEV_Handle),('x',c_int_le),('y',c_int_le)])
        self.GUI_MEMDEV_CopyCompatibleToLCDAt = StaticFunction(device, 0x4ffe2, thumb=1, name='GUI_MEMDEV_CopyCompatibleToLCDAt', return_type=None, size=366, line=121, arg_list=[('hMem',GUI_MEMDEV_Handle),('x',c_int_le),('y',c_int_le)])
