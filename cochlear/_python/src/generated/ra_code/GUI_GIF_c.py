...
class GUI_GIF_PARAM__structure(Structure):
    pFileData = PointerType("c_ubyte")
    FileSize = c_ulong_le
    Off = c_ulong_le
    _pack_ = 1
    _fields_ = [
...
class GUI_GIF_CONTEXT__structure(Structure):
    NumBytesInBuffer = c_uint_le
    pBuffer = PointerType("c_ubyte")
    fpGetData = PointerType('GUI_GIF_GET_DATA_FUNC')
    pParam = PointerType("void")
    _pack_ = 1
    _fields_ = [
                ('NumBytesInBuffer', c_uint_le),
                ('pBuffer', PointerType("c_ubyte")),
...
class IMAGE_DESCRIPTOR__structure(Structure):
    XPos = c_int_le
    YPos = c_int_le
    XSize = c_int_le
    YSize = c_int_le
...
class LZW_CONTEXT__structure(Structure):
    aBuffer = c_ubyte * 258
    aCode = c_short_le * 4096
    aPrefix = c_ubyte * 4096
    aDecompBuffer = c_ubyte * 3000
    sp = PointerType("c_ubyte")
    CurBit = c_int_le
    LastBit = c_int_le
    GetDone = c_int_le
    LastByte = c_int_le
    ReturnClear = c_int_le
    CodeSize = c_int_le
    SetCodeSize = c_int_le
    MaxCode = c_int_le
    MaxCodeSize = c_int_le
    ClearCode = c_int_le
    EndCode = c_int_le
    FirstCode = c_int_le
    OldCode = c_int_le
...
GUI_GIF_CONTEXT = GUI_GIF_CONTEXT__structure
IMAGE_DESCRIPTOR = IMAGE_DESCRIPTOR__structure
...
GUI_GIF_PARAM = GUI_GIF_PARAM__structure
...
LZW_CONTEXT = LZW_CONTEXT__structure
...
class Code(AbstractCode):
    ...
    ### Type definitions ###
    ########################
    GUI_GIF_PARAM__structure = GUI_GIF_PARAM__structure
    ...
    GUI_GIF_CONTEXT__structure = GUI_GIF_CONTEXT__structure
    IMAGE_DESCRIPTOR__structure = IMAGE_DESCRIPTOR__structure
    ...
    LZW_CONTEXT__structure = LZW_CONTEXT__structure
    ...
    CLEAR_UNUSED_PIXELS = CLEAR_UNUSED_PIXELS
    ...
    DRAW_FROM_DATABLOCK = DRAW_FROM_DATABLOCK
    GUI_HWIN = GUI_HWIN
    ...
    GUI_GIF_CONTEXT = GUI_GIF_CONTEXT
    ...
    def GUI_GIF_DrawSubEx(self, fpGetData, p, x0, y0, Index):
        '''
        Arguments:
        -fpGetData - PointerType("GUI_GIF_GET_DATA_FUNC")
        -p - PointerType('void')
    ...
    def GUI_GIF__ReadData(self, pContext, NumBytesReq, ppData, StartOfFile):
        '''
        Arguments:
        -pContext - PointerType("GUI_GIF_CONTEXT")
        -NumBytesReq - c_uint_le
        -ppData - PointerType('PointerType("c_ubyte")')
        -StartOfFile - c_uint_le
        Return type:
        -c_int_le
        Declaration line: 963
        '''
        pass

    def GUI_GIF_GetCommentEx(self, fpGetData, p, pBuffer, MaxSize, Index):
        '''
        Arguments:
        -fpGetData - PointerType("GUI_GIF_GET_DATA_FUNC")
        -p - PointerType('void')
    ...
    def GUI_GIF_Draw(self, pGIF, NumBytes, x0, y0):
        '''
        Arguments:
        -pGIF - PointerType('void')
        -NumBytes - c_ulong_le
        -x0 - c_int_le
        -y0 - c_int_le
        Return type:
        -c_int_le
        Declaration line: 1118
        '''
        pass

    def GUI_GIF__InitLZW(self, InputCodeSize):
        '''
        Arguments:
        -InputCodeSize - c_int_le
        Return type:
        -None
        Declaration line: 946
        '''
        pass

    def _ClearUnusedPixels(self, x0, y0, pDescriptor, pInfo, Num, Denom):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        -pDescriptor - PointerType("IMAGE_DESCRIPTOR")
        -pInfo - PointerType('GUI_GIF_IMAGE_INFO')
        -Num - c_int_le
        -Denom - c_int_le
        Return type:
        -None
    ...
    def GUI_GIF__DrawFromFilePointer(self, pContext, x0, y0, Index, Num, Denom, pfDrawFromDataBlock, pfClearUnusedPixels):
        '''
        Arguments:
        -pContext - PointerType("GUI_GIF_CONTEXT")
        -x0 - c_int_le
        ...
        -Num - c_int_le
        -Denom - c_int_le
        -pfDrawFromDataBlock - PointerType('DRAW_FROM_DATABLOCK')
        -pfClearUnusedPixels - PointerType("CLEAR_UNUSED_PIXELS")
        Return type:
        -c_int_le
        Declaration line: 761
        '''
        pass

    def GUI_GIF_GetYSize(self, pGIF):
        '''
        Arguments:
        -pGIF - PointerType('void')
        Return type:
        -c_int_le
        Declaration line: 1053
        '''
        pass

    def _DrawFromDataBlock(self, pContext, pDescriptor, x0, y0, Transparency, Disposal, Num, Denom):
        '''
        Arguments:
        -pContext - PointerType("GUI_GIF_CONTEXT")
        -pDescriptor - PointerType('IMAGE_DESCRIPTOR')
    ...
    def GUI_GIF_GetInfo(self, pGIF, NumBytes, pInfo):
        '''
        Arguments:
        -pGIF - PointerType("void")
        -NumBytes - c_ulong_le
        -pInfo - PointerType('GUI_GIF_INFO')
        Return type:
        -c_int_le
    ...
    def GUI_GIF_GetInfoEx(self, fpGetData, p, pInfo):
        '''
        Arguments:
        -fpGetData - PointerType("GUI_GIF_GET_DATA_FUNC")
        -p - PointerType('void')
        ...
        Return type:
        -c_int_le
        Declaration line: 1126
        '''
        pass

    def GUI_GIF_GetXSizeEx(self, fpGetData, p):
        '''
        Arguments:
        -fpGetData - PointerType('GUI_GIF_GET_DATA_FUNC')
        -p - PointerType("void")
    ...
    def _GetDataBlock(self, pContext, pBuffer):
        '''
        Arguments:
        -pContext - PointerType('GUI_GIF_CONTEXT')
        -pBuffer - PointerType("c_ubyte")
        Return type:
        -c_int_le
        Declaration line: 117
        '''
        pass

    def _GetNextCode(self, pContext):
        '''
        Arguments:
        -pContext - PointerType('GUI_GIF_CONTEXT')
        Return type:
    ...
    def GUI_GIF_GetImageInfo(self, pGIF, NumBytes, pInfo, Index):
        '''
        Arguments:
        -pGIF - PointerType("void")
        -NumBytes - c_ulong_le
    ...
    def GUI_GIF__GetNextByte(self, pContext):
        '''
        Arguments:
        -pContext - PointerType("GUI_GIF_CONTEXT")
        Return type:
        -c_int_le
        Declaration line: 877
        '''
        pass

    def _GetSizeAndColorTable(self, pContext, pxSize, pySize, pNumColors):
        '''
        Arguments:
        -pContext - PointerType('GUI_GIF_CONTEXT')
        -pxSize - PointerType("c_int_le")
        -pySize - PointerType('c_int_le')
        -pNumColors - PointerType("c_int_le")
        Return type:
        -c_int_le
        Declaration line: 519
        '''
        pass

    def GUI_GIF_GetYSizeEx(self, fpGetData, p):
        '''
        Arguments:
        -fpGetData - PointerType('GUI_GIF_GET_DATA_FUNC')
        -p - PointerType("void")
    ...
    def GUI_GIF_GetComment(self, pGIF, NumBytes, pBuffer, MaxSize, Index):
        '''
        Arguments:
        -pGIF - PointerType('void')
        -NumBytes - c_ulong_le
        ...
        Return type:
        -c_int_le
        Declaration line: 1184
        '''
        pass

    def GUI_GIF_DrawSub(self, pGIF, NumBytes, x0, y0, Index):
        '''
        Arguments:
        -pGIF - PointerType('void')
        -NumBytes - c_ulong_le
        ...
        Return type:
        -c_int_le
        Declaration line: 1099
        '''
        pass

    def GUI_GIF_GetXSize(self, pGIF):
        '''
        Arguments:
        -pGIF - PointerType("void")
        Return type:
        -c_int_le
        Declaration line: 1034
        '''
        pass

    def GUI_GIF__GetData(self, p, NumBytesReq, ppData, StartOfFile):
        '''
        Arguments:
        -p - PointerType('void')
        -NumBytesReq - c_int_le
        -ppData - PointerType("PointerType('c_ubyte')")
        -StartOfFile - c_uint_le
        Return type:
        -c_int_le
        Declaration line: 999
        '''
        pass

    def GUI_GIF_DrawEx(self, fpGetData, p, x0, y0):
        '''
        Arguments:
        -fpGetData - PointerType('GUI_GIF_GET_DATA_FUNC')
        -p - PointerType("void")
        ...
        Return type:
        -c_int_le
        Declaration line: 1110
        '''
        pass

    def GUI_GIF_GetImageInfoEx(self, fpGetData, p, pInfo, Index):
        '''
        Arguments:
        -fpGetData - PointerType('GUI_GIF_GET_DATA_FUNC')
        -p - PointerType("void")
    ...
    _aMaskTbl = c_int_le * 16
    _aBuffer = c_ubyte * 256
    GUI_DecChar = c_byte
    GUI_GIF__aInterlaceOffset = c_int_le * 4
    GUI_MEMDEV__APIList16 = tLCDDEV_APIList_struct
    GUI_GIF__aColorTable = GUI_COLOR * 256
    GUI_GIF__LZWContext = LZW_CONTEXT
    GUI_Context = GUI_CONTEXT
    GUI_GIF__aInterlaceYPos = c_int_le * 4
    ...
    def __init__(self, device):
        ...
        self._aMaskTbl = StaticVariable(device, c_int_le * 16, 0x6125c, True)
        self._aBuffer = StaticVariable(device, c_ubyte * 256, 0x80008b3cL, False)
        self.GUI_DecChar = StaticVariable(device, c_byte, 0x80008030L, False)
        self.GUI_GIF__aInterlaceOffset = StaticVariable(device, c_int_le * 4, 0x6129c, True)
        self.GUI_MEMDEV__APIList16 = StaticVariable(device, self.tLCDDEV_APIList_struct, 0x61b4c, True)
        self.GUI_GIF__aColorTable = StaticVariable(device, GUI_COLOR * 256, 0x80008c3cL, False)
        self.GUI_GIF__LZWContext = StaticVariable(device, self.LZW_CONTEXT, 0x8000903cL, False)
        self.GUI_Context = StaticVariable(device, self.GUI_CONTEXT, 0x40005b98, False)
        self.GUI_GIF__aInterlaceYPos = StaticVariable(device, c_int_le * 4, 0x612ac, True)

        ######################
        ### Functions data ###
        ######################
        self.GUI_GIF_DrawSubEx = StaticFunction(device, 0x2bff8, thumb=1, name='GUI_GIF_DrawSubEx', return_type=c_int_le, size=74, line=1064, arg_list=[('fpGetData',PointerType("GUI_GIF_GET_DATA_FUNC")),('p',PointerType('void')),('x0',c_int_le),('y0',c_int_le),('Index',c_int_le)])
        self.GUI_GIF__ReadData = StaticFunction(device, 0x2b5d0, thumb=1, name='GUI_GIF__ReadData', return_type=c_int_le, size=34, line=963, arg_list=[('pContext',PointerType("GUI_GIF_CONTEXT")),('NumBytesReq',c_uint_le),('ppData',PointerType('PointerType("c_ubyte")')),('StartOfFile',c_uint_le)])
        self.GUI_GIF_GetCommentEx = StaticFunction(device, 0x2c476, thumb=1, name='GUI_GIF_GetCommentEx', return_type=c_int_le, size=344, line=1170, arg_list=[('fpGetData',PointerType("GUI_GIF_GET_DATA_FUNC")),('p',PointerType('void')),('pBuffer',PointerType("c_ubyte")),('MaxSize',c_int_le),('Index',c_int_le)])
        self.GUI_GIF_Draw = StaticFunction(device, 0x2c0e2, thumb=1, name='GUI_GIF_Draw', return_type=c_int_le, size=86, line=1118, arg_list=[('pGIF',PointerType('void')),('NumBytes',c_ulong_le),('x0',c_int_le),('y0',c_int_le)])
        self.GUI_GIF__InitLZW = StaticFunction(device, 0x2b878, thumb=1, name='GUI_GIF__InitLZW', return_type=None, size=60, line=946, arg_list=[('InputCodeSize',c_int_le)])
        self._ClearUnusedPixels = StaticFunction(device, 0x2bbda, thumb=1, name='_ClearUnusedPixels', return_type=None, size=176, line=715, arg_list=[('x0',c_int_le),('y0',c_int_le),('pDescriptor',PointerType("IMAGE_DESCRIPTOR")),('pInfo',PointerType('GUI_GIF_IMAGE_INFO')),('Num',c_int_le),('Denom',c_int_le)])
        self.GUI_GIF__DrawFromFilePointer = StaticFunction(device, 0x2bc8a, thumb=1, name='GUI_GIF__DrawFromFilePointer', return_type=c_int_le, size=594, line=761, arg_list=[('pContext',PointerType("GUI_GIF_CONTEXT")),('x0',c_int_le),('y0',c_int_le),('Index',c_int_le),('Num',c_int_le),('Denom',c_int_le),('pfDrawFromDataBlock',PointerType('DRAW_FROM_DATABLOCK')),('pfClearUnusedPixels',PointerType("CLEAR_UNUSED_PIXELS"))])
        self.GUI_GIF_GetYSize = StaticFunction(device, 0x2bfb4, thumb=1, name='GUI_GIF_GetYSize', return_type=c_int_le, size=68, line=1053, arg_list=[('pGIF',PointerType('void'))])
        self._DrawFromDataBlock = StaticFunction(device, 0x2b8b4, thumb=1, name='_DrawFromDataBlock', return_type=c_int_le, size=566, line=302, arg_list=[('pContext',PointerType("GUI_GIF_CONTEXT")),('pDescriptor',PointerType('IMAGE_DESCRIPTOR')),('x0',c_int_le),('y0',c_int_le),('Transparency',c_int_le),('Disposal',c_int_le),('Num',c_int_le),('Denom',c_int_le)])
        self.GUI_GIF_GetInfo = StaticFunction(device, 0x2c280, thumb=1, name='GUI_GIF_GetInfo', return_type=c_int_le, size=40, line=1137, arg_list=[('pGIF',PointerType("void")),('NumBytes',c_ulong_le),('pInfo',PointerType('GUI_GIF_INFO'))])
        self.GUI_GIF_GetInfoEx = StaticFunction(device, 0x2c138, thumb=1, name='GUI_GIF_GetInfoEx', return_type=c_int_le, size=328, line=1126, arg_list=[('fpGetData',PointerType("GUI_GIF_GET_DATA_FUNC")),('p',PointerType('void')),('pInfo',PointerType("GUI_GIF_INFO"))])
        self.GUI_GIF_GetXSizeEx = StaticFunction(device, 0x2bf0c, thumb=1, name='GUI_GIF_GetXSizeEx', return_type=c_int_le, size=50, line=1026, arg_list=[('fpGetData',PointerType('GUI_GIF_GET_DATA_FUNC')),('p',PointerType("void"))])
        self._GetDataBlock = StaticFunction(device, 0x2b5f2, thumb=1, name='_GetDataBlock', return_type=c_int_le, size=104, line=117, arg_list=[('pContext',PointerType('GUI_GIF_CONTEXT')),('pBuffer',PointerType("c_ubyte"))])
        self._GetNextCode = StaticFunction(device, 0x2b65a, thumb=1, name='_GetNextCode', return_type=c_int_le, size=184, line=147, arg_list=[('pContext',PointerType('GUI_GIF_CONTEXT'))])
        self.GUI_GIF_GetImageInfo = StaticFunction(device, 0x2c44a, thumb=1, name='GUI_GIF_GetImageInfo', return_type=c_int_le, size=44, line=1159, arg_list=[('pGIF',PointerType("void")),('NumBytes',c_ulong_le),('pInfo',PointerType('GUI_GIF_IMAGE_INFO')),('Index',c_int_le)])
        self.GUI_GIF__GetNextByte = StaticFunction(device, 0x2b712, thumb=1, name='GUI_GIF__GetNextByte', return_type=c_int_le, size=358, line=877, arg_list=[('pContext',PointerType("GUI_GIF_CONTEXT"))])
        self._GetSizeAndColorTable = StaticFunction(device, 0x2baea, thumb=1, name='_GetSizeAndColorTable', return_type=c_int_le, size=240, line=519, arg_list=[('pContext',PointerType('GUI_GIF_CONTEXT')),('pxSize',PointerType("c_int_le")),('pySize',PointerType('c_int_le')),('pNumColors',PointerType("c_int_le"))])
        self.GUI_GIF_GetYSizeEx = StaticFunction(device, 0x2bf82, thumb=1, name='GUI_GIF_GetYSizeEx', return_type=c_int_le, size=50, line=1045, arg_list=[('fpGetData',PointerType('GUI_GIF_GET_DATA_FUNC')),('p',PointerType("void"))])
        self.GUI_GIF_GetComment = StaticFunction(device, 0x2c5ce, thumb=1, name='GUI_GIF_GetComment', return_type=c_int_le, size=48, line=1184, arg_list=[('pGIF',PointerType('void')),('NumBytes',c_ulong_le),('pBuffer',PointerType("c_ubyte")),('MaxSize',c_int_le),('Index',c_int_le)])
        self.GUI_GIF_DrawSub = StaticFunction(device, 0x2c042, thumb=1, name='GUI_GIF_DrawSub', return_type=c_int_le, size=86, line=1099, arg_list=[('pGIF',PointerType('void')),('NumBytes',c_ulong_le),('x0',c_int_le),('y0',c_int_le),('Index',c_int_le)])
        self.GUI_GIF_GetXSize = StaticFunction(device, 0x2bf3e, thumb=1, name='GUI_GIF_GetXSize', return_type=c_int_le, size=68, line=1034, arg_list=[('pGIF',PointerType("void"))])
        self.GUI_GIF__GetData = StaticFunction(device, 0x2bedc, thumb=1, name='GUI_GIF__GetData', return_type=c_int_le, size=48, line=999, arg_list=[('p',PointerType('void')),('NumBytesReq',c_int_le),('ppData',PointerType("PointerType('c_ubyte')")),('StartOfFile',c_uint_le)])
        self.GUI_GIF_DrawEx = StaticFunction(device, 0x2c098, thumb=1, name='GUI_GIF_DrawEx', return_type=c_int_le, size=74, line=1110, arg_list=[('fpGetData',PointerType('GUI_GIF_GET_DATA_FUNC')),('p',PointerType("void")),('x0',c_int_le),('y0',c_int_le)])
        self.GUI_GIF_GetImageInfoEx = StaticFunction(device, 0x2c2a8, thumb=1, name='GUI_GIF_GetImageInfoEx', return_type=c_int_le, size=418, line=1148, arg_list=[('fpGetData',PointerType('GUI_GIF_GET_DATA_FUNC')),('p',PointerType("void")),('pInfo',PointerType('GUI_GIF_IMAGE_INFO')),('Index',c_int_le)])
