...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        self._APIList = StaticVariable(device, self.tGUI_ENC_APIList, 0x61bfc, True)
        ...
        ### Functions data ###
        ######################
        self._ClearLine = StaticFunction(device, 0x30bde, thumb=1, name='_ClearLine', return_type=None, size=106, line=113, arg_list=[('s',PointerType("c_byte")),('Len',c_int_le)])
        self._DispLine = StaticFunction(device, 0x30c48, thumb=1, name='_DispLine', return_type=None, size=36, line=139, arg_list=[('s',PointerType('c_byte')),('Len',c_int_le)])
        self._DispChar = StaticFunction(device, 0x30b24, thumb=1, name='_DispChar', return_type=None, size=186, line=36, arg_list=[('c',c_ushort_le)])
