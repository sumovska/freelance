...
class const():
    ...
    ###############
    LCD_CACHE = 0
    LCD_WRITE_BUFFER_SIZE = 500
    LCD_USE_SERIAL_3PIN = 0
    LCD_USE_PARALLEL_16 = 0
    LCD_DISPLAY_INDEX = 0
    LCD_SUPPORT_CACHECONTROL = 0
    LCD_NUM_DUMMY_READS = 1
    REG_INC_MODE = 54
    REG_CASET = 42
    REG_RASET = 43
    REG_RAM_ACCESS_W = 44
...
class Code(AbstractCode):
    ...
    def _NextPixel_End(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2969
        '''
        pass
    ...
    def LCD_L0_Off(self, ):
        ...
        Return type:
        -None
        Declaration line: 3234
        '''
        pass

    def _NextPixel_NextLine(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2961
        '''
        pass
    ...
    def LCD_L0_On(self, ):
        ...
        Return type:
        -None
        Declaration line: 3228
        '''
        pass

    def LCD_L0_SetLUTEntry(self, Pos, Color):
        '''
        Arguments:
        -Pos - c_ubyte
        -Color - LCD_COLOR
        Return type:
        -None
        Declaration line: 3376
        '''
        pass

    def LCD_L0_GetDevFunc(self, Index):
        '''
        Arguments:
        -Index - c_int_le
        Return type:
    ...
    def LCD_L0_FillRect(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        ...
        Return type:
        -None
        Declaration line: 3137
        '''
        pass

    def LCD_L0_DrawVLine(self, x, y0, y1):
        '''
        Arguments:
        -x - c_int_le
        -y0 - c_int_le
        ...
        Return type:
        -None
        Declaration line: 3123
        '''
        pass

    def _SetRect(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        ...
        Return type:
        -None
        Declaration line: 2233
        '''
        pass

    def LCD_L0_SetOrg(self, x, y):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        Return type:
        -None
        Declaration line: 3220
        '''
        pass

    def LCD_L0_XorPixel(self, x, y):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        Return type:
        -None
        Declaration line: 3100
        '''
        pass

    def _NextPixel_Start(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        ...
        Return type:
        -None
        Declaration line: 2937
        '''
        pass

    def LCD_L0_DrawHLine(self, x0, y, x1):
        '''
        Arguments:
        -x0 - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 3109
        '''
        pass

    def LCD_L0_Init(self, ):
        '''
        Arguments:
        Return type:
        -c_int_le
        Declaration line: 3249
        '''
        pass

    def LCD_L0_GetPixelIndex(self, x, y):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def LCD_L0_SetPixelIndex(self, x, y, PixelIndex):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 3031
        '''
        pass

    def _NextPixel_SetPixel(self, PixelIndex):
        '''
        Arguments:
        -PixelIndex - c_int_le
        Return type:
        -None
        Declaration line: 2949
        '''
        pass

    def LCD_L0_DrawBitmap(self, x0, y0, xsize, ysize, BitsPerPixel, BytesPerLine, pData, Diff, pTrans):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        -xsize - c_int_le
        -ysize - c_int_le
        -BitsPerPixel - c_int_le
        -BytesPerLine - c_int_le
        -pData - PointerType('c_ubyte')
        -Diff - c_int_le
        -pTrans - PointerType("c_ushort_le")
        Return type:
        -None
        Declaration line: 3173
        '''
        pass

    def _ReadRect(self, x0, y0, x1, y1, p):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    _NumPixelsInBuffer = c_int_le
    GUI_Context = GUI_CONTEXT
    GUI_pLCD_APIList = PointerType('tLCD_APIList')
    _WriteBuffer = c_ubyte * 500
    ...
    _x0 = c_int_le
    _x1 = c_int_le
    _NextPixel_API = LCD_API_NEXT_PIXEL
    _pBuffer = PointerType("c_ubyte")
    ...
    def __init__(self, device):
        ...
        self._NumPixelsInBuffer = StaticVariable(device, c_int_le, 0x80008070L, False)
        ...
        self._WriteBuffer = StaticVariable(device, c_ubyte * 500, 0x40005e84, False)
        self.GUI_XBF_APIList_Prop_Ext = StaticVariable(device, self.tGUI_XBF_APIList, 0x61c08, True)
        self._aPair = StaticVariable(device, c_ubyte * 4, 0x80008078L, False)
        ...
        self._x0 = StaticVariable(device, c_int_le, 0x80008044L, False)
        self._x1 = StaticVariable(device, c_int_le, 0x80008048L, False)
        self._NextPixel_API = StaticVariable(device, self.LCD_API_NEXT_PIXEL, 0x8000807cL, False)
        self._pBuffer = StaticVariable(device, PointerType("c_ubyte"), 0x80008074L, False)
        self.GUI_pfDispCharStyle = StaticVariable(device, PointerType('Subroutine'), 0x80008034L, False)

        ######################
        ### Functions data ###
        ######################
        self._NextPixel_End = StaticFunction(device, 0x3008c, thumb=1, name='_NextPixel_End', return_type=None, size=28, line=2969, arg_list=[])
        self.LCD_L0_Off = StaticFunction(device, 0x30720, thumb=1, name='LCD_L0_Off', return_type=None, size=2, line=3234, arg_list=[])
        self._NextPixel_NextLine = StaticFunction(device, 0x3008a, thumb=1, name='_NextPixel_NextLine', return_type=None, size=2, line=2961, arg_list=[])
        self.LCD_L0_On = StaticFunction(device, 0x3071e, thumb=1, name='LCD_L0_On', return_type=None, size=2, line=3228, arg_list=[])
        self.LCD_L0_SetLUTEntry = StaticFunction(device, 0x30940, thumb=1, name='LCD_L0_SetLUTEntry', return_type=None, size=2, line=3376, arg_list=[('Pos',c_ubyte),('Color',LCD_COLOR)])
        self.LCD_L0_GetDevFunc = StaticFunction(device, 0x30942, thumb=1, name='LCD_L0_GetDevFunc', return_type=PointerType("void"), size=28, line=3385, arg_list=[('Index',c_int_le)])
        self.LCD_L0_FillRect = StaticFunction(device, 0x30114, thumb=1, name='LCD_L0_FillRect', return_type=None, size=200, line=3137, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.LCD_L0_DrawVLine = StaticFunction(device, 0x30226, thumb=1, name='LCD_L0_DrawVLine', return_type=None, size=74, line=3123, arg_list=[('x',c_int_le),('y0',c_int_le),('y1',c_int_le)])
        self._SetRect = StaticFunction(device, 0x2fedc, thumb=1, name='_SetRect', return_type=None, size=106, line=2233, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.LCD_L0_SetOrg = StaticFunction(device, 0x3071c, thumb=1, name='LCD_L0_SetOrg', return_type=None, size=2, line=3220, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.LCD_L0_XorPixel = StaticFunction(device, 0x300f4, thumb=1, name='LCD_L0_XorPixel', return_type=None, size=32, line=3100, arg_list=[('x',c_int_le),('y',c_int_le)])
        self._NextPixel_Start = StaticFunction(device, 0x30044, thumb=1, name='_NextPixel_Start', return_type=None, size=22, line=2937, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.LCD_L0_DrawHLine = StaticFunction(device, 0x301dc, thumb=1, name='LCD_L0_DrawHLine', return_type=None, size=74, line=3109, arg_list=[('x0',c_int_le),('y',c_int_le),('x1',c_int_le)])
        self.LCD_L0_Init = StaticFunction(device, 0x30722, thumb=1, name='LCD_L0_Init', return_type=c_int_le, size=542, line=3249, arg_list=[])
        self.LCD_L0_GetPixelIndex = StaticFunction(device, 0x2ffbe, thumb=1, name='LCD_L0_GetPixelIndex', return_type=c_uint_le, size=134, line=3066, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.LCD_L0_SetPixelIndex = StaticFunction(device, 0x2ff46, thumb=1, name='LCD_L0_SetPixelIndex', return_type=None, size=120, line=3031, arg_list=[('x',c_int_le),('y',c_int_le),('PixelIndex',c_int_le)])
        self._NextPixel_SetPixel = StaticFunction(device, 0x3005a, thumb=1, name='_NextPixel_SetPixel', return_type=None, size=48, line=2949, arg_list=[('PixelIndex',c_int_le)])
        self.LCD_L0_DrawBitmap = StaticFunction(device, 0x30270, thumb=1, name='LCD_L0_DrawBitmap', return_type=None, size=1196, line=3173, arg_list=[('x0',c_int_le),('y0',c_int_le),('xsize',c_int_le),('ysize',c_int_le),('BitsPerPixel',c_int_le),('BytesPerLine',c_int_le),('pData',PointerType('c_ubyte')),('Diff',c_int_le),('pTrans',PointerType("c_ushort_le"))])
        self._ReadRect = StaticFunction(device, 0x300a8, thumb=1, name='_ReadRect', return_type=None, size=76, line=2993, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le),('p',PointerType('void'))])
