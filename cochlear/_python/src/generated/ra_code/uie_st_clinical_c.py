...
class Code(AbstractCode):
    ...
    def UIE_P_StClinical(self, me, pEvt):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.UIE_P_StClinical = StaticFunction(device, 0x3cf94, thumb=1, name='UIE_P_StClinical', return_type=HSM_StateRet_t, size=128, line=78, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
