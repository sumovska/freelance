...
class ELOG_P_CatDescriptor_tag(Structure):
    meta = ELOG_Metadata_t
    entrySize = u16
    entryNum = u16
    phyMetaAddr = u32
    phyBufAddr = u32
...
ELOG_P_CatDescriptor_t = ELOG_P_CatDescriptor_tag
...
class Code(AbstractCode):
    ...
    ELOG_P_CatDescriptor_tag = ELOG_P_CatDescriptor_tag
    DEROM_FlashInfo_tag = DEROM_FlashInfo_tag
    ELOG_P_CatDescriptor_t = ELOG_P_CatDescriptor_t
    ...
    def elogCatMetadataInit(self, pMeta, cipStartAddr, catSize):
        '''
        Arguments:
        -pMeta - PointerType("ELOG_Metadata_t")
        -cipStartAddr - u32
        -catSize - u32
        Return type:
        -None
        Declaration line: 560
        '''
        pass

    def ELOG_Configure(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def elogConvertTotalIdxToPageRelativeIdx(self, absoluteIdx, entrySize, numOfPages, pPage, pPageIdx):
        '''
        Arguments:
        -absoluteIdx - u16
        -entrySize - u16
        -numOfPages - u16
        -pPage - PointerType('u16')
        -pPageIdx - PointerType("u16")
        Return type:
        -None
        Declaration line: 599
        '''
        pass

    def ELOG_Read(self, catDesc, entryIdx, buf):
        '''
        Arguments:
        -catDesc - u8
        -entryIdx - u16
    ...
    def elogCatDescriptorInit(self, catDesc):
        '''
        Arguments:
        -catDesc - u8
        Return type:
        -Status
        Declaration line: 448
        '''
        pass

    def ELOG_Log(self, catDesc, pBuff):
        '''
        Arguments:
        -catDesc - u8
        -pBuff - PointerType("u8")
        Return type:
        -Status
    ...
    def elogEromPageEraseWrite(self, dstAddr, pSrcAddr, dataSize, permanent):
        '''
        Arguments:
        -dstAddr - u32
        ...
        Return type:
        -Status
        Declaration line: 821
        '''
        pass

    def ELOG_CatInit(self, catDesc, nvmStartAddr, cipStartAddr, metaOffset, catOffset, catSize, entrySize, useMutex, mutexPrio):
        '''
        Arguments:
        -catDesc - u8
        -nvmStartAddr - u32
    ...
    def elogLogEntry(self, catDesc, pLogEntry):
        '''
        Arguments:
        -catDesc - u8
        -pLogEntry - PointerType("u8")
        Return type:
        -None
    ...
    def elogWriteMetaToFlash(self, catDesc):
        '''
        Arguments:
        -catDesc - u8
        Return type:
    ...
    def elogWriteBufToFlash(self, catDesc):
        '''
        Arguments:
        -catDesc - u8
        Return type:
        -Status
        Declaration line: 779
        '''
        pass

    def ELOG_GetNumOfEntries(self, catDesc):
        '''
        Arguments:
        -catDesc - u8
        Return type:
    ...
    elogCatDesc = ELOG_P_CatDescriptor_t * 6
    OSRdyTbl = INT8U * 8
    ...
    def __init__(self, device):
        ...
        self.elogCatDesc = StaticVariable(device, ELOG_P_CatDescriptor_t * 6, 0x40006138, False)
        ...
        ### Functions data ###
        ######################
        self.elogCatMetadataInit = StaticFunction(device, 0x336c6, thumb=1, name='elogCatMetadataInit', return_type=None, size=62, line=560, arg_list=[('pMeta',PointerType("ELOG_Metadata_t")),('cipStartAddr',u32),('catSize',u32)])
        self.ELOG_Configure = StaticFunction(device, 0x337f6, thumb=1, name='ELOG_Configure', return_type=None, size=28, line=282, arg_list=[])
        self.elogConvertTotalIdxToPageRelativeIdx = StaticFunction(device, 0x33704, thumb=1, name='elogConvertTotalIdxToPageRelativeIdx', return_type=None, size=44, line=599, arg_list=[('absoluteIdx',u16),('entrySize',u16),('numOfPages',u16),('pPage',PointerType('u16')),('pPageIdx',PointerType("u16"))])
        self.ELOG_Read = StaticFunction(device, 0x339ba, thumb=1, name='ELOG_Read', return_type=Status, size=96, line=402, arg_list=[('catDesc',u8),('entryIdx',u16),('buf',PointerType('u8'))])
        self.elogCatDescriptorInit = StaticFunction(device, 0x33730, thumb=1, name='elogCatDescriptorInit', return_type=Status, size=198, line=448, arg_list=[('catDesc',u8)])
        self.ELOG_Log = StaticFunction(device, 0x3392c, thumb=1, name='ELOG_Log', return_type=Status, size=118, line=336, arg_list=[('catDesc',u8),('pBuff',PointerType("u8"))])
        self.ELOG_Fini = StaticFunction(device, 0x3385a, thumb=1, name='ELOG_Fini', return_type=Status, size=28, line=308, arg_list=[('fini_type',INT_FiniType_t)])
        self.elogEromPageEraseWrite = StaticFunction(device, 0x33632, thumb=1, name='elogEromPageEraseWrite', return_type=Status, size=72, line=821, arg_list=[('dstAddr',u32),('pSrcAddr',PointerType('u8')),('dataSize',u32),('permanent',bool)])
        self.ELOG_CatInit = StaticFunction(device, 0x33586, thumb=1, name='ELOG_CatInit', return_type=Status, size=172, line=188, arg_list=[('catDesc',u8),('nvmStartAddr',u32),('cipStartAddr',u32),('metaOffset',u32),('catOffset',u32),('catSize',u32),('entrySize',u8),('useMutex',u8),('mutexPrio',u8)])
        self.elogLogEntry = StaticFunction(device, 0x33876, thumb=1, name='elogLogEntry', return_type=None, size=182, line=643, arg_list=[('catDesc',u8),('pLogEntry',PointerType("u8"))])
        self.elogWriteMetaToFlash = StaticFunction(device, 0x3367a, thumb=1, name='elogWriteMetaToFlash', return_type=Status, size=76, line=737, arg_list=[('catDesc',u8)])
        self.elogWriteBufToFlash = StaticFunction(device, 0x33812, thumb=1, name='elogWriteBufToFlash', return_type=Status, size=72, line=779, arg_list=[('catDesc',u8)])
        self.ELOG_GetNumOfEntries = StaticFunction(device, 0x339a2, thumb=1, name='ELOG_GetNumOfEntries', return_type=u16, size=24, line=387, arg_list=[('catDesc',u8)])
        self.ELOG_Init = StaticFunction(device, 0x33558, thumb=1, name='ELOG_Init', return_type=Status, size=46, line=145, arg_list=[('init_type',INT_InitType_t)])
