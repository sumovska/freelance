...
class Code(AbstractCode):
    ...
    def GUI_SetFont(self, pNewFont):
        '''
        Arguments:
        -pNewFont - PointerType("GUI_FONT")
        Return type:
        -PointerType('GUI_FONT')
        Declaration line: 33
        '''
        pass
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_SetFont = StaticFunction(device, 0x2e194, thumb=1, name='GUI_SetFont', return_type=PointerType('GUI_FONT'), size=14, line=33, arg_list=[('pNewFont',PointerType("GUI_FONT"))])
