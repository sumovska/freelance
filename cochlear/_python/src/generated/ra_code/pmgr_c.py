...
class Code(AbstractCode):
    ...
    def PMGR_ChangeMode(self, pwrMode, wakeUpSrc):
        '''
        Arguments:
        -pwrMode - PMGR_PwrMode_t
        -wakeUpSrc - u16
        Return type:
        -None
    ...
    def PMGR_PeriphEnable(self, periphMask):
        '''
        Arguments:
        -periphMask - u32
        Return type:
        -u32
        Declaration line: 209
        '''
        pass
    ...
    def PMGR_ChargingCfg(self, chargeMode):
        '''
        Arguments:
        -chargeMode - PMGR_ChargingMode_t
        Return type:
        -None
        Declaration line: 332
        '''
        pass

    def PMGR_TurnWAOn(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 373
        '''
        pass

    def PMGR_PeriphDisable(self, periphMask):
        '''
        Arguments:
        -periphMask - u32
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.PMGR_ChangeMode = StaticFunction(device, 0x5bee4, thumb=1, name='PMGR_ChangeMode', return_type=None, size=40, line=295, arg_list=[('pwrMode',PMGR_PwrMode_t),('wakeUpSrc',u16)])
        self.PMGR_PeriphEnable = StaticFunction(device, 0x5bea6, thumb=1, name='PMGR_PeriphEnable', return_type=u32, size=34, line=209, arg_list=[('periphMask',u32)])
        self.PMGR_Init = StaticFunction(device, 0x5be60, thumb=1, name='PMGR_Init', return_type=None, size=70, line=163, arg_list=[])
        self.PMGR_TurnWAOff = StaticFunction(device, 0x5bf5a, thumb=1, name='PMGR_TurnWAOff', return_type=None, size=20, line=404, arg_list=[])
        self.PMGR_ChargingCfg = StaticFunction(device, 0x5bf0c, thumb=1, name='PMGR_ChargingCfg', return_type=None, size=66, line=332, arg_list=[('chargeMode',PMGR_ChargingMode_t)])
        self.PMGR_TurnWAOn = StaticFunction(device, 0x5bf4e, thumb=1, name='PMGR_TurnWAOn', return_type=None, size=12, line=373, arg_list=[])
        self.PMGR_PeriphDisable = StaticFunction(device, 0x5bec8, thumb=1, name='PMGR_PeriphDisable', return_type=u32, size=28, line=247, arg_list=[('periphMask',u32)])
