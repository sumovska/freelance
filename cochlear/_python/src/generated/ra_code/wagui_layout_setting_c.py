...
class SettingType_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    SETTING_ON = 0
    SETTING_ONOFF = 1
    SETTING_OFF = 2
...
class VolSensUniBi_tag(Structure):
    uni = WAGUI_P_Res_t
    left = WAGUI_P_Res_t
    right = WAGUI_P_Res_t
    _pack_ = 1
...
VolSensUniBi_t = VolSensUniBi_tag
class VolSensIcons_tag(Structure):
    def_ = VolSensUniBi_t
    dis = VolSensUniBi_t
    val = VolSensUniBi_t
    _pack_ = 1
...
VolSensIcons_t = VolSensIcons_tag
...
class const():
    ...
    ###############
    BTE_SERIAL_NO_POS = 0
    BTE_SERIAL_NO_DIGITS = 13
    WA_SERIAL_NO_POS = 0
    WA_SERIAL_NO_DIGITS = 13
    INT_MODULE = 165
    ERROR = -1
    SUCCESS = 0
    FALSE = 0
...
class Code(AbstractCode):
    ...
    SettingType_tag = SettingType_tag
    ...
    VolSensUniBi_tag = VolSensUniBi_tag
    ...
    VolSensUniBi_t = VolSensUniBi_t
    VolSensIcons_tag = VolSensIcons_tag
    ...
    def WAGUI_ShowVolume(self, vPi, updateMode):
        '''
        Arguments:
        -vPi - PointerType("WAGUI_VolSensInfo_t")
    ...
    def WAGUI_ShowNrtAbortInstruction(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1750
        '''
        pass

    def WAGUI_ShowNrtRemoveContralateralInstruction(self, nrtBteId):
        '''
        Arguments:
        -nrtBteId - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1173
        '''
        pass

    def ShowVolSens(self, vPi, segHeight, marHeight, updateMode):
        '''
        Arguments:
        -vPi - PointerType('WAGUI_VolSensInfo_t')
        -segHeight - c_int_le
    ...
    def WAGUI_ShowBteVersionInfo(self, pairedBtes, identBteLeft, identBteRight):
        '''
        Arguments:
        -pairedBtes - WBST_BteId_t
        -identBteLeft - PointerType("WBST_BteIdentifiers_t")
        -identBteRight - PointerType('WBST_BteIdentifiers_t')
        Return type:
        -None
        Declaration line: 924
        '''
        pass

    def WAGUI_ShowNrtNotPossibleInstruction(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAGUI_ShowTelecoilMixing(self, value):
        '''
        Arguments:
        -value - WBST_Value_t
        Return type:
    ...
    def WAGUI_ShowBilateralControl(self, selection, selected, active):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 638
        '''
        pass

    def DrawBassTrebleValueScaleSide(self, scaleMin, scaleMax, hint, value, side, scheme):
        '''
        Arguments:
        -scaleMin - WBST_Value_t
        -scaleMax - WBST_Value_t
        -hint - WBST_Value_t
        -value - WBST_Value_t
        -side - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1321
        '''
        pass

    def WAGUI_ShowVolumePopup(self, vPi, updateMode):
        '''
        Arguments:
        -vPi - PointerType('WAGUI_VolSensInfo_t')
        -updateMode - WAGUI_UpdateMode_t
        Return type:
        -None
        Declaration line: 589
        '''
        pass

    def WAGUI_ShowNrtBass(self, bteId, pairedBtes, hint, value):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1894
        '''
        pass

    def WAGUI_ShowNrtMasterVolume(self, bteId, pairedBtes, hint, value, expectedMin, expectedMax):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
        -hint - WBST_Value_t
        -value - WBST_Value_t
        -expectedMin - WBST_Value_t
        -expectedMax - WBST_Value_t
        Return type:
        -None
        Declaration line: 1823
        '''
        pass

    def DrawNrtCurrentLevel(self, x, y, currentLvl, stim):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 1618
        '''
        pass

    def ShowVolSensPopup(self, vPi, updateMode):
        '''
        Arguments:
        -vPi - PointerType("WAGUI_VolSensInfo_t")
        -updateMode - WAGUI_UpdateMode_t
        Return type:
        -None
        Declaration line: 464
        '''
        pass

    def WAGUI_ShowBass(self, bteId, pairedBtes, hint, value):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1501
        '''
        pass

    def WAGUI_ShowRaBeepsSelection(self, selection, selected, active):
        '''
        Arguments:
        -selection - PointerType('WAGUI_Selection_t')
        -selected - c_int_le
        ...
        Return type:
        -None
        Declaration line: 714
        '''
        pass

    def WAGUI_ShowAutoClassIconsSelection(self, selection, selected, active):
        '''
        Arguments:
        -selection - PointerType("WAGUI_Selection_t")
        -selected - c_int_le
    ...
    def DrawMVBTValue(self, value, valueSigned, side, scheme):
        '''
        Arguments:
        -value - WBST_Value_t
        -valueSigned - bool
        ...
        Return type:
        -None
        Declaration line: 1381
        '''
        pass

    def WAGUI_ShowRaAlertsSelection(self, selection, selected, active):
        '''
        Arguments:
        -selection - PointerType('WAGUI_Selection_t')
        -selected - c_int_le
        ...
        Return type:
        -None
        Declaration line: 733
        '''
        pass

    def WAGUI_ShowSensitivityPopup(self, sPi, updateMode):
        '''
        Arguments:
        -sPi - PointerType("WAGUI_VolSensInfo_t")
        -updateMode - WAGUI_UpdateMode_t
        Return type:
        -None
    ...
    def WAGUI_ShowNrtInitInstruction(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1602
        '''
        pass

    def ShowMixing(self, value, mixingIcon):
        '''
        Arguments:
        -value - WBST_Value_t
        -mixingIcon - WAGUI_P_Res_t
        Return type:
        -None
        Declaration line: 771
        '''
        pass

    def WAGUI_ShowNrtSkippedInstruction(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAGUI_OverlayMasterVolumeLimitReachedPopup(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1853
        '''
        pass

    def WAGUI_ShowBteButtonsSelection(self, selection, selected, active):
        '''
        Arguments:
        -selection - PointerType('WAGUI_Selection_t')
        -selected - c_int_le
        ...
        Return type:
        -None
        Declaration line: 657
        '''
        pass

    def WAGUI_ShowNrtEntry(self, bteId, pairedBtes):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
    ...
    def WAGUI_ShowNrtPauseSelection(self, selection, selected):
        '''
        Arguments:
        -selection - PointerType("WAGUI_Selection_t")
        -selected - c_int_le
        Return type:
        -None
        Declaration line: 1731
        '''
        pass

    def WAGUI_UpdateMasterVolumeAction(self, action):
        '''
        Arguments:
    ...
    def DrawMVBTScaleEx(self, scaleMin, scaleMax, hint, value, expectedMin, expectedMax, r, colorScaleBkg, colorScaleValue):
        '''
        Arguments:
        -scaleMin - WBST_Value_t
        -scaleMax - WBST_Value_t
        ...
        -expectedMin - WBST_Value_t
        -expectedMax - WBST_Value_t
        -r - PointerType('GUI_RECT')
        -colorScaleBkg - GUI_COLOR
        -colorScaleValue - GUI_COLOR
        Return type:
        -None
        Declaration line: 1220
        '''
        pass

    def WAGUI_ShowBteBeepsSelection(self, selection, selected, active):
        '''
        Arguments:
        -selection - PointerType("WAGUI_Selection_t")
        -selected - c_int_le
        ...
        Return type:
        -None
        Declaration line: 676
        '''
        pass

    def WAGUI_ShowMasterVolume(self, bteId, pairedBtes, hint, value, expectedMin, expectedMax):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1455
        '''
        pass

    def OverlayPopupVolSens(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1989
        '''
        pass

    def WAGUI_ShowAccessoryMixing(self, value, accType, stream, streamType):
        '''
        Arguments:
        -value - WBST_Value_t
        -accType - WBST_Value_t
        ...
        Return type:
        -None
        Declaration line: 830
        '''
        pass

    def WAGUI_ShowBassBi(self, hintLeft, valueLeft, hintRight, valueRight):
        '''
        Arguments:
        -hintLeft - WBST_Value_t
        -valueLeft - WBST_Value_t
        -hintRight - WBST_Value_t
        -valueRight - WBST_Value_t
        Return type:
        -None
        Declaration line: 1528
        '''
        pass

    def WAGUI_ShowNrtMasterVolumeInstruction(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1807
        '''
        pass

    def DrawMVBTScale(self, scaleMin, scaleMax, hint, value, expectedMin, expectedMax, scheme):
        '''
        Arguments:
        -scaleMin - WBST_Value_t
        -scaleMax - WBST_Value_t
        ...
        Return type:
        -None
        Declaration line: 1300
        '''
        pass

    def WAGUI_ShowNrtProgress(self, fmcState, segfill, currentLvl, updateMode, stim):
        '''
        Arguments:
        -fmcState - WBST_Value_t
        -segfill - u8
        -currentLvl - u8
        -updateMode - WAGUI_UpdateMode_t
        -stim - bool
        Return type:
        -None
        Declaration line: 1644
        '''
        pass

    def WAGUI_ShowDemoSelection(self, selection, selected):
        '''
        Arguments:
        -selection - PointerType('WAGUI_Selection_t')
        -selected - c_int_le
    ...
    def DrawVersionStr(self, x, y, fwVersion, serialNo, small):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        -fwVersion - PointerType("c_byte")
        -serialNo - PointerType('c_byte')
        -small - bool
        Return type:
        -None
        Declaration line: 866
        '''
        pass

    def WAGUI_ShowLangSelection(self, selected):
        '''
        Arguments:
        -selected - c_int_le
        Return type:
        -None
        Declaration line: 1041
        '''
        pass

    def DrawVolSensScale(self, value, segHeight, marHeight, bteId, isDef, isDisabled):
        '''
        Arguments:
        -value - c_int_le
        -segHeight - c_int_le
        ...
        Return type:
        -None
        Declaration line: 211
        '''
        pass

    def WAGUI_ShowBteLightsSelection(self, selection, selected, active):
        '''
        Arguments:
        -selection - PointerType("WAGUI_Selection_t")
        -selected - c_int_le
        ...
        Return type:
        -None
        Declaration line: 695
        '''
        pass

    def BcdToAscii(self, bcdString, buf, digits):
        '''
        Arguments:
        -bcdString - PointerType('u8')
        -buf - PointerType("c_byte")
        -digits - c_int_le
        Return type:
        -None
        Declaration line: 2002
        '''
        pass

    def WAGUI_ShowSensitivity(self, vPi, updateMode):
        '''
        Arguments:
        -vPi - PointerType('WAGUI_VolSensInfo_t')
        -updateMode - WAGUI_UpdateMode_t
    ...
    def WAGUI_ShowNrtBassInstruction(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAGUI_ShowDeviceSettingsEntry(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAGUI_OverlayRaBeepsPopup(self, mode, sel):
        '''
        Arguments:
    ...
    def WAGUI_ShowHearingSettingsEntry(self, bteId, pairedBtes):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
        Return type:
        -None
        Declaration line: 1063
        '''
        pass

    def WAGUI_ShowNrtTreble(self, bteId, pairedBtes, hint, value):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1938
        '''
        pass

    def WAGUI_ShowNrtConfirmation(self, selection, selected):
        '''
        Arguments:
        -selection - PointerType("WAGUI_Selection_t")
        -selected - c_int_le
        Return type:
        -None
        Declaration line: 1966
        '''
        pass

    def WAGUI_ShowTrebleBi(self, hintLeft, valueLeft, hintRight, valueRight):
        '''
        Arguments:
        -hintLeft - WBST_Value_t
        -valueLeft - WBST_Value_t
        ...
        Return type:
        -None
        Declaration line: 1578
        '''
        pass

    def WAGUI_UpdateSettingAction(self, action):
        '''
        Arguments:
        -action - WAGUI_SettingAction_t
        Return type:
    ...
    def WAGUI_ShowRaVersionInfo(self, identRa, modal):
        '''
        Arguments:
        -identRa - PointerType('WBST_RaIdentifiers_t')
        -modal - bool
        Return type:
        -None
        Declaration line: 1003
        '''
        pass

    def WAGUI_ShowSideSelection(self, selection, selected):
        '''
        Arguments:
        -selection - PointerType("WAGUI_Selection_t")
        -selected - c_int_le
    ...
    def WAGUI_ShowTreble(self, bteId, pairedBtes, hint, value):
        '''
        Arguments:
        -bteId - WBST_BteId_t
        -pairedBtes - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1551
        '''
        pass

    def WAGUI_ShowSwitchSelection(self, selection, selected):
        '''
        Arguments:
        -selection - PointerType('WAGUI_Selection_t')
        -selected - c_int_le
        Return type:
        -None
        Declaration line: 144
        '''
        pass

    def WAGUI_ShowNrtTrebleInstruction(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def __init__(self, device):
        ...
        self.currentMvBelowPos = StaticVariable(device, self.GUI_POINT, 0x80008860L, False)

        ######################
        ### Functions data ###
        ######################
        self.WAGUI_ShowVolume = StaticFunction(device, 0x4d4ba, thumb=1, name='WAGUI_ShowVolume', return_type=None, size=66, line=428, arg_list=[('vPi',PointerType("WAGUI_VolSensInfo_t")),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowNrtAbortInstruction = StaticFunction(device, 0x4eaea, thumb=1, name='WAGUI_ShowNrtAbortInstruction', return_type=None, size=38, line=1750, arg_list=[])
        self.WAGUI_ShowNrtRemoveContralateralInstruction = StaticFunction(device, 0x4e02e, thumb=1, name='WAGUI_ShowNrtRemoveContralateralInstruction', return_type=None, size=242, line=1173, arg_list=[('nrtBteId',WBST_BteId_t)])
        self.ShowVolSens = StaticFunction(device, 0x4d0f4, thumb=1, name='ShowVolSens', return_type=None, size=966, line=265, arg_list=[('vPi',PointerType('WAGUI_VolSensInfo_t')),('segHeight',c_int_le),('marHeight',c_int_le),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowBteVersionInfo = StaticFunction(device, 0x4dccc, thumb=1, name='WAGUI_ShowBteVersionInfo', return_type=None, size=282, line=924, arg_list=[('pairedBtes',WBST_BteId_t),('identBteLeft',PointerType("WBST_BteIdentifiers_t")),('identBteRight',PointerType('WBST_BteIdentifiers_t'))])
        self.WAGUI_ShowNrtNotPossibleInstruction = StaticFunction(device, 0x4eb10, thumb=1, name='WAGUI_ShowNrtNotPossibleInstruction', return_type=None, size=114, line=1766, arg_list=[])
        self.WAGUI_ShowTelecoilMixing = StaticFunction(device, 0x4db74, thumb=1, name='WAGUI_ShowTelecoilMixing', return_type=None, size=56, line=850, arg_list=[('value',WBST_Value_t)])
        self.WAGUI_ShowBilateralControl = StaticFunction(device, 0x4d85c, thumb=1, name='WAGUI_ShowBilateralControl', return_type=None, size=60, line=638, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le),('active',c_int_le)])
        self.DrawBassTrebleValueScaleSide = StaticFunction(device, 0x4e32e, thumb=1, name='DrawBassTrebleValueScaleSide', return_type=None, size=244, line=1321, arg_list=[('scaleMin',WBST_Value_t),('scaleMax',WBST_Value_t),('hint',WBST_Value_t),('value',WBST_Value_t),('side',WBST_BteId_t),('scheme',ColorScheme_t)])
        self.WAGUI_ShowVolumePopup = StaticFunction(device, 0x4d776, thumb=1, name='WAGUI_ShowVolumePopup', return_type=None, size=142, line=589, arg_list=[('vPi',PointerType('WAGUI_VolSensInfo_t')),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowNrtBass = StaticFunction(device, 0x4ecf2, thumb=1, name='WAGUI_ShowNrtBass', return_type=None, size=134, line=1894, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('hint',WBST_Value_t),('value',WBST_Value_t)])
        self.WAGUI_ShowNrtMasterVolume = StaticFunction(device, 0x4ebce, thumb=1, name='WAGUI_ShowNrtMasterVolume', return_type=None, size=146, line=1823, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('hint',WBST_Value_t),('value',WBST_Value_t),('expectedMin',WBST_Value_t),('expectedMax',WBST_Value_t)])
        self.DrawNrtCurrentLevel = StaticFunction(device, 0x4e88e, thumb=1, name='DrawNrtCurrentLevel', return_type=None, size=88, line=1618, arg_list=[('x',c_int_le),('y',c_int_le),('currentLvl',c_int_le),('stim',bool)])
        self.ShowVolSensPopup = StaticFunction(device, 0x4d54a, thumb=1, name='ShowVolSensPopup', return_type=None, size=556, line=464, arg_list=[('vPi',PointerType("WAGUI_VolSensInfo_t")),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowBass = StaticFunction(device, 0x4e660, thumb=1, name='WAGUI_ShowBass', return_type=None, size=140, line=1501, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('hint',WBST_Value_t),('value',WBST_Value_t)])
        self.WAGUI_ShowRaBeepsSelection = StaticFunction(device, 0x4d940, thumb=1, name='WAGUI_ShowRaBeepsSelection', return_type=None, size=56, line=714, arg_list=[('selection',PointerType('WAGUI_Selection_t')),('selected',c_int_le),('active',c_int_le)])
        self.WAGUI_ShowAutoClassIconsSelection = StaticFunction(device, 0x4d9b0, thumb=1, name='WAGUI_ShowAutoClassIconsSelection', return_type=None, size=56, line=752, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le),('active',c_int_le)])
        self.DrawMVBTValue = StaticFunction(device, 0x4e422, thumb=1, name='DrawMVBTValue', return_type=None, size=328, line=1381, arg_list=[('value',WBST_Value_t),('valueSigned',bool),('side',WBST_BteId_t),('scheme',ColorScheme_t)])
        self.WAGUI_ShowRaAlertsSelection = StaticFunction(device, 0x4d978, thumb=1, name='WAGUI_ShowRaAlertsSelection', return_type=None, size=56, line=733, arg_list=[('selection',PointerType('WAGUI_Selection_t')),('selected',c_int_le),('active',c_int_le)])
        self.WAGUI_ShowSensitivityPopup = StaticFunction(device, 0x4d804, thumb=1, name='WAGUI_ShowSensitivityPopup', return_type=None, size=88, line=613, arg_list=[('sPi',PointerType("WAGUI_VolSensInfo_t")),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowNrtInitInstruction = StaticFunction(device, 0x4e868, thumb=1, name='WAGUI_ShowNrtInitInstruction', return_type=None, size=38, line=1602, arg_list=[])
        self.ShowMixing = StaticFunction(device, 0x4d9e8, thumb=1, name='ShowMixing', return_type=None, size=290, line=771, arg_list=[('value',WBST_Value_t),('mixingIcon',WAGUI_P_Res_t)])
        self.WAGUI_ShowNrtSkippedInstruction = StaticFunction(device, 0x4eb82, thumb=1, name='WAGUI_ShowNrtSkippedInstruction', return_type=None, size=38, line=1791, arg_list=[])
        self.WAGUI_OverlayMasterVolumeLimitReachedPopup = StaticFunction(device, 0x4ec60, thumb=1, name='WAGUI_OverlayMasterVolumeLimitReachedPopup', return_type=None, size=108, line=1853, arg_list=[])
        self.WAGUI_ShowBteButtonsSelection = StaticFunction(device, 0x4d898, thumb=1, name='WAGUI_ShowBteButtonsSelection', return_type=None, size=56, line=657, arg_list=[('selection',PointerType('WAGUI_Selection_t')),('selected',c_int_le),('active',c_int_le)])
        self.WAGUI_ShowNrtEntry = StaticFunction(device, 0x4df80, thumb=1, name='WAGUI_ShowNrtEntry', return_type=None, size=174, line=1137, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t)])
        self.WAGUI_ShowNrtPauseSelection = StaticFunction(device, 0x4eaac, thumb=1, name='WAGUI_ShowNrtPauseSelection', return_type=None, size=62, line=1731, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le)])
        self.WAGUI_UpdateMasterVolumeAction = StaticFunction(device, 0x4e60a, thumb=1, name='WAGUI_UpdateMasterVolumeAction', return_type=None, size=86, line=1484, arg_list=[('action',WAGUI_SettingAction_t)])
        self.DrawMVBTScaleEx = StaticFunction(device, 0x4e120, thumb=1, name='DrawMVBTScaleEx', return_type=None, size=468, line=1220, arg_list=[('scaleMin',WBST_Value_t),('scaleMax',WBST_Value_t),('hint',WBST_Value_t),('value',WBST_Value_t),('expectedMin',WBST_Value_t),('expectedMax',WBST_Value_t),('r',PointerType('GUI_RECT')),('colorScaleBkg',GUI_COLOR),('colorScaleValue',GUI_COLOR)])
        self.WAGUI_ShowBteBeepsSelection = StaticFunction(device, 0x4d8d0, thumb=1, name='WAGUI_ShowBteBeepsSelection', return_type=None, size=56, line=676, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le),('active',c_int_le)])
        self.WAGUI_ShowMasterVolume = StaticFunction(device, 0x4e56a, thumb=1, name='WAGUI_ShowMasterVolume', return_type=None, size=160, line=1455, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('hint',WBST_Value_t),('value',WBST_Value_t),('expectedMin',WBST_Value_t),('expectedMax',WBST_Value_t)])
        self.OverlayPopupVolSens = StaticFunction(device, 0x4d53a, thumb=1, name='OverlayPopupVolSens', return_type=None, size=16, line=1989, arg_list=[])
        self.WAGUI_ShowAccessoryMixing = StaticFunction(device, 0x4db0a, thumb=1, name='WAGUI_ShowAccessoryMixing', return_type=None, size=106, line=830, arg_list=[('value',WBST_Value_t),('accType',WBST_Value_t),('stream',WBST_Value_t),('streamType',WBST_Value_t)])
        self.WAGUI_ShowBassBi = StaticFunction(device, 0x4e6ec, thumb=1, name='WAGUI_ShowBassBi', return_type=None, size=120, line=1528, arg_list=[('hintLeft',WBST_Value_t),('valueLeft',WBST_Value_t),('hintRight',WBST_Value_t),('valueRight',WBST_Value_t)])
        self.WAGUI_ShowNrtMasterVolumeInstruction = StaticFunction(device, 0x4eba8, thumb=1, name='WAGUI_ShowNrtMasterVolumeInstruction', return_type=None, size=38, line=1807, arg_list=[])
        self.DrawMVBTScale = StaticFunction(device, 0x4e2f4, thumb=1, name='DrawMVBTScale', return_type=None, size=58, line=1300, arg_list=[('scaleMin',WBST_Value_t),('scaleMax',WBST_Value_t),('hint',WBST_Value_t),('value',WBST_Value_t),('expectedMin',WBST_Value_t),('expectedMax',WBST_Value_t),('scheme',ColorScheme_t)])
        self.WAGUI_ShowNrtProgress = StaticFunction(device, 0x4e8e6, thumb=1, name='WAGUI_ShowNrtProgress', return_type=None, size=454, line=1644, arg_list=[('fmcState',WBST_Value_t),('segfill',u8),('currentLvl',u8),('updateMode',WAGUI_UpdateMode_t),('stim',bool)])
        self.WAGUI_ShowDemoSelection = StaticFunction(device, 0x4cfaa, thumb=1, name='WAGUI_ShowDemoSelection', return_type=None, size=58, line=163, arg_list=[('selection',PointerType('WAGUI_Selection_t')),('selected',c_int_le)])
        self.DrawVersionStr = StaticFunction(device, 0x4dbac, thumb=1, name='DrawVersionStr', return_type=None, size=232, line=866, arg_list=[('x',c_int_le),('y',c_int_le),('fwVersion',PointerType("c_byte")),('serialNo',PointerType('c_byte')),('small',bool)])
        self.WAGUI_ShowLangSelection = StaticFunction(device, 0x4de54, thumb=1, name='WAGUI_ShowLangSelection', return_type=None, size=62, line=1041, arg_list=[('selected',c_int_le)])
        self.DrawVolSensScale = StaticFunction(device, 0x4d038, thumb=1, name='DrawVolSensScale', return_type=None, size=188, line=211, arg_list=[('value',c_int_le),('segHeight',c_int_le),('marHeight',c_int_le),('bteId',WBST_BteId_t),('isDef',bool),('isDisabled',bool)])
        self.WAGUI_ShowBteLightsSelection = StaticFunction(device, 0x4d908, thumb=1, name='WAGUI_ShowBteLightsSelection', return_type=None, size=56, line=695, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le),('active',c_int_le)])
        self.BcdToAscii = StaticFunction(device, 0x4dc94, thumb=1, name='BcdToAscii', return_type=None, size=56, line=2002, arg_list=[('bcdString',PointerType('u8')),('buf',PointerType("c_byte")),('digits',c_int_le)])
        self.WAGUI_ShowSensitivity = StaticFunction(device, 0x4d4fc, thumb=1, name='WAGUI_ShowSensitivity', return_type=None, size=62, line=446, arg_list=[('vPi',PointerType('WAGUI_VolSensInfo_t')),('updateMode',WAGUI_UpdateMode_t)])
        self.WAGUI_ShowNrtBassInstruction = StaticFunction(device, 0x4eccc, thumb=1, name='WAGUI_ShowNrtBassInstruction', return_type=None, size=38, line=1878, arg_list=[])
        self.WAGUI_ShowDeviceSettingsEntry = StaticFunction(device, 0x4df36, thumb=1, name='WAGUI_ShowDeviceSettingsEntry', return_type=None, size=74, line=1120, arg_list=[])
        self.WAGUI_OverlayRaBeepsPopup = StaticFunction(device, 0x4cf30, thumb=1, name='WAGUI_OverlayRaBeepsPopup', return_type=None, size=60, line=109, arg_list=[('mode',WAGUI_CoverMode_t),('sel',u8)])
        self.WAGUI_ShowHearingSettingsEntry = StaticFunction(device, 0x4de92, thumb=1, name='WAGUI_ShowHearingSettingsEntry', return_type=None, size=164, line=1063, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t)])
        self.WAGUI_ShowNrtTreble = StaticFunction(device, 0x4ed9e, thumb=1, name='WAGUI_ShowNrtTreble', return_type=None, size=134, line=1938, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('hint',WBST_Value_t),('value',WBST_Value_t)])
        self.WAGUI_ShowNrtConfirmation = StaticFunction(device, 0x4ee24, thumb=1, name='WAGUI_ShowNrtConfirmation', return_type=None, size=56, line=1966, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le)])
        self.WAGUI_ShowTrebleBi = StaticFunction(device, 0x4e7f0, thumb=1, name='WAGUI_ShowTrebleBi', return_type=None, size=120, line=1578, arg_list=[('hintLeft',WBST_Value_t),('valueLeft',WBST_Value_t),('hintRight',WBST_Value_t),('valueRight',WBST_Value_t)])
        self.WAGUI_UpdateSettingAction = StaticFunction(device, 0x4d01e, thumb=1, name='WAGUI_UpdateSettingAction', return_type=None, size=26, line=201, arg_list=[('action',WAGUI_SettingAction_t)])
        self.WAGUI_ShowRaVersionInfo = StaticFunction(device, 0x4dde6, thumb=1, name='WAGUI_ShowRaVersionInfo', return_type=None, size=110, line=1003, arg_list=[('identRa',PointerType('WBST_RaIdentifiers_t')),('modal',bool)])
        self.WAGUI_ShowSideSelection = StaticFunction(device, 0x4cfe4, thumb=1, name='WAGUI_ShowSideSelection', return_type=None, size=58, line=182, arg_list=[('selection',PointerType("WAGUI_Selection_t")),('selected',c_int_le)])
        self.WAGUI_ShowTreble = StaticFunction(device, 0x4e764, thumb=1, name='WAGUI_ShowTreble', return_type=None, size=140, line=1551, arg_list=[('bteId',WBST_BteId_t),('pairedBtes',WBST_BteId_t),('hint',WBST_Value_t),('value',WBST_Value_t)])
        self.WAGUI_ShowSwitchSelection = StaticFunction(device, 0x4cf6c, thumb=1, name='WAGUI_ShowSwitchSelection', return_type=None, size=62, line=144, arg_list=[('selection',PointerType('WAGUI_Selection_t')),('selected',c_int_le)])
        self.WAGUI_ShowNrtTrebleInstruction = StaticFunction(device, 0x4ed78, thumb=1, name='WAGUI_ShowNrtTrebleInstruction', return_type=None, size=38, line=1922, arg_list=[])
