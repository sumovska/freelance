...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.UIE_P_StTop = StaticFunction(device, 0x4207c, thumb=1, name='UIE_P_StTop', return_type=HSM_StateRet_t, size=26, line=72, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
