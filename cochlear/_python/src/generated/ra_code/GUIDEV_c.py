...
class Code(AbstractCode):
    ...
    def GUI_MEMDEV_Select(self, hMem):
        '''
        Arguments:
    ...
    def GUI_MEMDEV__Color2Index(self, Color):
        '''
        Arguments:
        -Color - LCD_COLOR
        Return type:
    ...
    def GUI_MEMDEV__WriteToActiveAt(self, hMem, x, y):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        -x - c_int_le
    ...
    def GUI_MEMDEV_CopyToLCD(self, hMem):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        Return type:
        -None
        Declaration line: 358
        '''
        pass

    def GUI_MEMDEV__GetIndexMask(self, ):
        '''
        Arguments:
        Return type:
        -c_uint_le
    ...
    def GUI_MEMDEV_Delete(self, hMemDev):
        '''
        Arguments:
        -hMemDev - GUI_MEMDEV_Handle
        Return type:
        -None
        Declaration line: 86
        '''
    ...
    def GUI_MEMDEV_CreateEx(self, x0, y0, xSize, ySize, Flags):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GUI_MEMDEV_CopyToLCDAt(self, hMem, x, y):
        '''
        Arguments:
        -hMem - GUI_MEMDEV_Handle
        -x - c_int_le
    ...
    def GUI_MEMDEV__CreateFixed(self, x0, y0, xsize, ysize, Flags, pMemDevAPI, pfColor2Index, pfIndex2Color, pfGetIndexMask):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def GUI_MEMDEV_Create(self, x0, y0, xsize, ysize):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        ...
        Return type:
        -GUI_MEMDEV_Handle
        Declaration line: 220
        '''
        pass

    def GUI_MEMDEV__Index2Color(self, Index):
        '''
        Arguments:
        -Index - c_int_le
        Return type:
    ...
    def GUI_MEMDEV__GetRect(self, pRect):
        '''
        Arguments:
        -pRect - PointerType("GUI_RECT")
        Return type:
        -None
        Declaration line: 41
        '''
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_MEMDEV_Select = StaticFunction(device, 0x2b28a, thumb=1, name='GUI_MEMDEV_Select', return_type=GUI_MEMDEV_Handle, size=58, line=228, arg_list=[('hMem',GUI_MEMDEV_Handle)])
        self.GUI_MEMDEV__Color2Index = StaticFunction(device, 0x2b0a6, thumb=1, name='GUI_MEMDEV__Color2Index', return_type=c_uint_le, size=26, line=53, arg_list=[('Color',LCD_COLOR)])
        self.GUI_MEMDEV__WriteToActiveAt = StaticFunction(device, 0x2b2c4, thumb=1, name='GUI_MEMDEV__WriteToActiveAt', return_type=None, size=432, line=256, arg_list=[('hMem',GUI_MEMDEV_Handle),('x',c_int_le),('y',c_int_le)])
        self.GUI_MEMDEV_CopyToLCD = StaticFunction(device, 0x2b4e0, thumb=1, name='GUI_MEMDEV_CopyToLCD', return_type=None, size=92, line=358, arg_list=[('hMem',GUI_MEMDEV_Handle)])
        self.GUI_MEMDEV__GetIndexMask = StaticFunction(device, 0x2b0da, thumb=1, name='GUI_MEMDEV__GetIndexMask', return_type=c_uint_le, size=22, line=71, arg_list=[])
        self.GUI_MEMDEV_Delete = StaticFunction(device, 0x2b0f0, thumb=1, name='GUI_MEMDEV_Delete', return_type=None, size=50, line=86, arg_list=[('hMemDev',GUI_MEMDEV_Handle)])
        self.GUI_MEMDEV_CreateEx = StaticFunction(device, 0x2b1ee, thumb=1, name='GUI_MEMDEV_CreateEx', return_type=GUI_MEMDEV_Handle, size=78, line=187, arg_list=[('x0',c_int_le),('y0',c_int_le),('xSize',c_int_le),('ySize',c_int_le),('Flags',c_int_le)])
        self.GUI_MEMDEV_CopyToLCDAt = StaticFunction(device, 0x2b474, thumb=1, name='GUI_MEMDEV_CopyToLCDAt', return_type=None, size=108, line=310, arg_list=[('hMem',GUI_MEMDEV_Handle),('x',c_int_le),('y',c_int_le)])
        self.GUI_MEMDEV__CreateFixed = StaticFunction(device, 0x2b122, thumb=1, name='GUI_MEMDEV__CreateFixed', return_type=GUI_MEMDEV_Handle, size=204, line=107, arg_list=[('x0',c_int_le),('y0',c_int_le),('xsize',c_int_le),('ysize',c_int_le),('Flags',c_int_le),('pMemDevAPI',PointerType("tLCDDEV_APIList")),('pfColor2Index',PointerType('tLCDDEV_Color2Index')),('pfIndex2Color',PointerType("tLCDDEV_Index2Color")),('pfGetIndexMask',PointerType('tLCDDEV_GetIndexMask'))])
        self.GUI_MEMDEV_Create = StaticFunction(device, 0x2b23c, thumb=1, name='GUI_MEMDEV_Create', return_type=GUI_MEMDEV_Handle, size=78, line=220, arg_list=[('x0',c_int_le),('y0',c_int_le),('xsize',c_int_le),('ysize',c_int_le)])
        self.GUI_MEMDEV__Index2Color = StaticFunction(device, 0x2b0c0, thumb=1, name='GUI_MEMDEV__Index2Color', return_type=LCD_COLOR, size=26, line=62, arg_list=[('Index',c_int_le)])
        self.GUI_MEMDEV__GetRect = StaticFunction(device, 0x2b078, thumb=1, name='GUI_MEMDEV__GetRect', return_type=None, size=46, line=41, arg_list=[('pRect',PointerType("GUI_RECT"))])
