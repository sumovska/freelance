...
class Code(AbstractCode):
    ...
    def _WrapGetNumCharsDisp(self, pText, xSize, WrapMode, pxDist):
        '''
        Arguments:
        -pText - PointerType("c_byte")
        -xSize - c_int_le
        -WrapMode - GUI_WRAPMODE
        -pxDist - PointerType('c_int_le')
        Return type:
        -c_int_le
        Declaration line: 240
        '''
        pass

    def GUI__WrapGetNumBytesToNextLine(self, pText, xSize, WrapMode):
        '''
        Arguments:
        -pText - PointerType("c_byte")
        -xSize - c_int_le
    ...
    def GUI__WrapGetNumCharsToNextLine(self, pText, xSize, WrapMode):
        '''
        Arguments:
        -pText - PointerType('c_byte')
        -xSize - c_int_le
    ...
    def GUI__WrapGetNumCharsDisp(self, pText, xSize, WrapMode):
        '''
        Arguments:
        -pText - PointerType("c_byte")
        -xSize - c_int_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self._WrapGetNumCharsDisp = StaticFunction(device, 0x310b0, thumb=1, name='_WrapGetNumCharsDisp', return_type=c_int_le, size=378, line=240, arg_list=[('pText',PointerType("c_byte")),('xSize',c_int_le),('WrapMode',GUI_WRAPMODE),('pxDist',PointerType('c_int_le'))])
        self.GUI__WrapGetNumBytesToNextLine = StaticFunction(device, 0x3128c, thumb=1, name='GUI__WrapGetNumBytesToNextLine', return_type=c_int_le, size=102, line=304, arg_list=[('pText',PointerType("c_byte")),('xSize',c_int_le),('WrapMode',GUI_WRAPMODE)])
        self.GUI__WrapGetNumCharsToNextLine = StaticFunction(device, 0x3122e, thumb=1, name='GUI__WrapGetNumCharsToNextLine', return_type=c_int_le, size=94, line=278, arg_list=[('pText',PointerType('c_byte')),('xSize',c_int_le),('WrapMode',GUI_WRAPMODE)])
        self.GUI__WrapGetNumCharsDisp = StaticFunction(device, 0x3122a, thumb=1, name='GUI__WrapGetNumCharsDisp', return_type=c_int_le, size=4, line=270, arg_list=[('pText',PointerType("c_byte")),('xSize',c_int_le),('WrapMode',GUI_WRAPMODE)])
