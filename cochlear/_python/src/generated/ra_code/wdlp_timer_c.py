...
class Code(AbstractCode):
    ...
    def WDLP_P_StreamTimerSwitchMode(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WDLP_P_HiResTimerStart(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WDLP_P_StreamTimerConfig(self, preSyncDuration, postSyncDuration):
        '''
        Arguments:
        -preSyncDuration - u32
        -postSyncDuration - u32
        Return type:
        -Status
    ...
    def WDLP_P_HiResTimerConfig(self, duration):
        '''
        Arguments:
        -duration - u32
        Return type:
        -Status
        Declaration line: 214
        '''
        pass
    ...
    def WDLP_P_StreamTimerStop(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WDLP_P_StreamTimerStart(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WDLP_P_HiResTimerStop(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 331
        '''
        pass
    ...
    def StreamTimerIsr(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 424
        '''
        pass

    def WDLP_P_TimerInitialize(self, pMbox):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        self.pTimerMbox = StaticVariable(device, PointerType("OS_EVENT") * 2, 0x4000019c, False)
        ...
        self.WDLP_P_StreamTimerSwitchMode = StaticFunction(device, 0x55e82, thumb=1, name='WDLP_P_StreamTimerSwitchMode', return_type=None, size=8, line=363, arg_list=[])
        self.WDLP_P_HiResTimerStart = StaticFunction(device, 0x55e56, thumb=1, name='WDLP_P_HiResTimerStart', return_type=None, size=8, line=299, arg_list=[])
        self.WDLP_P_StreamTimerConfig = StaticFunction(device, 0x55e14, thumb=1, name='WDLP_P_StreamTimerConfig', return_type=Status, size=66, line=255, arg_list=[('preSyncDuration',u32),('postSyncDuration',u32)])
        ...
        self.WDLP_P_HiResTimerConfig = StaticFunction(device, 0x55dea, thumb=1, name='WDLP_P_HiResTimerConfig', return_type=Status, size=42, line=214, arg_list=[('duration',u32)])
        ...
        self.WDLP_P_StreamTimerStop = StaticFunction(device, 0x55e76, thumb=1, name='WDLP_P_StreamTimerStop', return_type=None, size=12, line=347, arg_list=[])
        self.WDLP_P_StreamTimerStart = StaticFunction(device, 0x55e5e, thumb=1, name='WDLP_P_StreamTimerStart', return_type=None, size=12, line=314, arg_list=[])
        self.WDLP_P_HiResTimerStop = StaticFunction(device, 0x55e6a, thumb=1, name='WDLP_P_HiResTimerStop', return_type=None, size=12, line=331, arg_list=[])
        ...
        self.StreamTimerIsr = StaticFunction(device, 0x55d04, thumb=1, name='StreamTimerIsr', return_type=None, size=56, line=424, arg_list=[])
        self.WDLP_P_TimerInitialize = StaticFunction(device, 0x55d70, thumb=1, name='WDLP_P_TimerInitialize', return_type=Status, size=122, line=103, arg_list=[('pMbox',PointerType('PointerType("OS_EVENT")'))])
        self.HiResTimerIsr = StaticFunction(device, 0x55d3c, thumb=1, name='HiResTimerIsr', return_type=None, size=52, line=379, arg_list=[])
