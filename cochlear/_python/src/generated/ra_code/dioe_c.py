...
class Code(AbstractCode):
    ...
    def DIOE_RegisterQ(self, dioeQTmp):
        '''
        Arguments:
        -dioeQTmp - PointerType("OS_EVENT")
        Return type:
        -Status
    ...
    def DIOE_SleepLineHigh(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 325
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self.dioeQ = StaticVariable(device, PointerType('OS_EVENT'), 0x800089fcL, False)
        ...
        ### Functions data ###
        ######################
        self.DIOE_SleepLineConf = StaticFunction(device, 0x5a57c, thumb=1, name='DIOE_SleepLineConf', return_type=None, size=22, line=294, arg_list=[])
        self.DIOE_SleepLineLow = StaticFunction(device, 0x5a592, thumb=1, name='DIOE_SleepLineLow', return_type=None, size=20, line=309, arg_list=[])
        self.DIOE_RegisterQ = StaticFunction(device, 0x5a548, thumb=1, name='DIOE_RegisterQ', return_type=Status, size=28, line=254, arg_list=[('dioeQTmp',PointerType("OS_EVENT"))])
        self.DIOE_GetButtonStatus = StaticFunction(device, 0x5a51e, thumb=1, name='DIOE_GetButtonStatus', return_type=DIOE_ButtonStatus_t, size=42, line=228, arg_list=[])
        self.DIOE_Fini = StaticFunction(device, 0x5a4ee, thumb=1, name='DIOE_Fini', return_type=Status, size=48, line=194, arg_list=[('fini_type',INT_FiniType_t)])
        self.DIOE_Init = StaticFunction(device, 0x5a4a0, thumb=1, name='DIOE_Init', return_type=Status, size=78, line=153, arg_list=[('init_type',INT_InitType_t)])
        self.DIOE_SleepLineHigh = StaticFunction(device, 0x5a5a6, thumb=1, name='DIOE_SleepLineHigh', return_type=None, size=20, line=325, arg_list=[])
        self.DIOE_Isr = StaticFunction(device, 0x5a564, thumb=1, name='DIOE_Isr', return_type=None, size=24, line=278, arg_list=[])
