...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_GetStringDistX = StaticFunction(device, 0x32168, thumb=1, name='GUI_GetStringDistX', return_type=c_int_le, size=22, line=33, arg_list=[('s',PointerType("c_byte"))])
