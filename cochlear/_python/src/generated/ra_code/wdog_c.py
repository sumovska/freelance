...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        self.wdogInitialized = StaticVariable(device, self.bool, 0x80008b2cL, False)
        ...
        self.wdogTaskStack = StaticVariable(device, OS_STK * 64, 0x4000d134, False)
        ...
        ### Functions data ###
        ######################
        self.WdogTask = StaticFunction(device, 0x5cc8c, thumb=1, name='WdogTask', return_type=None, size=20, line=230, arg_list=[('pArg',PointerType('void'))])
        self.WDOG_Init = StaticFunction(device, 0x5cca0, thumb=1, name='WDOG_Init', return_type=Status, size=136, line=92, arg_list=[('initType',INT_InitType_t)])
        self.WDOG_Fini = StaticFunction(device, 0x5cd28, thumb=1, name='WDOG_Fini', return_type=Status, size=38, line=192, arg_list=[('finiType',INT_FiniType_t)])
