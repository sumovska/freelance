...
class Code(AbstractCode):
    ...
    def GUIPROP_EXT__FindChar(self, pPropExt, c):
        '''
        Arguments:
        -pPropExt - PointerType("GUI_FONT_PROP_EXT")
        -c - c_ushort_le
        Return type:
        -PointerType('GUI_FONT_PROP_EXT')
        Declaration line: 33
        '''
        pass

    def GUIPROP_EXT_GetCharDistX(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
    ...
    def GUIPROP_EXT_GetFontInfo(self, pFont, pfi):
        '''
        Arguments:
    ...
    def GUIPROP_EXT_DispChar(self, c):
        '''
        Arguments:
        -c - c_ushort_le
        Return type:
    ...
    def GUIPROP_EXT_IsInFont(self, pFont, c):
        '''
        Arguments:
        -pFont - PointerType("GUI_FONT")
        -c - c_ushort_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUIPROP_EXT__FindChar = StaticFunction(device, 0x30d5c, thumb=1, name='GUIPROP_EXT__FindChar', return_type=PointerType('GUI_FONT_PROP_EXT'), size=24, line=33, arg_list=[('pPropExt',PointerType("GUI_FONT_PROP_EXT")),('c',c_ushort_le)])
        self.GUIPROP_EXT_GetCharDistX = StaticFunction(device, 0x30e04, thumb=1, name='GUIPROP_EXT_GetCharDistX', return_type=c_int_le, size=62, line=82, arg_list=[('c',c_ushort_le)])
        self.GUIPROP_EXT_GetFontInfo = StaticFunction(device, 0x30e42, thumb=1, name='GUIPROP_EXT_GetFontInfo', return_type=None, size=6, line=91, arg_list=[('pFont',PointerType("GUI_FONT")),('pfi',PointerType('GUI_FONTINFO'))])
        self.GUIPROP_EXT_DispChar = StaticFunction(device, 0x30d74, thumb=1, name='GUIPROP_EXT_DispChar', return_type=None, size=144, line=55, arg_list=[('c',c_ushort_le)])
        self.GUIPROP_EXT_IsInFont = StaticFunction(device, 0x30e48, thumb=1, name='GUIPROP_EXT_IsInFont', return_type=c_byte, size=32, line=100, arg_list=[('pFont',PointerType("GUI_FONT")),('c',c_ushort_le)])
