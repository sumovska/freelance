...
class Code(AbstractCode):
    ...
    def mclTaskFun(self, pArg):
        '''
        Arguments:
        -pArg - PointerType('void')
        Return type:
        -None
        Declaration line: 447
        '''
        pass

    def mclSmBteRebootEvRebootRes(self, pCtx, pEvent):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 670
        '''
        pass

    def MCL_P_ApiReq(self, mclEventId, pClbkFun, bteId, pData, dataLength):
        '''
        Arguments:
        -mclEventId - MCL_P_Event_t
        -pClbkFun - PointerType("void")
    ...
    def mclSmEvEnter(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
    ...
    def mclSmBteRebootEvErrRsp(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
        Return type:
        -None
        Declaration line: 707
        '''
        pass

    def mclSmEvExit(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
        Return type:
        -None
        Declaration line: 600
        '''
        pass

    def mclSmAnyEvInvalidError(self, pCtx, pEvent):
        '''
        Arguments:
        -pCtx - PointerType("MCL_P_Context_t")
        -pEvent - PointerType('MCL_P_Msg_t')
        Return type:
        -None
        Declaration line: 738
        '''
        pass

    def MCL_P_SmInit(self, init_type):
        '''
        Arguments:
    ...
    OSTmrFree = INT16U
    mclItcQueue = ITC_Queue_t * 4
    OSTCBList = PointerType("OS_TCB")
    mclTaskStack = OS_STK * 128
    ...
    def __init__(self, device):
        ...
        self.mclCtx = StaticVariable(device, self.MCL_P_Context_t, 0x4000ab48, False)
        ...
        self.mclReqHndl = StaticVariable(device, mclEvntProcesFun * 22 * 8, 0x6f80c, True)
        ...
        self.mclItcPoolMem = StaticVariable(device, ITC_MemPool_t * 44 * 4, 0x4000a894, False)
        ...
        self.mclItcQueue = StaticVariable(device, ITC_Queue_t * 4, 0x4000a884, False)
        self.OSTCBList = StaticVariable(device, PointerType("OS_TCB"), 0x40000064, False)
        self.mclTaskStack = StaticVariable(device, OS_STK * 128, 0x4000a948, False)
        ...
        ### Functions data ###
        ######################
        self.mclTaskFun = StaticFunction(device, 0x3869c, thumb=1, name='mclTaskFun', return_type=None, size=116, line=447, arg_list=[('pArg',PointerType('void'))])
        self.mclSmBteRebootEvRebootRes = StaticFunction(device, 0x388da, thumb=1, name='mclSmBteRebootEvRebootRes', return_type=None, size=34, line=670, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.MCL_P_ApiReq = StaticFunction(device, 0x387b8, thumb=1, name='MCL_P_ApiReq', return_type=MCL_Status_t, size=98, line=393, arg_list=[('mclEventId',MCL_P_Event_t),('pClbkFun',PointerType("void")),('bteId',INT_Bte_t),('pData',PointerType('void')),('dataLength',u32)])
        self.mclSmEvEnter = StaticFunction(device, 0x3881a, thumb=1, name='mclSmEvEnter', return_type=None, size=86, line=539, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.mclSmBteRebootEvErrRsp = StaticFunction(device, 0x388fc, thumb=1, name='mclSmBteRebootEvErrRsp', return_type=None, size=32, line=707, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.mclSmEvExit = StaticFunction(device, 0x38870, thumb=1, name='mclSmEvExit', return_type=None, size=106, line=600, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.mclSmAnyEvInvalidError = StaticFunction(device, 0x3891c, thumb=1, name='mclSmAnyEvInvalidError', return_type=None, size=82, line=738, arg_list=[('pCtx',PointerType("MCL_P_Context_t")),('pEvent',PointerType('MCL_P_Msg_t'))])
        self.MCL_P_SmInit = StaticFunction(device, 0x38710, thumb=1, name='MCL_P_SmInit', return_type=Status, size=168, line=305, arg_list=[('init_type',INT_InitType_t)])
