...
class Code(AbstractCode):
    ...
    def LCD_SetBkColorIndex(self, Index):
        '''
        Arguments:
        -Index - c_int_le
        Return type:
    ...
    def LCD_PassingBitmapsAllowed(self, ):
        '''
        Arguments:
        Return type:
        -c_int_le
    ...
    def LCD_DrawHLine(self, x0, y, x1):
        '''
        Arguments:
        -x0 - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 153
        '''
        pass

    def LCD_SetBkColor(self, color):
        '''
        Arguments:
        -color - GUI_COLOR
        Return type:
    ...
    def LCD_GetpfDrawBitmap(self, ):
        '''
        Arguments:
        Return type:
        -PointerType('tLCDDEV_DrawBitmap')
        Declaration line: 228
        '''
        pass

    def LCD_SetClipRectMax(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def LCD_DrawBitmap(self, x0, y0, xsize, ysize, xMul, yMul, BitsPerPixel, BytesPerLine, pPixel, pTrans):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
        ...
        -pPixel - PointerType("c_ubyte")
        -pTrans - PointerType('c_ushort_le')
        Return type:
        -None
        Declaration line: 263
        '''
        pass

    def LCD_SetColorIndex(self, Index):
        '''
        Arguments:
        -Index - c_int_le
        Return type:
        -None
        Declaration line: 100
        '''
        pass

    def LCD_DrawVLine(self, x, y0, y1):
        '''
        Arguments:
        -x - c_int_le
        -y0 - c_int_le
    ...
    def LCD_Color2Index(self, Color):
        '''
        Arguments:
        -Color - LCD_COLOR
        Return type:
    ...
    def LCD_FillRect(self, x0, y0, x1, y1):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def LCD_Index2Color(self, Index):
        '''
        Arguments:
        -Index - c_int_le
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_SetBkColorIndex = StaticFunction(device, 0x2c73a, thumb=1, name='LCD_SetBkColorIndex', return_type=None, size=20, line=108, arg_list=[('Index',c_int_le)])
        self.LCD_PassingBitmapsAllowed = StaticFunction(device, 0x2c864, thumb=1, name='LCD_PassingBitmapsAllowed', return_type=c_int_le, size=4, line=250, arg_list=[])
        self.LCD_DrawHLine = StaticFunction(device, 0x2c7aa, thumb=1, name='LCD_DrawHLine', return_type=None, size=56, line=153, arg_list=[('x0',c_int_le),('y',c_int_le),('x1',c_int_le)])
        self.LCD_SetBkColor = StaticFunction(device, 0x2cb2c, thumb=1, name='LCD_SetBkColor', return_type=None, size=42, line=464, arg_list=[('color',GUI_COLOR)])
        self.LCD_SetDrawMode = StaticFunction(device, 0x2c74e, thumb=1, name='LCD_SetDrawMode', return_type=LCD_DRAWMODE, size=30, line=116, arg_list=[('dm',LCD_DRAWMODE)])
        self.LCD_Init = StaticFunction(device, 0x2caea, thumb=1, name='LCD_Init', return_type=c_int_le, size=50, line=402, arg_list=[])
        self.LCD_GetpfDrawBitmap = StaticFunction(device, 0x2c85c, thumb=1, name='LCD_GetpfDrawBitmap', return_type=PointerType('tLCDDEV_DrawBitmap'), size=8, line=228, arg_list=[])
        self.LCD_SetClipRectMax = StaticFunction(device, 0x2cae0, thumb=1, name='LCD_SetClipRectMax', return_type=None, size=10, line=394, arg_list=[])
        self.LCD_DrawBitmap = StaticFunction(device, 0x2c868, thumb=1, name='LCD_DrawBitmap', return_type=None, size=632, line=263, arg_list=[('x0',c_int_le),('y0',c_int_le),('xsize',c_int_le),('ysize',c_int_le),('xMul',c_int_le),('yMul',c_int_le),('BitsPerPixel',c_int_le),('BytesPerLine',c_int_le),('pPixel',PointerType("c_ubyte")),('pTrans',PointerType('c_ushort_le'))])
        self.LCD_SetColorIndex = StaticFunction(device, 0x2c728, thumb=1, name='LCD_SetColorIndex', return_type=None, size=18, line=100, arg_list=[('Index',c_int_le)])
        self.LCD_DrawVLine = StaticFunction(device, 0x2c7e2, thumb=1, name='LCD_DrawVLine', return_type=None, size=56, line=176, arg_list=[('x',c_int_le),('y0',c_int_le),('y1',c_int_le)])
        self.LCD_Color2Index = StaticFunction(device, 0x2cb1c, thumb=1, name='LCD_Color2Index', return_type=c_int_le, size=8, line=448, arg_list=[('Color',LCD_COLOR)])
        self.LCD_FillRect = StaticFunction(device, 0x2c81a, thumb=1, name='LCD_FillRect', return_type=None, size=66, line=199, arg_list=[('x0',c_int_le),('y0',c_int_le),('x1',c_int_le),('y1',c_int_le)])
        self.LCD_DrawPixel = StaticFunction(device, 0x2c76c, thumb=1, name='LCD_DrawPixel', return_type=None, size=62, line=131, arg_list=[('x',c_int_le),('y',c_int_le)])
        self.LCD_Index2Color = StaticFunction(device, 0x2cb24, thumb=1, name='LCD_Index2Color', return_type=LCD_COLOR, size=8, line=456, arg_list=[('Index',c_int_le)])
        self.LCD_SetColor = StaticFunction(device, 0x2cb56, thumb=1, name='LCD_SetColor', return_type=None, size=40, line=475, arg_list=[('color',GUI_COLOR)])
