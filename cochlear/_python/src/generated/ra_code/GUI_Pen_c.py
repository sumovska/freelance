...
class Code(AbstractCode):
    ...
    def GUI_SetPenSize(self, PenSize):
        '''
        Arguments:
        -PenSize - c_ubyte
        Return type:
    ...
    def GUI_SetPenShape(self, PenShape):
        '''
        Arguments:
        -PenShape - c_ubyte
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_GetPenSize = StaticFunction(device, 0x2e7e4, thumb=1, name='GUI_GetPenSize', return_type=c_ubyte, size=6, line=32, arg_list=[])
        self.GUI_GetPenShape = StaticFunction(device, 0x2e7ea, thumb=1, name='GUI_GetPenShape', return_type=c_ubyte, size=6, line=44, arg_list=[])
        self.GUI_SetPenSize = StaticFunction(device, 0x2e7f0, thumb=1, name='GUI_SetPenSize', return_type=c_ubyte, size=10, line=56, arg_list=[('PenSize',c_ubyte)])
        self.GUI_SetPenShape = StaticFunction(device, 0x2e7fa, thumb=1, name='GUI_SetPenShape', return_type=c_ubyte, size=10, line=69, arg_list=[('PenShape',c_ubyte)])
