...
class WAE_P_PairRequestType_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    WAE_PAIR_TYPE_USER_REQ = 1
    WAE_PAIR_TYPE_REFRESH_REQ = 2
...
class WAE_P_CoilConfirmState_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    WAE_CC_NOT_REQUESTED = 0
    WAE_CC_REQUESTED = 1
    WAE_CC_AWAITING_PAUSE_START = 2
    WAE_CC_AWAITING_PAUSE_END = 3
    WAE_CC_DONE = 4
...
class WAE_P_PairState_tag(c_ubyte,Enumed):
    _ctype = c_ubyte
    WAE_PAIR_PAIR_NONE = 0
    WAE_PAIR_PAIR_REQ_SENT = 1
    WAE_PAIR_COIL_CONFIRMATION = 2
    WAE_PAIR_GS45_WHOISTHERE_PKG_REQ_SENT = 3
    WAE_PAIR_COIL_RECONFIRMATION = 4
    WAE_PAIR_GS45_BASIC_PKG_REQ_SENT = 5
    WAE_PAIR_REMOVE = 6
    WAE_PAIR_CANCEL = 7
    WAE_PAIR_CANCEL_PENDING = 8
...
WAE_P_PairRequestType_t = WAE_P_PairRequestType_tag
...
WAE_P_CoilConfirmState_t = WAE_P_CoilConfirmState_tag
...
WAE_P_PairState_t = WAE_P_PairState_tag
...
class const():
    ...
    ### Defines ###
    ###############
    WAE_PAIR_TIMER_NAME = 'waePairTmr'
    WAE_PAIR_TIMER_DUR = 250
    WAE_PAIR_COIL_TIMER_NAME = 'waePairCoilTmr'
    WAE_PAIR_BTE_SERIAL_NIBBLES = 13
    DSPI_0 = 1
    DSPI_1 = 2
    DSPI_FIFO_SIZE = 8
    DBG_ON = 0
...
class Code(AbstractCode):
    ...
    WAE_P_PairRequestType_tag = WAE_P_PairRequestType_tag
    ...
    WAE_P_CoilConfirmState_tag = WAE_P_CoilConfirmState_tag
    ...
    WAE_P_PairState_tag = WAE_P_PairState_tag
    ...
    WAE_P_PairRequestType_t = WAE_P_PairRequestType_t
    ...
    WAE_P_CoilConfirmState_t = WAE_P_CoilConfirmState_t
    ...
    WAE_P_PairState_t = WAE_P_PairState_t
    ...
    def waePairTmrStop(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1810
        '''
        pass

    def waePairProcPolling_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        ...
        Return type:
        -None
        Declaration line: 1900
        '''
        pass

    def waePairResetPairing_res(self, bte, result):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        Return type:
        -None
        Declaration line: 1535
        '''
        pass

    def waePairRefreshFailed(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        ...
        Return type:
        -None
        Declaration line: 1674
        '''
        pass

    def WAE_P_PairConfigure(self, pBteIdx1st, pBteIdx2nd):
        '''
        Arguments:
    ...
    def waePairBteNotPaired(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1614
        '''
        pass

    def waePairTmrStart(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def WAE_P_PairTimerHandler(self, pTmr, pArg):
        '''
        Arguments:
    ...
    def waePairFinish(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
        Return type:
        -None
        Declaration line: 1630
        '''
        pass

    def waePairProcessPairRequest(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
    ...
    def waePairCoilConfirmTimerHandler(self, pTmr, pArg):
        '''
        Arguments:
        -pTmr - PointerType('void')
        -pArg - PointerType("void")
        Return type:
        -None
        Declaration line: 2132
        '''
        pass

    def waeGetWbstSide(self, cipBteSide):
        '''
        Arguments:
        -cipBteSide - CIP_BteSide_t
        Return type:
        -WBST_BteId_t
        Declaration line: 2151
        '''
        pass

    def waePairProcessCancelResp(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
        ...
        Return type:
        -None
        Declaration line: 1499
        '''
        pass

    def waePairProcPair_res(self, result):
        '''
        Arguments:
        -result - CIP_ProcResult_t
        Return type:
    ...
    def WAE_P_PairInit(self, coilPauseStartTimeout, coilPauseEndTimeout):
        '''
        Arguments:
        -coilPauseStartTimeout - u16
        -coilPauseEndTimeout - u16
        Return type:
        -Status
    ...
    def waePairProcessGS45WhoIsTherePkgResp(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
        ...
        Return type:
        -None
        Declaration line: 1140
        '''
        pass

    def waePairProcessPairResp(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
    ...
    def waePairProcWhoIsThere_res(self, bte, result, bteIdentifiers, bteSide, checkCoil):
        '''
        Arguments:
        -bte - INT_Bte_t
        -result - CIP_ProcResult_t
        -bteIdentifiers - PointerType("WBST_BteIdentifiers_t")
        -bteSide - CIP_BteSide_t
        -checkCoil - bool
        Return type:
        -None
    ...
    def waePairCoilConfirmTmrStart(self, delayInTicks):
        '''
        Arguments:
        -delayInTicks - u32
        Return type:
    ...
    def waePairCoilConfirmTmrStop(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2105
        '''
        pass

    def waePairSameBtePairing(self, pNewBteSerNo, existingBteId):
        '''
        Arguments:
        -pNewBteSerNo - PointerType('byte')
        -existingBteId - WBST_BteId_t
        Return type:
        -bool
        Declaration line: 1975
        '''
        pass

    def waePairProcessRefreshRequest(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
    ...
    def WAE_P_PairCoilStimProcess(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
    ...
    def WAE_P_PairRemoveReqProcess(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
    ...
    def waePairRefreshFinish(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1714
        '''
        pass

    def WAE_P_PairCancelReqProcess(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
    ...
    def waePairSwapWbstIdx(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2048
        '''
        pass

    def waePairProcessGS45AdvancedPkgResp(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
        ...
        Return type:
        -None
        Declaration line: 1247
        '''
        pass

    def WAE_P_PairNewReqProcess(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
    ...
    def waePairProcessResetReq(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pWaeState - PointerType('WAE_P_State_t')
        -pExpectedEventId - PointerType("ITC_EventId_t")
    ...
    def WAE_P_PairRefreshReqProcess(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
    ...
    def waePairSendGS45WhoIsThere(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
        Return type:
        -Status
        Declaration line: 1869
        '''
        pass

    def waePairSendGS45AdvancedPkg(self, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
    ...
    def waePairStartCoilConfirmation(self, pWaeState, pExpectedEventId, reconfirm):
        '''
        Arguments:
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
        ...
        Return type:
        -Status
        Declaration line: 1835
        '''
        pass

    def WAE_P_PairResProcess(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
    ...
    OSIdleCtr = INT32U
    waeNewPairWindowOpen = bool
    cipProcMemoryPool = PointerType('OS_MEM')
    OSCtxSwCtr = INT32U
    waePairBteProcessed = WAE_P_BteIdx_t
    OSRunning = BOOLEAN
    waePairReturnToState = WAE_P_State_t
    waePairTimer = PointerType("OS_TMR")
    OSMemTbl = OS_MEM * 15
    OSTaskCtr = INT8U
    waePairCoilConfirmTimer = PointerType('OS_TMR')
    OSTmrTime = INT32U
    OSQFreeList = PointerType("OS_Q")
    pWaePairBteLink = PointerType('WAE_P_BteLink_t') * 2
    OSTmrUsed = INT16U
    OSTCBTbl = OS_TCB * 26
    waePairCoilConfirmStart = u32
    waePairCoilPauseStartDelay = u32
    OSEventTbl = OS_EVENT * 80
    OSEventFreeList = PointerType("OS_EVENT")
    OSPrioHighRdy = INT8U
    OSQTbl = OS_Q * 20
    waePairType = WAE_P_PairRequestType_t
    waePairCoilPauseStartTimeout = u16
    OSFlagFreeList = PointerType('OS_FLAG_GRP')
    OSTCBFreeList = PointerType("OS_TCB")
    OSRdyGrp = INT8U
    OSTCBCur = PointerType('OS_TCB')
    OSLockNesting = INT8U
    waePairBteSettings = WBST_BteSettings_t
    waeCoilConfirmState = WAE_P_CoilConfirmState_t
    cipProcQueue = PointerType("OS_EVENT")
    waeActionStatusCode = WAE_StatusCode_t
    ...
    OSPrioCur = INT8U
    waePairState = WAE_P_PairState_t
    OSIntNesting = INT8U
    OSTCBPrioTbl = PointerType('OS_TCB') * 61
    waePairBteIdentifiers = WBST_BteIdentifiers_t
    waePairBteToBeProcessedNext = WAE_P_BteIdx_t
    OSTCBList = PointerType("OS_TCB")
    OSTmrFreeList = PointerType('OS_TMR')
    OSTmrSemSignal = PointerType("OS_EVENT")
    waePairBteSide = CIP_BteSide_t
    waePairCoilPauseEndTimeout = u16
    OSRdyTbl = INT8U * 8
    WAE_P_FiniFun = INT_FiniFun_t * 20
    waePairRefreshData = WAE_P_PairRefreshReq_t
    ...
    def __init__(self, device):
        ...
        self.waeNewPairWindowOpen = StaticVariable(device, self.bool, 0x7fe000b7, False)
        ...
        self.waePairBteProcessed = StaticVariable(device, self.WAE_P_BteIdx_t, 0x7fe000b3, False)
        self.OSRunning = StaticVariable(device, self.BOOLEAN, 0x40000049, False)
        self.waePairReturnToState = StaticVariable(device, self.WAE_P_State_t, 0x7fe000b1, False)
        self.waePairTimer = StaticVariable(device, PointerType("OS_TMR"), 0x7fe000c4, False)
        ...
        self.waePairCoilConfirmTimer = StaticVariable(device, PointerType('OS_TMR'), 0x7fe000c8, False)
        ...
        self.pWaePairBteLink = StaticVariable(device, PointerType('WAE_P_BteLink_t') * 2, 0x7fe000d4, False)
        ...
        self.waePairCoilConfirmStart = StaticVariable(device, self.u32, 0x7fe000cc, False)
        self.waePairCoilPauseStartDelay = StaticVariable(device, self.u32, 0x7fe000d0, False)
        ...
        self.waePairType = StaticVariable(device, self.WAE_P_PairRequestType_t, 0x7fe000b5, False)
        self.waePairCoilPauseStartTimeout = StaticVariable(device, self.u16, 0x7fe000b8, False)
        ...
        self.waePairBteSettings = StaticVariable(device, self.WBST_BteSettings_t, 0x7fe00aa2, False)
        self.waeCoilConfirmState = StaticVariable(device, self.WAE_P_CoilConfirmState_t, 0x7fe000b0, False)
        self.cipProcQueue = StaticVariable(device, PointerType("OS_EVENT"), 0x80008930L, False)
        self.waeActionStatusCode = StaticVariable(device, self.WAE_StatusCode_t, 0x7fe000bc, False)
        ...
        self.waePairState = StaticVariable(device, self.WAE_P_PairState_t, 0x7fe000b2, False)
        ...
        self.waePairBteIdentifiers = StaticVariable(device, self.WBST_BteIdentifiers_t, 0x7fe00a84, False)
        self.waePairBteToBeProcessedNext = StaticVariable(device, self.WAE_P_BteIdx_t, 0x7fe000b4, False)
        ...
        self.waePairBteSide = StaticVariable(device, self.CIP_BteSide_t, 0x7fe000b6, False)
        self.waePairCoilPauseEndTimeout = StaticVariable(device, self.u16, 0x7fe000ba, False)
        ...
        self.waePairRefreshData = StaticVariable(device, self.WAE_P_PairRefreshReq_t, 0x7fe000c0, False)
        ...
        ### Functions data ###
        ######################
        self.waePairTmrStop = StaticFunction(device, 0x462cc, thumb=1, name='waePairTmrStop', return_type=None, size=26, line=1810, arg_list=[])
        self.waePairProcPolling_res = StaticFunction(device, 0x465fa, thumb=1, name='waePairProcPolling_res', return_type=None, size=26, line=1900, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.waePairResetPairing_res = StaticFunction(device, 0x46264, thumb=1, name='waePairResetPairing_res', return_type=None, size=26, line=1535, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t)])
        self.waePairRefreshFailed = StaticFunction(device, 0x465ae, thumb=1, name='waePairRefreshFailed', return_type=None, size=76, line=1674, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.WAE_P_PairConfigure = StaticFunction(device, 0x461a4, thumb=1, name='WAE_P_PairConfigure', return_type=None, size=22, line=332, arg_list=[('pBteIdx1st',PointerType("WAE_P_BteLink_t")),('pBteIdx2nd',PointerType('WAE_P_BteLink_t'))])
        self.waePairBteNotPaired = StaticFunction(device, 0x464b0, thumb=1, name='waePairBteNotPaired', return_type=None, size=38, line=1614, arg_list=[])
        self.waePairTmrStart = StaticFunction(device, 0x461ba, thumb=1, name='waePairTmrStart', return_type=None, size=22, line=1779, arg_list=[])
        self.WAE_P_PairTimerHandler = StaticFunction(device, 0x46160, thumb=1, name='WAE_P_PairTimerHandler', return_type=None, size=12, line=308, arg_list=[('pTmr',PointerType("void")),('pArg',PointerType('void'))])
        self.waePairFinish = StaticFunction(device, 0x46482, thumb=1, name='waePairFinish', return_type=None, size=46, line=1630, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waePairProcessPairRequest = StaticFunction(device, 0x461ec, thumb=1, name='waePairProcessPairRequest', return_type=None, size=108, line=836, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waePairCoilConfirmTimerHandler = StaticFunction(device, 0x468fe, thumb=1, name='waePairCoilConfirmTimerHandler', return_type=None, size=26, line=2132, arg_list=[('pTmr',PointerType('void')),('pArg',PointerType("void"))])
        self.waeGetWbstSide = StaticFunction(device, 0x466e4, thumb=1, name='waeGetWbstSide', return_type=WBST_BteId_t, size=38, line=2151, arg_list=[('cipBteSide',CIP_BteSide_t)])
        self.waePairProcessCancelResp = StaticFunction(device, 0x464d6, thumb=1, name='waePairProcessCancelResp', return_type=None, size=58, line=1499, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waePairProcPair_res = StaticFunction(device, 0x461d0, thumb=1, name='waePairProcPair_res', return_type=None, size=28, line=572, arg_list=[('result',CIP_ProcResult_t)])
        self.WAE_P_PairInit = StaticFunction(device, 0x4616c, thumb=1, name='WAE_P_PairInit', return_type=Status, size=56, line=267, arg_list=[('coilPauseStartTimeout',u16),('coilPauseEndTimeout',u16)])
        self.waePairProcessGS45WhoIsTherePkgResp = StaticFunction(device, 0x4698a, thumb=1, name='waePairProcessGS45WhoIsTherePkgResp', return_type=None, size=222, line=1140, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waePairProcessPairResp = StaticFunction(device, 0x46a68, thumb=1, name='waePairProcessPairResp', return_type=None, size=94, line=939, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waePairProcWhoIsThere_res = StaticFunction(device, 0x46396, thumb=1, name='waePairProcWhoIsThere_res', return_type=None, size=62, line=999, arg_list=[('bte',INT_Bte_t),('result',CIP_ProcResult_t),('bteIdentifiers',PointerType("WBST_BteIdentifiers_t")),('bteSide',CIP_BteSide_t),('checkCoil',bool)])
        self.waePairCoilConfirmTmrStart = StaticFunction(device, 0x46918, thumb=1, name='waePairCoilConfirmTmrStart', return_type=None, size=66, line=2065, arg_list=[('delayInTicks',u32)])
        self.waePairCoilConfirmTmrStop = StaticFunction(device, 0x46b86, thumb=1, name='waePairCoilConfirmTmrStop', return_type=None, size=22, line=2105, arg_list=[])
        self.waePairSameBtePairing = StaticFunction(device, 0x46676, thumb=1, name='waePairSameBtePairing', return_type=bool, size=110, line=1975, arg_list=[('pNewBteSerNo',PointerType('byte')),('existingBteId',WBST_BteId_t)])
        self.waePairProcessRefreshRequest = StaticFunction(device, 0x463d4, thumb=1, name='waePairProcessRefreshRequest', return_type=None, size=142, line=1035, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.WAE_P_PairCoilStimProcess = StaticFunction(device, 0x46b9c, thumb=1, name='WAE_P_PairCoilStimProcess', return_type=bool, size=192, line=728, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.WAE_P_PairRemoveReqProcess = StaticFunction(device, 0x4631e, thumb=1, name='WAE_P_PairRemoveReqProcess', return_type=None, size=120, line=455, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waePairRefreshFinish = StaticFunction(device, 0x46510, thumb=1, name='waePairRefreshFinish', return_type=None, size=158, line=1714, arg_list=[])
        self.WAE_P_PairCancelReqProcess = StaticFunction(device, 0x462e6, thumb=1, name='WAE_P_PairCancelReqProcess', return_type=None, size=56, line=391, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waePairSwapWbstIdx = StaticFunction(device, 0x46664, thumb=1, name='waePairSwapWbstIdx', return_type=None, size=18, line=2048, arg_list=[])
        self.waePairProcessGS45AdvancedPkgResp = StaticFunction(device, 0x4670a, thumb=1, name='waePairProcessGS45AdvancedPkgResp', return_type=None, size=452, line=1247, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.WAE_P_PairNewReqProcess = StaticFunction(device, 0x46258, thumb=1, name='WAE_P_PairNewReqProcess', return_type=None, size=12, line=363, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waePairProcessResetReq = StaticFunction(device, 0x4627e, thumb=1, name='waePairProcessResetReq', return_type=None, size=78, line=1552, arg_list=[('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.WAE_P_PairRefreshReqProcess = StaticFunction(device, 0x46462, thumb=1, name='WAE_P_PairRefreshReqProcess', return_type=None, size=32, line=548, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waePairSendGS45WhoIsThere = StaticFunction(device, 0x468ce, thumb=1, name='waePairSendGS45WhoIsThere', return_type=Status, size=48, line=1869, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waePairSendGS45AdvancedPkg = StaticFunction(device, 0x46614, thumb=1, name='waePairSendGS45AdvancedPkg', return_type=Status, size=80, line=1920, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waePairStartCoilConfirmation = StaticFunction(device, 0x4695a, thumb=1, name='waePairStartCoilConfirmation', return_type=Status, size=48, line=1835, arg_list=[('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t')),('reconfirm',bool)])
        self.WAE_P_PairResProcess = StaticFunction(device, 0x46ac6, thumb=1, name='WAE_P_PairResProcess', return_type=None, size=192, line=594, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
