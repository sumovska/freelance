...
class Code(AbstractCode):
    ...
    def CIP_ProcWriteProfile(self, callback, bte, retryNum, profile):
        '''
        Arguments:
        -callback - CIP_ProcWriteProfile_res
        -bte - INT_Bte_t
        -retryNum - u8
        -profile - PointerType('CIP_EcapProfile_t')
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcResetPairing(self, callback, bte, type):
        '''
        Arguments:
        -callback - CIP_ProcResetPairing_res
        -bte - INT_Bte_t
        -type - CIP_PairingType_t
        Return type:
        -CIP_ProcResult_t
        Declaration line: 51
        '''
    ...
    def CIP_ProcAction(self, callback, bte, action, parameter):
        '''
        Arguments:
        -callback - CIP_ProcAction_res
        -bte - INT_Bte_t
        -action - CIP_ProcAction_t
        -parameter - WBST_Value_t
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcMeasureImpedance(self, callback, bte, retryNum, runCommonGround, runMP1, runMP2, runMP1plus2):
        '''
        Arguments:
        -callback - CIP_ProcMeasureImpedance_res
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def CIP_ProcMVBTSet(self, callback, bte, retryNum, mv, bass, treble, selector):
        '''
        Arguments:
        -callback - CIP_ProcMVBTSet_res
        -bte - INT_Bte_t
        -retryNum - u8
        -mv - u8
        -bass - s8
    ...
    def CIP_ProcReadMclinicMapType(self, callback, bte, retryNum):
        '''
        Arguments:
        -callback - CIP_ProcReadMclinicMapType_res
        -bte - INT_Bte_t
        -retryNum - u8
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcWriteLinkConstProfileMeanMeasured(self, callback, bte, retryNum, constK, constA, constB, profileMean, measuredElectrodes, resetVddLimit):
        '''
        Arguments:
        -callback - CIP_ProcWriteLinkConstProfileMeanMeasured_res
        -bte - INT_Bte_t
        -retryNum - u8
        -constK - u16
        -constA - u16
    ...
    def CIP_ProcPair(self, callback, type):
        '''
        Arguments:
        -callback - CIP_ProcPair_res
        -type - CIP_PairingType_t
        Return type:
        -CIP_ProcResult_t
        Declaration line: 27
    ...
    def CIP_ProcReadImpedance(self, callback, bte, retryNum, part):
        '''
        Arguments:
        -callback - CIP_ProcReadImpedance_res
        -bte - INT_Bte_t
        -retryNum - u8
        -part - u8
        Return type:
    ...
    def CIP_ProcMeasureNrtTrace(self, callback, bte, retryNum, timeout, probeElectrode, recordingElectrode, currentLevel, probeRate):
        '''
        Arguments:
        -callback - CIP_ProcMeasureNrtTrace_res
        -bte - INT_Bte_t
        -retryNum - u8
        -timeout - u16
        -probeElectrode - u8
    ...
    def CIP_ProcMeasureLink(self, callback, bte, retryNum):
        '''
        Arguments:
        -callback - CIP_ProcMeasureLink_res
        -bte - INT_Bte_t
        -retryNum - u8
        Return type:
        -CIP_ProcResult_t
        Declaration line: 480
        '''
        pass

    def CIP_ProcCancel(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def CIP_ProcMeasureImplantID(self, callback, bte, retryNum):
        '''
        Arguments:
        -callback - CIP_ProcMeasureImplantID_res
        -bte - INT_Bte_t
        -retryNum - u8
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcStopFitting(self, callback, bte, retryNum):
        '''
        Arguments:
        -callback - CIP_ProcStopFitting_res
        -bte - INT_Bte_t
        -retryNum - u8
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcStartFitting(self, callback, bte, retryNum, sftClientId):
        '''
        Arguments:
        -callback - CIP_ProcStartFitting_res
        -bte - INT_Bte_t
        -retryNum - u8
    ...
    def CIP_ProcWriteLinkConst(self, callback, bte, retryNum, constK, constA, constB):
        '''
        Arguments:
        -callback - CIP_ProcWriteLinkConst_res
        -bte - INT_Bte_t
        -retryNum - u8
        -constK - u16
        -constA - u16
    ...
    def CIP_ProcReboot(self, callback, bte, retryNum, rebootType):
        '''
        Arguments:
        -callback - CIP_ProcReboot_res
        -bte - INT_Bte_t
        -retryNum - u8
        -rebootType - CIP_RebootType_t
        Return type:
        -CIP_ProcResult_t
        Declaration line: 169
        '''
        pass

    def CIP_ProcElectrodeCondition(self, callback, bte, retryNum, conditioningCL, electrode):
        '''
        Arguments:
        -callback - CIP_ProcElectrodeCondition_res
        -bte - INT_Bte_t
        -retryNum - u8
        -conditioningCL - u8
        -electrode - u8
    ...
    def CIP_ProcReadProfileMeanMeasured(self, callback, bte, retryNum):
        '''
        Arguments:
        -callback - CIP_ProcReadProfileMeanMeasured_res
        -bte - INT_Bte_t
        -retryNum - u8
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcWhoIsThere(self, callback, bte, initialPairing):
        '''
        Arguments:
        -callback - CIP_ProcWhoIsThere_res
        -bte - INT_Bte_t
        -initialPairing - bool
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcPolling(self, callback, bte, pollingType, bteSettings):
        '''
        Arguments:
        -callback - CIP_ProcPolling_res
        -bte - INT_Bte_t
        -pollingType - CIP_ProcPollingType_t
        -bteSettings - PointerType("WBST_BteSettings_t")
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcMVBTGet(self, callback, bte, retryNum):
        '''
        Arguments:
        -callback - CIP_ProcMVBTGet_res
        -bte - INT_Bte_t
        -retryNum - u8
        Return type:
        -CIP_ProcResult_t
    ...
    def CIP_ProcReadProfile(self, callback, bte, retryNum, type):
        '''
        Arguments:
        -callback - CIP_ProcReadProfile_res
        -bte - INT_Bte_t
        -retryNum - u8
        -type - CIP_EcapProfileType_t
        Return type:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.CIP_ProcWriteProfile = StaticFunction(device, 0x578ca, thumb=1, name='CIP_ProcWriteProfile', return_type=CIP_ProcResult_t, size=80, line=597, arg_list=[('callback',CIP_ProcWriteProfile_res),('bte',INT_Bte_t),('retryNum',u8),('profile',PointerType('CIP_EcapProfile_t'))])
        self.CIP_ProcResetPairing = StaticFunction(device, 0x57280, thumb=1, name='CIP_ProcResetPairing', return_type=CIP_ProcResult_t, size=68, line=51, arg_list=[('callback',CIP_ProcResetPairing_res),('bte',INT_Bte_t),('type',CIP_PairingType_t)])
        self.CIP_ProcAction = StaticFunction(device, 0x5734c, thumb=1, name='CIP_ProcAction', return_type=CIP_ProcResult_t, size=86, line=127, arg_list=[('callback',CIP_ProcAction_res),('bte',INT_Bte_t),('action',CIP_ProcAction_t),('parameter',WBST_Value_t)])
        self.CIP_ProcMeasureImpedance = StaticFunction(device, 0x5756e, thumb=1, name='CIP_ProcMeasureImpedance', return_type=CIP_ProcResult_t, size=108, line=331, arg_list=[('callback',CIP_ProcMeasureImpedance_res),('bte',INT_Bte_t),('retryNum',u8),('runCommonGround',bool),('runMP1',bool),('runMP2',bool),('runMP1plus2',bool)])
        self.CIP_ProcMVBTSet = StaticFunction(device, 0x5743e, thumb=1, name='CIP_ProcMVBTSet', return_type=CIP_ProcResult_t, size=108, line=221, arg_list=[('callback',CIP_ProcMVBTSet_res),('bte',INT_Bte_t),('retryNum',u8),('mv',u8),('bass',s8),('treble',s8),('selector',u8)])
        self.CIP_ProcReadMclinicMapType = StaticFunction(device, 0x576b4, thumb=1, name='CIP_ProcReadMclinicMapType', return_type=CIP_ProcResult_t, size=62, line=420, arg_list=[('callback',CIP_ProcReadMclinicMapType_res),('bte',INT_Bte_t),('retryNum',u8)])
        self.CIP_ProcWriteLinkConstProfileMeanMeasured = StaticFunction(device, 0x577a8, thumb=1, name='CIP_ProcWriteLinkConstProfileMeanMeasured', return_type=CIP_ProcResult_t, size=132, line=505, arg_list=[('callback',CIP_ProcWriteLinkConstProfileMeanMeasured_res),('bte',INT_Bte_t),('retryNum',u8),('constK',u16),('constA',u16),('constB',u16),('profileMean',u8),('measuredElectrodes',u32),('resetVddLimit',bool)])
        self.CIP_ProcPair = StaticFunction(device, 0x5724c, thumb=1, name='CIP_ProcPair', return_type=CIP_ProcResult_t, size=52, line=27, arg_list=[('callback',CIP_ProcPair_res),('type',CIP_PairingType_t)])
        self.CIP_ProcReadImpedance = StaticFunction(device, 0x5762e, thumb=1, name='CIP_ProcReadImpedance', return_type=CIP_ProcResult_t, size=134, line=393, arg_list=[('callback',CIP_ProcReadImpedance_res),('bte',INT_Bte_t),('retryNum',u8),('part',u8)])
        self.CIP_ProcMeasureNrtTrace = StaticFunction(device, 0x576f2, thumb=1, name='CIP_ProcMeasureNrtTrace', return_type=CIP_ProcResult_t, size=120, line=445, arg_list=[('callback',CIP_ProcMeasureNrtTrace_res),('bte',INT_Bte_t),('retryNum',u8),('timeout',u16),('probeElectrode',u8),('recordingElectrode',u8),('currentLevel',u8),('probeRate',u8)])
        self.CIP_ProcMeasureLink = StaticFunction(device, 0x5776a, thumb=1, name='CIP_ProcMeasureLink', return_type=CIP_ProcResult_t, size=62, line=480, arg_list=[('callback',CIP_ProcMeasureLink_res),('bte',INT_Bte_t),('retryNum',u8)])
        self.CIP_ProcCancel = StaticFunction(device, 0x573a2, thumb=1, name='CIP_ProcCancel', return_type=None, size=22, line=154, arg_list=[])
        self.CIP_ProcMeasureImplantID = StaticFunction(device, 0x57530, thumb=1, name='CIP_ProcMeasureImplantID', return_type=CIP_ProcResult_t, size=62, line=306, arg_list=[('callback',CIP_ProcMeasureImplantID_res),('bte',INT_Bte_t),('retryNum',u8)])
        self.CIP_ProcStopFitting = StaticFunction(device, 0x574f2, thumb=1, name='CIP_ProcStopFitting', return_type=CIP_ProcResult_t, size=62, line=281, arg_list=[('callback',CIP_ProcStopFitting_res),('bte',INT_Bte_t),('retryNum',u8)])
        self.CIP_ProcStartFitting = StaticFunction(device, 0x574aa, thumb=1, name='CIP_ProcStartFitting', return_type=CIP_ProcResult_t, size=72, line=254, arg_list=[('callback',CIP_ProcStartFitting_res),('bte',INT_Bte_t),('retryNum',u8),('sftClientId',CIP_StartFittingSessionClientId_t)])
        self.CIP_ProcWriteLinkConst = StaticFunction(device, 0x5782c, thumb=1, name='CIP_ProcWriteLinkConst', return_type=CIP_ProcResult_t, size=96, line=541, arg_list=[('callback',CIP_ProcWriteLinkConst_res),('bte',INT_Bte_t),('retryNum',u8),('constK',u16),('constA',u16),('constB',u16)])
        self.CIP_ProcReboot = StaticFunction(device, 0x573b8, thumb=1, name='CIP_ProcReboot', return_type=CIP_ProcResult_t, size=72, line=169, arg_list=[('callback',CIP_ProcReboot_res),('bte',INT_Bte_t),('retryNum',u8),('rebootType',CIP_RebootType_t)])
        self.CIP_ProcElectrodeCondition = StaticFunction(device, 0x575da, thumb=1, name='CIP_ProcElectrodeCondition', return_type=CIP_ProcResult_t, size=84, line=364, arg_list=[('callback',CIP_ProcElectrodeCondition_res),('bte',INT_Bte_t),('retryNum',u8),('conditioningCL',u8),('electrode',u8)])
        self.CIP_ProcReadProfileMeanMeasured = StaticFunction(device, 0x5788c, thumb=1, name='CIP_ProcReadProfileMeanMeasured', return_type=CIP_ProcResult_t, size=62, line=572, arg_list=[('callback',CIP_ProcReadProfileMeanMeasured_res),('bte',INT_Bte_t),('retryNum',u8)])
        self.CIP_ProcWhoIsThere = StaticFunction(device, 0x572c4, thumb=1, name='CIP_ProcWhoIsThere', return_type=CIP_ProcResult_t, size=62, line=76, arg_list=[('callback',CIP_ProcWhoIsThere_res),('bte',INT_Bte_t),('initialPairing',bool)])
        self.CIP_ProcPolling = StaticFunction(device, 0x57302, thumb=1, name='CIP_ProcPolling', return_type=CIP_ProcResult_t, size=74, line=100, arg_list=[('callback',CIP_ProcPolling_res),('bte',INT_Bte_t),('pollingType',CIP_ProcPollingType_t),('bteSettings',PointerType("WBST_BteSettings_t"))])
        self.CIP_ProcMVBTGet = StaticFunction(device, 0x57400, thumb=1, name='CIP_ProcMVBTGet', return_type=CIP_ProcResult_t, size=62, line=196, arg_list=[('callback',CIP_ProcMVBTGet_res),('bte',INT_Bte_t),('retryNum',u8)])
        self.CIP_ProcReadProfile = StaticFunction(device, 0x5791a, thumb=1, name='CIP_ProcReadProfile', return_type=CIP_ProcResult_t, size=72, line=623, arg_list=[('callback',CIP_ProcReadProfile_res),('bte',INT_Bte_t),('retryNum',u8),('type',CIP_EcapProfileType_t)])
