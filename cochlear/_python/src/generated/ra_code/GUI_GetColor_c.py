...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_GetColor = StaticFunction(device, 0x2e1e8, thumb=1, name='GUI_GetColor', return_type=GUI_COLOR, size=16, line=68, arg_list=[])
        self.GUI_GetBkColor = StaticFunction(device, 0x2e1cc, thumb=1, name='GUI_GetBkColor', return_type=GUI_COLOR, size=16, line=44, arg_list=[])
        self.GUI_GetBkColorIndex = StaticFunction(device, 0x2e1c0, thumb=1, name='GUI_GetBkColorIndex', return_type=c_int_le, size=12, line=32, arg_list=[])
        self.GUI_GetColorIndex = StaticFunction(device, 0x2e1dc, thumb=1, name='GUI_GetColorIndex', return_type=c_int_le, size=12, line=56, arg_list=[])
