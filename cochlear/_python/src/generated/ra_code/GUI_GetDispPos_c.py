...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_GetDispPosY = StaticFunction(device, 0x3215c, thumb=1, name='GUI_GetDispPosY', return_type=c_int_le, size=8, line=50, arg_list=[])
        self.GUI_GetDispPosX = StaticFunction(device, 0x32154, thumb=1, name='GUI_GetDispPosX', return_type=c_int_le, size=8, line=35, arg_list=[])
