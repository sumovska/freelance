...
class Code(AbstractCode):
    ...
    def OSTimeDlyHMSM(self, hours, minutes, seconds, ms):
        '''
        Arguments:
        -hours - INT8U
        -minutes - INT8U
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.OSTimeSet = StaticFunction(device, 0x2a9de, thumb=1, name='OSTimeSet', return_type=None, size=18, line=249, arg_list=[('ticks',INT32U)])
        self.OSTimeDly = StaticFunction(device, 0x2a8b4, thumb=1, name='OSTimeDly', return_type=None, size=62, line=44, arg_list=[('ticks',INT16U)])
        self.OSTimeDlyResume = StaticFunction(device, 0x2a94a, thumb=1, name='OSTimeDlyResume', return_type=INT8U, size=130, line=160, arg_list=[('prio',INT8U)])
        self.OSTimeDlyHMSM = StaticFunction(device, 0x2a8f2, thumb=1, name='OSTimeDlyHMSM', return_type=INT8U, size=88, line=92, arg_list=[('hours',INT8U),('minutes',INT8U),('seconds',INT8U),('ms',INT16U)])
        self.OSTimeGet = StaticFunction(device, 0x2a9cc, thumb=1, name='OSTimeGet', return_type=INT32U, size=18, line=220, arg_list=[])
