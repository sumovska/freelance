...
class Code(AbstractCode):
    ...
    def LCD_Color2Index_M565(self, Color):
        '''
        Arguments:
        -Color - LCD_COLOR
        Return type:
    ...
    def LCD_GetIndexMask_M565(self, ):
        '''
        Arguments:
        Return type:
        -c_uint_le
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.LCD_Color2Index_M565 = StaticFunction(device, 0x2d21c, thumb=1, name='LCD_Color2Index_M565', return_type=c_uint_le, size=22, line=49, arg_list=[('Color',LCD_COLOR)])
        self.LCD_GetIndexMask_M565 = StaticFunction(device, 0x2d232, thumb=1, name='LCD_GetIndexMask_M565', return_type=c_uint_le, size=4, line=61, arg_list=[])
