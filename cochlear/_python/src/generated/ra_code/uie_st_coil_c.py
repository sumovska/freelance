...
class Code(AbstractCode):
    ...
    def UIE_P_StPairingConfirmation(self, me, pEvt):
        '''
        Arguments:
        ...
        Return type:
        -HSM_StateRet_t
        Declaration line: 315
        '''
        pass

    def UIE_P_StPairingInProgress(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_IsCoilHandlingEnabled(self, ):
        '''
        Arguments:
        Return type:
        -bool
    ...
    def UIE_P_EnableCoilHandling(self, enable):
        '''
        Arguments:
        -enable - bool
        Return type:
    ...
    def UIE_P_StCoilStimulation(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def __init__(self, device):
        ...
        self.coilHandlingEnabled = StaticVariable(device, self.bool, 0x800084d0L, False)
        ...
        self.prevPairedBtes = StaticVariable(device, self.WBST_BteId_t, 0x800084d1L, False)
        ...
        ### Functions data ###
        ######################
        self.UIE_P_StPairingConfirmation = StaticFunction(device, 0x3d01c, thumb=1, name='UIE_P_StPairingConfirmation', return_type=HSM_StateRet_t, size=148, line=315, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StPairingInProgress = StaticFunction(device, 0x3d0b0, thumb=1, name='UIE_P_StPairingInProgress', return_type=HSM_StateRet_t, size=334, line=176, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_IsCoilHandlingEnabled = StaticFunction(device, 0x3d304, thumb=1, name='UIE_P_IsCoilHandlingEnabled', return_type=bool, size=6, line=384, arg_list=[])
        self.UIE_P_EnableCoilHandling = StaticFunction(device, 0x3d2fe, thumb=1, name='UIE_P_EnableCoilHandling', return_type=None, size=6, line=376, arg_list=[('enable',bool)])
        self.UIE_P_StCoilStimulation = StaticFunction(device, 0x3d1fe, thumb=1, name='UIE_P_StCoilStimulation', return_type=HSM_StateRet_t, size=256, line=74, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
