...
class Queue_tag(Structure):
    queueSize = u8
    evntSize = u8
    ppQueueMem = PointerType("PointerType('void')")
    pPoolMem = PointerType('u8')
    init = bool
    pQHndl = PointerType("OS_EVENT")
    pMHndl = PointerType('OS_MEM')
    _fields_ = [
                ('queueSize', u8),
                ('evntSize', u8),
                ('ppQueueMem', PointerType("PointerType('void')")),
...
class Code(AbstractCode):
    ...
    def ITC_QSend(self, sndrId, rcvQId, evntId, length, pEvntData, prior):
        '''
        Arguments:
        -sndrId - INT_ModId_t
        -rcvQId - ITC_QId_t
    ...
    def ITC_QCreate(self, qID, queueSize, evntSize, ppQueueMem, pPoolMem):
        '''
        Arguments:
        -qID - ITC_QId_t
        -queueSize - u8
    ...
    def itcMemCopy(self, pdest, psrc, size):
        '''
        Arguments:
        -pdest - PointerType("u8")
        -psrc - PointerType('u8')
        -size - u16
        Return type:
        -None
    ...
    def ITC_QReceive(self, rcvSqId, pSndrId, pEvntId, pLength, pEvntData, timeout):
        '''
        Arguments:
        -rcvSqId - ITC_QId_t
        -pSndrId - PointerType("INT_ModId_t")
        -pEvntId - PointerType('ITC_EventId_t')
    ...
    def ITC_IsQEmpty(self, qId):
        '''
        Arguments:
        -qId - ITC_QId_t
        Return type:
        -bool
        Declaration line: 504
        '''
        pass

    def ITC_TimerHandler(self, ptmr, parg):
        '''
        Arguments:
    ...
    def ITC_Fini(self, fini_type):
        '''
        Arguments:
        -fini_type - INT_FiniType_t
        Return type:
        -Status
        Declaration line: 127
        '''
        pass

    def ITC_Init(self, init_type):
        '''
        Arguments:
    ...
    def ITC_QDelete(self, qID):
        '''
        Arguments:
        -qID - ITC_QId_t
        Return type:
        -Status
        Declaration line: 248
        '''
        pass

    def ITC_QAccept(self, rcvSqId, pSndrId, pEvntId, pLength, pEvntData):
        '''
        Arguments:
        -rcvSqId - ITC_QId_t
        -pSndrId - PointerType("INT_ModId_t")
    ...
    def __init__(self, device):
        ...
        self.QArray = StaticVariable(device, Queue_t * 23, 0x4000cf0c, False)
        ...
        ### Functions data ###
        ######################
        self.ITC_QSend = StaticFunction(device, 0x5bcce, thumb=1, name='ITC_QSend', return_type=Status, size=134, line=286, arg_list=[('sndrId',INT_ModId_t),('rcvQId',ITC_QId_t),('evntId',ITC_EventId_t),('length',u16),('pEvntData',PointerType('void')),('prior',bool)])
        self.ITC_QCreate = StaticFunction(device, 0x5bc2e, thumb=1, name='ITC_QCreate', return_type=Status, size=100, line=186, arg_list=[('qID',ITC_QId_t),('queueSize',u8),('evntSize',u8),('ppQueueMem',PointerType("PointerType('void')")),('pPoolMem',PointerType('u8'))])
        self.itcMemCopy = StaticFunction(device, 0x5bcb8, thumb=1, name='itcMemCopy', return_type=None, size=22, line=567, arg_list=[('pdest',PointerType("u8")),('psrc',PointerType('u8')),('size',u16)])
        self.ITC_QReceive = StaticFunction(device, 0x5bd54, thumb=1, name='ITC_QReceive', return_type=Status, size=100, line=374, arg_list=[('rcvSqId',ITC_QId_t),('pSndrId',PointerType("INT_ModId_t")),('pEvntId',PointerType('ITC_EventId_t')),('pLength',PointerType("u16")),('pEvntData',PointerType('void')),('timeout',u32)])
        self.ITC_IsQEmpty = StaticFunction(device, 0x5be16, thumb=1, name='ITC_IsQEmpty', return_type=bool, size=36, line=504, arg_list=[('qId',ITC_QId_t)])
        self.ITC_TimerHandler = StaticFunction(device, 0x5be3a, thumb=1, name='ITC_TimerHandler', return_type=None, size=32, line=525, arg_list=[('ptmr',PointerType("void")),('parg',PointerType('void'))])
        self.ITC_Fini = StaticFunction(device, 0x5bbf8, thumb=1, name='ITC_Fini', return_type=Status, size=54, line=127, arg_list=[('fini_type',INT_FiniType_t)])
        self.ITC_Init = StaticFunction(device, 0x5bbdc, thumb=1, name='ITC_Init', return_type=Status, size=28, line=99, arg_list=[('init_type',INT_InitType_t)])
        self.ITC_QDelete = StaticFunction(device, 0x5bc92, thumb=1, name='ITC_QDelete', return_type=Status, size=38, line=248, arg_list=[('qID',ITC_QId_t)])
        self.ITC_QAccept = StaticFunction(device, 0x5bdb8, thumb=1, name='ITC_QAccept', return_type=Status, size=94, line=445, arg_list=[('rcvSqId',ITC_QId_t),('pSndrId',PointerType("INT_ModId_t")),('pEvntId',PointerType('ITC_EventId_t')),('pLength',PointerType("u16")),('pEvntData',PointerType('void'))])
