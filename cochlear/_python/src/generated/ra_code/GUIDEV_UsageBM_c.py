...
class GUI_USAGE_BM__structure__struct0(Structure):
...
class GUI_USAGE_BM__structure(Structure):
    Public = GUI_USAGE
    Private = GUI_USAGE_BM__structure__struct0
    _pack_ = 1
    _fields_ = [
                ('Public', GUI_USAGE),
                ('Private', GUI_USAGE_BM__structure__struct0),
...
GUI_USAGE_BM = GUI_USAGE_BM__structure
...
class Code(AbstractCode):
    ...
    GUI_USAGE_BM__structure__struct0 = GUI_USAGE_BM__structure__struct0
    ...
    GUI_USAGE_BM__structure = GUI_USAGE_BM__structure
    GUI_AUTODEV__structure = GUI_AUTODEV__structure
    GUI_FONT = GUI_FONT
    GUI_AUTODEV = GUI_AUTODEV
    GUI_USAGE_BM = GUI_USAGE_BM

    #################
    ### Functions ###
    #################

    def GUI_USAGE_BM_Create(self, x0, y0, xsize, ysize, Flags):
        '''
        Arguments:
        -x0 - c_int_le
        -y0 - c_int_le
    ...
    def _GUI_USAGE_BM_Delete(self, hDevUsage):
        '''
        Arguments:
        -hDevUsage - GUI_MEMDEV_Handle
        Return type:
        -None
    ...
    def GUI_USAGE_BM_GetNextDirty(self, p, pxOff, yOff):
        '''
        Arguments:
        -p - PointerType('GUI_USAGE')
        -pxOff - PointerType("c_int_le")
        -yOff - c_int_le
        Return type:
        -c_int_le
    ...
    def GUI_USAGE_BM_AddHLine(self, p, x, y, len):
        '''
        Arguments:
        -p - PointerType("GUI_USAGE")
        -x - c_int_le
    ...
    def GUI_USAGE_BM_AddPixel(self, p, x, y):
        '''
        Arguments:
        -p - PointerType('GUI_USAGE')
        -x - c_int_le
    ...
    def __init__(self, device):
        ...
        self.API = StaticVariable(device, self.tUSAGE_APIList, 0x61b14, True)
        ...
        ### Functions data ###
        ######################
        self.GUI_USAGE_BM_Create = StaticFunction(device, 0x2d650, thumb=1, name='GUI_USAGE_BM_Create', return_type=GUI_USAGE_Handle, size=68, line=212, arg_list=[('x0',c_int_le),('y0',c_int_le),('xsize',c_int_le),('ysize',c_int_le),('Flags',c_int_le)])
        self._GUI_USAGE_BM_Delete = StaticFunction(device, 0x2d644, thumb=1, name='_GUI_USAGE_BM_Delete', return_type=None, size=12, line=184, arg_list=[('hDevUsage',GUI_MEMDEV_Handle)])
        self.GUI_USAGE_BM_GetNextDirty = StaticFunction(device, 0x2d59a, thumb=1, name='GUI_USAGE_BM_GetNextDirty', return_type=c_int_le, size=170, line=122, arg_list=[('p',PointerType('GUI_USAGE')),('pxOff',PointerType("c_int_le")),('yOff',c_int_le)])
        self.GUI_USAGE_BM_Clear = StaticFunction(device, 0x2d584, thumb=1, name='GUI_USAGE_BM_Clear', return_type=None, size=22, line=113, arg_list=[('p',PointerType('GUI_USAGE'))])
        self.GUI_USAGE_BM_AddHLine = StaticFunction(device, 0x2d512, thumb=1, name='GUI_USAGE_BM_AddHLine', return_type=None, size=114, line=73, arg_list=[('p',PointerType("GUI_USAGE")),('x',c_int_le),('y',c_int_le),('len',c_int_le)])
        self.GUI_USAGE_BM_AddPixel = StaticFunction(device, 0x2d4e4, thumb=1, name='GUI_USAGE_BM_AddPixel', return_type=None, size=46, line=52, arg_list=[('p',PointerType('GUI_USAGE')),('x',c_int_le),('y',c_int_le)])
