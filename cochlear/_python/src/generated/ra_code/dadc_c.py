...
class Code(AbstractCode):
    ...
    def DADC_GetVoltage(self, channel):
        '''
        Arguments:
        -channel - u8
        Return type:
    ...
    OSTmrTbl = OS_TMR * 26
    dadcReadSem = PointerType("OS_EVENT")
    ...
    def __init__(self, device):
        ...
        self.dadcReadSem = StaticVariable(device, PointerType("OS_EVENT"), 0x80008950L, False)
        ...
        ### Functions data ###
        ######################
        self.DADC_GetVoltage = StaticFunction(device, 0x5957e, thumb=1, name='DADC_GetVoltage', return_type=u16, size=194, line=159, arg_list=[('channel',u8)])
        self.compare2numbers = StaticFunction(device, 0x59564, thumb=1, name='compare2numbers', return_type=c_int_le, size=26, line=232, arg_list=[('a',PointerType('void')),('b',PointerType("void"))])
        self.DADC_Init = StaticFunction(device, 0x594b4, thumb=1, name='DADC_Init', return_type=None, size=176, line=92, arg_list=[('channel',u8)])
