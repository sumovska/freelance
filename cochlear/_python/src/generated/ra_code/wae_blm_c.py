...
class Code(AbstractCode):
    ...
    def WAE_P_BLM_SendClinicalIndReq(self, clinicalReq):
        '''
        Arguments:
        -clinicalReq - ITC_EventId_t
        Return type:
        -None
        Declaration line: 74
        '''
    ...
    def WAE_P_BLM_SendClinicalPairReq(self, pairReq, bteId):
        '''
        Arguments:
        -pairReq - ITC_EventId_t
        -bteId - BLM_BteId_t
        Return type:
        -None
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.WAE_P_BLM_SendClinicalIndReq = StaticFunction(device, 0x42c34, thumb=1, name='WAE_P_BLM_SendClinicalIndReq', return_type=None, size=26, line=74, arg_list=[('clinicalReq',ITC_EventId_t)])
        self.WAE_P_BLM_SendClinicalPairReq = StaticFunction(device, 0x42c4e, thumb=1, name='WAE_P_BLM_SendClinicalPairReq', return_type=None, size=44, line=113, arg_list=[('pairReq',ITC_EventId_t),('bteId',BLM_BteId_t)])
