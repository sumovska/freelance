...
class Code(AbstractCode):
    ...
    def GUI_MoveRect(self, pRect, dx, dy):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_MoveRect = StaticFunction(device, 0x30ee8, thumb=1, name='GUI_MoveRect', return_type=None, size=30, line=32, arg_list=[('pRect',PointerType("GUI_RECT")),('dx',c_int_le),('dy',c_int_le)])
