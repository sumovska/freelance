...
class Code(AbstractCode):
    ...
    def MCL_MVBTInit(self, clbkFun, bteId, mClinicMapPresent, clinicalMapPresent):
        '''
        Arguments:
        -clbkFun - MCL_GenericCallback_t
        -bteId - INT_Bte_t
        -mClinicMapPresent - bool
        -clinicalMapPresent - bool
        Return type:
    ...
    def MCL_Diagnostics(self, statusClbkFun, stopClbkFun, bteId):
        '''
        Arguments:
        -statusClbkFun - MCL_DiagnosticsCallback_t
    ...
    def MCL_MVBTGet(self, clbkFun, bteId):
        '''
        Arguments:
        -clbkFun - MCL_MVBTGetCallback_t
        -bteId - INT_Bte_t
        Return type:
        -MCL_Status_t
    ...
    def MCL_GetNvmRoData(self, ):
        '''
        Arguments:
        Return type:
        -PointerType("MCL_NVM_RO_t")
        Declaration line: 325
        '''
        pass

    def MCL_Exit(self, clbkFun, bteId, rebootBte):
        '''
        Arguments:
        -clbkFun - MCL_GenericCallback_t
        -bteId - INT_Bte_t
    ...
    def MCL_FMCRun(self, coilOffAlarmInd):
        '''
        Arguments:
        -coilOffAlarmInd - bool
        Return type:
    ...
    def MCL_FMCInit(self, clbkFmcStatus, clbkAnrtStatus, clbkElConditionStatus, bteId, fmcFlow):
        '''
        Arguments:
    ...
    def MCL_FMCStop(self, ):
        '''
        Arguments:
        Return type:
        -MCL_Status_t
        Declaration line: 283
        '''
        pass

    def MCL_MVBTSet(self, clbkFun, bteId, masterVolume, bass, treble, selector):
        '''
        Arguments:
        -clbkFun - MCL_GenericCallback_t
        -bteId - INT_Bte_t
        ...
        Return type:
        -MCL_Status_t
        Declaration line: 154
        '''
        pass

    def MCL_Enter(self, clbkFun, bteId, rebootBte):
        '''
        Arguments:
        -clbkFun - MCL_GenericCallback_t
        -bteId - INT_Bte_t
    ...
    def __init__(self, device):
        ...
        self.mclNvmRo = StaticVariable(device, self.MCL_NVM_RO_t, 0x4000a53c, False)
        ...
        ### Functions data ###
        ######################
        self.MCL_Init = StaticFunction(device, 0x34ab8, thumb=1, name='MCL_Init', return_type=Status, size=46, line=70, arg_list=[('init_type',INT_InitType_t)])
        self.MCL_MVBTInit = StaticFunction(device, 0x34b58, thumb=1, name='MCL_MVBTInit', return_type=MCL_Status_t, size=32, line=180, arg_list=[('clbkFun',MCL_GenericCallback_t),('bteId',INT_Bte_t),('mClinicMapPresent',bool),('clinicalMapPresent',bool)])
        self.MCL_Diagnostics = StaticFunction(device, 0x34c28, thumb=1, name='MCL_Diagnostics', return_type=MCL_Status_t, size=36, line=299, arg_list=[('statusClbkFun',MCL_DiagnosticsCallback_t),('stopClbkFun',MCL_DiagnosticsStopCallback_t),('bteId',INT_Bte_t)])
        self.MCL_FMCPause = StaticFunction(device, 0x34bc8, thumb=1, name='MCL_FMCPause', return_type=MCL_Status_t, size=32, line=249, arg_list=[])
        self.MCL_FMCSkip = StaticFunction(device, 0x34be8, thumb=1, name='MCL_FMCSkip', return_type=MCL_Status_t, size=32, line=266, arg_list=[])
        self.MCL_DiagnosticsStop = StaticFunction(device, 0x34c4c, thumb=1, name='MCL_DiagnosticsStop', return_type=MCL_Status_t, size=20, line=316, arg_list=[])
        self.MCL_Fini = StaticFunction(device, 0x34ae6, thumb=1, name='MCL_Fini', return_type=Status, size=4, line=100, arg_list=[('finiType',INT_FiniType_t)])
        self.MCL_MVBTGet = StaticFunction(device, 0x34b1a, thumb=1, name='MCL_MVBTGet', return_type=MCL_Status_t, size=22, line=143, arg_list=[('clbkFun',MCL_MVBTGetCallback_t),('bteId',INT_Bte_t)])
        self.MCL_GetNvmRoData = StaticFunction(device, 0x34c60, thumb=1, name='MCL_GetNvmRoData', return_type=PointerType("MCL_NVM_RO_t"), size=4, line=325, arg_list=[])
        self.MCL_Exit = StaticFunction(device, 0x34b04, thumb=1, name='MCL_Exit', return_type=MCL_Status_t, size=22, line=127, arg_list=[('clbkFun',MCL_GenericCallback_t),('bteId',INT_Bte_t),('rebootBte',bool)])
        self.MCL_FMCRun = StaticFunction(device, 0x34ba6, thumb=1, name='MCL_FMCRun', return_type=MCL_Status_t, size=34, line=229, arg_list=[('coilOffAlarmInd',bool)])
        self.MCL_FMCInit = StaticFunction(device, 0x34b78, thumb=1, name='MCL_FMCInit', return_type=MCL_Status_t, size=46, line=202, arg_list=[('clbkFmcStatus',MCL_FMCStatusCallback_t),('clbkAnrtStatus',MCL_ANRTStatusCallback_t),('clbkElConditionStatus',MCL_ElConditionStatusCallback_t),('bteId',INT_Bte_t),('fmcFlow',MCL_FlowType_t)])
        self.MCL_FMCStop = StaticFunction(device, 0x34c08, thumb=1, name='MCL_FMCStop', return_type=MCL_Status_t, size=32, line=283, arg_list=[])
        self.MCL_MVBTSet = StaticFunction(device, 0x34b30, thumb=1, name='MCL_MVBTSet', return_type=MCL_Status_t, size=40, line=154, arg_list=[('clbkFun',MCL_GenericCallback_t),('bteId',INT_Bte_t),('masterVolume',s16),('bass',s16),('treble',s16),('selector',MCL_MVBTSelector_t)])
        self.MCL_Enter = StaticFunction(device, 0x34aea, thumb=1, name='MCL_Enter', return_type=MCL_Status_t, size=26, line=111, arg_list=[('clbkFun',MCL_GenericCallback_t),('bteId',INT_Bte_t),('rebootBte',bool)])
