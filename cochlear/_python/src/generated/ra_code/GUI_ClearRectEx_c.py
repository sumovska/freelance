...
class Code(AbstractCode):
    ...
    def GUI_ClearRectEx(self, pRect):
        '''
        Arguments:
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_ClearRectEx = StaticFunction(device, 0x2febc, thumb=1, name='GUI_ClearRectEx', return_type=None, size=30, line=32, arg_list=[('pRect',PointerType("GUI_RECT"))])
