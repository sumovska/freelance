...
class WAE_P_MClinicBteCfg_tag(Structure):
    pBteLink = PointerType('WAE_P_BteLink_t') * 2
    bteIdx = WAE_P_BteIdx_t
    nonMClinicBteWbstId = WBST_BteId_t
    nonMClinicBteIdx = WAE_P_BteIdx_t
    actId = WAE_BteUserActionId_t
    mvbt = WBST_Value_t
    postFmcStep = WBST_Value_t
    fmcActive = bool
    diagStatusSent = bool
    stopReason = MCL_LOG_MclinicStopReason_t
    mvbtInitStaus = WAE_StatusCode_t
...
WAE_P_MClinicBteCfg_t = WAE_P_MClinicBteCfg_tag
...
class waeMClinicRequestCache__structure__union0(Union):
    requestUie = WAE_BteUserAction_t
...
class waeMClinicRequestCache__structure(Structure):
    msg = waeMClinicRequestCache__structure__union0
    msgLength = u8
    sndrId = INT_ModId_t
    evntId = ITC_EventId_t
    _pack_ = 1
...
class Code(AbstractCode):
    ...
    WAE_P_MClinicBteCfg_tag = WAE_P_MClinicBteCfg_tag
    ...
    WAE_P_MClinicBteCfg_t = WAE_P_MClinicBteCfg_t
    ...
    waeMClinicRequestCache__structure__union0 = waeMClinicRequestCache__structure__union0
    ...
    waeMClinicRequestCache__structure = waeMClinicRequestCache__structure
    ...
    def waeMClinicResetCtx(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2514
        '''
        pass

    def WAE_P_MClinicProcessingEventFromUie(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
    ...
    def waeMClinicReqDiagStop(self, cipBteId, wbstBteId, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -cipBteId - INT_Bte_t
        -wbstBteId - WBST_BteId_t
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
        -pExpectedEventId - PointerType("ITC_EventId_t")
        Return type:
        -None
        Declaration line: 2439
        '''
        pass

    def waeMClinicClearBteAlarms(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2613
        '''
        pass

    def waeMClinicReqDiag(self, cipBteId, wbstBteId, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -cipBteId - INT_Bte_t
        -wbstBteId - WBST_BteId_t
    ...
    def WAE_P_MClinicProcessingEventFromWae(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
    ...
    def WAE_P_MClinicStop(self, userExit):
        '''
        Arguments:
        -userExit - bool
        Return type:
        -None
        Declaration line: 711
        '''
        pass

    def WAE_P_MClinicConfigure(self, bteIdx1st, bteIdx2nd):
        '''
        Arguments:
        -bteIdx1st - PointerType('WAE_P_BteLink_t')
        -bteIdx2nd - PointerType("WAE_P_BteLink_t")
        Return type:
        -None
    ...
    def WAE_P_MClinicInit(self, pWaeNvm):
        '''
        Arguments:
        -pWaeNvm - PointerType('WAE_NVM_RO_t')
        Return type:
        -None
    ...
    def WAE_P_MClinicInactivity(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
        ...
        Return type:
        -None
        Declaration line: 595
        '''
        pass

    def WAE_P_MClinicAfterPairingRefreshment(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
        ...
        Return type:
        -None
        Declaration line: 672
        '''
        pass

    def waeMClinicClbkMVBTInit(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        Return type:
        -None
        Declaration line: 1435
        '''
        pass

    def WAE_P_MClinicCoilOffAlarmInd_Set(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def waeMClinicCovertReqToStatus(self, actId):
        '''
        Arguments:
        -actId - WAE_BteUserActionId_t
        Return type:
        -WAE_BteStatusId_t
        Declaration line: 2345
        '''
        pass

    def WAE_P_MClinicFollowBteState(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
        ...
        Return type:
        -None
        Declaration line: 629
        '''
        pass

    def waeMClinicPrepareMVBTValues(self, pEvent, pMasterVolume, pBass, pTreble):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pMasterVolume - PointerType("s16")
        -pBass - PointerType('s16')
        -pTreble - PointerType("s16")
        Return type:
        -s16
        Declaration line: 2311
        '''
        pass

    def waeMClinicConvertBteId(self, wbstId):
        '''
        Arguments:
        -wbstId - WBST_BteId_t
        Return type:
        -WAE_P_BteIdx_t
        Declaration line: 2270
        '''
        pass

    def WAE_P_MClinicExit(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
        ...
        Return type:
        -None
        Declaration line: 726
        '''
        pass

    def waeMClinicReqFmcPlay(self, cipBteId, wbstBteId, coilOffAlarmInd, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -cipBteId - INT_Bte_t
        -wbstBteId - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1524
        '''
        pass

    def waeMClinicClbkDiagStatus(self, status, bteId, electrodeStatus, electrodeNum):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        -electrodeStatus - PointerType('MCL_ElImpStatus_t')
        -electrodeNum - u8
        Return type:
        -None
    ...
    def waeMClinicClbkANRTStatus(self, status, bteId, aNrtStatus, electrodeNum, fmcStep, currentLvl, trace, traceSampleNum):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        -aNrtStatus - MCL_AnrtStatus_t
        -electrodeNum - u8
        -fmcStep - u8
        -currentLvl - u8
        -trace - PointerType("u8")
        -traceSampleNum - u8
        Return type:
        -None
        Declaration line: 1959
        '''
        pass

    def waeMClinicReqFmcStop(self, wbstBteId, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -wbstBteId - WBST_BteId_t
        -pEvent - PointerType('WAE_P_Event_t')
        ...
        Return type:
        -None
        Declaration line: 1670
        '''
        pass

    def waeMClinicClbkExitPairingDropped(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        Return type:
        -None
        Declaration line: 1000
        '''
        pass

    def WAE_P_MClinicCoilOffAlarmInd_Clear(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def waeMClinicClbkEnter(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
    ...
    def waeMClinicReqMVBTSet(self, cipBteId, wbstBteId, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -cipBteId - INT_Bte_t
        -wbstBteId - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1205
        '''
        pass

    def waeMClinicClbkMVBTSet(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        Return type:
        -None
        Declaration line: 1296
        '''
        pass

    def WAE_P_MClinicStart(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType('WAE_P_Event_t')
        -pWaeState - PointerType("WAE_P_State_t")
    ...
    def waeMClinicTranslateStatus(self, mclError):
        '''
        Arguments:
        -mclError - MCL_Status_t
        Return type:
        -WAE_StatusCode_t
        Declaration line: 2450
        '''
        pass

    def waeMClinicClbkFMCStatus(self, status, bteId, fmcStatus, mean, dataArray, dataArrayElemNum):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        ...
        -mean - u8
        -dataArray - PointerType("s8")
        -dataArrayElemNum - u8
        Return type:
        -None
        Declaration line: 1702
        '''
        pass

    def waeMClinicClbkExitInactivity(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
    ...
    def waeMClinicClbkDiagStopStatus(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
    ...
    def waeMClinicClbkElConditionStatus(self, status, bteId, conditioningStatus, electrodeNum):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        -conditioningStatus - MCL_ElConditionStatus_t
        -electrodeNum - u8
        Return type:
        -None
        Declaration line: 2065
        '''
        pass

    def waeMClinicLogStop(self, stopReason):
        '''
        Arguments:
        -stopReason - MCL_LOG_MclinicStopReason_t
        Return type:
        -None
        Declaration line: 2493
        '''
        pass

    def waeMClinicResetWbstMclData(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 2531
        '''
        pass

    def waeMClinicReqMVBTInit(self, cipBteId, wbstBteId, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -cipBteId - INT_Bte_t
        -wbstBteId - WBST_BteId_t
        ...
        Return type:
        -None
        Declaration line: 1374
        '''
        pass

    def waeMClinicReqExit(self, bteId, clbkExitFun, rebootBte, stopReason, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -bteId - INT_Bte_t
        -clbkExitFun - MCL_GenericCallback_t
        -rebootBte - bool
        -stopReason - MCL_LOG_MclinicStopReason_t
        -pWaeState - PointerType("WAE_P_State_t")
        -pExpectedEventId - PointerType('ITC_EventId_t')
    ...
    def waeMClinicProcessBteNotFound(self, wbstId):
        '''
        Arguments:
        -wbstId - WBST_BteId_t
        Return type:
        -None
        Declaration line: 2570
        '''
        pass

    def waeMClinicClbkExit(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        Return type:
        -None
        Declaration line: 892
        '''
        pass

    def waeMClinicClbkMVBTGet(self, status, bteId, masterVolume, bass, treble, mapTypeIntraOrPost, mapTypeFlatOrProfile, profileMean):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
        ...
        -bass - s16
        -treble - s16
        -mapTypeIntraOrPost - u8
        -mapTypeFlatOrProfile - u8
        -profileMean - s16
        Return type:
        -None
    ...
    def WAE_P_MClinicIdle(self, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -pEvent - PointerType("WAE_P_Event_t")
        -pWaeState - PointerType('WAE_P_State_t')
    ...
    def waeMClinicReqFmcSkip(self, wbstBteId, pEvent, pWaeState, pExpectedEventId):
        '''
        Arguments:
        -wbstBteId - WBST_BteId_t
        -pEvent - PointerType('WAE_P_Event_t')
        ...
        Return type:
        -None
        Declaration line: 1625
        '''
        pass

    def waeMClinicClbkExitEnforced(self, status, bteId):
        '''
        Arguments:
        -status - MCL_Status_t
        -bteId - INT_Bte_t
    ...
    pWaeMClinicNvm = PointerType("WAE_NVM_RO_t")
    ...
    waeMClinicBteCfg = WAE_P_MClinicBteCfg_t
    ...
    waeMClinicRequestCache = waeMClinicRequestCache__structure
    ...
    def __init__(self, device):
        ...
        self.pWaeMClinicNvm = StaticVariable(device, PointerType("WAE_NVM_RO_t"), 0x7fe00078, False)
        ...
        self.waeMClinicBteCfg = StaticVariable(device, self.WAE_P_MClinicBteCfg_t, 0x7fe00a6c, False)
        ...
        self.waeMClinicRequestCache = StaticVariable(device, self.waeMClinicRequestCache__structure, 0x7fe0007c, False)

        ######################
        ### Functions data ###
        ######################
        self.waeMClinicResetCtx = StaticFunction(device, 0x44ab4, thumb=1, name='waeMClinicResetCtx', return_type=None, size=22, line=2514, arg_list=[])
        self.WAE_P_MClinicProcessingEventFromUie = StaticFunction(device, 0x45948, thumb=1, name='WAE_P_MClinicProcessingEventFromUie', return_type=None, size=92, line=534, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicReqDiagStop = StaticFunction(device, 0x4593c, thumb=1, name='waeMClinicReqDiagStop', return_type=None, size=12, line=2439, arg_list=[('cipBteId',INT_Bte_t),('wbstBteId',WBST_BteId_t),('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waeMClinicClearBteAlarms = StaticFunction(device, 0x44c7e, thumb=1, name='waeMClinicClearBteAlarms', return_type=None, size=38, line=2613, arg_list=[])
        self.waeMClinicReqDiag = StaticFunction(device, 0x44e34, thumb=1, name='waeMClinicReqDiag', return_type=None, size=52, line=2391, arg_list=[('cipBteId',INT_Bte_t),('wbstBteId',WBST_BteId_t),('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.WAE_P_MClinicProcessingEventFromWae = StaticFunction(device, 0x45932, thumb=1, name='WAE_P_MClinicProcessingEventFromWae', return_type=None, size=10, line=523, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.WAE_P_MClinicStop = StaticFunction(device, 0x45b1e, thumb=1, name='WAE_P_MClinicStop', return_type=None, size=16, line=711, arg_list=[('userExit',bool)])
        self.WAE_P_MClinicConfigure = StaticFunction(device, 0x44aca, thumb=1, name='WAE_P_MClinicConfigure', return_type=None, size=22, line=300, arg_list=[('bteIdx1st',PointerType('WAE_P_BteLink_t')),('bteIdx2nd',PointerType("WAE_P_BteLink_t"))])
        self.WAE_P_MClinicInit = StaticFunction(device, 0x44a3c, thumb=1, name='WAE_P_MClinicInit', return_type=None, size=6, line=293, arg_list=[('pWaeNvm',PointerType('WAE_NVM_RO_t'))])
        self.WAE_P_MClinicInactivity = StaticFunction(device, 0x45a00, thumb=1, name='WAE_P_MClinicInactivity', return_type=None, size=32, line=595, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.WAE_P_MClinicAfterPairingRefreshment = StaticFunction(device, 0x45ae0, thumb=1, name='WAE_P_MClinicAfterPairingRefreshment', return_type=None, size=62, line=672, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicClbkMVBTInit = StaticFunction(device, 0x456c6, thumb=1, name='waeMClinicClbkMVBTInit', return_type=None, size=128, line=1435, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
        self.WAE_P_MClinicCoilOffAlarmInd_Set = StaticFunction(device, 0x44a2c, thumb=1, name='WAE_P_MClinicCoilOffAlarmInd_Set', return_type=None, size=8, line=270, arg_list=[])
        self.waeMClinicCovertReqToStatus = StaticFunction(device, 0x44c48, thumb=1, name='waeMClinicCovertReqToStatus', return_type=WAE_BteStatusId_t, size=54, line=2345, arg_list=[('actId',WAE_BteUserActionId_t)])
        self.WAE_P_MClinicFollowBteState = StaticFunction(device, 0x45a20, thumb=1, name='WAE_P_MClinicFollowBteState', return_type=None, size=76, line=629, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waeMClinicPrepareMVBTValues = StaticFunction(device, 0x454aa, thumb=1, name='waeMClinicPrepareMVBTValues', return_type=s16, size=106, line=2311, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pMasterVolume',PointerType("s16")),('pBass',PointerType('s16')),('pTreble',PointerType("s16"))])
        self.waeMClinicConvertBteId = StaticFunction(device, 0x44bca, thumb=1, name='waeMClinicConvertBteId', return_type=WAE_P_BteIdx_t, size=50, line=2270, arg_list=[('wbstId',WBST_BteId_t)])
        self.WAE_P_MClinicExit = StaticFunction(device, 0x45b2e, thumb=1, name='WAE_P_MClinicExit', return_type=None, size=86, line=726, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicReqFmcPlay = StaticFunction(device, 0x45372, thumb=1, name='waeMClinicReqFmcPlay', return_type=None, size=168, line=1524, arg_list=[('cipBteId',INT_Bte_t),('wbstBteId',WBST_BteId_t),('coilOffAlarmInd',bool),('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waeMClinicClbkDiagStatus = StaticFunction(device, 0x44d64, thumb=1, name='waeMClinicClbkDiagStatus', return_type=None, size=208, line=2117, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t),('electrodeStatus',PointerType('MCL_ElImpStatus_t')),('electrodeNum',u8)])
        self.waeMClinicClbkANRTStatus = StaticFunction(device, 0x4502a, thumb=1, name='waeMClinicClbkANRTStatus', return_type=None, size=246, line=1959, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t),('aNrtStatus',MCL_AnrtStatus_t),('electrodeNum',u8),('fmcStep',u8),('currentLvl',u8),('trace',PointerType("u8")),('traceSampleNum',u8)])
        self.waeMClinicReqFmcStop = StaticFunction(device, 0x44f58, thumb=1, name='waeMClinicReqFmcStop', return_type=None, size=46, line=1670, arg_list=[('wbstBteId',WBST_BteId_t),('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicClbkExitPairingDropped = StaticFunction(device, 0x45a6c, thumb=1, name='waeMClinicClbkExitPairingDropped', return_type=None, size=116, line=1000, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
        self.WAE_P_MClinicCoilOffAlarmInd_Clear = StaticFunction(device, 0x44a34, thumb=1, name='WAE_P_MClinicCoilOffAlarmInd_Clear', return_type=None, size=8, line=280, arg_list=[])
        self.waeMClinicClbkEnter = StaticFunction(device, 0x44b14, thumb=1, name='waeMClinicClbkEnter', return_type=None, size=182, line=771, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
        self.waeMClinicReqMVBTSet = StaticFunction(device, 0x45514, thumb=1, name='waeMClinicReqMVBTSet', return_type=None, size=176, line=1205, arg_list=[('cipBteId',INT_Bte_t),('wbstBteId',WBST_BteId_t),('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waeMClinicClbkMVBTSet = StaticFunction(device, 0x4541a, thumb=1, name='waeMClinicClbkMVBTSet', return_type=None, size=144, line=1296, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
        self.WAE_P_MClinicStart = StaticFunction(device, 0x44bfc, thumb=1, name='WAE_P_MClinicStart', return_type=None, size=76, line=326, arg_list=[('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicTranslateStatus = StaticFunction(device, 0x44d28, thumb=1, name='waeMClinicTranslateStatus', return_type=WAE_StatusCode_t, size=60, line=2450, arg_list=[('mclError',MCL_Status_t)])
        self.waeMClinicClbkFMCStatus = StaticFunction(device, 0x45120, thumb=1, name='waeMClinicClbkFMCStatus', return_type=None, size=594, line=1702, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t),('fmcStatus',MCL_FMCStatus_t),('mean',u8),('dataArray',PointerType("s8")),('dataArrayElemNum',u8)])
        self.waeMClinicClbkExitInactivity = StaticFunction(device, 0x459a4, thumb=1, name='waeMClinicClbkExitInactivity', return_type=None, size=92, line=957, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
        self.waeMClinicClbkDiagStopStatus = StaticFunction(device, 0x44ca4, thumb=1, name='waeMClinicClbkDiagStopStatus', return_type=None, size=132, line=2204, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
        self.waeMClinicClbkElConditionStatus = StaticFunction(device, 0x44fb4, thumb=1, name='waeMClinicClbkElConditionStatus', return_type=None, size=118, line=2065, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t),('conditioningStatus',MCL_ElConditionStatus_t),('electrodeNum',u8)])
        self.waeMClinicLogStop = StaticFunction(device, 0x44e68, thumb=1, name='waeMClinicLogStop', return_type=None, size=54, line=2493, arg_list=[('stopReason',MCL_LOG_MclinicStopReason_t)])
        self.waeMClinicResetWbstMclData = StaticFunction(device, 0x44a42, thumb=1, name='waeMClinicResetWbstMclData', return_type=None, size=114, line=2531, arg_list=[])
        self.waeMClinicReqMVBTInit = StaticFunction(device, 0x45746, thumb=1, name='waeMClinicReqMVBTInit', return_type=None, size=124, line=1374, arg_list=[('cipBteId',INT_Bte_t),('wbstBteId',WBST_BteId_t),('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicReqExit = StaticFunction(device, 0x44f36, thumb=1, name='waeMClinicReqExit', return_type=None, size=34, line=869, arg_list=[('bteId',INT_Bte_t),('clbkExitFun',MCL_GenericCallback_t),('rebootBte',bool),('stopReason',MCL_LOG_MclinicStopReason_t),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicProcessBteNotFound = StaticFunction(device, 0x44ae0, thumb=1, name='waeMClinicProcessBteNotFound', return_type=None, size=52, line=2570, arg_list=[('wbstId',WBST_BteId_t)])
        self.waeMClinicClbkExit = StaticFunction(device, 0x44e9e, thumb=1, name='waeMClinicClbkExit', return_type=None, size=152, line=892, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
        self.waeMClinicClbkMVBTGet = StaticFunction(device, 0x455c4, thumb=1, name='waeMClinicClbkMVBTGet', return_type=None, size=258, line=1099, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t),('masterVolume',s16),('bass',s16),('treble',s16),('mapTypeIntraOrPost',u8),('mapTypeFlatOrProfile',u8),('profileMean',s16)])
        self.WAE_P_MClinicIdle = StaticFunction(device, 0x45832, thumb=1, name='WAE_P_MClinicIdle', return_type=None, size=256, line=373, arg_list=[('pEvent',PointerType("WAE_P_Event_t")),('pWaeState',PointerType('WAE_P_State_t')),('pExpectedEventId',PointerType("ITC_EventId_t"))])
        self.waeMClinicReqFmcSkip = StaticFunction(device, 0x44f86, thumb=1, name='waeMClinicReqFmcSkip', return_type=None, size=46, line=1625, arg_list=[('wbstBteId',WBST_BteId_t),('pEvent',PointerType('WAE_P_Event_t')),('pWaeState',PointerType("WAE_P_State_t")),('pExpectedEventId',PointerType('ITC_EventId_t'))])
        self.waeMClinicClbkExitEnforced = StaticFunction(device, 0x457c2, thumb=1, name='waeMClinicClbkExitEnforced', return_type=None, size=112, line=1047, arg_list=[('status',MCL_Status_t),('bteId',INT_Bte_t)])
