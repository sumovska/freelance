...
class const():
    ...
    ### Defines ###
    ###############
    RES_PACK_ID_ADDR = 2149376004
    RES_COUNT_ADDR = 2149376012
    RAT_ADDR = 2149376014
    RDD_ADDR = 2149443588
    WAGUI_P_GIF_LANG_SPEC_GIF_COUNT = 1
    RAT_VALID_FIELD_ADDRESS = 2147484704
    RDD_VALID_FIELD_ADDRESS = 2147484706
    RAT_VALID_CORRECT_LO_BYTE = 165
    RAT_VALID_CORRECT_HI_BYTE = 150
    RDD_VALID_CORRECT_LO_BYTE = 165
    RDD_VALID_CORRECT_HI_BYTE = 150
    GUI_OS = 0
    GUI_SUPPORT_TOUCH = 0
    GUI_SUPPORT_MOUSE = 0
...
class Code(AbstractCode):
    ...
    def WAGUI_P_GetExtGifImageInfo(self, extGif, gifImageInfo, sub):
        '''
        Arguments:
        -extGif - WAGUI_P_Res_t
        -gifImageInfo - PointerType('GUI_GIF_IMAGE_INFO')
        -sub - c_int_le
        Return type:
        -bool
    ...
    def WAGUI_RATIntegrityCheck(self, ):
        '''
        Arguments:
        Return type:
        -Status
    ...
    def GetExtGifData(self, p, numBytesReq, ppData, startOfFile):
        '''
        Arguments:
        -p - PointerType("void")
    ...
    def WAGUI_ReInitExtImages(self, selectedLangId):
        '''
        Arguments:
        -selectedLangId - u8
        Return type:
    ...
    def WAGUI_P_DrawExtGif(self, x, y, extGif, sub, flags):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def WAGUI_RDDValidFieldCheck(self, ):
        '''
        Arguments:
        Return type:
        -Status
    ...
    def GetExtResAddr(self, extRes, resSize):
        '''
        Arguments:
        -extRes - WAGUI_P_Res_t
        -resSize - PointerType('u32')
        Return type:
        -u32
    ...
    def WAGUI_P_DrawText(self, x, y, tId, align, color, font):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
        ...
        Return type:
        -None
        Declaration line: 303
        '''
        pass

    def WAGUI_P_GetExtGifInfo(self, extGif, gifInfo):
        '''
        Arguments:
        -extGif - WAGUI_P_Res_t
        -gifInfo - PointerType("GUI_GIF_INFO")
        Return type:
        -bool
    ...
    def waguiCheckDataBlockIntegrityEROM(self, startAddress, maxLength):
        '''
        Arguments:
        -startAddress - u32
        -maxLength - u32
    ...
    def WAGUI_P_DrawStr(self, x, y, str, align, color, font):
        '''
        Arguments:
        -x - c_int_le
        -y - c_int_le
    ...
    def GetExtFontData(self, Off, NumBytes, pVoid, pBuffer):
        '''
        Arguments:
        -Off - c_ulong_le
        -NumBytes - c_ushort_le
        -pVoid - PointerType("void")
        -pBuffer - PointerType('void')
        Return type:
        -c_int_le
    ...
    def WAGUI_RATValidFieldCheck(self, ):
        '''
        Arguments:
        Return type:
        -Status
    ...
    def WAGUI_RDDIntegrityCheck(self, ):
        '''
        Arguments:
        Return type:
        -Status
    ...
    def WAGUI_P_IsMultilineStr(self, str):
        '''
        Arguments:
        -str - PointerType("c_byte")
        Return type:
    ...
    def WAGUI_GetNumOfLanguages(self, ):
        '''
        Arguments:
        Return type:
        -u8
    ...
    def WAGUI_InitExtImages(self, selectedLangId):
        '''
        Arguments:
        -selectedLangId - u8
        Return type:
    ...
    def WAGUI_P_SetExtFont(self, extFont):
        '''
        Arguments:
        -extFont - WAGUI_P_Res_t
        Return type:
    ...
    def __init__(self, device):
        ...
        self.numOfLanguages = StaticVariable(device, self.u8, 0x80008801L, False)
        self.OSTmrSem = StaticVariable(device, PointerType('OS_EVENT'), 0x40000088, False)
        self.langRTL = StaticVariable(device, self.bool, 0x80008802L, False)
        self.OSTaskCtr = StaticVariable(device, self.INT8U, 0x4000004a, False)
        self.resLangOffs = StaticVariable(device, u32 * 2, 0x80008810L, False)
        ...
        self.textAddr = StaticVariable(device, u32 * 245, 0x81008aacL, False)
        ...
        self.textBuf = StaticVariable(device, u8 * 512, 0x81009280L, False)
        ...
        self.resDataBuf = StaticVariable(device, u8 * 1024, 0x81008e80L, False)
        ...
        self.resBaseOffs = StaticVariable(device, u32 * 523, 0x81008280L, False)
        ...
        self.ressInit = StaticVariable(device, self.bool, 0x80008800L, False)
        ...
        self.cachedTextId = StaticVariable(device, self.WAGUI_P_TextId_t, 0x80008804L, False)
        ...
        ### Functions data ###
        ######################
        self.WAGUI_P_GetExtGifImageInfo = StaticFunction(device, 0x49d2c, thumb=1, name='WAGUI_P_GetExtGifImageInfo', return_type=bool, size=18, line=267, arg_list=[('extGif',WAGUI_P_Res_t),('gifImageInfo',PointerType('GUI_GIF_IMAGE_INFO')),('sub',c_int_le)])
        self.WAGUI_P_IsLangRTL = StaticFunction(device, 0x49f66, thumb=1, name='WAGUI_P_IsLangRTL', return_type=bool, size=6, line=498, arg_list=[])
        self.WAGUI_RATIntegrityCheck = StaticFunction(device, 0x49f00, thumb=1, name='WAGUI_RATIntegrityCheck', return_type=Status, size=40, line=381, arg_list=[])
        self.GetExtGifData = StaticFunction(device, 0x49c24, thumb=1, name='GetExtGifData', return_type=c_int_le, size=98, line=606, arg_list=[('p',PointerType("void")),('numBytesReq',c_int_le),('ppData',PointerType('PointerType("c_ubyte")')),('startOfFile',c_uint_le)])
        self.WAGUI_ReInitExtImages = StaticFunction(device, 0x49b9c, thumb=1, name='WAGUI_ReInitExtImages', return_type=None, size=68, line=176, arg_list=[('selectedLangId',u8)])
        self.WAGUI_P_DrawExtGif = StaticFunction(device, 0x49c86, thumb=1, name='WAGUI_P_DrawExtGif', return_type=None, size=150, line=223, arg_list=[('x',c_int_le),('y',c_int_le),('extGif',WAGUI_P_Res_t),('sub',c_int_le),('flags',c_int_le)])
        self.WAGUI_P_GetText = StaticFunction(device, 0x49aac, thumb=1, name='WAGUI_P_GetText', return_type=PointerType("c_byte"), size=96, line=446, arg_list=[('tId',WAGUI_P_TextId_t)])
        self.WAGUI_RDDValidFieldCheck = StaticFunction(device, 0x49dfa, thumb=1, name='WAGUI_RDDValidFieldCheck', return_type=Status, size=34, line=349, arg_list=[])
        self.GetExtResAddr = StaticFunction(device, 0x49b0c, thumb=1, name='GetExtResAddr', return_type=u32, size=60, line=657, arg_list=[('extRes',WAGUI_P_Res_t),('resSize',PointerType('u32'))])
        self.WAGUI_P_DrawText = StaticFunction(device, 0x49db4, thumb=1, name='WAGUI_P_DrawText', return_type=None, size=38, line=303, arg_list=[('x',c_int_le),('y',c_int_le),('tId',WAGUI_P_TextId_t),('align',c_int_le),('color',GUI_COLOR),('font',WAGUI_P_Res_t)])
        self.WAGUI_P_GetExtGifInfo = StaticFunction(device, 0x49d1c, thumb=1, name='WAGUI_P_GetExtGifInfo', return_type=bool, size=16, line=260, arg_list=[('extGif',WAGUI_P_Res_t),('gifInfo',PointerType("GUI_GIF_INFO"))])
        self.waguiCheckDataBlockIntegrityEROM = StaticFunction(device, 0x49e1c, thumb=1, name='waguiCheckDataBlockIntegrityEROM', return_type=Status, size=228, line=519, arg_list=[('startAddress',u32),('maxLength',u32)])
        self.WAGUI_P_DrawStr = StaticFunction(device, 0x49d82, thumb=1, name='WAGUI_P_DrawStr', return_type=None, size=50, line=292, arg_list=[('x',c_int_le),('y',c_int_le),('str',PointerType('c_byte')),('align',c_int_le),('color',GUI_COLOR),('font',WAGUI_P_Res_t)])
        self.GetExtFontData = StaticFunction(device, 0x49d3e, thumb=1, name='GetExtFontData', return_type=c_int_le, size=24, line=650, arg_list=[('Off',c_ulong_le),('NumBytes',c_ushort_le),('pVoid',PointerType("void")),('pBuffer',PointerType('void'))])
        self.WAGUI_RATValidFieldCheck = StaticFunction(device, 0x49dda, thumb=1, name='WAGUI_RATValidFieldCheck', return_type=Status, size=32, line=315, arg_list=[])
        self.WAGUI_RDDIntegrityCheck = StaticFunction(device, 0x49f28, thumb=1, name='WAGUI_RDDIntegrityCheck', return_type=Status, size=40, line=418, arg_list=[])
        self.WAGUI_P_IsMultilineStr = StaticFunction(device, 0x49f50, thumb=1, name='WAGUI_P_IsMultilineStr', return_type=bool, size=22, line=485, arg_list=[('str',PointerType("c_byte"))])
        self.UpdateTextAddr = StaticFunction(device, 0x49b48, thumb=1, name='UpdateTextAddr', return_type=None, size=84, line=692, arg_list=[])
        self.WAGUI_GetNumOfLanguages = StaticFunction(device, 0x49c1e, thumb=1, name='WAGUI_GetNumOfLanguages', return_type=u8, size=6, line=206, arg_list=[])
        self.WAGUI_InitExtImages = StaticFunction(device, 0x49be0, thumb=1, name='WAGUI_InitExtImages', return_type=u8, size=62, line=142, arg_list=[('selectedLangId',u8)])
        self.WAGUI_P_SetExtFont = StaticFunction(device, 0x49d56, thumb=1, name='WAGUI_P_SetExtFont', return_type=PointerType('GUI_FONT'), size=44, line=274, arg_list=[('extFont',WAGUI_P_Res_t)])
