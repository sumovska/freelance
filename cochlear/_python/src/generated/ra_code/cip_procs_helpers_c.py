...
class Code(AbstractCode):
    ...
    def CIP2_GetNumberOfTokens(self, tokens):
        '''
        Arguments:
        -tokens - u32
        Return type:
    ...
    def CIP3_GetCoeffsForPolling(self, bte, pollingType, cip3_coeffs):
        '''
        Arguments:
        -bte - INT_Bte_t
        -pollingType - CIP_ProcPollingType_t
        -cip3_coeffs - PointerType("u16")
        Return type:
        -u8
    ...
    def CIP3_FillInWbst(self, outWbst, coefficientValues, coefficientList, coefficientListSize):
        '''
        Arguments:
        -outWbst - PointerType('WBST_BteSettings_t')
        -coefficientValues - PointerType("u8")
        -coefficientList - PointerType('u16')
        -coefficientListSize - u8
        Return type:
        -None
    ...
    def CIP_DetermineCipVersion(self, whoIsThereData):
        '''
        Arguments:
        -whoIsThereData - PointerType("CIP_WhoIsThereResult_t")
        Return type:
        -CIP_Version
        Declaration line: 23
        '''
    ...
    def CIP2_GetTokensForPolling(self, pollingType):
        '''
        Arguments:
        -pollingType - CIP_ProcPollingType_t
        Return type:
    ...
    def CIP2_GetTokenPtr(self, token, tokenValues, tokenList, tokenSize):
        '''
        Arguments:
        -token - u32
        -tokenValues - PointerType('u8')
        -tokenList - PointerType("u32")
        -tokenSize - u8
        Return type:
        -PointerType('u8')
    ...
    def CIP2_FillInWbst(self, outWbst, coeffValues, coeffList, coeffListSize):
        '''
        Arguments:
        -outWbst - PointerType("WBST_BteSettings_t")
        -coeffValues - PointerType('u8')
        -coeffList - PointerType("u32")
        -coeffListSize - u8
        Return type:
        -None
    ...
    def CIP3_GetCoeffPtr(self, coeff, coeffValues, coeffList, coeffListSize):
        '''
        Arguments:
        -coeff - u16
        -coeffValues - PointerType('u8')
        -coeffList - PointerType("CIP3_CoefficientId_t")
        -coeffListSize - u8
        Return type:
        -PointerType('u8')
    ...
    def CIP3_GetTokenPtr(self, token, tokenValues, tokenList, tokenListSize):
        '''
        Arguments:
        -token - u8
        -tokenValues - PointerType("u8")
        -tokenList - PointerType('CIP3_StatusToken_t')
        -tokenListSize - u8
        Return type:
        -PointerType("u8")
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.CIP2_GetNumberOfTokens = StaticFunction(device, 0x579d2, thumb=1, name='CIP2_GetNumberOfTokens', return_type=u8, size=38, line=94, arg_list=[('tokens',u32)])
        self.CIP3_GetCoeffsForPolling = StaticFunction(device, 0x57df4, thumb=1, name='CIP3_GetCoeffsForPolling', return_type=u8, size=302, line=472, arg_list=[('bte',INT_Bte_t),('pollingType',CIP_ProcPollingType_t),('cip3_coeffs',PointerType("u16"))])
        self.CIP3_FillInWbst = StaticFunction(device, 0x57f22, thumb=1, name='CIP3_FillInWbst', return_type=None, size=1196, line=540, arg_list=[('outWbst',PointerType('WBST_BteSettings_t')),('coefficientValues',PointerType("u8")),('coefficientList',PointerType('u16')),('coefficientListSize',u8)])
        self.CIP_DetermineCipVersion = StaticFunction(device, 0x57984, thumb=1, name='CIP_DetermineCipVersion', return_type=CIP_Version, size=46, line=23, arg_list=[('whoIsThereData',PointerType("CIP_WhoIsThereResult_t"))])
        self.CIP2_GetTokensForPolling = StaticFunction(device, 0x579b2, thumb=1, name='CIP2_GetTokensForPolling', return_type=u32, size=32, line=56, arg_list=[('pollingType',CIP_ProcPollingType_t)])
        self.CIP2_GetTokenPtr = StaticFunction(device, 0x579f8, thumb=1, name='CIP2_GetTokenPtr', return_type=PointerType('u8'), size=52, line=110, arg_list=[('token',u32),('tokenValues',PointerType('u8')),('tokenList',PointerType("u32")),('tokenSize',u8)])
        self.CIP2_FillInWbst = StaticFunction(device, 0x57a9c, thumb=1, name='CIP2_FillInWbst', return_type=None, size=856, line=179, arg_list=[('outWbst',PointerType("WBST_BteSettings_t")),('coeffValues',PointerType('u8')),('coeffList',PointerType("u32")),('coeffListSize',u8)])
        self.CIP3_GetCoeffPtr = StaticFunction(device, 0x57a66, thumb=1, name='CIP3_GetCoeffPtr', return_type=PointerType('u8'), size=54, line=156, arg_list=[('coeff',u16),('coeffValues',PointerType('u8')),('coeffList',PointerType("CIP3_CoefficientId_t")),('coeffListSize',u8)])
        self.CIP3_GetTokenPtr = StaticFunction(device, 0x57a2c, thumb=1, name='CIP3_GetTokenPtr', return_type=PointerType("u8"), size=58, line=133, arg_list=[('token',u8),('tokenValues',PointerType("u8")),('tokenList',PointerType('CIP3_StatusToken_t')),('tokenListSize',u8)])
