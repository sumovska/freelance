...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.GUI_GetFontDistY = StaticFunction(device, 0x2cf30, thumb=1, name='GUI_GetFontDistY', return_type=c_int_le, size=8, line=91, arg_list=[])
        self.GUI_DispNextLine = StaticFunction(device, 0x2cf38, thumb=1, name='GUI_DispNextLine', return_type=None, size=18, line=34, arg_list=[])
        self.GUI_GetYAdjust = StaticFunction(device, 0x2cf88, thumb=1, name='GUI_GetYAdjust', return_type=c_int_le, size=38, line=70, arg_list=[])
        self.GUI_GetCharDistX = StaticFunction(device, 0x2cfae, thumb=1, name='GUI_GetCharDistX', return_type=c_int_le, size=8, line=103, arg_list=[('c',c_ushort_le)])
        self.GL_DispChar = StaticFunction(device, 0x2cf4a, thumb=1, name='GL_DispChar', return_type=None, size=62, line=45, arg_list=[('c',c_ushort_le)])
