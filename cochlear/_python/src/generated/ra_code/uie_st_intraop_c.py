...
class Code(AbstractCode):
    ...
    def UIE_P_StIntraOpNrtResultElectrode(self, me, pEvt):
        '''
        Arguments:
        ...
        Return type:
        -HSM_StateRet_t
        Declaration line: 494
        '''
        pass

    def ShowIntraOpPromptAlarm(self, me, prompt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -prompt - WAGUI_IntraOpPrompt_t
        Return type:
        -None
        Declaration line: 1752
        '''
        pass

    def UIE_P_StIntraOpNrtFinishing(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1539
        '''
        pass

    def SetRaBeepVolume(self, me, volume, condSound):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -volume - c_int_le
        ...
        Return type:
        -None
        Declaration line: 1841
        '''
        pass

    def UIE_P_StIntraOpNrtResultProfile(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_StIntraOpNrtNotPossible(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_StIntraOpNrtInProgress(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 842
        '''
        pass

    def UIE_P_StIntraOpDiag(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def GetValidNrtMeasurements(self, ):
        '''
        Arguments:
        Return type:
        -c_int_le
    ...
    def ShowStIntraOpNrtProgress(self, me, updateMode, viewMode, stim, animFrame):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -updateMode - WAGUI_UpdateMode_t
        -viewMode - WAGUI_IntraOpNrtMode_t
        -stim - bool
        -animFrame - u8
        Return type:
        -None
        Declaration line: 815
        '''
        pass

    def UIE_P_IsIntraOpWarningPending(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1706
        '''
        pass

    def UIE_P_StIntraOpNrtInProgressProfile(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1161
        '''
        pass

    def UIE_P_StIntraOpNrtInit(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 759
        '''
        pass

    def UIE_P_StIntraOpNrtInProgressElectrode(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1143
        '''
        pass

    def UIE_P_StIntraOpCarousel(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def IsMClinicBteAvailable(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 1712
        '''
        pass

    def UIE_P_StIntraOpNrtInProgressTrace(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1179
        '''
        pass

    def UIE_P_StIntraOp(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
    ...
    def UIE_P_StIntraOpNrtPaused(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1240
        '''
        pass

    def UIE_P_StIntraOpSettingsEntry(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 1664
        '''
        pass

    def GetIntraOpPrompt(self, ):
        '''
        Arguments:
        Return type:
        -WAGUI_IntraOpPrompt_t
        Declaration line: 1723
        '''
        pass

    def UIE_P_StIntraOpWarning(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType("UIE_P_Sm_t")
        -pEvt - PointerType('UIE_P_SmEvent_t')
        Return type:
        -HSM_StateRet_t
        Declaration line: 180
        '''
        pass

    def GetDiagNrtElectrodeData(self, ):
        '''
        Arguments:
        Return type:
        -PointerType("WBST_ElectrodeData_t")
        Declaration line: 1783
        '''
        pass

    def UIE_P_StIntraOpHome(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_StIntraOpNrtConfirmation(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_StIntraOpDiagResult(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_StIntraOpNrtResultTrace(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 618
        '''
        pass

    def InvalidateBteResultData(self, ):
        '''
        Arguments:
        Return type:
        -None
        Declaration line: 1885
        '''
        pass

    def IsValidNrtTraceElectrodeData(self, nrtElNum):
        '''
        Arguments:
        -nrtElNum - c_int_le
        Return type:
        -c_int_le
        Declaration line: 1860
        '''
        pass

    def UIE_P_StIntraOpNrt(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 705
        '''
        pass

    def UIE_P_StIntraOpNrtInProgressCarousel(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
    ...
    def UIE_P_StIntraOpNrtCanceled(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 1449
        '''
        pass

    def GetBteEcapData(self, ):
        '''
        Arguments:
        Return type:
    ...
    def GetDiagCGElectrodeData(self, diagInited):
        '''
        Arguments:
        -diagInited - bool
        Return type:
        -PointerType("WBST_ElectrodeData_t")
        Declaration line: 1808
        '''
        pass

    def UIE_P_StIntraOpNrtNotWritten(self, me, pEvt):
        '''
        Arguments:
        -me - PointerType('UIE_P_Sm_t')
        -pEvt - PointerType("UIE_P_SmEvent_t")
        Return type:
        -HSM_StateRet_t
        Declaration line: 1494
        '''
        pass

    def GetNrtResultState(self, nrtViewMode):
        '''
        Arguments:
        -nrtViewMode - WAGUI_IntraOpNrtMode_t
        Return type:
        -HSM_State_t
        Declaration line: 1830
        '''
        pass
    ...
    def __init__(self, device):
        ...
        self.intraOpWarningConfirmed = StaticVariable(device, self.bool, 0x800085b4L, False)
        ...
        self.nrtSuspended = StaticVariable(device, self.bool, 0x800085b6L, False)
        ...
        self.resumeDiag = StaticVariable(device, self.bool, 0x800085b8L, False)
        ...
        self.diagInterrupted = StaticVariable(device, self.bool, 0x800085b7L, False)
        self.nrtViewMode = StaticVariable(device, self.WAGUI_IntraOpNrtMode_t, 0x800085b5L, False)
        ...
        self.playingCondSound = StaticVariable(device, self.bool, 0x800085b9L, False)
        ...
        self.nrtTraceViewElNum = StaticVariable(device, c_int_le, 0x800085c8L, False)
        ...
        ### Functions data ###
        ######################
        self.UIE_P_StIntraOpNrtResultElectrode = StaticFunction(device, 0x3f748, thumb=1, name='UIE_P_StIntraOpNrtResultElectrode', return_type=HSM_StateRet_t, size=204, line=494, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.ShowIntraOpPromptAlarm = StaticFunction(device, 0x3e854, thumb=1, name='ShowIntraOpPromptAlarm', return_type=None, size=100, line=1752, arg_list=[('me',PointerType('UIE_P_Sm_t')),('prompt',WAGUI_IntraOpPrompt_t)])
        self.UIE_P_StIntraOpNrtFinishing = StaticFunction(device, 0x3efe6, thumb=1, name='UIE_P_StIntraOpNrtFinishing', return_type=HSM_StateRet_t, size=192, line=1539, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.SetRaBeepVolume = StaticFunction(device, 0x3f2d0, thumb=1, name='SetRaBeepVolume', return_type=None, size=64, line=1841, arg_list=[('me',PointerType("UIE_P_Sm_t")),('volume',c_int_le),('condSound',bool)])
        self.UIE_P_StIntraOpNrtResultProfile = StaticFunction(device, 0x3ed44, thumb=1, name='UIE_P_StIntraOpNrtResultProfile', return_type=HSM_StateRet_t, size=146, line=556, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpNrtNotPossible = StaticFunction(device, 0x3ee36, thumb=1, name='UIE_P_StIntraOpNrtNotPossible', return_type=HSM_StateRet_t, size=152, line=1386, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpNrtInProgress = StaticFunction(device, 0x3f3f8, thumb=1, name='UIE_P_StIntraOpNrtInProgress', return_type=HSM_StateRet_t, size=606, line=842, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpDiag = StaticFunction(device, 0x3e8ec, thumb=1, name='UIE_P_StIntraOpDiag', return_type=HSM_StateRet_t, size=320, line=371, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.GetValidNrtMeasurements = StaticFunction(device, 0x3eb90, thumb=1, name='GetValidNrtMeasurements', return_type=c_int_le, size=42, line=1868, arg_list=[])
        self.ShowStIntraOpNrtProgress = StaticFunction(device, 0x3f27c, thumb=1, name='ShowStIntraOpNrtProgress', return_type=None, size=84, line=815, arg_list=[('me',PointerType('UIE_P_Sm_t')),('updateMode',WAGUI_UpdateMode_t),('viewMode',WAGUI_IntraOpNrtMode_t),('stim',bool),('animFrame',u8)])
        self.UIE_P_IsIntraOpWarningPending = StaticFunction(device, 0x3f9a6, thumb=1, name='UIE_P_IsIntraOpWarningPending', return_type=bool, size=26, line=1706, arg_list=[])
        self.UIE_P_StIntraOpNrtInProgressProfile = StaticFunction(device, 0x3f846, thumb=1, name='UIE_P_StIntraOpNrtInProgressProfile', return_type=HSM_StateRet_t, size=48, line=1161, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StIntraOpNrtInit = StaticFunction(device, 0x3f656, thumb=1, name='UIE_P_StIntraOpNrtInit', return_type=HSM_StateRet_t, size=126, line=759, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StIntraOpNrtInProgressElectrode = StaticFunction(device, 0x3f814, thumb=1, name='UIE_P_StIntraOpNrtInProgressElectrode', return_type=HSM_StateRet_t, size=50, line=1143, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StIntraOpCarousel = StaticFunction(device, 0x3e784, thumb=1, name='UIE_P_StIntraOpCarousel', return_type=HSM_StateRet_t, size=114, line=121, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.IsMClinicBteAvailable = StaticFunction(device, 0x3ef5e, thumb=1, name='IsMClinicBteAvailable', return_type=bool, size=24, line=1712, arg_list=[])
        self.UIE_P_StIntraOpNrtInProgressTrace = StaticFunction(device, 0x3f876, thumb=1, name='UIE_P_StIntraOpNrtInProgressTrace', return_type=HSM_StateRet_t, size=212, line=1179, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StIntraOp = StaticFunction(device, 0x3e6c4, thumb=1, name='UIE_P_StIntraOp', return_type=HSM_StateRet_t, size=50, line=98, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StIntraOpNrtPaused = StaticFunction(device, 0x3f10e, thumb=1, name='UIE_P_StIntraOpNrtPaused', return_type=HSM_StateRet_t, size=366, line=1240, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.UIE_P_StIntraOpSettingsEntry = StaticFunction(device, 0x3f94a, thumb=1, name='UIE_P_StIntraOpSettingsEntry', return_type=HSM_StateRet_t, size=92, line=1664, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.GetIntraOpPrompt = StaticFunction(device, 0x3ea2c, thumb=1, name='GetIntraOpPrompt', return_type=WAGUI_IntraOpPrompt_t, size=66, line=1723, arg_list=[])
        self.UIE_P_StIntraOpWarning = StaticFunction(device, 0x3e7f6, thumb=1, name='UIE_P_StIntraOpWarning', return_type=HSM_StateRet_t, size=94, line=180, arg_list=[('me',PointerType("UIE_P_Sm_t")),('pEvt',PointerType('UIE_P_SmEvent_t'))])
        self.GetDiagNrtElectrodeData = StaticFunction(device, 0x3ebea, thumb=1, name='GetDiagNrtElectrodeData', return_type=PointerType("WBST_ElectrodeData_t"), size=78, line=1783, arg_list=[])
        self.UIE_P_StIntraOpHome = StaticFunction(device, 0x3e6f6, thumb=1, name='UIE_P_StIntraOpHome', return_type=HSM_StateRet_t, size=142, line=223, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpNrtConfirmation = StaticFunction(device, 0x3ef76, thumb=1, name='UIE_P_StIntraOpNrtConfirmation', return_type=HSM_StateRet_t, size=112, line=1618, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpDiagResult = StaticFunction(device, 0x3ea6e, thumb=1, name='UIE_P_StIntraOpDiagResult', return_type=HSM_StateRet_t, size=270, line=288, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpNrtResultTrace = StaticFunction(device, 0x3ec38, thumb=1, name='UIE_P_StIntraOpNrtResultTrace', return_type=HSM_StateRet_t, size=268, line=618, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.InvalidateBteResultData = StaticFunction(device, 0x3edf2, thumb=1, name='InvalidateBteResultData', return_type=None, size=68, line=1885, arg_list=[])
        self.IsValidNrtTraceElectrodeData = StaticFunction(device, 0x3eb7c, thumb=1, name='IsValidNrtTraceElectrodeData', return_type=c_int_le, size=20, line=1860, arg_list=[('nrtElNum',c_int_le)])
        self.UIE_P_StIntraOpNrt = StaticFunction(device, 0x3f6d4, thumb=1, name='UIE_P_StIntraOpNrt', return_type=HSM_StateRet_t, size=116, line=705, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpNrtInProgressCarousel = StaticFunction(device, 0x3f310, thumb=1, name='UIE_P_StIntraOpNrtInProgressCarousel', return_type=HSM_StateRet_t, size=232, line=1061, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.UIE_P_StIntraOpNrtCanceled = StaticFunction(device, 0x3f0a6, thumb=1, name='UIE_P_StIntraOpNrtCanceled', return_type=HSM_StateRet_t, size=104, line=1449, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.GetBteEcapData = StaticFunction(device, 0x3ebba, thumb=1, name='GetBteEcapData', return_type=PointerType('WBST_EcapProfile_t'), size=48, line=1909, arg_list=[])
        self.GetDiagCGElectrodeData = StaticFunction(device, 0x3e8b8, thumb=1, name='GetDiagCGElectrodeData', return_type=PointerType("WBST_ElectrodeData_t"), size=52, line=1808, arg_list=[('diagInited',bool)])
        self.UIE_P_StIntraOpNrtNotWritten = StaticFunction(device, 0x3eece, thumb=1, name='UIE_P_StIntraOpNrtNotWritten', return_type=HSM_StateRet_t, size=144, line=1494, arg_list=[('me',PointerType('UIE_P_Sm_t')),('pEvt',PointerType("UIE_P_SmEvent_t"))])
        self.GetNrtResultState = StaticFunction(device, 0x3edd6, thumb=1, name='GetNrtResultState', return_type=HSM_State_t, size=28, line=1830, arg_list=[('nrtViewMode',WAGUI_IntraOpNrtMode_t)])
