...
class Code(AbstractCode):
    ...
    def GUIPROP_EXT__SetfpClearLine(self, fpClearLine):
        '''
        Arguments:
        -fpClearLine - PointerType('Subroutine')
        Return type:
        -None
        Declaration line: 96
        '''
    ...
    def GUIPROP_EXT__DispLine(self, s, Len):
        '''
        Arguments:
    ...
    def GUIPROP_EXT__ClearLine(self, s, Len):
        '''
        Arguments:
        -s - PointerType('c_byte')
        -Len - c_int_le
    ...
    _fpClearLine = PointerType("Subroutine")
    ...
    def __init__(self, device):
        ...
        self._fpClearLine = StaticVariable(device, PointerType("Subroutine"), 0x8000808cL, False)
        ...
        ### Functions data ###
        ######################
        self.GUIPROP_EXT__SetfpClearLine = StaticFunction(device, 0x30d4c, thumb=1, name='GUIPROP_EXT__SetfpClearLine', return_type=None, size=6, line=96, arg_list=[('fpClearLine',PointerType('Subroutine'))])
        self.GUIPROP_EXT__DispLine = StaticFunction(device, 0x30d0a, thumb=1, name='GUIPROP_EXT__DispLine', return_type=None, size=66, line=75, arg_list=[('s',PointerType("c_byte")),('Len',c_int_le)])
        self.GUIPROP_EXT__ClearLine = StaticFunction(device, 0x30c7c, thumb=1, name='GUIPROP_EXT__ClearLine', return_type=None, size=142, line=33, arg_list=[('s',PointerType('c_byte')),('Len',c_int_le)])
