...
class StreamingPairingState_t__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    PAIRING_RX_BC = 0
    PAIRING_TX_REQ = 1
    PAIRING_RX_RES = 2
...
class StreamingPairSasIdx_t__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    PAIR_SAS_IDX_NONE = 0
    PAIR_SAS_IDX1 = 8
    PAIR_SAS_IDX2 = 16
...
class StreamingPairFl2Type_t__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    PAIR_FL2_NONE = 0
    PAIR_FL2_SAS2 = 3
    PAIR_FL2_BTB2 = 9

class StreamingPairDevice_t__enumeration(c_ubyte,Enumed):
    _ctype = c_ubyte
    PAIR_DEV_SAS1 = 144
    PAIR_DEV_MINIMIC = 146
    PAIR_DEV_FARLANDER2 = 147
...
StreamingPairDevice_t = StreamingPairDevice_t__enumeration
StreamingPairFl2Type_t = StreamingPairFl2Type_t__enumeration
StreamingState_t = StreamingState_t__enumeration
StreamingPairSasIdx_t = StreamingPairSasIdx_t__enumeration
OS_FLAGS = INT16U
StreamingPairingState_t = StreamingPairingState_t__enumeration
...
class InterferingCtx_t__structure(Structure):
    rfFreqChannel = u8
    nordicPower = u8
    pwrReg = byte
    _pack_ = 1
...
class StreamingRtPairingCtx_t__structure(Structure):
    state = StreamingPairingState_t
    leftBcBeacons = u16
    pfcIdx = u8
    spAddress = u8 * 4
    pfcTimer = u32
    timeout = u32
    firstPairingRespReceived = bool
    packetsCounter = u8
    _fields_ = [
                ('state', StreamingPairingState_t),
                ('leftBcBeacons', u16),
...
class StreamingPairReq_t__structure(Structure):
    header = u8
    parity = u8
    reserved = u8
    length = u8
...
InterferingCtx_t = InterferingCtx_t__structure
StreamingRtPairingCtx_t = StreamingRtPairingCtx_t__structure
...
StreamingPairReq_t = StreamingPairReq_t__structure
...
class StreamingPairingCtx_t__structure(Structure):
    noOfBeacons = u16
    requestDelay = u32
    streamAddr = u8 * 4
    spAddr = u8 * 4
    filterSpAddr = bool
    pairReq = StreamingPairReq_t
    pPairReqBuf = PointerType('u8')
    _fields_ = [
                ('noOfBeacons', u16),
                ('requestDelay', u32),
                ('streamAddr', u8 * 4),
...
StreamingPairingCtx_t = StreamingPairingCtx_t__structure
...
class const():
    ...
    TRUE = 1
    NULL = 0
    NORDIC_RF_FREQ_MIN = 0
    NORDIC_RF_FREQ_MAX = 82
...
class Code(AbstractCode):
    ...
    ### Enums ###
    #############
    StreamingPairingState_t__enumeration = StreamingPairingState_t__enumeration
    ...
    StreamingPairSasIdx_t__enumeration = StreamingPairSasIdx_t__enumeration
    INT_FiniType_tag = INT_FiniType_tag
    StreamingPairFl2Type_t__enumeration = StreamingPairFl2Type_t__enumeration
    StreamingPairDevice_t__enumeration = StreamingPairDevice_t__enumeration
    ...
    StreamingPairDevice_t = StreamingPairDevice_t
    StreamingPairFl2Type_t = StreamingPairFl2Type_t
    StreamingState_t = StreamingState_t
    StreamingPairSasIdx_t = StreamingPairSasIdx_t
    OS_FLAGS = OS_FLAGS
    StreamingPairingState_t = StreamingPairingState_t
    INT_FiniType_t = INT_FiniType_t
    os_sem_data = os_sem_data
    os_flag_grp = os_flag_grp
    InterferingCtx_t__structure = InterferingCtx_t__structure
    os_tcb = os_tcb
    os_mem_data = os_mem_data
    os_mbox_data = os_mbox_data
    os_stk_data = os_stk_data
    StreamingPfc_t__structure = StreamingPfc_t__structure
    StreamingRtPairingCtx_t__structure = StreamingRtPairingCtx_t__structure
    os_mutex_data = os_mutex_data
    os_flag_node = os_flag_node
    ...
    os_event = os_event
    StreamingPairReq_t__structure = StreamingPairReq_t__structure
    os_tmr_wheel = os_tmr_wheel
    os_mem = os_mem
    os_tmr = os_tmr
    ...
    OS_Q_DATA = OS_Q_DATA
    OS_MUTEX_DATA = OS_MUTEX_DATA
    InterferingCtx_t = InterferingCtx_t
    StreamingRtPairingCtx_t = StreamingRtPairingCtx_t
    OS_SEM_DATA = OS_SEM_DATA
    OS_FLAG_GRP = OS_FLAG_GRP
    OS_MEM_DATA = OS_MEM_DATA
    OS_TMR_WHEEL = OS_TMR_WHEEL
    ...
    StreamingPairReq_t = StreamingPairReq_t
    ...
    StreamingPairingCtx_t__structure = StreamingPairingCtx_t__structure
    ...
    StreamingPairingCtx_t = StreamingPairingCtx_t
    ...
    def StreamingGetTxBufferSize(self, ):
        '''
        Arguments:
        Return type:
        -u16
        Declaration line: 318
        '''
        pass

    def StreamingGetRxDataAddress(self, ):
        '''
        Arguments:
        Return type:
        -PointerType("u8")
    ...
    def StreamingSetTxDataAddress(self, txAddress):
        '''
        Arguments:
        -txAddress - PointerType('u8')
        Return type:
        -None
        Declaration line: 398
        '''
        pass

    def StreamingStartAbbax(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def StreamingStart(self, pattern):
        '''
        Arguments:
        -pattern - PointerType("StreamingPattern_t")
        Return type:
        -None
    ...
    def StreamingInit(self, originalEint3Isr, stackPointer, stackSize):
        '''
        Arguments:
        -originalEint3Isr - IsrPtr_t
        -stackPointer - PointerType('OS_STK')
        -stackSize - u32
        Return type:
        -u8
        Declaration line: 28
    ...
    def StreamingGetDefaultSlotDuration(self, ):
        '''
        Arguments:
        Return type:
        -u32
    ...
    def StreamingSetTxAddress(self, txAddress):
        '''
        Arguments:
        -txAddress - PointerType("u8")
        Return type:
    ...
    def StreamingGetTxAddress(self, ):
        '''
        Arguments:
        Return type:
        -PointerType('u8')
    ...
    def StreamingGetPfcTable(self, pfc):
        '''
        Arguments:
        -pfc - PointerType("u8")
        Return type:
    ...
    def StreamingPair(self, streamerAddress, device, fl2Type, extIdx, spAddress, brandInfo):
        '''
        Arguments:
        -streamerAddress - PointerType('u8')
        -device - u8
        -fl2Type - u8
        -extIdx - u8
        -spAddress - PointerType("u8")
        -brandInfo - u8
        Return type:
        -None
        Declaration line: 569
        '''
        pass

    def StreamingSendM2Sequence(self, ):
        '''
        Arguments:
        Return type:
        -bool
        Declaration line: 532
        '''
        pass

    def StreamingSetSlotDuration(self, ns):
        '''
        Arguments:
        -ns - u32
        Return type:
        -None
        Declaration line: 456
        '''
        pass

    def StreamingGetTxDataBufferAddr(self, ):
        '''
        Arguments:
        Return type:
        -PointerType('u8')
    ...
    def StreamingPairRaw(self, pairingCtx):
        '''
        Arguments:
        -pairingCtx - PointerType("StreamingPairingCtx_t")
        Return type:
        -None
    ...
    def StreamingSetPfcTable(self, pfc):
        '''
        Arguments:
        -pfc - PointerType('u8')
        Return type:
        -None
        Declaration line: 251
        '''
        pass

    def StreamingDisablePfc(self, pfcIndex):
        '''
        Arguments:
        -pfcIndex - u8
        Return type:
    ...
    def StreamingSetTxBufferSize(self, size):
        '''
        Arguments:
        -size - u16
        Return type:
    ...
    def StreamingSetTxDataBufferSize(self, size):
        '''
        Arguments:
        -size - u16
        Return type:
        -None
        Declaration line: 347
        '''
        pass

    def InterferingStart(self, rfFreqChannel, nordicPower):
        '''
        Arguments:
        -rfFreqChannel - u8
        -nordicPower - u8
        Return type:
        -None
        Declaration line: 213
        '''
        pass

    def InterferingStop(self, ):
        '''
        Arguments:
        Return type:
        -None
    ...
    def StreamingGetTxBufferAddr(self, ):
        '''
        Arguments:
        Return type:
        -PointerType("u8")
        Declaration line: 312
        '''
        pass

    def StreamingGetRxDataBufferAddr(self, ):
        '''
        Arguments:
        Return type:
        -PointerType('u8')
    ...
    def StreamingSetRxDataAddress(self, rxAddress):
        '''
        Arguments:
        -rxAddress - PointerType("u8")
        Return type:
        -None
    ...
    def StreamingEnablePfc(self, pfcIndex):
        '''
        Arguments:
        -pfcIndex - u8
        Return type:
    ...
    def StreamingGetTxDataAddress(self, ):
        '''
        Arguments:
        Return type:
        -PointerType('u8')
    ...
    def StreamingGetTxDataBufferSize(self, ):
        '''
        Arguments:
        Return type:
        -u16
    ...
    def StreamingGetSlotDuration(self, ):
        '''
        Arguments:
        Return type:
        -u32
        Declaration line: 465
        '''
        pass
    ...
    def StreamingSendDataPackets(self, sequence):
        '''
        Arguments:
        -sequence - PointerType("StreamingDataSeqDesc_t")
        Return type:
        -bool
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.StreamingGetTxBufferSize = StaticFunction(device, 0x8100a540L, thumb=0, name='StreamingGetTxBufferSize', project='streaming_functions', return_type=u16, size=12, line=318, arg_list=[])
        self.StreamingGetRxDataAddress = StaticFunction(device, 0x8100a610L, thumb=0, name='StreamingGetRxDataAddress', project='streaming_functions', return_type=PointerType("u8"), size=8, line=445, arg_list=[])
        self.StreamingSetTxDataAddress = StaticFunction(device, 0x8100a5b8L, thumb=0, name='StreamingSetTxDataAddress', project='streaming_functions', return_type=None, size=40, line=398, arg_list=[('txAddress',PointerType('u8'))])
        self.StreamingStartAbbax = StaticFunction(device, 0x8100a3f0L, thumb=0, name='StreamingStartAbbax', project='streaming_functions', return_type=None, size=20, line=170, arg_list=[])
        self.StreamingStart = StaticFunction(device, 0x8100a2c8L, thumb=0, name='StreamingStart', project='streaming_functions', return_type=None, size=236, line=102, arg_list=[('pattern',PointerType("StreamingPattern_t"))])
        self.StreamingInit = StaticFunction(device, 0x8100a18cL, thumb=0, name='StreamingInit', project='streaming_functions', return_type=u8, size=172, line=28, arg_list=[('originalEint3Isr',IsrPtr_t),('stackPointer',PointerType('OS_STK')),('stackSize',u32)])
        ...
        self.ReturnToIdle = StaticFunction(device, 0x8100a404L, thumb=0, name='ReturnToIdle', project='streaming_functions', return_type=None, size=68, line=180, arg_list=[])
        self.StreamingGetDefaultSlotDuration = StaticFunction(device, 0x8100a644L, thumb=0, name='StreamingGetDefaultSlotDuration', project='streaming_functions', return_type=u32, size=8, line=478, arg_list=[])
        self.StreamingSetTxAddress = StaticFunction(device, 0x8100a588L, thumb=0, name='StreamingSetTxAddress', project='streaming_functions', return_type=None, size=40, line=367, arg_list=[('txAddress',PointerType("u8"))])
        self.StreamingGetTxAddress = StaticFunction(device, 0x8100a5b0L, thumb=0, name='StreamingGetTxAddress', project='streaming_functions', return_type=PointerType('u8'), size=8, line=385, arg_list=[])
        self.StreamingGetPfcTable = StaticFunction(device, 0x8100a4e4L, thumb=0, name='StreamingGetPfcTable', project='streaming_functions', return_type=None, size=40, line=268, arg_list=[('pfc',PointerType("u8"))])
        self.StreamingPair = StaticFunction(device, 0x8100a768L, thumb=0, name='StreamingPair', project='streaming_functions', return_type=None, size=172, line=569, arg_list=[('streamerAddress',PointerType('u8')),('device',u8),('fl2Type',u8),('extIdx',u8),('spAddress',PointerType("u8")),('brandInfo',u8)])
        self.StreamingSendM2Sequence = StaticFunction(device, 0x8100a708L, thumb=0, name='StreamingSendM2Sequence', project='streaming_functions', return_type=bool, size=32, line=532, arg_list=[])
        self.StreamingSetSlotDuration = StaticFunction(device, 0x8100a618L, thumb=0, name='StreamingSetSlotDuration', project='streaming_functions', return_type=None, size=24, line=456, arg_list=[('ns',u32)])
        self.StreamingGetTxDataBufferAddr = StaticFunction(device, 0x8100a558L, thumb=0, name='StreamingGetTxDataBufferAddr', project='streaming_functions', return_type=PointerType('u8'), size=12, line=335, arg_list=[])
        self.StreamingFini = StaticFunction(device, 0x8100a238L, thumb=0, name='StreamingFini', project='streaming_functions', return_type=u8, size=144, line=77, arg_list=[])
        self.StreamingStop = StaticFunction(device, 0x8100a448L, thumb=0, name='StreamingStop', project='streaming_functions', return_type=None, size=16, line=199, arg_list=[])
        self.StreamingPairRaw = StaticFunction(device, 0x8100a728L, thumb=0, name='StreamingPairRaw', project='streaming_functions', return_type=None, size=64, line=548, arg_list=[('pairingCtx',PointerType("StreamingPairingCtx_t"))])
        self.StreamingSetPfcTable = StaticFunction(device, 0x8100a4b0L, thumb=0, name='StreamingSetPfcTable', project='streaming_functions', return_type=None, size=52, line=251, arg_list=[('pfc',PointerType('u8'))])
        self.StreamingDisablePfc = StaticFunction(device, 0x8100a520L, thumb=0, name='StreamingDisablePfc', project='streaming_functions', return_type=None, size=20, line=296, arg_list=[('pfcIndex',u8)])
        self.StreamingSetTxBufferSize = StaticFunction(device, 0x8100a54cL, thumb=0, name='StreamingSetTxBufferSize', project='streaming_functions', return_type=None, size=12, line=329, arg_list=[('size',u16)])
        self.StreamingSetTxDataBufferSize = StaticFunction(device, 0x8100a570L, thumb=0, name='StreamingSetTxDataBufferSize', project='streaming_functions', return_type=None, size=12, line=347, arg_list=[('size',u16)])
        self.InterferingStart = StaticFunction(device, 0x8100a458L, thumb=0, name='InterferingStart', project='streaming_functions', return_type=None, size=68, line=213, arg_list=[('rfFreqChannel',u8),('nordicPower',u8)])
        self.InterferingStop = StaticFunction(device, 0x8100a49cL, thumb=0, name='InterferingStop', project='streaming_functions', return_type=None, size=20, line=234, arg_list=[])
        self.StreamingGetTxBufferAddr = StaticFunction(device, 0x8100a534L, thumb=0, name='StreamingGetTxBufferAddr', project='streaming_functions', return_type=PointerType("u8"), size=12, line=312, arg_list=[])
        self.StreamingGetRxDataBufferAddr = StaticFunction(device, 0x8100a57cL, thumb=0, name='StreamingGetRxDataBufferAddr', project='streaming_functions', return_type=PointerType('u8'), size=12, line=353, arg_list=[])
        self.StreamingSetRxDataAddress = StaticFunction(device, 0x8100a5e8L, thumb=0, name='StreamingSetRxDataAddress', project='streaming_functions', return_type=None, size=40, line=428, arg_list=[('rxAddress',PointerType("u8"))])
        self.StreamingEnablePfc = StaticFunction(device, 0x8100a50cL, thumb=0, name='StreamingEnablePfc', project='streaming_functions', return_type=None, size=20, line=284, arg_list=[('pfcIndex',u8)])
        self.StreamingGetTxDataAddress = StaticFunction(device, 0x8100a5e0L, thumb=0, name='StreamingGetTxDataAddress', project='streaming_functions', return_type=PointerType('u8'), size=8, line=415, arg_list=[])
        self.StreamingStartA2dp = StaticFunction(device, 0x8100a3dcL, thumb=0, name='StreamingStartA2dp', project='streaming_functions', return_type=None, size=20, line=158, arg_list=[])
        self.StreamingStartAbba = StaticFunction(device, 0x8100a3c8L, thumb=0, name='StreamingStartAbba', project='streaming_functions', return_type=None, size=20, line=146, arg_list=[])
        self.StreamingGetTxDataBufferSize = StaticFunction(device, 0x8100a564L, thumb=0, name='StreamingGetTxDataBufferSize', project='streaming_functions', return_type=u16, size=12, line=341, arg_list=[])
        self.StreamingGetSlotDuration = StaticFunction(device, 0x8100a630L, thumb=0, name='StreamingGetSlotDuration', project='streaming_functions', return_type=u32, size=20, line=465, arg_list=[])
        ...
        self.StreamingStartAbx = StaticFunction(device, 0x8100a3b4L, thumb=0, name='StreamingStartAbx', project='streaming_functions', return_type=None, size=20, line=134, arg_list=[])
        self.StreamingSendDataPackets = StaticFunction(device, 0x8100a64cL, thumb=0, name='StreamingSendDataPackets', project='streaming_functions', return_type=bool, size=188, line=491, arg_list=[('sequence',PointerType("StreamingDataSeqDesc_t"))])
