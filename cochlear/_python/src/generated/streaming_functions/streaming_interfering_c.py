...
class Code(AbstractCode):
    ...
    def SelectInterferingPower(self, nordicPower):
        '''
        Arguments:
        -nordicPower - u8
        Return type:
    ...
    def InterferingInit(self, ctx):
        '''
        Arguments:
        -ctx - PointerType("InterferingCtx_t")
        Return type:
        -None
        Declaration line: 21
        '''
    ...
    interferingCtx = InterferingCtx_t
    ...
    def __init__(self, device):
        ...
        ### Variables ###
        #################
        self.interferingCtx = StaticVariable(device, self.InterferingCtx_t, 0x7fe036a4, False)
        ...
        self.InterferingFini = StaticFunction(device, 0x7fe03398, thumb=0, name='InterferingFini', project='streaming_functions', return_type=None, size=76, line=49, arg_list=[])
        self.SelectInterferingPower = StaticFunction(device, 0x7fe03264, thumb=0, name='SelectInterferingPower', project='streaming_functions', return_type=u8, size=68, line=7, arg_list=[('nordicPower',u8)])
        self.InterferingInit = StaticFunction(device, 0x7fe032a8, thumb=0, name='InterferingInit', project='streaming_functions', return_type=None, size=240, line=21, arg_list=[('ctx',PointerType("InterferingCtx_t"))])
