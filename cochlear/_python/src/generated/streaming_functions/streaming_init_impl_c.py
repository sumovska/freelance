...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Variables ###
        #################
        self.finiFunctions = StaticVariable(device, INT_FiniFun_t * 9, 0x7fe03678, False)

        ######################
        ### Functions data ###
        ######################
        self.StreamStopRaFw = StaticFunction(device, 0x8100a0b4L, thumb=0, name='StreamStopRaFw', project='streaming_functions', return_type=None, size=212, line=53, arg_list=[])
