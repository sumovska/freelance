...
class Code(AbstractCode):
    ...
    def __init__(self, device):
        ...
        ### Functions data ###
        ######################
        self.reverse = StaticFunction(device, 0x7fe03214, thumb=0, name='reverse', project='streaming_functions', return_type=None, size=80, line=16, arg_list=[('buf',PointerType('u8')),('size',u16)])
